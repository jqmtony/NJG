 ...
 * output class name
 */
public abstract class AbstractBPMLogListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBPMLogListUI.class);
    /**
     * output class constructor
     */
    public AbstractBPMLogListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.bpm.app.BPMLogListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.bpm.client", "BPMLogListUI");
    }
