...
public class MaterialEnterPlanEntry extends BillEntryBase implements IMaterialEnterPlanEntry
{
    public MaterialEnterPlanEntry()
    {
        super();
        registerInterface(IMaterialEnterPlanEntry.class, this);
    }
    public MaterialEnterPlanEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMaterialEnterPlanEntry.class, this);
    }
    ...
    private MaterialEnterPlanEntryController getController() throws BOSException
    {
        return (MaterialEnterPlanEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialEnterPlanEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
