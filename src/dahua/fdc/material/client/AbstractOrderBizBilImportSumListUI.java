 ...
 * output class name
 */
public abstract class AbstractOrderBizBilImportSumListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOrderBizBilImportSumListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDButton kDButton1;
    protected com.kingdee.bos.ctrl.swing.KDButton kDButton2;
    /**
     * output class constructor
     */
    public AbstractOrderBizBilImportSumListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOrderBizBilImportSumListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","chk","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","entrys.id","handler.number","handler.name","entrys.seq","Fivouchered","entrys.curProject.name","entrys.supplier.name","entrys.material.number","entrys.materialName","entrys.model","entrys.unit.name","entrys.quantity","entrys.planQuantity","entrys.orderQuantity","entrys.enterTime","entrys.contractUnit.name","state","contractBill.name","contractBill.number","materialBill.name","materialBill.number"});
    ...
    public void initUIContentLayout()
    {
        ...
        kDButton1.setBounds(new Rectangle(916, 601, 73, 21));
        this.add(kDButton1, null);
        kDButton2.setBounds(new Rectangle(810, 601, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.material.app.OrderBizBilImportSumListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.material.client", "OrderBizBilImportSumListUI");
    }
