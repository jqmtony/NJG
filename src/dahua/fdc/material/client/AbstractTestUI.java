 ...
 * output class name
 */
public abstract class AbstractTestUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        // kDContainer1
        // tblMaterial		
        this.tblMaterial.setFormatXml(resHelper.getString("tblMaterial.formatXml"));
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMaterial, BorderLayout.CENTER);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.material.client", "TestUI");
    }
