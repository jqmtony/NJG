 ...
 * output class name
 */
public abstract class AbstractMaterialBaseListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMaterialBaseListUI.class);
     ...
     */
    public AbstractMaterialBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMaterialBaseListUI.class.getName());
        ...
        // kDSplitPane1		
        this.kDSplitPane1.setAlignmentX(0.2f);		
        this.kDSplitPane1.setAlignmentY(0.8f);		
        this.kDSplitPane1.setDividerLocation(200);
        // kDTreeView1
        // kDContainer1
        // kDTree1		
        this.kDTree1.setAlignmentX(0.2f);		
        this.kDTree1.setPreferredSize(new Dimension(78,20));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDSplitPane1.setBounds(new Rectangle(10, 128, 994, 499));
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.material.app.MaterialBaseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.material.client", "MaterialBaseListUI");
    }
