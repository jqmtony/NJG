...
public class MaterialTreeUtil {
	...
	/**私有构造方法*/
	private MaterialTreeUtil(){};
	/**声明*/
	private static MaterialTreeUtil materialTreeUtil = null;
	 ...
	 * @see  
	*/
	public static synchronized MaterialTreeUtil getMaterialTree(){
		/*
		 * 如果未被实例化则实例化
		 * 否则就直接返回
		 */
		if (materialTreeUtil  == null) {
			return materialTreeUtil = new MaterialTreeUtil();
		}else
	 ...
	 *	@param ITreeBase treeBaseFactoryRemoteInstance 基础数据工厂实例
