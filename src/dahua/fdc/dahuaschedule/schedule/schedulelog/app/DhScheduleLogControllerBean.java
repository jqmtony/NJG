...
public class DhScheduleLogControllerBean extends AbstractDhScheduleLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.dahuaschedule.schedule.schedulelog.app.DhScheduleLogControllerBean");
}