...
public class DahuaScheduleControllerBean extends AbstractDahuaScheduleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.dahuaschedule.schedule.app.DahuaScheduleControllerBean");
}