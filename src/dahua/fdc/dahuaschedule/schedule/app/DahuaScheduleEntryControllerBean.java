...
public class DahuaScheduleEntryControllerBean extends AbstractDahuaScheduleEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.dahuaschedule.schedule.app.DahuaScheduleEntryControllerBean");
}