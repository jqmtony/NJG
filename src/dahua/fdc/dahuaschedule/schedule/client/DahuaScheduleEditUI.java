 ...
 * output class name
 */
public class DahuaScheduleEditUI extends AbstractDahuaScheduleEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DahuaScheduleEditUI.class);
    
    /**
     * output class constructor
     */
    public DahuaScheduleEditUI() throws Exception
    {
        super();
    }
