 ...
 * output class name
 */
public abstract class AbstractDahuaScheduleListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDahuaScheduleListUI.class);
     ...
     */
    public AbstractDahuaScheduleListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDahuaScheduleListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.dahuaschedule.schedule.app", "DahuaScheduleQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(3, 4, 1006, 624));
        this.add(kDSplitPane1, new KDLayout.Constraints(3, 4, 1006, 624, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.dahuaschedule.schedule.app.DahuaScheduleListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDahuaScheduleListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDahuaScheduleListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.dahuaschedule.schedule.client", "DahuaScheduleListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","name","project.name","version","bizDate","creator.name","createTime","auditor.name","lastUpdateUser.name","lastUpdateTime"};
    }
