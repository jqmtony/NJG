...
public class AbstractAimCostInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    ...
    /**
     * Object:目标成本's 由目标本成调整单生成标志property 
     */
    public String getGenByAdjust()
    {
        return getString("genByAdjust");
    }
    public void setGenByAdjust(String item)
    {
        setString("genByAdjust", item);
    }
