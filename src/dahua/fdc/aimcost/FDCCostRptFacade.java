...
public class FDCCostRptFacade extends AbstractBizCtrl implements IFDCCostRptFacade
{
    ...
    /**
 *更新成本明细信息[指定工程项目]-User defined method
     */
    public void updateProjectCostDetail() throws BOSException, EASBizException
    {
        try {
            getController().updateProjectCostDetail(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    }
     /*getFullDynamicCost2-User defined method
     *@param priId 项目ID
     *@param period 期间
     *@return
     */
    public FullDynamicCostMap getFullDynamicCost2(String priId, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            return getController().getFullDynamicCost2(getContext(), priId, period);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@param param param
     */
    public void updateProjectCostDetail(Map param) throws BOSException, EASBizException
    {
        try {
            getController().updateProjectCostDetail(getContext(), param);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
