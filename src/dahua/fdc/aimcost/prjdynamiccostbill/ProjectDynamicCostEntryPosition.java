...
public class ProjectDynamicCostEntryPosition extends CoreBillEntryBase implements IProjectDynamicCostEntryPosition
{
    public ProjectDynamicCostEntryPosition()
    {
        super();
        registerInterface(IProjectDynamicCostEntryPosition.class, this);
    }
    public ProjectDynamicCostEntryPosition(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectDynamicCostEntryPosition.class, this);
    }
    ...
    private ProjectDynamicCostEntryPositionController getController() throws BOSException
    {
        return (ProjectDynamicCostEntryPositionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntryPositionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
