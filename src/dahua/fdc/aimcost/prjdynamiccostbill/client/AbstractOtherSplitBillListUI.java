 ...
 * output class name
 */
public abstract class AbstractOtherSplitBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOtherSplitBillListUI.class);
     ...
     */
    public AbstractOtherSplitBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOtherSplitBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.app", "OtherSplitBillQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(4, 5, 1004, 618));
        this.add(kDSplitPane1, new KDLayout.Constraints(4, 5, 1004, 618, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.app.OtherSplitBillListUIHandler";
	}
...
com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.OtherSplitBillInfo editData = (com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.OtherSplitBillInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.OtherSplitBillFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOtherSplitBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOtherSplitBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOtherSplitBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOtherSplitBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.client", "OtherSplitBillListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","curProject.name","contract.name","adjustAmount","comment","state","description","createTime","creator.name","auditTime","auditor.name","lastUpdateTime","lastUpdateUser.name"};
    }
