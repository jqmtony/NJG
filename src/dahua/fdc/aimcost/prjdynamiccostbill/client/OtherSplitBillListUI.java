 ...
 * output class name
 */
public class OtherSplitBillListUI extends AbstractOtherSplitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherSplitBillListUI.class);
    protected Set authorizedOrgs = null;
    /**
     * output class constructor
     */
    public OtherSplitBillListUI() throws Exception
    {
        super();
    }
