...
public class OtherSplitBillEntryControllerBean extends AbstractOtherSplitBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.app.OtherSplitBillEntryControllerBean");
}