...
public class OtherSplitNewEntryControllerBean extends AbstractOtherSplitNewEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.prjdynamiccostbill.app.OtherSplitNewEntryControllerBean");
}