...
public class ProjectDynamicCostEentryTotal extends CoreBillEntryBase implements IProjectDynamicCostEentryTotal
{
    public ProjectDynamicCostEentryTotal()
    {
        super();
        registerInterface(IProjectDynamicCostEentryTotal.class, this);
    }
    public ProjectDynamicCostEentryTotal(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectDynamicCostEentryTotal.class, this);
    }
    ...
    private ProjectDynamicCostEentryTotalController getController() throws BOSException
    {
        return (ProjectDynamicCostEentryTotalController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEentryTotalCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
