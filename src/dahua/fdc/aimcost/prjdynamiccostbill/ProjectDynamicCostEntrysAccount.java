...
public class ProjectDynamicCostEntrysAccount extends CoreBillEntryBase implements IProjectDynamicCostEntrysAccount
{
    public ProjectDynamicCostEntrysAccount()
    {
        super();
        registerInterface(IProjectDynamicCostEntrysAccount.class, this);
    }
    public ProjectDynamicCostEntrysAccount(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectDynamicCostEntrysAccount.class, this);
    }
    ...
    private ProjectDynamicCostEntrysAccountController getController() throws BOSException
    {
        return (ProjectDynamicCostEntrysAccountController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrysAccountCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
