...
public class ProjectDynamicCostEntrySixMonth extends CoreBillEntryBase implements IProjectDynamicCostEntrySixMonth
{
    public ProjectDynamicCostEntrySixMonth()
    {
        super();
        registerInterface(IProjectDynamicCostEntrySixMonth.class, this);
    }
    public ProjectDynamicCostEntrySixMonth(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectDynamicCostEntrySixMonth.class, this);
    }
    ...
    private ProjectDynamicCostEntrySixMonthController getController() throws BOSException
    {
        return (ProjectDynamicCostEntrySixMonthController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectDynamicCostEntrySixMonthCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
