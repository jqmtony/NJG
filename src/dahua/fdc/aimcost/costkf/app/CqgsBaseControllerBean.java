...
public class CqgsBaseControllerBean extends AbstractCqgsBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.costkf.app.CqgsBaseControllerBean");
}