 ...
 * output class name
 */
public abstract class AbstractUsesListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractUsesListUI.class);
    /**
     * output class constructor
     */
    public AbstractUsesListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.costkf.app.UsesListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.costkf.client", "UsesListUI");
    }
