...
public class FDCProjectCostDetailControllerBean extends AbstractFDCProjectCostDetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.FDCProjectCostDetailControllerBean");
}