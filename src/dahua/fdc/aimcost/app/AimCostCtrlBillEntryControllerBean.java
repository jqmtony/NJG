...
public class AimCostCtrlBillEntryControllerBean extends AbstractAimCostCtrlBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.AimCostCtrlBillEntryControllerBean");
}