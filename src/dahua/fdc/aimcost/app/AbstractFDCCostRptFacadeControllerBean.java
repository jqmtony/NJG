...
public abstract class AbstractFDCCostRptFacadeControllerBean extends AbstractBizControllerBean implements FDCCostRptFacadeController
{
    ...
    public AimCostMap getAimCost(Context ctx, String orgOrPrjId, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            ...
            return (AimCostMap)svcCtx.getMethodReturnValue();
    ...
    public ProductAimCostMap getProductAimCost(Context ctx, String prjId, ProjectStageEnum indexProjectStage, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceAfter(svcCtx);
            return (ProductAimCostMap)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
            throw ex0;
    ...
    public FullDynamicCostMap getFullDynamicCost(Context ctx, String prjId, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceAfter(svcCtx);
            return (FullDynamicCostMap)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
            throw ex0;
    ...
    public ProductDynamicCostMap getProductDynamicCost(Context ctx, String prjId, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceAfter(svcCtx);
            return (ProductDynamicCostMap)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
            throw ex0;
    ...
    public DynamicCostMap getDynamicCost(Context ctx, String prjId, PeriodInfo period, boolean isLeaf) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceAfter(svcCtx);
            return (DynamicCostMap)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
            throw ex0;
    ...
    public FullDynamicCostMap getFullDynamicCost2(Context ctx, String priId, PeriodInfo period) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("89646583-5704-4cc8-b6ce-b3ca40821eeb"), new Object[]{ctx, priId, period});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
            FullDynamicCostMap retValue = (FullDynamicCostMap)_getFullDynamicCost2(ctx, priId, period);
            svcCtx.setMethodReturnValue(retValue);
            }
            invokeServiceAfter(svcCtx);
            return (FullDynamicCostMap)svcCtx.getMethodReturnValue();
    ...
    protected abstract FullDynamicCostMap _getFullDynamicCost2(Context ctx, String priId, IObjectValue period) throws BOSException, EASBizException;
    public void updateProjectCostDetail(Context ctx) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("1ebd6454-431b-4d36-b36b-67879fefe955"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            _updateProjectCostDetail(ctx);
            invokeServiceAfter(svcCtx);
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
    ...
    protected abstract void _updateProjectCostDetail(Context ctx) throws BOSException, EASBizException;

    public void updateProjectCostDetail(Context ctx, Map param) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("620271e3-3e2d-4a4c-a8ca-112912973de8"), new Object[]{ctx, param});
            invokeServiceBefore(svcCtx);
            _updateProjectCostDetail(ctx, param);
            invokeServiceAfter(svcCtx);
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
    ...
    protected abstract void _updateProjectCostDetail(Context ctx, Map param) throws BOSException, EASBizException;
