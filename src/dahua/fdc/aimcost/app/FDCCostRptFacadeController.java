...
public interface FDCCostRptFacadeController extends BizController
{
    ...
    public FullDynamicCostMap getFullDynamicCost2(Context ctx, String priId, PeriodInfo period) throws BOSException, EASBizException, RemoteException;
   
    public void updateProjectCostDetail(Context ctx) throws BOSException, EASBizException, RemoteException;
    public void updateProjectCostDetail(Context ctx,Map param) throws BOSException, EASBizException, RemoteException;
