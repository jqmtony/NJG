 ...
 * output class name
 */
public abstract class AbstractProjectCostAnalysisUI extends com.kingdee.eas.fdc.basedata.client.FDCRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectCostAnalysisUI.class);
     ...
     */
    public AbstractProjectCostAnalysisUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectCostAnalysisUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 745, 579));        tblMain.setBounds(new Rectangle(4, 32, 739, 543));
        kDPanel1.add(tblMain, new KDLayout.Constraints(4, 32, 739, 543, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnAll.setBounds(new Rectangle(6, 6, 110, 21));
        kDPanel1.add(btnAll, new KDLayout.Constraints(6, 6, 110, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.ProjectCostAnalysisUIHandler";
	}
    ...
    /**
     * output btnAll_actionPerformed method
     */
    protected void btnAll_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionAll extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectCostAnalysisUI.this, "ActionAll", "actionAll_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "ProjectCostAnalysisUI");
    }
