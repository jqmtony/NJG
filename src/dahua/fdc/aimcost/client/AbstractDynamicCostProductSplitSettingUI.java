 ...
 * output class name
 */
public abstract class AbstractDynamicCostProductSplitSettingUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDynamicCostProductSplitSettingUI.class);
     ...
     */
    public AbstractDynamicCostProductSplitSettingUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDynamicCostProductSplitSettingUI.class.getName());
        ...
        // menuItemApportion
        this.menuItemApportion.setAction((IItemAction)ActionProxyFactory.getProxy(actionSplit, new Class[] { IItemAction.class }, getServiceContext()));		
        this.menuItemApportion.setText(resHelper.getString("menuItemApportion.text"));		
        this.menuItemApportion.setToolTipText(resHelper.getString("menuItemApportion.toolTipText"));
    ...
    public void initUIMenuBarLayout()
    {
        ...
        menuEdit.add(menuItemApportion);
        //menuView
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.DynamicCostProductSplitSettingUIHandler";
	}
    ...
    protected class ActionSelectAll extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDynamicCostProductSplitSettingUI.this, "ActionSelectAll", "actionSelectAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelectNone extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDynamicCostProductSplitSettingUI.this, "ActionSelectNone", "actionSelectNone_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDynamicCostProductSplitSettingUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "DynamicCostProductSplitSettingUI");
    }
