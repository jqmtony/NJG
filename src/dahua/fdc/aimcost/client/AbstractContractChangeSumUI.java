 ...
 * output class name
 */
public abstract class AbstractContractChangeSumUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractChangeSumUI.class);
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox f7ChangeType;
    protected ActionRefresh actionRefresh = null;
    /**
     * output class constructor
     */
    public AbstractContractChangeSumUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractChangeSumUI.class.getName());
        ...
        this.f7ChangeType = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.f7ChangeType.setName("f7ChangeType");
        // CoreUI
        // tblMain		
        ...
        // f7ChangeType		
        this.f7ChangeType.setDisplayFormat("$name$");		
        this.f7ChangeType.setEditFormat("$number$");		
        this.f7ChangeType.setCommitFormat("$number$");		
        this.f7ChangeType.setQueryInfo("com.kingdee.eas.fdc.basedata.app.F7ChangeTypeQuery");		
        this.f7ChangeType.setEditable(true);
        this.f7ChangeType.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    f7ChangeType_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        contChangeType.setBounds(new Rectangle(648, 9, 270, 19));
        this.add(contChangeType, new KDLayout.Constraints(648, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        //contYear
        contYear.setBoundEditor(spiYear);
        //contProjectType
        contProjectType.setBoundEditor(f7ProjectType);
        //contChangeType
        contChangeType.setBoundEditor(f7ChangeType);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.ContractChangeSumUIHandler";
	}
    ...
    /**
     * output f7ChangeType_dataChanged method
     */
    protected void f7ChangeType_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
        //write your code here
    }
    ...
    protected class ActionRefresh extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractChangeSumUI.this, "ActionRefresh", "actionRefresh_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "ContractChangeSumUI");
    }
