...
public abstract class AbstractAimCostDynInfoUI extends com.kingdee.eas.fdc.basedata.client.FDCAcctRptBaseUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(11, 32, 991, 587));
        this.add(tblMain, new KDLayout.Constraints(11, 32, 991, 587, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        lblProject.setBounds(new Rectangle(11, 6, 86, 19));
        this.add(lblProject, new KDLayout.Constraints(11, 6, 86, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtProject.setBounds(new Rectangle(93, 6, 195, 19));
        this.add(txtProject, new KDLayout.Constraints(93, 6, 195, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        lblPeriod.setBounds(new Rectangle(597, 6, 38, 19));
        this.add(lblPeriod, new KDLayout.Constraints(597, 6, 38, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        lblPeriodDesc.setBounds(new Rectangle(631, 6, 195, 19));
        this.add(lblPeriodDesc, new KDLayout.Constraints(631, 6, 195, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtTotalConstrArea.setBounds(new Rectangle(389, 6, 195, 19));
        this.add(txtTotalConstrArea, new KDLayout.Constraints(389, 6, 195, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        lblTotalConstrArea.setBounds(new Rectangle(320, 6, 72, 19));
        this.add(lblTotalConstrArea, new KDLayout.Constraints(320, 6, 72, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnAll.setBounds(new Rectangle(839, 6, 148, 21));
        this.add(btnAll, new KDLayout.Constraints(839, 6, 148, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
    ...
    protected class ActionAll extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAimCostDynInfoUI.this, "ActionAll", "actionAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimCostDynInfoUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
