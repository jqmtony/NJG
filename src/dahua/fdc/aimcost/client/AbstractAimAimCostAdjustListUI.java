 ...
 * output class name
 */
public abstract class AbstractAimAimCostAdjustListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAimAimCostAdjustListUI.class);
    /**
     * output class constructor
     */
    public AbstractAimAimCostAdjustListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAimAimCostAdjustListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.aimcost.app", "AimAimCostAdjustQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.AimAimCostAdjustListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "AimAimCostAdjustListUI");
    }
    /**
