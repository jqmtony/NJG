 ...
 * output class name
 */
public abstract class AbstractDyCostSumUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDyCostSumUI.class);
     ...
     */
    public AbstractDyCostSumUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDyCostSumUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.DyCostSumUIHandler";
	}
    ...
    protected class ActionRefresh extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDyCostSumUI.this, "ActionRefresh", "actionRefresh_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "DyCostSumUI");
    }
