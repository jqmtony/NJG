 ...
 * output class name
 */
public abstract class AbstractAimCostAdjustListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAimCostAdjustListUI.class);
    /**
     * output class constructor
     */
    public AbstractAimCostAdjustListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAimCostAdjustListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.AimCostAdjustListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "AimCostAdjustListUI");
    }
    /**
