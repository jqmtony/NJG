...
public abstract class AbstractAimCostUI extends com.kingdee.eas.framework.client.TreeListUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contMeasureStage.setBounds(new Rectangle(8, 71, 306, 19));
        pnlDescription.add(contMeasureStage, new KDLayout.Constraints(8, 71, 306, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnAll.setBounds(new Rectangle(340, 71, 146, 21));
        pnlDescription.add(btnAll, new KDLayout.Constraints(340, 71, 146, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contSumArea
    ...
    protected class ActionAll extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimCostUI.this, "ActionAll", "actionAll_actionPerformed", e);
        }
    }
