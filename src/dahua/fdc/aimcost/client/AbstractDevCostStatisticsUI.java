 ...
 * output class name
 */
public abstract class AbstractDevCostStatisticsUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDevCostStatisticsUI.class);
     ...
     */
    public AbstractDevCostStatisticsUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDevCostStatisticsUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.DevCostStatisticsUIHandler";
	}
    ...
    protected class ActionRefresh extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDevCostStatisticsUI.this, "ActionRefresh", "actionRefresh_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "DevCostStatisticsUI");
    }
