 ...
 * output class name
 */
public abstract class AbstractPeriodProductDynamicCostUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPeriodProductDynamicCostUI.class);
     ...
     */
    public AbstractPeriodProductDynamicCostUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPeriodProductDynamicCostUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.PeriodProductDynamicCostUIHandler";
	}
    ...
    protected class ActionSubmit extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPeriodProductDynamicCostUI.this, "ActionSubmit", "actionSubmit_actionPerformed", e);
        }
    }
    ...
    protected class ActionApportion extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPeriodProductDynamicCostUI.this, "ActionApportion", "actionApportion_actionPerformed", e);
        }
    }
    ...
    protected class ActionRevert extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPeriodProductDynamicCostUI.this, "ActionRevert", "actionRevert_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "PeriodProductDynamicCostUI");
    }
    /**
