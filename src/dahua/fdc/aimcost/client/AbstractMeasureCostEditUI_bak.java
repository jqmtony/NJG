 ...
 * output class name
 */
public abstract class AbstractMeasureCostEditUI_bak extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMeasureCostEditUI_bak.class);
     ...
     */
    public AbstractMeasureCostEditUI_bak() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMeasureCostEditUI_bak.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contVersionNumber.setBounds(new Rectangle(15, 13, 270, 19));
        this.add(contVersionNumber, new KDLayout.Constraints(15, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(352, 13, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(352, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer3.setBounds(new Rectangle(680, 13, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(680, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contVersionNumber
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.MeasureCostEditUI_bakHandler";
	}
    ...
    protected class ActionAddRow extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMeasureCostEditUI_bak.this, "ActionAddRow", "actionAddRow_actionPerformed", e);
        }
    }
    ...
    protected class ActionDeleteRow extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMeasureCostEditUI_bak.this, "ActionDeleteRow", "actionDeleteRow_actionPerformed", e);
        }
    }
    ...
    protected class ActionImportApportion extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMeasureCostEditUI_bak.this, "ActionImportApportion", "actionImportApportion_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "MeasureCostEditUI_bak");
    }
