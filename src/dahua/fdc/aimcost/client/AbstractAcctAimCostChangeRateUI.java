 ...
 * output class name
 */
public abstract class AbstractAcctAimCostChangeRateUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAcctAimCostChangeRateUI.class);
     ...
     */
    public AbstractAcctAimCostChangeRateUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAcctAimCostChangeRateUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.AcctAimCostChangeRateUIHandler";
	}
    ...
    protected class ActionRefresh extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAcctAimCostChangeRateUI.this, "ActionRefresh", "actionRefresh_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "AcctAimCostChangeRateUI");
    }
