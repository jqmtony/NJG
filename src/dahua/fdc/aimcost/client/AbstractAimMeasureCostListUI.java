 ...
 * output class name
 */
public abstract class AbstractAimMeasureCostListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAimMeasureCostListUI.class);
     ...
     */
    public AbstractAimMeasureCostListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAimMeasureCostListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","state","measureStage.name","versionNumber","versionName","attachment","isLastVersion","orgUnit.name","project.number","project.name","creator.name","createTime","description","orgUnit.id","project.id","projectType.name","sourceBillId"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.AimMeasureCostListUIHandler";
	}
    ...
    protected class ActionExportToAim extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAimMeasureCostListUI.this, "ActionExportToAim", "actionExportToAim_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimMeasureCostListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimMeasureCostListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionExportIndex extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimMeasureCostListUI.this, "ActionExportIndex", "actionExportIndex_actionPerformed", e);
        }
    }
    ...
    protected class ActionVersion extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAimMeasureCostListUI.this, "ActionVersion", "actionVersion_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "AimMeasureCostListUI");
    }
    /**
