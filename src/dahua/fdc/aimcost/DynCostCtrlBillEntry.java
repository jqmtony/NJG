...
public class DynCostCtrlBillEntry extends BillEntryBase implements IDynCostCtrlBillEntry
{
    public DynCostCtrlBillEntry()
    {
        super();
        registerInterface(IDynCostCtrlBillEntry.class, this);
    }
    public DynCostCtrlBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IDynCostCtrlBillEntry.class, this);
    }
    ...
    private DynCostCtrlBillEntryController getController() throws BOSException
    {
        return (DynCostCtrlBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynCostCtrlBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
