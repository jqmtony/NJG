...
public class PhotoNumberControllerBean extends AbstractPhotoNumberControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.photomanager.app.PhotoNumberControllerBean");
}