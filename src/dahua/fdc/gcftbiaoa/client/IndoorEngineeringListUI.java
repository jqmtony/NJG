 ...
 * output class name
 */
public class IndoorEngineeringListUI extends AbstractIndoorEngineeringListUI
{
	private static final long serialVersionUID = 1L;
    private static final Logger logger = CoreUIObject.getLogger(IndoorEngineeringListUI.class);
    private final static String CANTUNAUDIT = "cantUnAudit";
	private final static String CANTAUDIT = "cantAudit";
    /**
     * output class constructor
     */
    public IndoorEngineeringListUI() throws Exception
    {
        super();
    }
	...
	public void actionRevise_actionPerformed(ActionEvent e) throws Exception {
		...
		com.kingdee.eas.fdc.gcftbiaoa.IDecorationEngineering remoteInstance = com.kingdee.eas.fdc.gcftbiaoa.DecorationEngineeringFactory.getRemoteInstance();
		DecorationEngineeringInfo DecorationEngineeringinfo = remoteInstance.getDecorationEngineeringInfo(new ObjectUuidPK(id),getSelectors());   //getSelectors 修订后，不点保存，不显示F7字段的值
		...
		uiContext.put("DecorationEngineeringInfo", DecorationEngineeringinfo);
	 ...
	 private void checkBeforeAuditOrUnAudit(DecorationEngineeringInfo DecorationEngineeringinfo , FDCBillStateEnum aduit,String Waring ) {
			//检查单据是否在审核中
			FDCClientUtils.checkBillInWorkflow(this, DecorationEngineeringinfo.getId().toString());
			boolean b = DecorationEngineeringinfo!=null&&DecorationEngineeringinfo.getState()!=null&&DecorationEngineeringinfo.getState().equals(aduit);
			if(!b){
		...
		public void actionAduit_actionPerformed(ActionEvent e) throws Exception {
			...
			checkBeforeAuditOrUnAudit(DecorationEngineeringinfo, FDCBillStateEnum.SUBMITTED, CANTAUDIT);
		...
		public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
			...
			IDecorationEngineering remoteInstance = DecorationEngineeringFactory.getRemoteInstance();
			DecorationEngineeringInfo DecorationEngineeringinfo = remoteInstance.getDecorationEngineeringInfo(new ObjectUuidPK(id));
			checkBeforeAuditOrUnAudit(DecorationEngineeringinfo, FDCBillStateEnum.AUDITTED, CANTUNAUDIT);
