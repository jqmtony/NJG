...
public abstract class AbstractGcftbEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","engineeringProject","allshare","facilityName","proptreyRight","constructionArea","startTime","actualStartTine","completionTime","actualCompeltionTime","totalCost","costHasOccurred","allocationIndex","totalAmount","share","sharePrice","Remark"});
    ...
    public void initUIContentLayout()
    {
        ...
        kDContainer2.setBounds(new Rectangle(10, 242, 995, 377));
        this.add(kDContainer2, new KDLayout.Constraints(10, 242, 995, 377, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contNumber
