...
public abstract class AbstractIndoorengEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(20, 3, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(20, 3, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contState.setBounds(new Rectangle(359, 3, 270, 19));
        this.add(contState, new KDLayout.Constraints(359, 3, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contVersion.setBounds(new Rectangle(21, 33, 270, 19));
        this.add(contVersion, new KDLayout.Constraints(21, 33, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chklasted.setBounds(new Rectangle(621, 28, 77, 19));
        this.add(chklasted, new KDLayout.Constraints(621, 28, 77, 19, 0));
        contRoom.setBounds(new Rectangle(20, 64, 270, 19));
