...
public abstract class AbstractDesignchangeApproveUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
     ...
     */
    public AbstractDesignchangeApproveUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDesignchangeApproveUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(185, 65, 619, 556));
        this.add(kDTable1, new KDLayout.Constraints(185, 65, 619, 556, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(185, 39, 200, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(185, 39, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(431, 39, 200, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(431, 39, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        yd.setBounds(new Rectangle(697, 37, 110, 21));
        this.add(yd, new KDLayout.Constraints(697, 37, 110, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabel1.setBounds(new Rectangle(185, 7, 619, 26));
        this.add(kDLabel1, new KDLayout.Constraints(185, 7, 619, 26, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.wfui.DesignchangeApproveUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.wfui", "DesignchangeApproveUI");
    }
