 ...
 * output class name
 */
public abstract class AbstractContractApproveUI extends com.kingdee.eas.framework.client.EditUI
{
     ...
     */
    public AbstractContractApproveUI() throws Exception
    {
        super();
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(209, 8, 506, 617));
        this.add(kDTable1, new KDLayout.Constraints(209, 8, 506, 617, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.wfui.ContractApproveUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.wfui", "ContractApproveUI");
    }
