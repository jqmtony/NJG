...
public class TechnologyeconomyApproveUI extends AbstractTechnologyeconomyApproveUI
{
    ...
    private void initUI() throws BOSException, SQLException{
    	...
    	mergeManager.mergeBlock(10, 1, 11, 2);
    	mergeManager.mergeBlock(10, 3, 11, 4);
    	...
    	mergeManager.mergeBlock(13, 1, 14, 2);
    	mergeManager.mergeBlock(13, 3, 14, 4);
    	...
    	this.kDTable1.getColumn(0).setWidth(150);
    	this.kDTable1.getColumn(1).setWidth(150);
    	this.kDTable1.getColumn(2).setWidth(150);
    	this.kDTable1.getColumn(3).setWidth(150);
    	this.kDTable1.getColumn(4).setWidth(150);
    	...
    	sb.append(" ChangeAB.CFBIMUDF0052ID 经办人6,ChangeAB.CFworkNote 实际工作内容描述7,ChangeAB.CFappliAmount 签证申报费用8");
    	...
    	while(rowset.next()){
    		...
    		this.kDTable1.getCell(8, 1).setValue(rowset.getString(8));
    	}
