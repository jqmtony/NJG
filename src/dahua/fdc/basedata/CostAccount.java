...
public class CostAccount extends TreeBase implements ICostAccount
{
    public CostAccount()
    {
        super();
        registerInterface(ICostAccount.class, this);
    }
    public CostAccount(Context ctx)
    {
        super(ctx);
        registerInterface(ICostAccount.class, this);
    }
    ...
    private CostAccountController getController() throws BOSException
    {
        return (CostAccountController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCostAccountInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *导入成本科目系统模板-User defined method
     *@param cac 成本科目集合
     *@return
     */
    ...
    /**
     *保存可拆分科目状态-User defined method
     *@param ids 成本科目ID
     *@param isSplit 是否拆分
     */
    public void saveIsSplitCostAccount(List ids, boolean isSplit) throws BOSException
    {
        try {
            getController().saveIsSplitCostAccount(getContext(), ids, isSplit);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
