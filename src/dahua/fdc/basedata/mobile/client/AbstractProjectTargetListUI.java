 ...
 * output class name
 */
public abstract class AbstractProjectTargetListUI extends com.kingdee.eas.fdc.basedata.mobile.client.FdcMobileListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectTargetListUI.class);
    /**
     * output class constructor
     */
    public AbstractProjectTargetListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectTargetListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.app", "ProjectTargetQuery");
        //actionAudit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.mobile.app.ProjectTargetListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.client", "ProjectTargetListUI");
    }
