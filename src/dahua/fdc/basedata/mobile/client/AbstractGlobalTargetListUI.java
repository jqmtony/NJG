 ...
 * output class name
 */
public abstract class AbstractGlobalTargetListUI extends com.kingdee.eas.fdc.basedata.mobile.client.FdcMobileListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGlobalTargetListUI.class);
    /**
     * output class constructor
     */
    public AbstractGlobalTargetListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGlobalTargetListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.mobile.app.GlobalTargetListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.client", "GlobalTargetListUI");
    }
