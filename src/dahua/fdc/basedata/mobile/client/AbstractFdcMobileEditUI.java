 ...
 * output class name
 */
public abstract class AbstractFdcMobileEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFdcMobileEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDContainer containerMain;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAddEntry;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnInsertEntry;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnRemoveEntry;
     ...
     */
    public AbstractFdcMobileEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFdcMobileEditUI.class.getName());
        ...
        this.containerMain = new com.kingdee.bos.ctrl.swing.KDContainer();
        this.btnAddEntry = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnInsertEntry = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnRemoveEntry = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.kdtEntries = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        this.containerMain.setName("containerMain");
        this.btnAddEntry.setName("btnAddEntry");
        this.btnInsertEntry.setName("btnInsertEntry");
...
containerMain.getContentPane().setLayout(new BorderLayout(0, 0));        containerMain.getContentPane().add(kdtEntries, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.mobile.app.FdcMobileEditUIHandler";
	}
    ...
    protected class ActionAddEntry extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFdcMobileEditUI.this, "ActionAddEntry", "actionAddEntry_actionPerformed", e);
        }
    }
    ...
    protected class ActionInsertEntry extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFdcMobileEditUI.this, "ActionInsertEntry", "actionInsertEntry_actionPerformed", e);
        }
    }
    ...
    protected class ActionRemoveEntry extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFdcMobileEditUI.this, "ActionRemoveEntry", "actionRemoveEntry_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.client", "FdcMobileEditUI");
    }
