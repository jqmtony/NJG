 ...
 * output class name
 */
public abstract class AbstractGlobalTargetEditUI extends com.kingdee.eas.fdc.basedata.mobile.client.FdcMobileEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGlobalTargetEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.mobile.GlobalTargetBillInfo editData = null;
    protected ActionAutoGetData actionAutoGetData = null;
    /**
     * output class constructor
     */
    public AbstractGlobalTargetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGlobalTargetEditUI.class.getName());
		...
		String kdtEntriesStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol8\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol9\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seqNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"0\" /><t:Column t:key=\"number\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"1\" /><t:Column t:key=\"name\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"2\" /><t:Column t:key=\"projectTargetEntry\" t:width=\"200\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"3\" /><t:Column t:key=\"dataType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"4\" /><t:Column t:key=\"unit\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"5\" /><t:Column t:key=\"statisticsType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"6\" /><t:Column t:key=\"description\" t:width=\"400\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"7\" /><t:Column t:key=\"isPreDefine\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"8\" t:styleID=\"sCol8\" /><t:Column t:key=\"isAutoGetData\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"9\" t:styleID=\"sCol9\" /><t:Column t:key=\"isEnable\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"10\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seqNum}</t:Cell><t:Cell>$Resource{number}</t:Cell><t:Cell>$Resource{name}</t:Cell><t:Cell>$Resource{projectTargetEntry}</t:Cell><t:Cell>$Resource{dataType}</t:Cell><t:Cell>$Resource{unit}</t:Cell><t:Cell>$Resource{statisticsType}</t:Cell><t:Cell>$Resource{description}</t:Cell><t:Cell>$Resource{isPreDefine}</t:Cell><t:Cell>$Resource{isAutoGetData}</t:Cell><t:Cell>$Resource{isEnable}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        this.kdtEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
                ...
                this.kdtEntries.putBindContents("editData",new String[] {"seqNum","number","name","projectTargetEntry","projectTargetEntry.dataType","projectTargetEntry.unit","statisticsType","description","isPreDefine","isAutoGetData","isEnable"});
    ...
    public void initUIContentLayout()
    {
        ...
        containerMain.setBounds(new Rectangle(12, 70, 960, 485));
        this.add(containerMain, new KDLayout.Constraints(12, 70, 960, 485, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        btnRemoveEntry.setBounds(new Rectangle(700, 60, 30, 30));
        this.add(btnRemoveEntry, new KDLayout.Constraints(700, 60, 30, 30, 0));
...
containerMain.getContentPane().setLayout(new BorderLayout(0, 0));        containerMain.getContentPane().add(kdtEntries, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entries.isPreDefine", boolean.class, this.kdtEntries, "isPreDefine.text");
		dataBinder.registerBinding("entries.isAutoGetData", boolean.class, this.kdtEntries, "isAutoGetData.text");
		dataBinder.registerBinding("entries.isEnable", boolean.class, this.kdtEntries, "isEnable.text");
		dataBinder.registerBinding("entries", com.kingdee.eas.fdc.basedata.mobile.GlobalTargetEntryInfo.class, this.kdtEntries, "userObject");
		dataBinder.registerBinding("entries.seqNum", String.class, this.kdtEntries, "seqNum.text");
		dataBinder.registerBinding("entries.description", String.class, this.kdtEntries, "description.text");
		dataBinder.registerBinding("entries.statisticsType", com.kingdee.eas.fdc.basedata.TargetDataStatisticsTypeEnum.class, this.kdtEntries, "statisticsType.text");
		dataBinder.registerBinding("entries.projectTargetEntry", com.kingdee.eas.fdc.basedata.mobile.ProjectTargetEntryInfo.class, this.kdtEntries, "projectTargetEntry.text");
		dataBinder.registerBinding("entries.projectTargetEntry.dataType", com.kingdee.eas.fdc.basedata.DataTypeEnum.class, this.kdtEntries, "dataType.text");
		dataBinder.registerBinding("entries.projectTargetEntry.unit", com.kingdee.eas.basedata.assistant.MeasureUnitInfo.class, this.kdtEntries, "unit.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.mobile.app.GlobalTargetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.mobile.GlobalTargetBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entries.isPreDefine", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.isAutoGetData", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.isEnable", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.seqNum", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.description", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.statisticsType", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.projectTargetEntry", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.projectTargetEntry.dataType", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entries.projectTargetEntry.unit", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entries.statisticsType"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entries.projectTargetEntry.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entries.projectTargetEntry.id"));
			sic.add(new SelectorItemInfo("entries.projectTargetEntry.name"));
        	sic.add(new SelectorItemInfo("entries.projectTargetEntry.number"));
		}
    	sic.add(new SelectorItemInfo("entries.projectTargetEntry.dataType"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entries.projectTargetEntry.unit.*"));
		}
		else{
    ...
    protected class ActionAutoGetData extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractGlobalTargetEditUI.this, "ActionAutoGetData", "actionAutoGetData_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.client", "GlobalTargetEditUI");
    }
