 ...
 * output class name
 */
public abstract class AbstractProjectTargetValueListUI extends com.kingdee.eas.fdc.basedata.mobile.client.FdcMobileListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectTargetValueListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDSplitPane kDSplitPane1;
    protected com.kingdee.bos.ctrl.swing.KDTree treeProject;
    /**
     * output class constructor
     */
    public AbstractProjectTargetValueListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectTargetValueListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.app", "ProjectTargetValueQuery");
        //actionAudit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.mobile.app.ProjectTargetValueListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.mobile.client", "ProjectTargetValueListUI");
    }
