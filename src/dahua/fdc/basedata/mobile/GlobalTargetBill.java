...
public class GlobalTargetBill extends FdcMobileBill implements IGlobalTargetBill
{
    public GlobalTargetBill()
    {
        super();
        registerInterface(IGlobalTargetBill.class, this);
    }
    public GlobalTargetBill(Context ctx)
    {
        super(ctx);
        registerInterface(IGlobalTargetBill.class, this);
    }
    ...
    private GlobalTargetBillController getController() throws BOSException
    {
        return (GlobalTargetBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getGlobalTargetBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGlobalTargetBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGlobalTargetBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGlobalTargetBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGlobalTargetBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGlobalTargetBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
