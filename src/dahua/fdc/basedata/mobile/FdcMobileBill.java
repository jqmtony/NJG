...
public class FdcMobileBill extends FDCBill implements IFdcMobileBill
{
    public FdcMobileBill()
    {
        super();
        registerInterface(IFdcMobileBill.class, this);
    }
    public FdcMobileBill(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcMobileBill.class, this);
    }
    ...
    private FdcMobileBillController getController() throws BOSException
    {
        return (FdcMobileBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcMobileBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcMobileBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcMobileBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcMobileBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcMobileBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcMobileBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
