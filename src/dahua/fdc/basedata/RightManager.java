...
public class RightManager extends CoreBase implements IRightManager
{
    public RightManager()
    {
        super();
        registerInterface(IRightManager.class, this);
    }
    public RightManager(Context ctx)
    {
        super(ctx);
        registerInterface(IRightManager.class, this);
    }
    ...
    private RightManagerController getController() throws BOSException
    {
        return (RightManagerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRightManagerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRightManagerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRightManagerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRightManagerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRightManagerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRightManagerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
