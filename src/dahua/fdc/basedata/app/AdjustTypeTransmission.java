 ...
 * @see						
 */
public class AdjustTypeTransmission extends AbstractDataTransmission {
	...
	protected ICoreBase getController(Context ctx) throws TaskExternalException {
		try {
			return AdjustTypeFactory.getLocalInstance(ctx);
	...
	public CoreBaseInfo transmit(Hashtable hsData, Context ctx)
		...
		AdjustTypeInfo info = new AdjustTypeInfo();
