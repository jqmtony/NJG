...
public abstract class FDCBillEntryBaseControllerBean extends AbstractFDCBillEntryBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.FDCBillEntryBaseControllerBean");
}