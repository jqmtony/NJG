 ...
 * @version EAS5.1
 */
public class PaymentTypeControllerBean extends AbstractPaymentTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.PaymentTypeControllerBean");

	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_PaymentType set  FIsEnabled = ?  where FID = ? ";
