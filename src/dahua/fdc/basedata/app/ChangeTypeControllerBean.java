 ...
 * @version EAS5.1
 */
public class ChangeTypeControllerBean extends AbstractChangeTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.ChangeTypeControllerBean");

	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_ChangeType set  FIsEnabled = ?  where FID = ? ";
