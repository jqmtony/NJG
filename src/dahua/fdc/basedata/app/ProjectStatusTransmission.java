 ...
 * @see						
 */
public class ProjectStatusTransmission extends AbstractDataTransmission {
	...
	protected ICoreBase getController(Context ctx) throws TaskExternalException {
		try {
			return ProjectStatusFactory.getLocalInstance(ctx);
	...
	public CoreBaseInfo transmit(Hashtable hsData, Context ctx)
		 ...
		 */
		// 启用
		if (fIsEnabled.trim().equals(getResource(ctx, "no",resourceCommon))) {
