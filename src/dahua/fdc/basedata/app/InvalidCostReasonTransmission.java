 ...
 * @see						
 */
public class InvalidCostReasonTransmission extends AbstractDataTransmission {
	...
	protected ICoreBase getController(Context ctx) throws TaskExternalException {
		try {
			return InvalidCostReasonFactory.getLocalInstance(ctx);
	...
	public CoreBaseInfo transmit(Hashtable hsData, Context ctx)
		...
		InvalidCostReasonInfo info = new InvalidCostReasonInfo();
