...
public interface FDCBillBaseController extends BillBaseController
{
    public FDCBillBaseInfo getFDCBillBaseInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public FDCBillBaseInfo getFDCBillBaseInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public FDCBillBaseInfo getFDCBillBaseInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    public FDCBillBaseCollection getFDCBillBaseCollection(Context ctx) throws BOSException, RemoteException;
    public FDCBillBaseCollection getFDCBillBaseCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public FDCBillBaseCollection getFDCBillBaseCollection(Context ctx, String oql) throws BOSException, RemoteException;
