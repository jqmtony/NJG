 ...
 *
 */
public class ConSettleSplitObserver implements Observer {
	...
	private IRowSet getRefreshRowSet(Map param, Context ctx) throws BOSException {
		...
		String sql = "select distinct a.fid from T_CON_SettlementCostSplit a 						\n"
			+ "inner join T_CON_SettlementCostSplitEntry b on a.FID = b.FParentID 			\n"
