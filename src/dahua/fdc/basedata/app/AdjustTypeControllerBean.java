 ...
 * @version EAS5.1
 */
public class AdjustTypeControllerBean extends AbstractAdjustTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.AdjustTypeControllerBean");

	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_AdjustType set  FIsEnabled = ?  where FID = ? ";
