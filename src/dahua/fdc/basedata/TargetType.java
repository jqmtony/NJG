...
public class TargetType extends TreeBase implements ITargetType
{
    public TargetType()
    {
        super();
        registerInterface(ITargetType.class, this);
    }
    public TargetType(Context ctx)
    {
        super(ctx);
        registerInterface(ITargetType.class, this);
    }
    ...
    private TargetTypeController getController() throws BOSException
    {
        return (TargetTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTargetTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTargetTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTargetTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTargetTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTargetTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTargetTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().enabled(getContext(), ttPK);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().disEnabled(getContext(), ttPK);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
