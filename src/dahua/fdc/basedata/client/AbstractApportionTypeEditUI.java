 ...
 * output class name
 */
public abstract class AbstractApportionTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractApportionTypeEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsForCostApportion;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer1;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer2;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox kdBizTargetType;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox kdBizMeasureUnit;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsForGather;
    protected com.kingdee.eas.fdc.basedata.ApportionTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractApportionTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractApportionTypeEditUI.class.getName());
        ...
        this.chkIsForCostApportion = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.kDLabelContainer1 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.kDLabelContainer2 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.kdBizTargetType = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.kdBizMeasureUnit = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.chkIsForGather = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsForCostApportion.setName("chkIsForCostApportion");
        this.kDLabelContainer1.setName("kDLabelContainer1");
        this.kDLabelContainer2.setName("kDLabelContainer2");
        this.kdBizTargetType.setName("kdBizTargetType");
        this.kdBizMeasureUnit.setName("kdBizMeasureUnit");
        this.chkIsForGather.setName("chkIsForGather");
        // CoreUI
        ...
        // chkIsForCostApportion		
        this.chkIsForCostApportion.setText(resHelper.getString("chkIsForCostApportion.text"));
        // kDLabelContainer1		
        ...
        // kdBizTargetType		
        this.kdBizTargetType.setRequired(true);		
        this.kdBizTargetType.setEditable(true);		
        this.kdBizTargetType.setCommitFormat("$number$");		
        this.kdBizTargetType.setDisplayFormat("$name$");		
        this.kdBizTargetType.setEditFormat("$number$");
        // kdBizMeasureUnit		
        this.kdBizMeasureUnit.setCommitFormat("$number$");		
        this.kdBizMeasureUnit.setEditable(true);		
        this.kdBizMeasureUnit.setEditFormat("$number$");		
        this.kdBizMeasureUnit.setDisplayFormat("$name$");
        // chkIsForGather		
        this.chkIsForGather.setText(resHelper.getString("chkIsForGather.text"));		
        this.chkIsForGather.setVisible(false);
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(229, 130, 140, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(113, 160, 167, 70));
        this.add(bizDescription, null);
        kDLabel1.setBounds(new Rectangle(10, 160, 100, 19));
        this.add(kDLabel1, null);
        chkIsForCostApportion.setBounds(new Rectangle(110, 130, 140, 19));
        this.add(chkIsForCostApportion, null);
        kDLabelContainer1.setBounds(new Rectangle(10, 70, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(10, 100, 270, 19));
        this.add(kDLabelContainer2, null);
        chkIsForGather.setBounds(new Rectangle(10, 130, 140, 19));
        this.add(chkIsForGather, null);
        //contName
        contName.setBoundEditor(bizName);
        //contNumber
        contNumber.setBoundEditor(txtNumber);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(kdBizTargetType);
        //kDLabelContainer2
        kDLabelContainer2.setBoundEditor(kdBizMeasureUnit);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("forCostApportion", boolean.class, this.chkIsForCostApportion, "selected");
		dataBinder.registerBinding("targetType", com.kingdee.eas.fdc.basedata.TargetTypeInfo.class, this.kdBizTargetType, "data");
		dataBinder.registerBinding("measureUnit", com.kingdee.eas.basedata.assistant.MeasureUnitInfo.class, this.kdBizMeasureUnit, "data");
		dataBinder.registerBinding("forGather", boolean.class, this.chkIsForGather, "selected");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ApportionTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.ApportionTypeInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("forCostApportion", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("targetType", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("measureUnit", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("forGather", ValidateHelper.ON_SAVE);    		
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ApportionTypeEditUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.basedata.client.ApportionTypeEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.basedata.ApportionTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.basedata.ApportionTypeInfo objectValue = new com.kingdee.eas.fdc.basedata.ApportionTypeInfo();
