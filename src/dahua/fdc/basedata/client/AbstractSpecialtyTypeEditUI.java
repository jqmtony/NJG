 ...
 * output class name
 */
public abstract class AbstractSpecialtyTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSpecialtyTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.SpecialtyTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSpecialtyTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSpecialtyTypeEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(235, 105, 140, 19));
        this.add(chkIsEnabled, null);
        contChangeType.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contChangeType, null);
        kDLabel1.setBounds(new Rectangle(10, 105, 100, 19));
        this.add(kDLabel1, null);
        bizDescription.setBounds(new Rectangle(10, 125, 270, 70));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.SpecialtyTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.SpecialtyTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "SpecialtyTypeEditUI");
    }
