 ...
 * output class name
 */
public abstract class AbstractContractSourceEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractSourceEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.ContractSourceInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractContractSourceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractSourceEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ContractSourceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.ContractSourceInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ContractSourceEditUI");
    }
