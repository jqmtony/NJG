 ...
 * output class name
 */
public abstract class AbstractCostSplitAcctUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostSplitAcctUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox isSplitAcct;
    protected com.kingdee.bos.ctrl.swing.KDPanel levelPanel;
    ...
    protected ActionIsSplitAcct actionIsSplitAcct = null;
    /**
     * output class constructor
     */
    public AbstractCostSplitAcctUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostSplitAcctUI.class.getName());
        ...
        //actionIsSplitAcct
        this.actionIsSplitAcct = new ActionIsSplitAcct(this);
        getActionManager().registerAction("actionIsSplitAcct", actionIsSplitAcct);
         this.actionIsSplitAcct.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        ...
        this.isSplitAcct = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.levelPanel = new com.kingdee.bos.ctrl.swing.KDPanel();
        ...
        this.isSplitAcct.setName("isSplitAcct");
        ...
        // isSplitAcct
        this.isSplitAcct.setAction((IItemAction)ActionProxyFactory.getProxy(actionIsSplitAcct, new Class[] { IItemAction.class }, getServiceContext()));		
        this.isSplitAcct.setText(resHelper.getString("isSplitAcct.text"));		
        this.isSplitAcct.setSelected(true);
        // levelPanel
        // kDTreeView1		
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator2.setBounds(new Rectangle(10, 464, 728, 8));
        ...
        kDLabelContainer2.setBounds(new Rectangle(321, 11, 61, 19));
        this.add(kDLabelContainer2, null);
        isSplitAcct.setBounds(new Rectangle(565, 12, 172, 19));
        this.add(isSplitAcct, null);
        levelPanel.setBounds(new Rectangle(387, 11, 150, 19));
        this.add(levelPanel, null);
        //kDSplitPane1
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostSplitAcctUIHandler";
	}
    ...
    /**
     * output actionIsSplitAcct_actionPerformed method
     */
	...
	public RequestContext prepareActionIsSplitAcct(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionIsSplitAcct() {
    	return false;
    }
    ...
    protected class ActionSave extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCostSplitAcctUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostSplitAcctUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostSplitAcctUI.this, "ActionAllSelect", "actionAllSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionNoneSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostSplitAcctUI.this, "ActionNoneSelect", "actionNoneSelect_actionPerformed", e);
        }
    }

    /**
     * output ActionIsSplitAcct class
     */     
    protected class ActionIsSplitAcct extends ItemAction {     
    
        public ActionIsSplitAcct()
        {
            this(null);
        }

        public ActionIsSplitAcct(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionIsSplitAcct.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionIsSplitAcct.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionIsSplitAcct.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostSplitAcctUI.this, "ActionIsSplitAcct", "actionIsSplitAcct_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostSplitAcctUI");
    }
