 ...
 * output class name
 */
public abstract class AbstractProjectIndexDataRptMainUI extends com.kingdee.eas.fdc.basedata.client.FDCBIRptBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectIndexDataRptMainUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblMain;
    /**
     * output class constructor
     */
    public AbstractProjectIndexDataRptMainUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectIndexDataRptMainUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(5, 5, 1001, 616));
        this.add(tblMain, new KDLayout.Constraints(5, 5, 1001, 616, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ProjectIndexDataRptMainUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ProjectIndexDataRptMainUI");
    }
