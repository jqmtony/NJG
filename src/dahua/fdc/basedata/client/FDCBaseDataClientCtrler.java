...
public class FDCBaseDataClientCtrler {
	private CoreUI ui=null;
	private boolean isEditUI=false;
	ICoreBase iCoreBase=null;
	public FDCBaseDataClientCtrler(CoreUI coreUI,ICoreBase iCoreBase){
    ...
    S4	对下共享，对上隔离
    D1	管理者维护，创建者分配共享
    D2	编码名称集团统一，分配后其他属性分别维护
    D3	基本信息集团统一，分配后相关信息分别维护
    I	绝对隔离，创建者私有
	 */ 	
    ...
    public String getControlType()
    {
        ...
        if(FDCHelper.isEmpty(controlType)){
