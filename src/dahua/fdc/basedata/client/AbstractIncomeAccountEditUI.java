 ...
 * output class name
 */
public abstract class AbstractIncomeAccountEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractIncomeAccountEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.IncomeAccountInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractIncomeAccountEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractIncomeAccountEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(12, 113, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(12, 43, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(12, 139, 50, 19));
        this.add(contDescription, null);
        contLongNumber.setBounds(new Rectangle(12, 78, 270, 19));
        this.add(contLongNumber, null);
        chkIsEnabled.setBounds(new Rectangle(184, 172, 61, 19));
        this.add(chkIsEnabled, null);
        kDLabelContainer1.setBounds(new Rectangle(12, 8, 270, 19));
        this.add(kDLabelContainer1, null);
        bizDescription.setBounds(new Rectangle(12, 160, 269, 94));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.IncomeAccountEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.IncomeAccountInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "IncomeAccountEditUI");
    }
