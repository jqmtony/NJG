...
public abstract class AbstractProjectEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {chkprojectEnd}));
    ...
    {
        super.onShow();
        this.chkprojectEnd.requestFocusInWindow();
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("landInfomation", ValidateHelper.ON_SAVE);    		
	}
