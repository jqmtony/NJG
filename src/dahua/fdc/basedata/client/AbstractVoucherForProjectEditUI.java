 ...
 * output class name
 */
public abstract class AbstractVoucherForProjectEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVoucherForProjectEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contProjectEntry;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtProjectEntry;
    protected com.kingdee.eas.fdc.basedata.VoucherForProjectInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractVoucherForProjectEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractVoucherForProjectEditUI.class.getName());
        ...
        this.contProjectEntry = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtProjectEntry = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contProjectEntry.setName("contProjectEntry");
        this.prmtProjectEntry.setName("prmtProjectEntry");
        // CoreUI
        // contId		
        ...
        // prmtProduct
        // contProjectEntry		
        this.contProjectEntry.setBoundLabelText(resHelper.getString("contProjectEntry.boundLabelText"));		
        this.contProjectEntry.setBoundLabelLength(100);		
        this.contProjectEntry.setBoundLabelUnderline(true);
        // prmtProjectEntry
    ...
    public void initUIContentLayout()
    {
        ...
        contProjectEntry.setBounds(new Rectangle(300, 340, 270, 19));
        this.add(contProjectEntry, null);
        //contId
        ...
        //contProjectEntry
        contProjectEntry.setBoundEditor(prmtProjectEntry);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("projectEntry", com.kingdee.eas.fdc.basedata.CurProjProductEntriesInfo.class, this.prmtProjectEntry, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.VoucherForProjectEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.VoucherForProjectInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("projectEntry", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("projectEntry.*"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "VoucherForProjectEditUI");
    }
