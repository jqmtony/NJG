 ...
 * output class name
 */
public abstract class AbstractContractWOTCodingTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractWOTCodingTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.ContractWOTCodingTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractContractWOTCodingTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractWOTCodingTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 290, 110));
        this.setLayout(null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ContractWOTCodingTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.ContractWOTCodingTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ContractWOTCodingTypeEditUI");
    }
