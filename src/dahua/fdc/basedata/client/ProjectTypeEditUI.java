...
import com.kingdee.eas.fdc.basedata.IProjectType;
 ...
 * 描述:项目系列编辑
 * 
 * @author jackwang date:2006-11-13
 *         <p>
 * @version EAS5.2
 */
public class ProjectTypeEditUI extends AbstractProjectTypeEditUI {
	private static final Logger logger = CoreUIObject.getLogger(ProjectTypeEditUI.class);

	/**
	 * output class constructor
	 */
	public ProjectTypeEditUI() throws Exception {
		super();
	}
...
//		setBtnStatus();
	...
	private void setTitle() {
		FDCBaseDataClientUtils.setupUITitle(this, EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, FDCBaseDataClientUtils.PROJECTTYPE));
	}
...
//		FDCBaseTypeValidator.validate(((ProjectTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtNumber, bizName);
//	}
//
//	/**
...
//		IProjectType iProjectType = ProjectTypeFactory.getRemoteInstance();
//		if (iProjectType.disEnabled(new ObjectUuidPK(editData.getId()))) {
...
//		IProjectType iProjectType = ProjectTypeFactory.getRemoteInstance();
//		if (iProjectType.enabled(new ObjectUuidPK(editData.getId()))) {
...
//	}
	...
	protected IObjectValue createNewData() {
		...
		projectTypeInfo.setIsEnabled(isEnabled);
		return projectTypeInfo;
	}

	protected ICoreBase getBizInterface() throws Exception {
		return ProjectTypeFactory.getRemoteInstance();
	}
