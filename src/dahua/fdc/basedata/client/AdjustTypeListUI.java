 ...
 * @version EAS5.1
 */
public class AdjustTypeListUI extends AbstractAdjustTypeListUI {
	private static final Logger logger = CoreUIObject.getLogger(AdjustTypeListUI.class);

	/**
	 * output class constructor
	 */
	public AdjustTypeListUI() throws Exception {
		super();
	}
...
//	}
	...
	protected String getEditUIName() {
		...
		return AdjustTypeEditUI.class.getName();
	}
...
//		if(iAdjustType.enabled(new ObjectUuidPK(id))){
//			MsgBox.showWarning(EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, "Enabled_OK"));
//		}		
...
//		String id = row.getCell("id").getValue().toString().trim();
//		IAdjustType iAdjustType = AdjustTypeFactory.getRemoteInstance();
//		if(iAdjustType.disEnabled(new ObjectUuidPK(id))){
//			MsgBox.showWarning(EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, "DisEnabled_OK"));
//		}		
//		actionRefresh_actionPerformed(e);
//	}
