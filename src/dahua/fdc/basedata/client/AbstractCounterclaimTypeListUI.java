 ...
 * output class name
 */
public abstract class AbstractCounterclaimTypeListUI extends com.kingdee.eas.basedata.framework.client.DataBaseSIListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCounterclaimTypeListUI.class);
     ...
     */
    public AbstractCounterclaimTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCounterclaimTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "CounterclaimTypeQuery");
        //actionEnabled
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CounterclaimTypeListUIHandler";
	}
    ...
    protected class ActionEnabled extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCounterclaimTypeListUI.this, "ActionEnabled", "actionEnabled_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisEnabled extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCounterclaimTypeListUI.this, "ActionDisEnabled", "actionDisEnabled_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CounterclaimTypeListUI");
    }
