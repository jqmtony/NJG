 ...
 * output class name
 */
public abstract class AbstractTargetInfoListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTargetInfoListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnImport;
    protected ActionImport actionImport = null;
    /**
     * output class constructor
     */
    public AbstractTargetInfoListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTargetInfoListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "TargetInfoQuery");
        //actionImport
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.TargetInfoListUIHandler";
	}
    ...
    protected class ActionImport extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTargetInfoListUI.this, "ActionImport", "actionImport_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "TargetInfoListUI");
    }
