 ...
 * output class name
 */
public abstract class AbstractCostAccountImportUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostAccountImportUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDButton btnSelectProject;
     ...
     */
    public AbstractCostAccountImportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostAccountImportUI.class.getName());
        ...
        this.btnSelectProject = new com.kingdee.bos.ctrl.swing.KDButton();
        ...
        this.btnSelectProject.setName("btnSelectProject");
        ...
        // btnSelectProject		
        this.btnSelectProject.setText(resHelper.getString("btnSelectProject.text"));
        this.btnSelectProject.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnSelectProject_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(10, 9, 260, 19));
        this.add(kDLabelContainer2, null);
        btnSelectProject.setBounds(new Rectangle(282, 8, 89, 21));
        this.add(btnSelectProject, null);
        kDPanel2.setBounds(new Rectangle(10, 40, 530, 300));
...
kDPanel2.setLayout(new BorderLayout(0, 0));        kDPanel2.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostAccountImportUIHandler";
	}
    ...
    /**
     * output btnSelectProject_actionPerformed method
     */
    protected void btnSelectProject_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionSave extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCostAccountImportUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountImportUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountImportUI.this, "ActionAllSelect", "actionAllSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionNoneSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountImportUI.this, "ActionNoneSelect", "actionNoneSelect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostAccountImportUI");
    }
