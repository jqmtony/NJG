 ...
 * output class name
 */
public abstract class AbstractAreaIndexManagerUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAreaIndexManagerUI.class);
     ...
     */
    public AbstractAreaIndexManagerUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAreaIndexManagerUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.AreaIndexManagerUIHandler";
	}
    ...
    protected class ActionSave extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAreaIndexManagerUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "AreaIndexManagerUI");
    }
