 ...
 * output class name
 */
public abstract class AbstractContractTypeF7UI extends com.kingdee.eas.fdc.basedata.client.ContractTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractTypeF7UI.class);
     ...
     */
    public AbstractContractTypeF7UI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractTypeF7UI.class.getName());
        ...
        //actionEnabled
        actionEnabled.setEnabled(true);
        actionEnabled.setDaemonRun(false);

        _tempStr = resHelper.getString("ActionEnabled.SHORT_DESCRIPTION");
        actionEnabled.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("ActionEnabled.LONG_DESCRIPTION");
        actionEnabled.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("ActionEnabled.NAME");
        actionEnabled.putValue(ItemAction.NAME, _tempStr);
         this.actionEnabled.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        //actionDisEnabled
        actionDisEnabled.setEnabled(true);
        actionDisEnabled.setDaemonRun(false);

        _tempStr = resHelper.getString("ActionDisEnabled.SHORT_DESCRIPTION");
        actionDisEnabled.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("ActionDisEnabled.LONG_DESCRIPTION");
        actionDisEnabled.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("ActionDisEnabled.NAME");
        actionDisEnabled.putValue(ItemAction.NAME, _tempStr);
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(10, 10, 579, 334));
        this.add(pnlMain, new KDLayout.Constraints(10, 10, 579, 334, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDSeparator3.setBounds(new Rectangle(9, 355, 579, 10));
        this.add(kDSeparator3, new KDLayout.Constraints(9, 355, 579, 10, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT));
        btnConfirm.setBounds(new Rectangle(405, 367, 73, 21));
        this.add(btnConfirm, new KDLayout.Constraints(405, 367, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        btnCancel2.setBounds(new Rectangle(513, 367, 73, 21));
        this.add(btnCancel2, new KDLayout.Constraints(513, 367, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ContractTypeF7UIHandler";
	}
	...
	public RequestContext prepareActionEnabled(IItemAction itemAction) throws Exception {
			RequestContext request = super.prepareActionEnabled(itemAction);		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
		return request;
	...
	public RequestContext prepareActionDisEnabled(IItemAction itemAction) throws Exception {
			RequestContext request = super.prepareActionDisEnabled(itemAction);		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
		return request;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ContractTypeF7UI");
    }
