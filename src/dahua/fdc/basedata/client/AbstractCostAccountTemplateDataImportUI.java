 ...
 * output class name
 */
public abstract class AbstractCostAccountTemplateDataImportUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostAccountTemplateDataImportUI.class);
     ...
     */
    public AbstractCostAccountTemplateDataImportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostAccountTemplateDataImportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostAccountTemplateDataImportUIHandler";
	}
    ...
    protected class ActionSave extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCostAccountTemplateDataImportUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountTemplateDataImportUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllSelect extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountTemplateDataImportUI.this, "ActionAllSelect", "actionAllSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionNoneSelect extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountTemplateDataImportUI.this, "ActionNoneSelect", "actionNoneSelect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostAccountTemplateDataImportUI");
    }
