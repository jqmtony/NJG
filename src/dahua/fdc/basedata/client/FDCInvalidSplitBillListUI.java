 ...
 * output class name
 */
public class FDCInvalidSplitBillListUI extends AbstractFDCInvalidSplitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FDCInvalidSplitBillListUI.class);
    
    /**
     * output class constructor
     */
    public FDCInvalidSplitBillListUI() throws Exception
    {
        super();
    }
