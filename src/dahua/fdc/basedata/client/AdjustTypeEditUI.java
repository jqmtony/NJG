 ...
 * @version EAS5.1
 */
public class AdjustTypeEditUI extends AbstractAdjustTypeEditUI {
	private static final Logger logger = CoreUIObject.getLogger(AdjustTypeEditUI.class);

	/**
	 * output class constructor
	 */
	public AdjustTypeEditUI() throws Exception {
		super();
	}
...
//		setBtnStatus();
	...
	private void setTitle() {
		FDCBaseDataClientUtils.setupUITitle(this, EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, FDCBaseDataClientUtils.ADJUSTTYPE));
	}
...
//		FDCBaseTypeValidator.validate(((AdjustTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtNumber, bizName);
//	}
...
//			IAdjustType iAdjustType = AdjustTypeFactory.getRemoteInstance();
//			if(iAdjustType.disEnabled(new ObjectUuidPK(editData.getId()))){
...
//		if(this.editData!=null&&this.editData.getId()!=null){
//			IAdjustType iAdjustType = AdjustTypeFactory.getRemoteInstance();
//			if(iAdjustType.enabled(new ObjectUuidPK(editData.getId()))){
...
//	}
	protected IObjectValue createNewData() {
		AdjustTypeInfo adjustTypeInfo = new AdjustTypeInfo();
		adjustTypeInfo.setIsEnabled(isEnabled);
		return adjustTypeInfo;
	}

	protected ICoreBase getBizInterface() throws Exception {
		// TODO 自动生成方法存根
		return AdjustTypeFactory.getRemoteInstance();
	}
