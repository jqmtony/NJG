 ...
 * output class name
 */
public abstract class AbstractPaymentTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPaymentTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.PaymentTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPaymentTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPaymentTypeEditUI.class.getName());
        ...
        this.chkIsEnabled.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    chkIsEnabled_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
        ...
        this.prmtType.setQueryInfo("com.kingdee.eas.fdc.basedata.app.TypeQuery");		
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(235, 100, 140, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(10, 130, 270, 70));
        this.add(bizDescription, null);
        kDLabel1.setBounds(new Rectangle(10, 100, 100, 19));
        this.add(kDLabel1, null);
        contPayType.setBounds(new Rectangle(10, 70, 270, 19));
        ...
        //contPayType
        contPayType.setBoundEditor(prmtType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("payType", com.kingdee.eas.fdc.basedata.TypeInfo.class, this.prmtType, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.PaymentTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.PaymentTypeInfo)ov;
    }
    ...
    /**
     * output chkIsEnabled_actionPerformed method
     */
    protected void chkIsEnabled_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "PaymentTypeEditUI");
    }
