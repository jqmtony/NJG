 ...
 * output class name
 */
public abstract class AbstractApportionTypeListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractApportionTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractApportionTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractApportionTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "ApportionTypeQuery");
        //actionPageSetup
        ...
        this.tblMain.addKDTSelectListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTSelectListener() {
            public void tableSelectChanged(com.kingdee.bos.ctrl.kdf.table.event.KDTSelectEvent e) {
                ...
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","targetType.name","measureUnit.name","forCostApportion","forGather","isEnabled","description","id","CU.id","measureUnit.id","targetType.id"});
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(10, 11, 996, 580));
        this.add(tblMain, new KDLayout.Constraints(10, 11, 996, 580, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ApportionTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ApportionTypeListUI");
    }
