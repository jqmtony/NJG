 ...
 * output class name
 */
public abstract class AbstractCostCtrlBillUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostCtrlBillUI.class);
     ...
     */
    public AbstractCostCtrlBillUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostCtrlBillUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(321, 11, 275, 19));
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostCtrlBillUIHandler";
	}
    ...
    protected class ActionSave extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCostCtrlBillUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostCtrlBillUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostCtrlBillUI.this, "ActionAllSelect", "actionAllSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionNoneSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostCtrlBillUI.this, "ActionNoneSelect", "actionNoneSelect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostCtrlBillUI");
    }
