 ...
 * @version EAS5.2
 */
public class CostTargetListUI extends AbstractCostTargetListUI {
	private static final Logger logger = CoreUIObject.getLogger(CostTargetListUI.class);

	/**
	 * output class constructor
	 */
	public CostTargetListUI() throws Exception {
		super();
	}
...
//	}
	...
	protected String getEditUIName() {
		return CostTargetEditUI.class.getName();
	}
...
//		ICostTarget iCostTarget = CostTargetFactory.getRemoteInstance();
//		if(iCostTarget.enabled(new ObjectUuidPK(id))){
...
//		String id = row.getCell("id").getValue().toString().trim();
//		ICostTarget iCostTarget = CostTargetFactory.getRemoteInstance();
//		if(iCostTarget.disEnabled(new ObjectUuidPK(id))){
