...
public class FdcDataTable extends CoreBase implements IFdcDataTable
{
    public FdcDataTable()
    {
        super();
        registerInterface(IFdcDataTable.class, this);
    }
    public FdcDataTable(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcDataTable.class, this);
    }
    ...
    private FdcDataTableController getController() throws BOSException
    {
        return (FdcDataTableController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcDataTableInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcDataTableInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcDataTableInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcDataTableCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcDataTableCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcDataTableCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
