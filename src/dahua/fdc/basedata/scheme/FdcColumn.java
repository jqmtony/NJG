...
public class FdcColumn extends CoreBase implements IFdcColumn
{
    public FdcColumn()
    {
        super();
        registerInterface(IFdcColumn.class, this);
    }
    public FdcColumn(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcColumn.class, this);
    }
    ...
    private FdcColumnController getController() throws BOSException
    {
        return (FdcColumnController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcColumnInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcColumnInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcColumnInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcColumnCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcColumnCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcColumnCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
