...
public class FdcEntityObject extends CoreBase implements IFdcEntityObject
{
    public FdcEntityObject()
    {
        super();
        registerInterface(IFdcEntityObject.class, this);
    }
    public FdcEntityObject(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcEntityObject.class, this);
    }
    ...
    private FdcEntityObjectController getController() throws BOSException
    {
        return (FdcEntityObjectController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcEntityObjectInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcEntityObjectInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcEntityObjectInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcEntityObjectCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcEntityObjectCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcEntityObjectCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *同步元数据-User defined method
     *@param fullNamePerfix 完整名称前缀
     *@param isPackage 是否包
     *@return
     */
    ...
    {
        try {
            return getController().synchronizeMD(getContext(), fullNamePerfix, isPackage);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *同步EAS元数据(com.kingdee.eas)-User defined method
     *@return
     */
    public FdcEntityObjectCollection synchronizeEasMD() throws BOSException, EASBizException
    {
        try {
            return getController().synchronizeEasMD(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *同步基础元数据(com.kingdee.eas.base,com.kingdee.eas.basedata)-User defined method
     *@return
     */
    public FdcEntityObjectCollection synchronizeBaseMD() throws BOSException, EASBizException
    {
        try {
            return getController().synchronizeBaseMD(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *同步房地产元数据(com.kingdee.eas.fdc)-User defined method
     *@return
     */
    public FdcEntityObjectCollection synchronizeFdcMD() throws BOSException, EASBizException
    {
        try {
            return getController().synchronizeFdcMD(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
