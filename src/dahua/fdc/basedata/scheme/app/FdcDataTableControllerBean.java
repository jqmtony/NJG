...
public class FdcDataTableControllerBean extends AbstractFdcDataTableControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.scheme.app.FdcDataTableControllerBean");
}