...
public class AdjustType extends FDCDataBase implements IAdjustType
{
    public AdjustType()
    {
        super();
     ...
     *@return
     */
    public IObjectPK addnew(AdjustTypeInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 新增
     */
    public void addnew(IObjectPK pk, AdjustTypeInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 更新
     */
    public void update(IObjectPK pk, AdjustTypeInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector 局部更新
     */
    public void updatePartial(AdjustTypeInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 更新大对象
     */
    public void updateBigObject(IObjectPK pk, AdjustTypeInfo model) throws BOSException
    {
        try {
