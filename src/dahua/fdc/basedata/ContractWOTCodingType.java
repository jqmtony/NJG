...
public class ContractWOTCodingType extends ObjectBase implements IContractWOTCodingType
{
    public ContractWOTCodingType()
    {
        super();
        registerInterface(IContractWOTCodingType.class, this);
    }
    public ContractWOTCodingType(Context ctx)
    {
        super(ctx);
        registerInterface(IContractWOTCodingType.class, this);
    }
    ...
    private ContractWOTCodingTypeController getController() throws BOSException
    {
        return (ContractWOTCodingTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractWOTCodingTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWOTCodingTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWOTCodingTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWOTCodingTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWOTCodingTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWOTCodingTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
