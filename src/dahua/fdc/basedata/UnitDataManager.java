...
public class UnitDataManager extends DataBase implements IUnitDataManager
{
    public UnitDataManager()
    {
        super();
        registerInterface(IUnitDataManager.class, this);
    }
    public UnitDataManager(Context ctx)
    {
        super(ctx);
        registerInterface(IUnitDataManager.class, this);
    }
    ...
    private UnitDataManagerController getController() throws BOSException
    {
        return (UnitDataManagerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getUnitDataManagerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUnitDataManagerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUnitDataManagerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUnitDataManagerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUnitDataManagerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUnitDataManagerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
