...
public class CostTarget extends FDCDataBase implements ICostTarget
{
    public CostTarget()
    {
        super();
        registerInterface(ICostTarget.class, this);
    }
    public CostTarget(Context ctx)
    {
        super(ctx);
        registerInterface(ICostTarget.class, this);
    }
    ...
    private CostTargetController getController() throws BOSException
    {
        return (CostTargetController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCostTargetInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTargetInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTargetInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTargetCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTargetCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTargetCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
