...
public class IncomeAccountAssign extends CoreBase implements IIncomeAccountAssign
{
    public IncomeAccountAssign()
    {
        super();
        registerInterface(IIncomeAccountAssign.class, this);
    }
    public IncomeAccountAssign(Context ctx)
    {
        super(ctx);
        registerInterface(IIncomeAccountAssign.class, this);
    }
    ...
    private IncomeAccountAssignController getController() throws BOSException
    {
        return (IncomeAccountAssignController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getIncomeAccountAssignInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getIncomeAccountAssignInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getIncomeAccountAssignInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getIncomeAccountAssignCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getIncomeAccountAssignCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getIncomeAccountAssignCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
