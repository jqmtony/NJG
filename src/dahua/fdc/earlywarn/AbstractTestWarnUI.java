 ...
 * output class name
 */
public abstract class AbstractTestWarnUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTestWarnUI.class);
     ...
     */
    public AbstractTestWarnUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTestWarnUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(64, 41, 270, 19));
        this.add(kDLabelContainer1, null);
        btnOk.setBounds(new Rectangle(261, 91, 73, 21));
        this.add(btnOk, null);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.earlywarn.TestWarnUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.earlywarn", "TestWarnUI");
    }
