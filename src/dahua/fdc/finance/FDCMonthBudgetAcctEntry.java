...
public class FDCMonthBudgetAcctEntry extends FDCBudgetAcctEntry implements IFDCMonthBudgetAcctEntry
{
    public FDCMonthBudgetAcctEntry()
    {
        super();
        registerInterface(IFDCMonthBudgetAcctEntry.class, this);
    }
    public FDCMonthBudgetAcctEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCMonthBudgetAcctEntry.class, this);
    }
    ...
    private FDCMonthBudgetAcctEntryController getController() throws BOSException
    {
        return (FDCMonthBudgetAcctEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
