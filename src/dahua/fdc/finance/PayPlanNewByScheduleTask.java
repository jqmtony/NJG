...
public class PayPlanNewByScheduleTask extends PayPlanScheduleTaskBase implements IPayPlanNewByScheduleTask
{
    public PayPlanNewByScheduleTask()
    {
        super();
        registerInterface(IPayPlanNewByScheduleTask.class, this);
    }
    public PayPlanNewByScheduleTask(Context ctx)
    {
        super(ctx);
        registerInterface(IPayPlanNewByScheduleTask.class, this);
    }
    ...
    private PayPlanNewByScheduleTaskController getController() throws BOSException
    {
        return (PayPlanNewByScheduleTaskController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleTaskCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
