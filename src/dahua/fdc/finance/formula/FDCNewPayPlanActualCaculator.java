...
public class FDCNewPayPlanActualCaculator  implements IMethodBatchQuery, ICalculator{
	...
	public boolean batchQuery(Map methods) {
		...
		if (params != null) {
			for (int i = 0; i < params.size(); i++) {
				...
				try {
					BigDecimal amount = this.fdc_budget_cost_actual(
	...
	public BigDecimal fdc_budget_cost_actual(String fdcCompanyNumber,
