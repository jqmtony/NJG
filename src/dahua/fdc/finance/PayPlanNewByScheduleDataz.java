...
public class PayPlanNewByScheduleDataz extends PayPlanDataBase implements IPayPlanNewByScheduleDataz
{
    public PayPlanNewByScheduleDataz()
    {
        super();
        registerInterface(IPayPlanNewByScheduleDataz.class, this);
    }
    public PayPlanNewByScheduleDataz(Context ctx)
    {
        super(ctx);
        registerInterface(IPayPlanNewByScheduleDataz.class, this);
    }
    ...
    private PayPlanNewByScheduleDatazController getController() throws BOSException
    {
        return (PayPlanNewByScheduleDatazController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayPlanNewByScheduleDatazCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
