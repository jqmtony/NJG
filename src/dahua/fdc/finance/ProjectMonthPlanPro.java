...
public class ProjectMonthPlanPro extends FDCBill implements IProjectMonthPlanPro
{
    public ProjectMonthPlanPro()
    {
        super();
        registerInterface(IProjectMonthPlanPro.class, this);
    }
    public ProjectMonthPlanPro(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectMonthPlanPro.class, this);
    }
    ...
    private ProjectMonthPlanProController getController() throws BOSException
    {
        return (ProjectMonthPlanProController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectMonthPlanProInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanProInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanProInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanProCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanProCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanProCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
