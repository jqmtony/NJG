...
public class SubjectLevelSubject extends BillEntryBase implements ISubjectLevelSubject
{
    public SubjectLevelSubject()
    {
        super();
        registerInterface(ISubjectLevelSubject.class, this);
    }
    public SubjectLevelSubject(Context ctx)
    {
        super(ctx);
        registerInterface(ISubjectLevelSubject.class, this);
    }
    ...
    private SubjectLevelSubjectController getController() throws BOSException
    {
        return (SubjectLevelSubjectController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSubjectLevelSubjectInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSubjectLevelSubjectInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSubjectLevelSubjectInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSubjectLevelSubjectCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSubjectLevelSubjectCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSubjectLevelSubjectCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
