...
public class AbstractProjectYearPlanDateEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    ...
    /**
     * Object:项目年度付款规划明细分录's 类型property 
     */
    public com.kingdee.eas.fdc.finance.ProjectPlanDetialTypeEnum getType()
    {
        return com.kingdee.eas.fdc.finance.ProjectPlanDetialTypeEnum.getEnum(getString("type"));
    }
    public void setType(com.kingdee.eas.fdc.finance.ProjectPlanDetialTypeEnum item)
    {
		if (item != null) {
    ...
    /**
     * Object:项目年度付款规划明细分录's 季度property 
     */
