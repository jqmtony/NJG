...
public class FDCProDepSplit extends FDCSplitBill implements IFDCProDepSplit
{
    public FDCProDepSplit()
    {
        super();
        registerInterface(IFDCProDepSplit.class, this);
    }
    public FDCProDepSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCProDepSplit.class, this);
    }
    ...
    private FDCProDepSplitController getController() throws BOSException
    {
        return (FDCProDepSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCProDepSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *先删除原拆分，再更新滚动计划为‘未重新汇总状态’-User defined method
     *@param pk pk
     */
    public void reSplit(BOSUuid pk) throws BOSException
    {
        try {
            getController().reSplit(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *校验项目资金需求计划中的合同是否完全拆分-User defined method
     *@param planID planID
     *@return
     */
    ...
    {
        try {
            return getController().isConAllSplit(getContext(), planID);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
