...
public class FDCDepConPayPlanContract extends FDCBill implements IFDCDepConPayPlanContract
{
    public FDCDepConPayPlanContract()
    {
        super();
        registerInterface(IFDCDepConPayPlanContract.class, this);
    }
    public FDCDepConPayPlanContract(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCDepConPayPlanContract.class, this);
    }
    ...
    private FDCDepConPayPlanContractController getController() throws BOSException
    {
        return (FDCDepConPayPlanContractController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCDepConPayPlanContractCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
