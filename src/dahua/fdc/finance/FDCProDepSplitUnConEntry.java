...
public class FDCProDepSplitUnConEntry extends CoreBillEntryBase implements IFDCProDepSplitUnConEntry
{
    public FDCProDepSplitUnConEntry()
    {
        super();
        registerInterface(IFDCProDepSplitUnConEntry.class, this);
    }
    public FDCProDepSplitUnConEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCProDepSplitUnConEntry.class, this);
    }
    ...
    private FDCProDepSplitUnConEntryController getController() throws BOSException
    {
        return (FDCProDepSplitUnConEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitUnConEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
