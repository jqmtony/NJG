...
public abstract class AbstractProjectInvestPlanEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntry.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"account.codingNumber","account.name","","","task"});
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entry.task", com.kingdee.eas.fdc.schedule.FDCScheduleTaskInfo.class, this.kdtEntry, "task.text");
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entry.task", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
	    	...
	    	sic.add(new SelectorItemInfo("entry.task.id"));
			sic.add(new SelectorItemInfo("entry.task.name"));
        	sic.add(new SelectorItemInfo("entry.task.number"));
		}
