 ...
 * output class name
 */
public abstract class AbstractProjectMonthPlanProEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectMonthPlanProEditUI.class);
    ...
    protected com.kingdee.eas.fdc.finance.ProjectMonthPlanProInfo editData = null;
     ...
     */
    public AbstractProjectMonthPlanProEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectMonthPlanProEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contCurProject.setBounds(new Rectangle(10, 30, 270, 19));
        this.add(contCurProject, new KDLayout.Constraints(10, 30, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        pnlBig.setBounds(new Rectangle(10, 147, 991, 419));
        ...
        contRespPerson.setBounds(new Rectangle(732, 53, 270, 19));
        this.add(contRespPerson, new KDLayout.Constraints(732, 53, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contDepartment.setBounds(new Rectangle(732, 75, 270, 19));
        this.add(contDepartment, new KDLayout.Constraints(732, 75, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contNumber
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProjectMonthPlanProEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.ProjectMonthPlanProInfo)ov;
    }
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectMonthPlanProEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectMonthPlanProEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectMonthPlanProEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ProjectMonthPlanProEditUI");
    }
