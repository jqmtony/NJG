 ...
 * output class name
 */
public abstract class AbstractContractPayPlanEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox cbCurrency;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtEchangeRate;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.cbCurrency = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtEchangeRate = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.cbCurrency.setName("cbCurrency");
        this.txtEchangeRate.setName("txtEchangeRate");
        // CoreUI		
        this.setPreferredSize(new Dimension(800,629));
        // tblPayPlan
        ...
        this.tblPayPlan.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                try {
                    tblPayPlan_editStopped(e);
                } catch(Exception exc) {
                    handUIException(exc);
                }
            }
        ...
        this.contContractAmount.setBoundLabelLength(80);		
        ...
        // txtEchangeRate		
        this.txtEchangeRate.setEnabled(false);		
        this.txtEchangeRate.setHorizontalAlignment(4);
    ...
    public void initUIContentLayout()
    {
        ...
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 800, 629));
        tblPayPlan.setBounds(new Rectangle(0, 47, 800, 578));
        this.add(tblPayPlan, new KDLayout.Constraints(0, 47, 800, 578, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contContractAmount.setBounds(new Rectangle(10, 10, 240, 19));
        this.add(contContractAmount, new KDLayout.Constraints(10, 10, 240, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(279, 10, 240, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(279, 10, 240, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(549, 10, 240, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(549, 10, 240, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contContractAmount
        contContractAmount.setBoundEditor(txtContractAmount);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(cbCurrency);
        //kDLabelContainer2
        kDLabelContainer2.setBoundEditor(txtEchangeRate);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ContractPayPlanEditUIHandler";
	}
    ...
    /**
     * output tblPayPlan_editStopped method
     */
    protected void tblPayPlan_editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ContractPayPlanEditUI");
    }
