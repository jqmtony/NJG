 ...
 * output class name
 */
public abstract class AbstractFDCYearBudgetAcctDeptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCYearBudgetAcctDeptFilterUI.class);
     ...
     */
    public AbstractFDCYearBudgetAcctDeptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCYearBudgetAcctDeptFilterUI.class.getName());
        ...
        this.contDept.setBoundLabelLength(80);
        // prmtDept
        this.prmtDept.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    prmtDept_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    {
        this.setBounds(new Rectangle(10, 10, 360, 150));
        this.setLayout(null);
        contDept.setBounds(new Rectangle(42, 33, 270, 19));
        this.add(contDept, null);
        btnOK.setBounds(new Rectangle(182, 118, 73, 21));
        this.add(btnOK, null);
        btnNO.setBounds(new Rectangle(266, 118, 73, 21));
        this.add(btnNO, null);
        //contDept
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCYearBudgetAcctDeptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCYearBudgetAcctDeptFilterUI");
    }
