...
/**
 * 预算系统月度预算计划付款取数函数Wizard
 * @author pengwei_hou
 * 
 */
public class FDCMonthlyBudgetPayWizard extends FormulaWizardUI {

	private static final long serialVersionUID = -5561571037137768727L;

	/** 成本中心 */
	private KDBizPromptBox costCenter;

	public FDCMonthlyBudgetPayWizard() throws Exception {
		super();
		// TODO 自动生成构造函数存根
	}
