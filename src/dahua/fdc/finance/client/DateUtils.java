...
public final class DateUtils {
	...
	// ///////////////////
	/**
	 * 描述：将Date加N个月，多使用于失效日期处理 EXAMPLE: date = 2006-11-29 dateAddMonth(date, 1);
	 * date = 2006-12-29
	 * 
	 * @param Date
	 *            如果为Null，则返回当前日期加上N个月.
	 * @param months
	 *            正数为Date加上months个月，负数为Date减去months个月
	 * @return java.util.Date
	 * @author:daij 创建时间：2006-11-29 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	...
	/**
	 * 描述：将Date加N天 Example: date = 2006-11-29 dateAddDay(date, 1); date =
	 * 2006-11-30
	 * 
	 * @param Date
	 *            如果为Null，则返回当前日期加上N天.
	 * @param days
	 *            正数为Date加上days个月，负数为Date减去days个月
	 * @return java.util.Date 修改时间: 2010-03-12 run_zheng
	 *         <p>
	 */
	 ...
	 *            源日期
	 * @param field
	 *            增长的属性， 如:Calendar.DATE,具体参考Calendar
	 * @param amount
	 *            增长量
	 * @return 增长后的日期
	 * @author tjw 创建时间：2009-09-14 修改时间: 2010-03-12 run_zheng
	 *         <p>
	 */
	...
	/**
	 * 描述：某天的开始时间，yyyy-MM-dd 00:00:00.000 date为空，默认为当前日期
	 * 
	 * @param date
	 *            java.util.Date 源日期
	 * @return 目标日期
	 * @author:daij 创建时间：2006-11-27 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	...
	/**
	 *描述：某天的结束时间，yyyy-MM-dd 23:59:59.999 date为空，默认为当前日期
	 * 
	 * @param date
	 *            java.util.Date 源日期
	 * @return 目标日期
	...
	/**
	 *描述：以某天为基准的所在月第一天的开始时间，yyyy-MM-01 00:00:00.000 date为空，默认为当前日期
	 * 
	 * @param date
	 *            源日期
	 * @return 目标日期
	...
	/**
	 * 描述：返回精确到天的日期,显示格式为yyyy-MM-dd的日期 date为空，默认为当前日期
	 * 
	 * @param date
	 *            java.util.Date 源日期
	 * @return String 按yyyy-MM-dd格式化后的日期.
	 * @author:daij 创建时间：2009-8-8 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	...
	/**
	 * 描述：返回精确到天的日期,显示格式为yyyy-MM-dd HH:mm:ss的日期 date为空，默认为当前日期
	 * 
	 * @param date
	 *            java.util.Date 源日期
	 * @return String 按yyyy-MM-dd HH:mm:ss格式化后的日期.
	 * @author:tjw 创建时间：2010-6-23
	 */
	...
	// //////////////////
	/**
	 * 描述：将Date转换为Timestamp 注意：当date值为NULL时，可返回当前日期的Timestamp
	 * 
	 * @param date
	 *            源日期
	...
	/**
	 * 描述：将Timestamp转换为Date. 注意：当Timestamp值为NULL时，可返回当前日期的Date
	 * 
	 * @param time
	 *            源日期Timestamp值
	 ...
	 * @author:daij 创建时间：2007-4-19 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	...
	/**
	 * 描述：某个日期往前或者后推几天. date为空，默认为当前日期
	 * 
	 * @param amount
	 *            前或后推几天， 比如:amount = 1 则为明天， -1则为前天，以此类推
	 * @return Timestamp
	 * @author:daij 创建时间：2009-7-18 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	...
	/**
	 * 描述：某个日期的月往前或者后推几月. date为空，默认为当前日期
	 * 
	 * @param amount
	 *            前或后推几月， 比如:amount = 1 则为下个月， -1则为上个月，以此类推
	 * @return Timestamp
	 * @author:daij 创建时间：2009-7-18
	 *              <p>
	 */
	 ...
	 * 
	 * @param offsetPart
	 *            偏移部分 Calendar.YEAR, Calendar.MONTH, Calendar.DATE,
	 ...
	 *            偏移值
	 * @author tjw
	 * @return int -1 startDate < endDate 0 startDate = endDate 1 startDate >
	 *         endDate
	 */
	...
	/**
	 * 计算两个日期之间相差的天数 计算的返回值为date2 - date1 的天数
	 * 
	 * @author danny_du
	 * @param date1
	 * @param date2
	...
	/**
	 * 描述：两个日期精确到天比较. 注意：按天比较不考虑时,分，秒，毫秒.
	 * 
	 * @param dateLeft
	 *            可为NULL作为NOW处理
	 * @param dateRight
	 *            可为NULL作为NOW处理
	 * @return int -1 dateLeft < dateRight 0 dateLeft = dateRight 1 dateLeft >
	 *         dateRight
	 * @author:daij 创建时间：2006-11-27 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	public static int compareUpToDay(Date dateLeft, Date dateRight) {
		long result = fromDefNow(dateLeft).startOfDay().milliseconds() - fromDefNow(dateRight).startOfDay().milliseconds();
		return result > 0 ? 1 : result < 0 ? -1 : 0;
	}
	 ...
	 * 
	 * @param date
	 *            待比较的日期，可为NULL作为NOW处理
	 * @return int -1 NOW < dateRight 0 NOW = dateRight 1 NOW > dateRight
	 * @author:daij 创建时间：2006-11-27 修改时间: 2010-03-12 run_zheng
	 *              <p>
	 */
	 ...
	 *            可为NULL作为NOW处理
	 * @return int -1 dateLeft < dateRight 0 dateLeft = dateRight 1 dateLeft >
	 *         dateRight 创建时间: 2010-03-12 run_zheng
	 *         <p>
	 */
	...
	public static boolean isBetweenDate(Date date, Date dateLeft, Date dateRight) {
		return date.getTime() < dateLeft.getTime() ? false : date.getTime() > dateRight.getTime() ? false : true;
	}

	/**
	 * 描述： 判断某个日期是否是某个日期范围内有效， 对日期范围的左端将时分秒设置为00：00：00.000
	...
	/**
	 * 描述：获取判断日期落在有效日期范围内的sql字符串， 注意时间精确到天。 判断的规则：日期的结束时间 （yyyy-MM-dd
	 * 23:59:59）大于等于有效范围的左端 日期的开始时间 （yyyy-MM-dd 00:00:00）小于等于有效范围的右端
	 * 该规则不会造成日期落在日期范围两段的情况漏判断。
	 * 
	 * @param date
	 *            日期
	 * @param effectiveDateField
	 *            生效日期的字段名
	 * @param expireDateField
	 *            失效日期的字段名
	 * @return
	 */
	public static StringBuffer effectiveDaySql(Date date, String effectiveDateField, String expireDateField) {
		return effectiveCommonSql(expireDateField, from(date).startOfDay().formatString(DETAIL_FORMAT_STR), effectiveDateField, from(date).endOfDay().formatString(
				DETAIL_FORMAT_STR));
	}

	public static StringBuffer effectiveDaySql(String field, Date left, Date right) {
		return effectiveCommonSql(field, from(left).startOfDay().formatString(DETAIL_FORMAT_STR), field, from(right).endOfDay().formatString(DETAIL_FORMAT_STR));
	}

	public static StringBuffer effectiveDayRangeSql(Date left, Date right, String leftField, String rightField) {
		StringBuffer sb = new StringBuffer();
		sb.append("( ").append(effectiveDaySql(left, leftField, rightField)).append("  or ").append(effectiveDaySql(right, leftField, rightField)).append(" or ").append(
				effectiveDaySql(leftField, left, right)).append(" )");
		return sb;
	}

	/**
	 * 描述：获取判断日期落在有效日期范围内的sql字符串, 注意时间是精确到时分秒。 判断的规则：日期的结束时间 （yyyy-MM-dd
	 * hh:mm:ss）大于等于有效范围的左端 日期的开始时间 （yyyy-MM-dd hh:mm:ss）小于等于有效范围的右端
	 * 该规则不会造成日期落在日期范围两段的情况漏判断。
	 * 
	 * @param date
	 *            日期
	...
	public static StringBuffer effectiveTimeSql(Date date, String effectiveDateField, String expireDateField) {
		return effectiveCommonSql(expireDateField, from(date).formatString(DETAIL_FORMAT_STR), effectiveDateField, from(date).formatString(DETAIL_FORMAT_STR));
	}

	public static StringBuffer effectiveTimeSql(String field, Date left, Date right) {
		return effectiveCommonSql(field, from(left).formatString(DETAIL_FORMAT_STR), field, from(right).formatString(DETAIL_FORMAT_STR));
	}

	public static StringBuffer effectiveTimeRangeSql(Date left, Date right, String leftField, String rightField) {
		StringBuffer sb = new StringBuffer();
		sb.append("( ").append(effectiveTimeSql(left, leftField, rightField)).append("  or ").append(effectiveTimeSql(right, leftField, rightField)).append(" or ").append(
				effectiveTimeSql(leftField, left, right)).append(" )");
		return sb;
	}

	private static StringBuffer effectiveCommonSql(String leftField, String leftDateStr, String rightField, String rightDateStr) {
		StringBuffer sb = new StringBuffer();
		sb.append(" (").append(leftField).append(" >= {ts'").append(leftDateStr).append("'} ").append("and ").append(rightField).append(" <={ts'").append(rightDateStr).append(
				"'} )");
		return sb;
	}
	...
	// ///////
	/**
	 * 获取Date的伙伴类对象 使用方法如：DateUtil.from(DATE).addMonth(1).startOfDay().get()
	 * 获得下个月同一天的开始时间Date对象，比如现在是2010-03-11 10:49:33.23 建议在多次设置的情况下使用该API
	 * 
	 * @param date
	 *            初始化日期
	 * @return
	 ...
	 * 增加对应日期的年月日时分秒（负数往前推，正数往后推） 4、利用cutTail/millisecond(X)/millisecond()
	 * 截掉后面的毫秒/设置/获取秒后面的毫秒数 5、利用startOfDay/endOfDay/startOfMonth/endOfMonth
	 * 分别用于获取一天的开始/结束和一个月的开始/结束的日期 6、利用reset方法重置伙伴类的日期
	 ...
	 * 分别用于获取——（yyyy-MM-dd）/(yyyy-MM-dd HH:mm:ss) /（yyyy-MM-dd
	 * HH:mm:ss.SS）/（HH:mm:ss）/指定格式的——日期字符串 注意：1、不能多线程操作该类的对象，否则结果不可预料。
	...
	public static class DateObject {
		 ...
		 * 
		 * public DateAccompany nanos(int nanos){ this.nanos = nanos; return
		 * this; }
		 */
		...
		public DateObject endOfDay() {
			this.hour(MAX_HOUR).minute(MAX_MIN_SEC).second(MAX_MIN_SEC).millisecond(MAX_MILLIS); // .
																									// nanos
																									// (
																									// MAX_NANOS
																									// )
	 ...
	 * 
	 * @throws ParseException
	 * @author:junwu_tang 创建时间：2006-11-27
	 *                    <p>
	 */
