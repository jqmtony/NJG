...
/*		try {
	...
	public void actionCostSplit_actionPerformed(ActionEvent e) throws Exception {
		...
		// 判断在工程量拆分中的结算单是否已经拆分
		String msg = "结算后的工程量拆分必须在结算单拆分后才可以拆分!";
		boolean flag = FDCSplitClientHelper.isBillSplitedByContractBillId(this.getContractBillId(),
				"T_CON_SETTLEMENTCOSTSPLIT", "FCONTRACTBILLID");
		if (flag == false) {
