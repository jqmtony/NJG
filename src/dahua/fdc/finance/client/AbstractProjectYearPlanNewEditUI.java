 ...
 * output class name
 */
public abstract class AbstractProjectYearPlanNewEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectYearPlanNewEditUI.class);
    ...
    protected com.kingdee.eas.fdc.finance.ProjectYearPlanInfo editData = null;
     ...
     */
    public AbstractProjectYearPlanNewEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectYearPlanNewEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(10, 52, 632, 57));
        this.add(contDescription, new KDLayout.Constraints(10, 52, 632, 57, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        pnlBig.setBounds(new Rectangle(10, 121, 991, 445));
        this.add(pnlBig, new KDLayout.Constraints(10, 121, 991, 445, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        btnGet.setBounds(new Rectangle(883, 84, 119, 25));
        this.add(btnGet, new KDLayout.Constraints(883, 84, 119, 25, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProjectYearPlanNewEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.ProjectYearPlanInfo)ov;
    }
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectYearPlanNewEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectYearPlanNewEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectYearPlanNewEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    protected class ActionExportExcel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectYearPlanNewEditUI.this, "ActionExportExcel", "actionExportExcel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ProjectYearPlanNewEditUI");
    }
