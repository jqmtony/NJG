...
public abstract class AbstractFDCDepConPayPlanEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        //pnlBig
        pnlBig.add(kDPanel1, resHelper.getString("kDPanel1.constraints"));
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDContainer1, BorderLayout.CENTER);
        //kDContainer1
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblTotal, BorderLayout.CENTER);
        //pnlContract
