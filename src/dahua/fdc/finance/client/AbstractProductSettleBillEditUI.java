 ...
 * output class name
 */
public abstract class AbstractProductSettleBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProductSettleBillEditUI.class);
    ...
    protected com.kingdee.eas.fdc.finance.ProductSettleBillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractProductSettleBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProductSettleBillEditUI.class.getName());
        ...
        this.txtCompArea.setRequired(true);
        // contCompDate		
        ...
        // pkCompDate		
        this.pkCompDate.setRequired(true);
    ...
    {
        this.setBounds(new Rectangle(10, 10, 290, 70));
        this.setLayout(null);
        contCompArea.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contCompArea, null);
        contCompDate.setBounds(new Rectangle(10, 41, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProductSettleBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.ProductSettleBillInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ProductSettleBillEditUI");
    }
