 ...
 * output class name
 */
public abstract class AbstractPaymentSplitWithoutTxtConEditUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPaymentSplitWithoutTxtConEditUI.class);
     ...
     */
    public AbstractPaymentSplitWithoutTxtConEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPaymentSplitWithoutTxtConEditUI.class.getName());
        ...
        this.contContractName.setEnabled(false);
        // contCostAmt		
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer1.setBounds(new Rectangle(533, 571, 470, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(533, 571, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDLabelContainer8.setBounds(new Rectangle(10, 549, 470, 19));
        this.add(kDLabelContainer8, new KDLayout.Constraints(10, 549, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer10.setBounds(new Rectangle(10, 571, 470, 19));
        this.add(kDLabelContainer10, new KDLayout.Constraints(10, 571, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer11.setBounds(new Rectangle(533, 549, 470, 19));
        this.add(kDLabelContainer11, new KDLayout.Constraints(533, 549, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contContractNumber.setBounds(new Rectangle(533, 10, 470, 19));
        this.add(contContractNumber, new KDLayout.Constraints(533, 10, 470, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contContractName.setBounds(new Rectangle(10, 32, 470, 19));
        this.add(contContractName, new KDLayout.Constraints(10, 32, 470, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCostAmt.setBounds(new Rectangle(10, 54, 300, 19));
        this.add(contCostAmt, new KDLayout.Constraints(10, 54, 300, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        //contContractNumber
        contContractNumber.setBoundEditor(txtWithoutTxtConNumber);
        //contContractName
        contContractName.setBoundEditor(txtWithoutTxtConName);
        //contCostAmt
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("paymentBill.localAmt", java.math.BigDecimal.class, this.txtAmount, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.PaymentSplitWithoutTxtConEditUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("paymentBill.localAmt", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("paymentBill.localAmt"));
    ...
    protected class ActionViewPayment extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPaymentSplitWithoutTxtConEditUI.this, "ActionViewPayment", "actionViewPayment_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPaymentSplitWithoutTxtConEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
