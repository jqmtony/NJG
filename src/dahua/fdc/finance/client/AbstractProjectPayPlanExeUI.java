...
ctnRpt.getContentPane().setLayout(new BorderLayout(0, 0));        ctnRpt.getContentPane().add(tblMain, BorderLayout.CENTER);
    ...
    protected class ActionSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectPayPlanExeUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
