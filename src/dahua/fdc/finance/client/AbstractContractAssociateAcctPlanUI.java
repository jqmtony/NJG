 ...
 * output class name
 */
public abstract class AbstractContractAssociateAcctPlanUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractAssociateAcctPlanUI.class);
     ...
     */
    public AbstractContractAssociateAcctPlanUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractAssociateAcctPlanUI.class.getName());
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(table, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ContractAssociateAcctPlanUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ContractAssociateAcctPlanUI");
    }
