 ...
 * output class name
 */
public abstract class AbstractFDCYearBudgetAcctListUI extends com.kingdee.eas.fdc.finance.client.FDCBudgetAcctListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCYearBudgetAcctListUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCYearBudgetAcctListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCYearBudgetAcctListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","state","number","verNumber","period","curProject.name","orgUnit.name","creator.name","createTime","auditor.name","auditTime","orgUnit.id","curProject.id","","isLatestVer"});
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
        ...
        chkAll.setBounds(new Rectangle(240, 10, 68, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCYearBudgetAcctListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCYearBudgetAcctListUI");
    }
    /**
