...
public abstract class AbstractSetCostAccountLevelUI extends com.kingdee.eas.framework.client.CoreUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDPanel pagePanel;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox isSplit;
    protected ActionOk actionOk = null;
    protected ActionCancelSelect actionCancelSelect = null;
    protected ActionIsSplit actionIsSplit = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        //actionIsSplit
        this.actionIsSplit = new ActionIsSplit(this);
        getActionManager().registerAction("actionIsSplit", actionIsSplit);
         this.actionIsSplit.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        this.btnOk = new com.kingdee.bos.ctrl.swing.KDButton();
        this.btnCancel = new com.kingdee.bos.ctrl.swing.KDButton();
        this.kDTable1 = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        this.pagePanel = new com.kingdee.bos.ctrl.swing.KDPanel();
        this.isSplit = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.btnOk.setName("btnOk");
        this.btnCancel.setName("btnCancel");
        this.kDTable1.setName("kDTable1");
        this.pagePanel.setName("pagePanel");
        this.isSplit.setName("isSplit");
        // CoreUI		
        ...
        // pagePanel
        // isSplit
        this.isSplit.setAction((IItemAction)ActionProxyFactory.getProxy(actionIsSplit, new Class[] { IItemAction.class }, getServiceContext()));		
        this.isSplit.setText(resHelper.getString("isSplit.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(11, 42, 441, 422));
        this.add(kDTable1, null);
        pagePanel.setBounds(new Rectangle(11, 9, 150, 26));
        this.add(pagePanel, null);
        isSplit.setBounds(new Rectangle(332, 15, 140, 19));
        this.add(isSplit, null);
    ...
    /**
     * output actionIsSplit_actionPerformed method
     */
	...
	public RequestContext prepareActionIsSplit(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionIsSplit() {
    	return false;
    }
    ...
    /**
     * output ActionIsSplit class
     */     
    protected class ActionIsSplit extends ItemAction {     
    
        public ActionIsSplit()
        {
            this(null);
        }

        public ActionIsSplit(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionIsSplit.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionIsSplit.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionIsSplit.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSetCostAccountLevelUI.this, "ActionIsSplit", "actionIsSplit_actionPerformed", e);
        }
    }
