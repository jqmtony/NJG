 ...
 * output class name
 */
public abstract class AbstractProjectMonthPlanGatherEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectMonthPlanGatherEditUI.class);
    ...
    protected com.kingdee.eas.fdc.finance.ProjectMonthPlanGatherInfo editData = null;
     ...
     */
    public AbstractProjectMonthPlanGatherEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectMonthPlanGatherEditUI.class.getName());
        ...
        // CoreUI		
        this.setBorder(null);		
        this.setPreferredSize(new Dimension(1300,629));		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProjectMonthPlanGatherEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.ProjectMonthPlanGatherInfo)ov;
    }
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectMonthPlanGatherEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectMonthPlanGatherEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectMonthPlanGatherEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
