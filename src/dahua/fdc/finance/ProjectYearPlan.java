...
public class ProjectYearPlan extends FDCBill implements IProjectYearPlan
{
    public ProjectYearPlan()
    {
        super();
        registerInterface(IProjectYearPlan.class, this);
    }
    public ProjectYearPlan(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectYearPlan.class, this);
    }
    ...
    private ProjectYearPlanController getController() throws BOSException
    {
        return (ProjectYearPlanController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectYearPlanInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectYearPlanInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectYearPlanInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectYearPlanCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectYearPlanCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectYearPlanCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
