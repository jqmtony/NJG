...
public class PayPlanNewUnsignControllerBean extends AbstractPayPlanNewUnsignControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanNewUnsignControllerBean");
}