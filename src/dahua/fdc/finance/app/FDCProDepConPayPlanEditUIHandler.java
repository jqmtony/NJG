 ...
 * output class name
 */
public class FDCProDepConPayPlanEditUIHandler extends AbstractFDCProDepConPayPlanEditUIHandler
{
	...
	protected void _handleActionShowAudit(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}