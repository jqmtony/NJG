...

{
	...
	abstract protected void _handleAcionAddAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleAcionDelAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}