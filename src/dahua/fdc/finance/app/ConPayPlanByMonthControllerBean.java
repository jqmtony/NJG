...
public class ConPayPlanByMonthControllerBean extends AbstractConPayPlanByMonthControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanByMonthControllerBean");
}