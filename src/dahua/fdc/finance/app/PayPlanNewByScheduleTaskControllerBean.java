...
public class PayPlanNewByScheduleTaskControllerBean extends AbstractPayPlanNewByScheduleTaskControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanNewByScheduleTaskControllerBean");
}