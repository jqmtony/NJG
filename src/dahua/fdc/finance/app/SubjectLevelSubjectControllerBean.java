...
public class SubjectLevelSubjectControllerBean extends AbstractSubjectLevelSubjectControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.SubjectLevelSubjectControllerBean");
}