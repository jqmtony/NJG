...

{
	...
	abstract protected void _handleActionTrace(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionViewAdjust(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}