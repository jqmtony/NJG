...

{
	...
	abstract protected void _handleActionCloseInit(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionCloseProject(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionCloseInitAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionUnCloseInit(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionUnCloseProject(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionUnCloseInitAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}