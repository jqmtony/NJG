...
public class DepConPayPlanSplitEntryControllerBean extends AbstractDepConPayPlanSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.DepConPayPlanSplitEntryControllerBean");
}