...
public class ConPayPlanByScheduleTaskControllerBean extends AbstractConPayPlanByScheduleTaskControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanByScheduleTaskControllerBean");
}