...

{
	...
	public void handleActionIsSplit(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionIsSplit(request,response,context);
	}
	protected void _handleActionIsSplit(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}