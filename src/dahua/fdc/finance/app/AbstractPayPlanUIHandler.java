...

{
	...
	abstract protected void _handleActionPayRequest(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionEditContractPlan(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionEntryCellDown(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}