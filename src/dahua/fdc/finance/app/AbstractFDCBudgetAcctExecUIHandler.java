...

{
	...
	abstract protected void _handleActionViewCost(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionShowBlankRow(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionHideBlankRow(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionDeptQuery(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}