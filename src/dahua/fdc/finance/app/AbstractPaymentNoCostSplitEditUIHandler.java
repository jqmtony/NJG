 ...
 * output class name
 */
public abstract class AbstractPaymentNoCostSplitEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCNoCostSplitBillEditUIHandler

{
	...
	abstract protected void _handleActionAutoMatchSplit(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}