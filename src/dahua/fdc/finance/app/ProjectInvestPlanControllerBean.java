...
//    	return super.fetchInitData(ctx, paramMap);
    	...
    	if(billId != null){
        	...
        	sic.add(new SelectorItemInfo("entry.task.longNumber"));
        	sic.add(new SelectorItemInfo("entry.task.start"));
			sic.add(new SelectorItemInfo("entry.task.end"));
        	sic.add(new SelectorItemInfo("entry.task.isLeaf"));
			sic.add(new SelectorItemInfo("entry.task.level"));
