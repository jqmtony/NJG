 ...
 * output class name
 */
public abstract class AbstractFDCProDepConPayPlanEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCBillEditUIHandler

{
	...
	public void handleActionSummary(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionSummary(request,response,context);
	}
