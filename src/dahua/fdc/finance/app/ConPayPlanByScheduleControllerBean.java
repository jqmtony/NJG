...
public class ConPayPlanByScheduleControllerBean extends AbstractConPayPlanByScheduleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanByScheduleControllerBean");
}