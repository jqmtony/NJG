 ...
 * output class name
 */
public abstract class AbstractWorkLoadSplitEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCSplitBillEditUIHandler

{
	...
	public void handleActionViewWorkLoadBill(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewWorkLoadBill(request,response,context);
	}
	protected void _handleActionViewWorkLoadBill(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
