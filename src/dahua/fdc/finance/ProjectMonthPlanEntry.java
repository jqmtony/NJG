...
public class ProjectMonthPlanEntry extends CoreBillEntryBase implements IProjectMonthPlanEntry
{
    public ProjectMonthPlanEntry()
    {
        super();
        registerInterface(IProjectMonthPlanEntry.class, this);
    }
    public ProjectMonthPlanEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectMonthPlanEntry.class, this);
    }
    ...
    private ProjectMonthPlanEntryController getController() throws BOSException
    {
        return (ProjectMonthPlanEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
