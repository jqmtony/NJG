...
public class BuildPriceIndexEindexDataEbaseUnit extends CoreBillEntryBase implements IBuildPriceIndexEindexDataEbaseUnit
{
    public BuildPriceIndexEindexDataEbaseUnit()
    {
        super();
        registerInterface(IBuildPriceIndexEindexDataEbaseUnit.class, this);
    }
    public BuildPriceIndexEindexDataEbaseUnit(Context ctx)
    {
        super(ctx);
        registerInterface(IBuildPriceIndexEindexDataEbaseUnit.class, this);
    }
    ...
    private BuildPriceIndexEindexDataEbaseUnitController getController() throws BOSException
    {
        return (BuildPriceIndexEindexDataEbaseUnitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEbaseUnitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
