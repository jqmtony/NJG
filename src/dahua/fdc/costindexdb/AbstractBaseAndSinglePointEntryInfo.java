...
public class AbstractBaseAndSinglePointEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractBaseAndSinglePointEntryInfo()
    {
        this("id");
    }
    protected AbstractBaseAndSinglePointEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object: 基本要素 's 单据头 property 
     */
