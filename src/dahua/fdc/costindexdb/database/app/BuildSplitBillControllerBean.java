...
public class BuildSplitBillControllerBean extends AbstractBuildSplitBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.BuildSplitBillControllerBean");
}