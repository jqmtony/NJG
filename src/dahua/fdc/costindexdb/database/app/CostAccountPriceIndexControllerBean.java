...
public class CostAccountPriceIndexControllerBean extends AbstractCostAccountPriceIndexControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.CostAccountPriceIndexControllerBean");
}