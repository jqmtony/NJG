...
public class BasePointTempEntryControllerBean extends AbstractBasePointTempEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.BasePointTempEntryControllerBean");
}