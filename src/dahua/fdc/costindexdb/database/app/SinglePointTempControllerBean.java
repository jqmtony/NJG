...
public class SinglePointTempControllerBean extends AbstractSinglePointTempControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.SinglePointTempControllerBean");
}