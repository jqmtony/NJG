...
public class ProfessionPointControllerBean extends AbstractProfessionPointControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.ProfessionPointControllerBean");
}