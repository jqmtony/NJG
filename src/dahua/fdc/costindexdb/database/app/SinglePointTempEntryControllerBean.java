...
public class SinglePointTempEntryControllerBean extends AbstractSinglePointTempEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.SinglePointTempEntryControllerBean");
}