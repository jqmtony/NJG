...
public class CostAccountPriceIndexEntryControllerBean extends AbstractCostAccountPriceIndexEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.CostAccountPriceIndexEntryControllerBean");
}