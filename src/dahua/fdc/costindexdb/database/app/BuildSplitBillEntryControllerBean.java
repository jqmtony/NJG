...
public class BuildSplitBillEntryControllerBean extends AbstractBuildSplitBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.BuildSplitBillEntryControllerBean");
}