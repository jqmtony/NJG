...
public class BuildSplitBillEntryDetailControllerBean extends AbstractBuildSplitBillEntryDetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.BuildSplitBillEntryDetailControllerBean");
}