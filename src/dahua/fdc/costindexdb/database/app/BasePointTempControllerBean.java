...
public class BasePointTempControllerBean extends AbstractBasePointTempControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costindexdb.database.app.BasePointTempControllerBean");
}