 ...
 * output class name
 */
public class SinglePointTempEditUI extends AbstractSinglePointTempEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SinglePointTempEditUI.class);
    
    /**
     * output class constructor
     */
    public SinglePointTempEditUI() throws Exception
    {
        super();
    }
