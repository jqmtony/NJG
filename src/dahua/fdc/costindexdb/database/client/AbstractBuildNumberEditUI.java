 ...
 * output class name
 */
public abstract class AbstractBuildNumberEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBuildNumberEditUI.class);
     ...
     */
    public AbstractBuildNumberEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBuildNumberEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 330, 200));
        this.setLayout(null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.database.app.BuildNumberEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.prmtproductType.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.costindexdb.database.BuildNumberInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.database.client", "BuildNumberEditUI");
    }
