 ...
 * output class name
 */
public abstract class AbstractBasePointTempEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBasePointTempEditUI.class);
    ...
    protected com.kingdee.eas.fdc.costindexdb.database.BasePointTempInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBasePointTempEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBasePointTempEditUI.class.getName());
        ...
        final KDBizPromptBox kdtEntrys_unitBase_PromptBox = new KDBizPromptBox();
        kdtEntrys_unitBase_PromptBox.setQueryInfo("com.kingdee.eas.basedata.assistant.app.F7MeasureUnitQuery");
        kdtEntrys_unitBase_PromptBox.setVisible(true);
        kdtEntrys_unitBase_PromptBox.setEditable(true);
        kdtEntrys_unitBase_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_unitBase_PromptBox.setEditFormat("$number$");
        kdtEntrys_unitBase_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_unitBase_CellEditor = new KDTDefaultCellEditor(kdtEntrys_unitBase_PromptBox);
        this.kdtEntrys.getColumn("unitBase").setEditor(kdtEntrys_unitBase_CellEditor);
        ...
        KDTDefaultCellEditor kdtEntrys_beizhu_CellEditor = new KDTDefaultCellEditor(kdtEntrys_beizhu_TextField);
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(27, 17, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(387, 17, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(57, 566, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(341, 568, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisUse.setBounds(new Rectangle(27, 45, 83, 19));
        this.add(chkisUse, null);
        kdtEntrys.setBounds(new Rectangle(27, 73, 718, 484));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.fdc.costindexdb.database.BasePointTempEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.fdc.costindexdb.database.BasePointTempEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.database.app.BasePointTempEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.costindexdb.database.BasePointTempInfo)ov;
    }
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("Entrys.unitBase.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("Entrys.unitBase.id"));
			sic.add(new SelectorItemInfo("Entrys.unitBase.name"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.database.client", "BasePointTempEditUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.costindexdb.database.client.BasePointTempEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.costindexdb.database.BasePointTempFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.costindexdb.database.BasePointTempInfo objectValue = new com.kingdee.eas.fdc.costindexdb.database.BasePointTempInfo();
