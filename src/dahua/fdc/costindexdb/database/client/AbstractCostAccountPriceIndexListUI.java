 ...
 * output class name
 */
public abstract class AbstractCostAccountPriceIndexListUI extends com.kingdee.eas.framework.client.ListUI
{
     ...
     */
    public AbstractCostAccountPriceIndexListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostAccountPriceIndexListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","name","indexType.name","curProject.name","costAccount.name","beizhu","creator.name","createTime","lastUpdateUser.name","lastUpdateTime"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.database.app.CostAccountPriceIndexListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.database.client", "CostAccountPriceIndexListUI");
    }
