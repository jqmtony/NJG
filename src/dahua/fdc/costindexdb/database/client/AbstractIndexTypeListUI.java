 ...
 * output class name
 */
public abstract class AbstractIndexTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractIndexTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractIndexTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.database.app.IndexTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.database.client", "IndexTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.costindexdb.database.client.IndexTypeEditUI.class.getName();
    }
