 ...
 * output class name
 */
public abstract class AbstractBuildSplitBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBuildSplitBillEditUI.class);
     ...
     */
    public AbstractBuildSplitBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBuildSplitBillEditUI.class.getName());
        ...
        // contsourceNumber		
        this.contsourceNumber.setBoundLabelText(resHelper.getString("contsourceNumber.boundLabelText"));		
        this.contsourceNumber.setBoundLabelLength(100);		
        this.contsourceNumber.setBoundLabelUnderline(true);		
        this.contsourceNumber.setVisible(true);
        // contdataType		
        ...
        // contcontractLevel		
        this.contcontractLevel.setBoundLabelText(resHelper.getString("contcontractLevel.boundLabelText"));		
        this.contcontractLevel.setBoundLabelLength(100);		
        ...
        this.prmtcostAccount.setVisible(true);		
        ...
        // txtsourceNumber		
        this.txtsourceNumber.setVisible(true);		
        this.txtsourceNumber.setHorizontalAlignment(2);		
        this.txtsourceNumber.setMaxLength(200);		
        this.txtsourceNumber.setRequired(false);		
        this.txtsourceNumber.setEnabled(false);
        // dataType		
        this.dataType.setVisible(true);		
        this.dataType.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.costindexdb.database.BuildSplitDataType").toArray());		
        this.dataType.setRequired(false);		
        this.dataType.setEnabled(false);
        // contractLevel		
        this.contractLevel.setVisible(true);		
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(324, 581, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(324, 604, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(735, 581, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(735, 604, 270, 19));
        ...
        contsourceNumber.setBounds(new Rectangle(737, 32, 270, 19));
        this.add(contsourceNumber, null);
        contdataType.setBounds(new Rectangle(737, 7, 270, 19));
        ...
        //contsourceNumber
        contsourceNumber.setBoundEditor(txtsourceNumber);
        //contdataType
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.database.app.BuildSplitBillEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.prmtcostAccount.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.costindexdb.database.BuildSplitBillInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.database.client", "BuildSplitBillEditUI");
    }
    /**
    ...
    protected void applyDefaultValue(IObjectValue vo) {        
		vo.put("dataType","basePoint");
vo.put("contractLevel","sign");
