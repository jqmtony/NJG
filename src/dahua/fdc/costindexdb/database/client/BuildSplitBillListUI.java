 ...
 * output class name
 */
public class BuildSplitBillListUI extends AbstractBuildSplitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BuildSplitBillListUI.class);
    
    /**
     * output class constructor
     */
    public BuildSplitBillListUI() throws Exception
    {
        super();
    }
