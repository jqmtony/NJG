...
public class BuildPriceIndexEindexDataEdateData extends CoreBillEntryBase implements IBuildPriceIndexEindexDataEdateData
{
    public BuildPriceIndexEindexDataEdateData()
    {
        super();
        registerInterface(IBuildPriceIndexEindexDataEdateData.class, this);
    }
    public BuildPriceIndexEindexDataEdateData(Context ctx)
    {
        super(ctx);
        registerInterface(IBuildPriceIndexEindexDataEdateData.class, this);
    }
    ...
    private BuildPriceIndexEindexDataEdateDataController getController() throws BOSException
    {
        return (BuildPriceIndexEindexDataEdateDataController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildPriceIndexEindexDataEdateDataCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
