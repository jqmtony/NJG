 ...
 * output class name
 */
public abstract class AbstractBuildPriceQueryUI extends com.kingdee.eas.framework.client.BillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBuildPriceQueryUI.class);
    /**
     * output class constructor
     */
    public AbstractBuildPriceQueryUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBuildPriceQueryUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.costindexdb.app", "BuildPriceIndexQuery");
        // CoreUI		
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","bizDate","contractInfo","contractStation","orgName","projectStation","buildPriceBillStatus","beizhu","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","id","projectId","contractId"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.app.BuildPriceQueryUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.client", "BuildPriceQueryUI");
    }
