 ...
 * output class name
 */
public abstract class AbstractBaseAndSinglePointListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseAndSinglePointListUI.class);
     ...
     */
    public AbstractBaseAndSinglePointListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaseAndSinglePointListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.costindexdb.app", "BaseAndSinglePointQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(4, 8, 1003, 615));
        this.add(kDSplitPane1, new KDLayout.Constraints(4, 8, 1003, 615, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.app.BaseAndSinglePointListUIHandler";
	}
...
com.kingdee.eas.fdc.costindexdb.BaseAndSinglePointInfo editData = (com.kingdee.eas.fdc.costindexdb.BaseAndSinglePointInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.fdc.costindexdb.BaseAndSinglePointFactory.getRemoteInstance().refix(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBaseAndSinglePointListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseAndSinglePointListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseAndSinglePointListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAdudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseAndSinglePointListUI.this, "ActionUnAdudit", "actionUnAdudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionRefix extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseAndSinglePointListUI.this, "ActionRefix", "actionRefix_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.client", "BaseAndSinglePointListUI");
    }
    /**
    ...
    {
        return new String[] {"id","projectId","number","bizDate","projectName","version","isLatest","pointBillStatus","beizhu","auditor.name","audiTime","creator.name","createTime","lastUpdateUser.name","lastUpdateTime"};
    }
