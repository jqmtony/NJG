...
public abstract class AbstractBuildPriceIndexListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    ...
    protected EntityViewInfo queryBuildPriceIndexQuery1 = null;
    protected IMetaDataPK queryBuildPriceIndexQuery1PK;
    ...
    private void jbInit() throws Exception
    {
        ...
        queryBuildPriceIndexQuery1PK = new MetaDataPK("com.kingdee.eas.fdc.costindexdb.app", "BuildPriceIndexQuery");
        //actionRemove
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(kdtCost, BorderLayout.CENTER);
    ...
    public void setDataObject(String key, IObjectValue dataObject)
    {
        ...
        else if (key.equalsIgnoreCase("queryBuildPriceIndexQuery1")) {
            this.queryBuildPriceIndexQuery1 = (EntityViewInfo)dataObject;
		}
	}
    ...
    /**
     * output kdtCost_doRequestRowSet method
     */
    protected void kdtCost_doRequestRowSet(RequestRowSetEvent e)
    {
        if (this.queryBuildPriceIndexQuery1 != null) {
            int start = ((Integer)e.getParam1()).intValue();
            int length = ((Integer)e.getParam2()).intValue() - start + 1;
            try {
                IQueryExecutor exec = this.getQueryExecutor(this.queryBuildPriceIndexQuery1PK, this.queryBuildPriceIndexQuery1);
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("textData"));
        sic.add(new SelectorItemInfo("recordSeq"));
        sic.add(new SelectorItemInfo("curProject.name"));
        sic.add(new SelectorItemInfo("entrys.projectId0"));
