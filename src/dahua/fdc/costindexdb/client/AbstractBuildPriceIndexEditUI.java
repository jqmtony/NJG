 ...
 * output class name
 */
public abstract class AbstractBuildPriceIndexEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBuildPriceIndexEditUI.class);
     ...
     */
    public AbstractBuildPriceIndexEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBuildPriceIndexEditUI.class.getName());
        ...
        this.contcontractInfo.setVisible(true);
        // contbeizhu		
        ...
        // contbuildPriceBillStatus		
        this.contbuildPriceBillStatus.setBoundLabelText(resHelper.getString("contbuildPriceBillStatus.boundLabelText"));		
        this.contbuildPriceBillStatus.setBoundLabelLength(100);		
        this.contbuildPriceBillStatus.setBoundLabelUnderline(true);		
        this.contbuildPriceBillStatus.setVisible(true);
        // contprojectStation		
        this.contprojectStation.setBoundLabelText(resHelper.getString("contprojectStation.boundLabelText"));		
        this.contprojectStation.setBoundLabelLength(100);		
        this.contprojectStation.setBoundLabelUnderline(true);		
        this.contprojectStation.setVisible(true);		
        this.contprojectStation.setEnabled(false);
        // contcontractStation		
        this.contcontractStation.setBoundLabelText(resHelper.getString("contcontractStation.boundLabelText"));		
        ...
        this.txtorgName.setMaxLength(180);		
        this.txtorgName.setRequired(false);		
        this.txtorgName.setEnabled(false);
        // txtcontractInfo		
        this.txtcontractInfo.setVisible(true);		
        this.txtcontractInfo.setHorizontalAlignment(2);		
        this.txtcontractInfo.setMaxLength(180);		
        this.txtcontractInfo.setRequired(false);		
        ...
        // buildPriceBillStatus		
        this.buildPriceBillStatus.setVisible(true);		
        this.buildPriceBillStatus.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.basedata.FDCBillStateEnum").toArray());		
        this.buildPriceBillStatus.setRequired(false);		
        this.buildPriceBillStatus.setEnabled(false);
        // projectStation		
        this.projectStation.setVisible(true);		
        this.projectStation.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.costindexdb.ProjectStationEnum").toArray());		
        this.projectStation.setRequired(false);		
        this.projectStation.setEnabled(false);
        // contractStation		
        this.contractStation.setVisible(true);		
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contcontractInfo, new KDLayout.Constraints(8, 7, 635, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbeizhu.setBounds(new Rectangle(8, 53, 635, 37));
        this.add(contbeizhu, new KDLayout.Constraints(8, 53, 635, 37, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        //contbuildPriceBillStatus
        contbuildPriceBillStatus.setBoundEditor(buildPriceBillStatus);
        //contprojectStation
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.fdc.costindexdb.BuildPriceIndexEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("contractInfo", String.class, this.txtcontractInfo, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costindexdb.app.BuildPriceIndexEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.costindexdb.BuildPriceIndexInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("contractInfo", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costindexdb.client", "BuildPriceIndexEditUI");
    }
    /**
    ...
    protected void applyDefaultValue(IObjectValue vo) {        
		vo.put("buildPriceBillStatus","1SAVED");
vo.put("projectStation","10");
vo.put("contractStation","10");
