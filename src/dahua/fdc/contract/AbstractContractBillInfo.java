...
public class AbstractContractBillInfo extends com.kingdee.eas.fdc.basedata.FDCBillInfo implements Serializable 
{
    ...
    /**
     * Object:合同单据's 招标立项property 
     */
    public String getInviteBillID()
    {
        return getString("InviteBillID");
    }
    public void setInviteBillID(String item)
    {
        setString("InviteBillID", item);
    }
    /**
     * Object:合同单据's 评定标分录IDproperty 
     */
    public String getInviteBillEntryID()
    {
        return getString("InviteBillEntryID");
    }
    public void setInviteBillEntryID(String item)
    {
        setString("InviteBillEntryID", item);
    }
    /**
     * Object: 合同单据 's 招标立项 property 
     */
    ...
    /**
     * Object: 合同单据 's 战略协议 property 
     */
    public com.kingdee.eas.fdc.invite.news.StrategyPactInfo getStrategyPact()
    {
        return (com.kingdee.eas.fdc.invite.news.StrategyPactInfo)get("strategyPact");
    }
    public void setStrategyPact(com.kingdee.eas.fdc.invite.news.StrategyPactInfo item)
    {
        put("strategyPact", item);
    }
    /**
     * Object: 合同单据 's 议标 property 
     */
    public com.kingdee.eas.fdc.invite.news.TenderDiscusstionInfo getTenderDiscusstion()
    {
        return (com.kingdee.eas.fdc.invite.news.TenderDiscusstionInfo)get("tenderDiscusstion");
    }
    public void setTenderDiscusstion(com.kingdee.eas.fdc.invite.news.TenderDiscusstionInfo item)
    {
        put("tenderDiscusstion", item);
    }
    /**
     * Object:合同单据's 委托原因property 
     */
    public String getEntrustReason()
    {
        return getString("entrustReason");
    }
    public void setEntrustReason(String item)
    {
