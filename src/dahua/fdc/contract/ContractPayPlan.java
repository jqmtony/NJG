...
public class ContractPayPlan extends FDCBill implements IContractPayPlan
{
     ...
     *@return
     */
    public IObjectPK addnew(ContractPayPlanInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, ContractPayPlanInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void update(IObjectPK pk, ContractPayPlanInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector selector
     */
    public void updatePartial(ContractPayPlanInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void updateBigObject(IObjectPK pk, ContractPayPlanInfo model) throws BOSException
    {
        try {
