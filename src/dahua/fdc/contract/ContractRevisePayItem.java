...
public class ContractRevisePayItem extends CoreBillEntryBase implements IContractRevisePayItem
{
    public ContractRevisePayItem()
    {
        super();
        registerInterface(IContractRevisePayItem.class, this);
    }
    public ContractRevisePayItem(Context ctx)
    {
        super(ctx);
        registerInterface(IContractRevisePayItem.class, this);
    }
    ...
    private ContractRevisePayItemController getController() throws BOSException
    {
        return (ContractRevisePayItemController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractRevisePayItemInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRevisePayItemInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRevisePayItemInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRevisePayItemCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRevisePayItemCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRevisePayItemCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
