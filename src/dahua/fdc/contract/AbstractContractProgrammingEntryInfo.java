...
public class AbstractContractProgrammingEntryInfo extends com.kingdee.eas.framework.CoreBaseInfo implements Serializable 
{
     ...
     */
    public com.kingdee.eas.fdc.contract.ContractProgrammingInfo getParent()
    {
        return (com.kingdee.eas.fdc.contract.ContractProgrammingInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.fdc.contract.ContractProgrammingInfo item)
    {
        put("parent", item);
    }
    /**
    ...
    {
        return new BOSObjectType("21118986");
    }
}