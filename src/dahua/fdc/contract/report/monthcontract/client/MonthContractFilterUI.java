 ...
 * output class name
 */
public class MonthContractFilterUI extends AbstractMonthContractFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthContractFilterUI.class);
    
    /**
     * output class constructor
     */
    public MonthContractFilterUI() throws Exception
    {
        super();
    }
