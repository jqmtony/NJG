...
import com.kingdee.eas.fdc.contract.report.monthcontract.MonthContractReportFacadeFactory;
 ...
 * output class name
 */
public class MonthContractReportUI extends AbstractMonthContractReportUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthContractReportUI.class);
    private boolean isQuery = false;
    /**
     * output class constructor
     */
    public MonthContractReportUI() throws Exception
    {
        super();
...
//		kDTable1.getMergeManager().setMergeMode(KDTMergeManager.FREE_ROW_MERGE);
	...
	protected CommRptBaseConditionUI getQueryDialogUserPanel() throws Exception {
		// TODO Auto-generated method stub
		return new MonthContractFilterUI();
	}

	@Override
	protected ICommRptBase getRemoteInstance() throws BOSException {
		return MonthContractReportFacadeFactory.getRemoteInstance();
	}
	...
	protected void query() {
		...
		ReportUtils.mergerTable(
				kDTable1, 
				new String[]{"curProject","typeName","contractName","contractNumber","partBName","cotractAmount","signDate","contractPropert"}, 
				new String[]{"curProject","typeName","contractName","contractNumber","partBName","cotractAmount","signDate","contractPropert"}
		);
	}
