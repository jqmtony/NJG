 ...
 * output class name
 */
public abstract class AbstractContractWithoutTextFullListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractWithoutTextFullListUI.class);
     ...
     */
    public AbstractContractWithoutTextFullListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractWithoutTextFullListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractWithoutTextFullListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("fiSettleNo"));
    ...
    protected class ActionViewPayment extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractWithoutTextFullListUI.this, "ActionViewPayment", "actionViewPayment_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractWithoutTextFullListUI");
    }
