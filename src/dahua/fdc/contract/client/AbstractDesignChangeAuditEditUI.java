...
public abstract class AbstractDesignChangeAuditEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        tbpChangAudit.setBounds(new Rectangle(9, 269, 991, 259));
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 269, 991, 259, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        sfyjjd.setBounds(new Rectangle(731, 109, 122, 19));
        this.add(sfyjjd, new KDLayout.Constraints(731, 109, 122, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        Sfejjd.setBounds(new Rectangle(863, 109, 140, 19));
        this.add(Sfejjd, new KDLayout.Constraints(863, 109, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        Xscn.setBounds(new Rectangle(863, 131, 140, 19));
        this.add(Xscn, new KDLayout.Constraints(863, 131, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        Bjzb.setBounds(new Rectangle(733, 130, 128, 19));
        this.add(Bjzb, new KDLayout.Constraints(733, 130, 128, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
