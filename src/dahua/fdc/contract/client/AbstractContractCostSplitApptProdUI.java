 ...
 * output class name
 */
public abstract class AbstractContractCostSplitApptProdUI extends com.kingdee.eas.fdc.contract.client.ContractCostSplitApportionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractCostSplitApptProdUI.class);
    protected com.kingdee.eas.framework.CoreBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractContractCostSplitApptProdUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractCostSplitApptProdUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractCostSplitApptProdUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractCostSplitApptProdUI");
    }
