...
public abstract class AbstractContractPayPlanEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contNextRate;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contNextActAmount;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox cbDepartment;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.contNextRate = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contNextActAmount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.cbDepartment = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contNextRate.setName("contNextRate");
        this.contNextActAmount.setName("contNextActAmount");
        ...
        this.cbDepartment.setName("cbDepartment");
        ...
        this.contActAmount.setBoundLabelLength(150);		
        ...
        this.contRate.setBoundLabelLength(150);		
        this.contRate.setBoundLabelUnderline(true);
        // contNextRate		
        this.contNextRate.setBoundLabelText(resHelper.getString("contNextRate.boundLabelText"));		
        this.contNextRate.setBoundLabelLength(150);		
        this.contNextRate.setBoundLabelUnderline(true);
        // contNextActAmount		
        this.contNextActAmount.setBoundLabelText(resHelper.getString("contNextActAmount.boundLabelText"));		
        this.contNextActAmount.setBoundLabelLength(150);		
        this.contNextActAmount.setBoundLabelUnderline(true);
        // contPartB		
        ...
        // cbDepartment		
        this.cbDepartment.setRequired(true);		
        this.cbDepartment.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.contract.DepartmentEnum").toArray());
        // txtActAmount		
        ...
        // txtNextRate		
        this.txtNextRate.setDataType(1);		
        this.txtNextRate.setPrecision(2);		
        this.txtNextRate.setEnabled(false);
        // txtNextActAmount		
        this.txtNextActAmount.setPrecision(2);		
        this.txtNextActAmount.setDataType(1);		
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(10, 97, 630, 64));
        payPlan.add(contDescription, new KDLayout.Constraints(10, 97, 630, 64, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contVersion.setBounds(new Rectangle(728, 140, 270, 19));
        payPlan.add(contVersion, new KDLayout.Constraints(728, 140, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contEntry.setBounds(new Rectangle(10, 166, 986, 170));
        payPlan.add(contEntry, new KDLayout.Constraints(10, 166, 986, 170, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contBizDate.setBounds(new Rectangle(728, 118, 270, 19));
        payPlan.add(contBizDate, new KDLayout.Constraints(728, 118, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDepartment.setBounds(new Rectangle(728, 96, 270, 19));
        payPlan.add(contDepartment, new KDLayout.Constraints(728, 96, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contActAmount.setBounds(new Rectangle(10, 52, 270, 19));
        payPlan.add(contActAmount, new KDLayout.Constraints(10, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contRate.setBounds(new Rectangle(369, 52, 270, 19));
        payPlan.add(contRate, new KDLayout.Constraints(369, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNextRate.setBounds(new Rectangle(369, 74, 270, 19));
        payPlan.add(contNextRate, new KDLayout.Constraints(369, 74, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNextActAmount.setBounds(new Rectangle(10, 74, 270, 19));
        payPlan.add(contNextActAmount, new KDLayout.Constraints(10, 74, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPartB.setBounds(new Rectangle(728, 74, 270, 19));
        payPlan.add(contPartB, new KDLayout.Constraints(728, 74, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contNumber
...
contAct.getContentPane().setLayout(new BorderLayout(0, 0));        contAct.getContentPane().add(kdtAct, BorderLayout.CENTER);
        ...
        //contDepartment
        contDepartment.setBoundEditor(cbDepartment);
        //contActAmount
        contActAmount.setBoundEditor(txtActAmount);
        //contRate
        contRate.setBoundEditor(txtRate);
        //contNextRate
        contNextRate.setBoundEditor(txtNextRate);
        //contNextActAmount
        contNextActAmount.setBoundEditor(txtNextActAmount);
        //contPartB
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("department", com.kingdee.eas.fdc.contract.DepartmentEnum.class, this.cbDepartment, "selectedItem");
