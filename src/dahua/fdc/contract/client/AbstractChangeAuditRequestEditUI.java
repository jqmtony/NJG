...
public abstract class AbstractChangeAuditRequestEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator7.setBounds(new Rectangle(10, 219, 990, 8));
        this.add(kDSeparator7, new KDLayout.Constraints(10, 219, 990, 8, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 233, 993, 295, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contSpecialtyType.setBounds(new Rectangle(665, 69, 14, 19));
