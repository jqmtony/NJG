 ...
 * output class name
 */
public abstract class AbstractChangeAuditRequestEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractChangeAuditRequestEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox conCost;
     ...
     */
    public AbstractChangeAuditRequestEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractChangeAuditRequestEditUI.class.getName());
        ...
        this.conCost = new com.kingdee.bos.ctrl.swing.KDComboBox();
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator7.setBounds(new Rectangle(8, 166, 990, 8));
        this.add(kDSeparator7, new KDLayout.Constraints(8, 166, 990, 8, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAuditType.setBounds(new Rectangle(655, 17, 31, 19));
        this.add(contAuditType, new KDLayout.Constraints(655, 17, 31, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contChangeReason.setBounds(new Rectangle(298, 49, 28, 19));
        this.add(contChangeReason, new KDLayout.Constraints(298, 49, 28, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        tbpChangAudit.setBounds(new Rectangle(9, 184, 993, 344));
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 184, 993, 344, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contOrg.setBounds(new Rectangle(296, 29, 38, 19));
        this.add(contOrg, new KDLayout.Constraints(296, 29, 38, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contReaDesc.setBounds(new Rectangle(12, 127, 988, 31));
        this.add(contReaDesc, new KDLayout.Constraints(12, 127, 988, 31, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        this.add(contbillType, new KDLayout.Constraints(653, 42, 34, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contputForwardTime.setBounds(new Rectangle(377, 36, 270, 19));
        this.add(contputForwardTime, new KDLayout.Constraints(377, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contquality.setBounds(new Rectangle(730, 36, 270, 19));
        this.add(contquality, new KDLayout.Constraints(730, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttimeLi.setBounds(new Rectangle(730, 60, 270, 19));
        this.add(conttimeLi, new KDLayout.Constraints(730, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contsale.setBounds(new Rectangle(730, 84, 270, 19));
        this.add(contsale, new KDLayout.Constraints(730, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contcost.setBounds(new Rectangle(377, 60, 270, 19));
        this.add(contcost, new KDLayout.Constraints(377, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDPanel1.setBounds(new Rectangle(935, 274, 35, 78));
        this.add(kDPanel1, new KDLayout.Constraints(935, 274, 35, 78, 0));
        ...
        Sfejjd.setBounds(new Rectangle(15, 107, 266, 19));
        this.add(Sfejjd, new KDLayout.Constraints(15, 107, 266, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        Bjzb.setBounds(new Rectangle(378, 108, 266, 19));
        this.add(Bjzb, new KDLayout.Constraints(378, 108, 266, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        Xscn.setBounds(new Rectangle(731, 108, 263, 19));
        this.add(Xscn, new KDLayout.Constraints(731, 108, 263, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
...
ctnSuppEntrys.getContentPane().setLayout(new BorderLayout(0, 0));        ctnSuppEntrys.getContentPane().add(kdtSuppEntry, BorderLayout.CENTER);
        ...
        //contcost
        contcost.setBoundEditor(conCost);
        //contTotalCost
        contTotalCost.setBoundEditor(txtTotalCost);
        //kDPanel1
        kDPanel1.setLayout(new KDLayout());
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(935, 274, 35, 78));        conAttenTwo.setBounds(new Rectangle(12, 35, 379, 19));
        ...
        chkIsImportChange.setBounds(new Rectangle(709, 57, 99, 19));
        kDPanel1.add(chkIsImportChange, new KDLayout.Constraints(709, 57, 99, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ChangeAuditRequestEditUIHandler";
	}
    ...
    protected class ActionAddSupp extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionAddSupp", "actionAddSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelSupp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionDelSupp", "actionDelSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionRegister extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionRegister", "actionRegister_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionViewAttachment", "actionViewAttachment_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttenTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionAttenTwo", "actionAttenTwo_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestEditUI.this, "ActionViewTwo", "actionViewTwo_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ChangeAuditRequestEditUI");
    }
    /**
