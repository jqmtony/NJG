...
public abstract class AbstractContractCostSplitEditUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillEditUI
{
    ...
    protected ActionCostContractView actionCostContractView = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        //actionCostContractView
        this.actionCostContractView = new ActionCostContractView(this);
        ...
        // btnViewContract
        this.btnViewContract.setAction((IItemAction)ActionProxyFactory.getProxy(actionCostContractView, new Class[] { IItemAction.class }, getServiceContext()));		
        ...
        // menuViewContract
        this.menuViewContract.setAction((IItemAction)ActionProxyFactory.getProxy(actionCostContractView, new Class[] { IItemAction.class }, getServiceContext()));		
        this.menuViewContract.setText(resHelper.getString("menuViewContract.text"));
        this.menuViewContract.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    menuViewContract_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    /**
     * output menuViewContract_actionPerformed method
     */
    protected void menuViewContract_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    /**
     * output actionCostContractView_actionPerformed method
     */
	...
	public RequestContext prepareActionCostContractView(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionCostContractView() {
    	return false;
    }
    ...
    /**
     * output ActionCostContractView class
     */     
    protected class ActionCostContractView extends ItemAction {     
    
        public ActionCostContractView()
        {
            this(null);
        }

        public ActionCostContractView(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionCostContractView.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionCostContractView.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionCostContractView.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractContractCostSplitEditUI.this, "ActionCostContractView", "actionCostContractView_actionPerformed", e);
        }
    }
