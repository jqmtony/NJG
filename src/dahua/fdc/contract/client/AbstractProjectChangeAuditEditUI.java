 ...
 * output class name
 */
public abstract class AbstractProjectChangeAuditEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectChangeAuditEditUI.class);
     ...
     */
    public AbstractProjectChangeAuditEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectChangeAuditEditUI.class.getName());
        ...
        this.Bjzb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    Bjzb_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
        ...
        this.Xscn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    Xscn_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator7.setBounds(new Rectangle(6, 229, 990, 8));
        this.add(kDSeparator7, new KDLayout.Constraints(6, 229, 990, 8, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAuditType.setBounds(new Rectangle(10, 159, 271, 19));
        this.add(contAuditType, new KDLayout.Constraints(10, 159, 271, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        tbpChangAudit.setBounds(new Rectangle(9, 264, 991, 264));
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 264, 991, 264, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contOrg.setBounds(new Rectangle(664, 38, 13, 19));
        this.add(contOrg, new KDLayout.Constraints(664, 38, 13, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer2.setBounds(new Rectangle(662, 89, 52, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(662, 89, 52, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contReaDesc.setBounds(new Rectangle(12, 182, 635, 44));
        this.add(contReaDesc, new KDLayout.Constraints(12, 182, 635, 44, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbillType.setBounds(new Rectangle(658, 62, 34, 19));
        this.add(contbillType, new KDLayout.Constraints(658, 62, 34, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDPanel1.setBounds(new Rectangle(944, 309, 60, 171));
        this.add(kDPanel1, new KDLayout.Constraints(944, 309, 60, 171, 0));
        contreworkVisa.setBounds(new Rectangle(377, 108, 270, 19));
        this.add(contreworkVisa, new KDLayout.Constraints(377, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcontractAmPro.setBounds(new Rectangle(377, 133, 270, 19));
        this.add(contcontractAmPro, new KDLayout.Constraints(377, 133, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttotalChangeAmount.setBounds(new Rectangle(730, 108, 270, 19));
        this.add(conttotalChangeAmount, new KDLayout.Constraints(730, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdesignChangeAmount.setBounds(new Rectangle(12, 133, 270, 19));
        this.add(contdesignChangeAmount, new KDLayout.Constraints(12, 133, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contchangeEstimate.setBounds(new Rectangle(730, 84, 270, 19));
        this.add(contchangeEstimate, new KDLayout.Constraints(730, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contquality.setBounds(new Rectangle(12, 84, 270, 19));
        this.add(contquality, new KDLayout.Constraints(12, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttimeLi.setBounds(new Rectangle(377, 84, 270, 19));
        this.add(conttimeLi, new KDLayout.Constraints(377, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsale.setBounds(new Rectangle(730, 60, 270, 19));
        ...
        Sfejjd.setBounds(new Rectangle(879, 170, 166, 19));
        this.add(Sfejjd, new KDLayout.Constraints(879, 170, 166, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        this.add(sfyjjd, new KDLayout.Constraints(731, 170, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        refash.setBounds(new Rectangle(738, 238, 130, 21));
        this.add(refash, new KDLayout.Constraints(738, 238, 130, 21, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP));
        contsfhygh.setBounds(new Rectangle(731, 199, 270, 19));
        this.add(contsfhygh, new KDLayout.Constraints(731, 199, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
...
kDPanel3.setLayout(new BorderLayout(0, 0));        //contAheadDisPatch
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(944, 309, 60, 171));        conAttenTwo.setBounds(new Rectangle(12, 35, 379, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ProjectChangeAuditEditUIHandler";
	}
    ...
    /**
     * output Bjzb_actionPerformed method
     */
    protected void Bjzb_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionAddSupp extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionAddSupp", "actionAddSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelSupp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionDelSupp", "actionDelSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionRegister extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionRegister", "actionRegister_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionViewAttachment", "actionViewAttachment_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttenTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionAttenTwo", "actionAttenTwo_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionViewTwo", "actionViewTwo_actionPerformed", e);
        }
    }
    ...
    protected class actionAcctSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionAcctSelect", "actionAcctSelect_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProj extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionSplitProj", "actionSplitProj_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitBotUp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionSplitBotUp", "actionSplitBotUp_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProd extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionSplitProd", "actionSplitProd_actionPerformed", e);
        }
    }
    ...
    protected class actionImpContrSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionImpContrSplit", "actionImpContrSplit_actionPerformed", e);
        }
    }
    ...
    protected class actionAddSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionAddSplit", "actionAddSplit_actionPerformed", e);
        }
    }
    ...
    protected class actionRemoveSplitEntry extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "actionRemoveSplitEntry", "actionRemoveSplitEntry_actionPerformed", e);
        }
    }
    ...
    protected class ActionProfessionSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionProfessionSplit", "actionProfessionSplit_actionPerformed", e);
        }
    }
    ...
    protected class ActionContractPriceSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditEditUI.this, "ActionContractPriceSplit", "actionContractPriceSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ProjectChangeAuditEditUI");
    }
    /**
