 ...
 * output class name
 */
public abstract class AbstractChangeAuditRequestListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractChangeAuditRequestListUI.class);
     ...
     */
    public AbstractChangeAuditRequestListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractChangeAuditRequestListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ChangeAuditRequestQuery");
        //actionRemove
...
contAudit.getContentPane().setLayout(new BorderLayout(0, 0));        contAudit.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ChangeAuditRequestListUIHandler";
	}
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractChangeAuditRequestListUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestListUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionSetRespite extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestListUI.this, "ActionSetRespite", "actionSetRespite_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancelRespite extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChangeAuditRequestListUI.this, "ActionCancelRespite", "actionCancelRespite_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ChangeAuditRequestListUI");
    }
    /**
