 ...
 * output class name
 */
public class CompensationFullListUI extends AbstractCompensationFullListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompensationFullListUI.class);
     ...
     */
    public CompensationFullListUI() throws Exception
    {
        super();
    }
	...
	public void onLoad() throws Exception {
		...
		menuView.remove(menuItemRemove);
	...
	private CustomerQueryPanel getFilterUI() {
		if (this.filterUI == null) {
			try {
				this.filterUI = new CompensationFullFilterUI(this,this.actionOnLoad);
			} catch (Exception e) {
