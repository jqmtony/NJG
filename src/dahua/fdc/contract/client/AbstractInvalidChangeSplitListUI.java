 ...
 * output class name
 */
public abstract class AbstractInvalidChangeSplitListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInvalidChangeSplitListUI.class);
    /**
     * output class constructor
     */
    public AbstractInvalidChangeSplitListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.InvalidChangeSplitListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("costSplitCreator.name"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "InvalidChangeSplitListUI");
    }
