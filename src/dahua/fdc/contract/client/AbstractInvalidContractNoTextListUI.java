 ...
 * output class name
 */
public abstract class AbstractInvalidContractNoTextListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInvalidContractNoTextListUI.class);
     ...
     */
    public AbstractInvalidContractNoTextListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInvalidContractNoTextListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "InvalidContractNoTextQuery");
        //actionTrace
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.InvalidContractNoTextListUIHandler";
	}
    ...
    protected class actionTrace extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInvalidContractNoTextListUI.this, "actionTrace", "actionTrace_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAdjust extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInvalidContractNoTextListUI.this, "ActionViewAdjust", "actionViewAdjust_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "InvalidContractNoTextListUI");
    }
