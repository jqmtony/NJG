...
public abstract class AbstractConChangeSplitListUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillListUI
{
     ...
     */
    public AbstractConChangeSplitListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConChangeSplitListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ConChangeSplitQuery");
        //actionViewInvalid
...
mainPanel.setLayout(new BorderLayout(0, 0));        mainPanel.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ConChangeSplitListUIHandler";
	}
    ...
    protected class ActionViewInvalid extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractConChangeSplitListUI.this, "ActionViewInvalid", "actionViewInvalid_actionPerformed", e);
        }
    }
    ...
    protected class ActionClearSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractConChangeSplitListUI.this, "ActionClearSplit", "actionClearSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ConChangeSplitListUI");
    }
