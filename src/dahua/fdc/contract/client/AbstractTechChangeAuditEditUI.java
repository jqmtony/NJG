 ...
 * output class name
 */
public abstract class AbstractTechChangeAuditEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTechChangeAuditEditUI.class);
     ...
     */
    public AbstractTechChangeAuditEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTechChangeAuditEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator7.setBounds(new Rectangle(5, 224, 990, 8));
        this.add(kDSeparator7, new KDLayout.Constraints(5, 224, 990, 8, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAuditType.setBounds(new Rectangle(12, 155, 268, 19));
        this.add(contAuditType, new KDLayout.Constraints(12, 155, 268, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        tbpChangAudit.setBounds(new Rectangle(9, 254, 991, 274));
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 254, 991, 274, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contOrg.setBounds(new Rectangle(667, 41, 23, 19));
        this.add(contOrg, new KDLayout.Constraints(667, 41, 23, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer2.setBounds(new Rectangle(659, 19, 39, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(659, 19, 39, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contReaDesc.setBounds(new Rectangle(6, 178, 635, 43));
        this.add(contReaDesc, new KDLayout.Constraints(6, 178, 635, 43, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbillType.setBounds(new Rectangle(668, 98, 35, 19));
        this.add(contbillType, new KDLayout.Constraints(668, 98, 35, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contcontractAmPro.setBounds(new Rectangle(377, 132, 270, 19));
        this.add(contcontractAmPro, new KDLayout.Constraints(377, 132, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttotalChangeAmount.setBounds(new Rectangle(729, 108, 270, 19));
        this.add(conttotalChangeAmount, new KDLayout.Constraints(729, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdesignChangeAmount.setBounds(new Rectangle(12, 132, 270, 19));
        this.add(contdesignChangeAmount, new KDLayout.Constraints(12, 132, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        Sfejjd.setBounds(new Rectangle(863, 166, 140, 19));
        this.add(Sfejjd, new KDLayout.Constraints(863, 166, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        Bjzb.setBounds(new Rectangle(729, 137, 140, 19));
        this.add(Bjzb, new KDLayout.Constraints(729, 137, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        Xscn.setBounds(new Rectangle(865, 137, 140, 19));
        this.add(Xscn, new KDLayout.Constraints(865, 137, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        sfyjjd.setBounds(new Rectangle(729, 166, 140, 19));
        this.add(sfyjjd, new KDLayout.Constraints(729, 166, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contChangeReason.setBounds(new Rectangle(377, 155, 270, 19));
        this.add(contChangeReason, new KDLayout.Constraints(377, 155, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        refash.setBounds(new Rectangle(737, 228, 123, 21));
        this.add(refash, new KDLayout.Constraints(737, 228, 123, 21, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP));
        contsfhygh.setBounds(new Rectangle(729, 193, 270, 19));
        this.add(contsfhygh, new KDLayout.Constraints(729, 193, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
...
kDPanel3.setLayout(new BorderLayout(0, 0));        //contAheadDisPatch
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.TechChangeAuditEditUIHandler";
	}
    ...
    protected class ActionAddSupp extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionAddSupp", "actionAddSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelSupp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionDelSupp", "actionDelSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionRegister extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionRegister", "actionRegister_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionViewAttachment", "actionViewAttachment_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttenTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionAttenTwo", "actionAttenTwo_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "ActionViewTwo", "actionViewTwo_actionPerformed", e);
        }
    }
    ...
    protected class actionAcctSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionAcctSelect", "actionAcctSelect_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProj extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionSplitProj", "actionSplitProj_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitBotUp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionSplitBotUp", "actionSplitBotUp_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProd extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionSplitProd", "actionSplitProd_actionPerformed", e);
        }
    }
    ...
    protected class actionImpContrSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionImpContrSplit", "actionImpContrSplit_actionPerformed", e);
        }
    }
    ...
    protected class actionAddSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechChangeAuditEditUI.this, "actionAddSplit", "actionAddSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "TechChangeAuditEditUI");
    }
    /**
