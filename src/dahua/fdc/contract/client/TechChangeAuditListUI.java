 ...
 * output class name
 */
public class TechChangeAuditListUI extends AbstractTechChangeAuditListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TechChangeAuditListUI.class);

	private ChangeAuditListFilterUI filterUI = null;

	private CommonQueryDialog commonQueryDialog = null;

	public TechChangeAuditListUI() throws Exception
    {
        super();
...
//		}
	...
	protected String getEditUIName() {
		return com.kingdee.eas.fdc.contract.client.TechChangeAuditEditUI.class
				.getName();
	}
