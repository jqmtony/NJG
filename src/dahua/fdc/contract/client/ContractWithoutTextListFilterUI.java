...
public class ContractWithoutTextListFilterUI extends ContractWithoutTextFullFilterUI {
	private static final Logger logger = CoreUIObject.getLogger("com.kingdee.eas.fdc.contract.client.ContractWithoutTextFullFilterUI");

	private FullOrgUnitInfo company;
	private CurProjectInfo project;
	private Set authorizedOrgs;

	public ContractWithoutTextListFilterUI(ListUI listUI, ItemAction actionListOnLoad) throws Exception {
	...
	public void clear() {
		...
		this.f7Payee.setQueryInfo("com.kingdee.eas.basedata.master.cssp.app.F7SupplierQuery");
	}
