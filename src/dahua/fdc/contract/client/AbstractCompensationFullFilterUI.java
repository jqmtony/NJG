 ...
 * output class name
 */
public abstract class AbstractCompensationFullFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompensationFullFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox comboCompensationType;
     ...
     */
    public AbstractCompensationFullFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCompensationFullFilterUI.class.getName());
        ...
        this.comboCompensationType = new com.kingdee.bos.ctrl.swing.KDComboBox();
    ...
    public void initUIContentLayout()
    {
        ...
        //contPartB
        contPartB.setBoundEditor(comboCompensationType);
        //contDateFrom
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.CompensationFullFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "CompensationFullFilterUI");
    }
