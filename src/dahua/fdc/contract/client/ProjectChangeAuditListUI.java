 ...
 * output class name
 */
public class ProjectChangeAuditListUI extends AbstractProjectChangeAuditListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectChangeAuditListUI.class);

	private ChangeAuditListFilterUI filterUI = null;

	private CommonQueryDialog commonQueryDialog = null;

	public ProjectChangeAuditListUI() throws Exception
    {
        super();
...
//		}
	...
	protected String getEditUIName() {
		return com.kingdee.eas.fdc.contract.client.ProjectChangeAuditEditUI.class
				.getName();
	}
