 ...
 * output class name
 */
public class ContractCostSplitApptProjUI extends AbstractContractCostSplitApptProjUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractCostSplitApptProjUI.class);
    
    /**
     * output class constructor
     */
    public ContractCostSplitApptProjUI() throws Exception
    {
        super();
    }
