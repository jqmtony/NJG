 ...
 * output class name
 */
public class InvalidSettleSplitListUI extends AbstractInvalidSettleSplitListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(InvalidSettleSplitListUI.class);
	 ...
	 */
	public InvalidSettleSplitListUI() throws Exception {
		super();
	}
