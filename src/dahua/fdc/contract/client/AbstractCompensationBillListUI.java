 ...
 * output class name
 */
public abstract class AbstractCompensationBillListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompensationBillListUI.class);
     ...
     */
    public AbstractCompensationBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCompensationBillListUI.class.getName());
...
contContrList.getContentPane().setLayout(new BorderLayout(0, 0));        contContrList.getContentPane().add(tblMain, BorderLayout.CENTER);
        //contBillList
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblCompensation, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.CompensationBillListUIHandler";
	}
    ...
    /**
     * output tblCompensation_tableSelectChanged method
     */
    protected void tblCompensation_tableSelectChanged(com.kingdee.bos.ctrl.kdf.table.event.KDTSelectEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "CompensationBillListUI");
    }
    /**
