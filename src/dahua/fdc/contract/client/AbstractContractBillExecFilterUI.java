...
public abstract class AbstractContractBillExecFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contContractType.setBounds(new Rectangle(15, 7, 270, 19));
        this.add(contContractType, null);
        contProvider.setBounds(new Rectangle(15, 28, 270, 19));
        this.add(contProvider, null);
        contDateFrom.setBounds(new Rectangle(15, 50, 270, 19));
        this.add(contDateFrom, null);
        contDateTo.setBounds(new Rectangle(15, 72, 270, 19));
        this.add(contDateTo, null);
        plDateType.setBounds(new Rectangle(11, 130, 91, 174));
        this.add(plDateType, null);
        plSettleState.setBounds(new Rectangle(118, 130, 103, 174));
        this.add(plSettleState, null);
        chkAllContract.setBounds(new Rectangle(9, 304, 214, 19));
        this.add(chkAllContract, null);
        contYearTo.setBounds(new Rectangle(15, 72, 180, 19));
        this.add(contYearTo, null);
        contYearFrom.setBounds(new Rectangle(15, 50, 180, 19));
        this.add(contYearFrom, null);
        spiMonthFrom.setBounds(new Rectangle(218, 50, 49, 19));
        this.add(spiMonthFrom, null);
        spiMonthTo.setBounds(new Rectangle(218, 72, 49, 19));
        this.add(spiMonthTo, null);
        lblQuarterFrom.setBounds(new Rectangle(279, 50, 29, 19));
        this.add(lblQuarterFrom, null);
        lblQuarterTo.setBounds(new Rectangle(279, 72, 29, 19));
        this.add(lblQuarterTo, null);
        lblMonthFrom.setBounds(new Rectangle(279, 50, 29, 19));
        this.add(lblMonthFrom, null);
        lblMonthTo.setBounds(new Rectangle(279, 72, 29, 19));
        this.add(lblMonthTo, null);
        lblYearFrom.setBounds(new Rectangle(200, 50, 29, 19));
        this.add(lblYearFrom, null);
        lblYearTo.setBounds(new Rectangle(200, 72, 29, 19));
        this.add(lblYearTo, null);
        btnContractTypeSelect.setBounds(new Rectangle(293, 8, 69, 19));
        this.add(btnContractTypeSelect, null);
        kDLabelContainer1.setBounds(new Rectangle(15, 28, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(15, 28, 270, 19));
        this.add(kDLabelContainer2, null);
        contCurrency.setBounds(new Rectangle(15, 98, 270, 19));
