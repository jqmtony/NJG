 ...
 * output class name
 */
public abstract class AbstractTechEconChangeAuditEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTechEconChangeAuditEditUI.class);
     ...
     */
    public AbstractTechEconChangeAuditEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTechEconChangeAuditEditUI.class.getName());
        ...
        this.contReaDesc.setBoundLabelLength(16);		
        this.contReaDesc.setBoundLabelUnderline(true);		
        this.contReaDesc.setBoundLabelAlignment(8);
        // contbillType		
        ...
        this.kDLabelContainer11.setBoundLabelLength(16);		
        this.kDLabelContainer11.setBoundLabelAlignment(8);
        // kDPanel4		
        ...
        // txtconstructionHead		
        this.txtconstructionHead.setMaxLength(80);
        // prmtBIMUDF0052		
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator6.setBounds(new Rectangle(8, 535, 990, 5));
        this.add(kDSeparator6, new KDLayout.Constraints(8, 535, 990, 5, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDSeparator7.setBounds(new Rectangle(8, 238, 990, 8));
        this.add(kDSeparator7, new KDLayout.Constraints(8, 238, 990, 8, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCreator.setBounds(new Rectangle(9, 542, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(9, 542, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(9, 566, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(9, 566, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(12, 36, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(12, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(377, 542, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(377, 542, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contAuditTime.setBounds(new Rectangle(377, 566, 270, 19));
        ...
        contAuditType.setBounds(new Rectangle(377, 60, 270, 19));
        this.add(contAuditType, new KDLayout.Constraints(377, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contChangeState.setBounds(new Rectangle(730, 84, 270, 19));
        this.add(contChangeState, new KDLayout.Constraints(730, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        tbpChangAudit.setBounds(new Rectangle(9, 246, 991, 282));
        this.add(tbpChangAudit, new KDLayout.Constraints(9, 246, 991, 282, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contConductDept.setBounds(new Rectangle(12, 84, 270, 19));
        this.add(contConductDept, new KDLayout.Constraints(12, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(12, 60, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(12, 60, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(730, 59, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(730, 59, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contReaDesc.setBounds(new Rectangle(12, 155, 270, 79));
        this.add(contReaDesc, new KDLayout.Constraints(12, 155, 270, 79, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbillType.setBounds(new Rectangle(730, 36, 270, 19));
        this.add(contbillType, new KDLayout.Constraints(730, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contputForwardTime.setBounds(new Rectangle(377, 84, 270, 19));
        this.add(contputForwardTime, new KDLayout.Constraints(377, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contTotalCost.setBounds(new Rectangle(12, 131, 270, 19));
        this.add(contTotalCost, new KDLayout.Constraints(12, 131, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDPanel1.setBounds(new Rectangle(972, 309, 32, 215));
        this.add(kDPanel1, new KDLayout.Constraints(972, 309, 32, 215, 0));
        kDLabelContainer4.setBounds(new Rectangle(12, 108, 270, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(12, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer5.setBounds(new Rectangle(377, 108, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(377, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer6.setBounds(new Rectangle(730, 108, 270, 19));
        this.add(kDLabelContainer6, new KDLayout.Constraints(730, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer9.setBounds(new Rectangle(377, 131, 270, 19));
        this.add(kDLabelContainer9, new KDLayout.Constraints(377, 131, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer10.setBounds(new Rectangle(730, 131, 270, 19));
        this.add(kDLabelContainer10, new KDLayout.Constraints(730, 131, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer11.setBounds(new Rectangle(377, 155, 270, 79));
        this.add(kDLabelContainer11, new KDLayout.Constraints(377, 155, 270, 79, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDPanel4.setBounds(new Rectangle(730, 154, 270, 79));
        this.add(kDPanel4, new KDLayout.Constraints(730, 154, 270, 79, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
...
kDPanel3.setLayout(new BorderLayout(0, 0));        //contAheadDisPatch
        ...
        contAheadDisPatch.getContentPane().putClientProperty("OriginalBounds", new Rectangle(902, 569, 712, 46));        contAheadReason.setBounds(new Rectangle(740, 1, 400, 19));
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(972, 309, 32, 215));        conAttenTwo.setBounds(new Rectangle(12, 35, 379, 19));
        ...
        kDPanel1.add(kDLabelContainer3, new KDLayout.Constraints(152, 116, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contJobType.setBounds(new Rectangle(425, 114, 270, 19));
        kDPanel1.add(contJobType, new KDLayout.Constraints(425, 114, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttimeLi.setBounds(new Rectangle(139, 137, 270, 19));
        kDPanel1.add(conttimeLi, new KDLayout.Constraints(139, 137, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsale.setBounds(new Rectangle(419, 134, 270, 19));
        kDPanel1.add(contsale, new KDLayout.Constraints(419, 134, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contquality.setBounds(new Rectangle(117, 156, 270, 19));
        kDPanel1.add(contquality, new KDLayout.Constraints(117, 156, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contreworkVisa.setBounds(new Rectangle(406, 150, 270, 19));
        kDPanel1.add(contreworkVisa, new KDLayout.Constraints(406, 150, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcontractAmPro.setBounds(new Rectangle(689, 92, 270, 19));
        kDPanel1.add(contcontractAmPro, new KDLayout.Constraints(689, 92, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contchangeEstimate.setBounds(new Rectangle(696, 111, 270, 19));
        kDPanel1.add(contchangeEstimate, new KDLayout.Constraints(696, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttotalChangeAmount.setBounds(new Rectangle(684, 129, 270, 19));
        kDPanel1.add(conttotalChangeAmount, new KDLayout.Constraints(684, 129, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdesignChangeAmount.setBounds(new Rectangle(681, 149, 270, 19));
        kDPanel1.add(contdesignChangeAmount, new KDLayout.Constraints(681, 149, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //conAttenTwo
        ...
        //contquality
        contquality.setBoundEditor(conquality);
        //contreworkVisa
        ...
        //kDLabelContainer4
        kDLabelContainer4.setBoundEditor(txtconstructionHead);
        //kDLabelContainer5
        kDLabelContainer5.setBoundEditor(prmtBIMUDF0052);
        //kDLabelContainer6
        kDLabelContainer6.setBoundEditor(pkcompDate);
        //kDLabelContainer9
        kDLabelContainer9.setBoundEditor(txtpunisAmount);
        //kDLabelContainer10
        kDLabelContainer10.setBoundEditor(txtapprovedAmount);
        //kDLabelContainer11
        kDLabelContainer11.setBoundEditor(kDScrollPane2);
        //kDScrollPane2
        kDScrollPane2.getViewport().add(txtworkNote, null);
        //kDPanel4
        kDPanel4.setLayout(new KDLayout());
        kDPanel4.putClientProperty("OriginalBounds", new Rectangle(730, 154, 270, 79));        kDLabelContainer8.setBounds(new Rectangle(24, 41, 230, 19));
        kDPanel4.add(kDLabelContainer8, new KDLayout.Constraints(24, 41, 230, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer7.setBounds(new Rectangle(24, 17, 230, 19));
        kDPanel4.add(kDLabelContainer7, new KDLayout.Constraints(24, 17, 230, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDLabelContainer8
        kDLabelContainer8.setBoundEditor(txtappliAmount);
        //kDLabelContainer7
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.TechEconChangeAuditEditUIHandler";
	}
    ...
    protected class ActionAddSupp extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionAddSupp", "actionAddSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelSupp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionDelSupp", "actionDelSupp_actionPerformed", e);
        }
    }
    ...
    protected class ActionRegister extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionRegister", "actionRegister_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionViewAttachment", "actionViewAttachment_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttenTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionAttenTwo", "actionAttenTwo_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewTwo extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "ActionViewTwo", "actionViewTwo_actionPerformed", e);
        }
    }
    ...
    protected class actionAcctSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "actionAcctSelect", "actionAcctSelect_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProj extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "actionSplitProj", "actionSplitProj_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitBotUp extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "actionSplitBotUp", "actionSplitBotUp_actionPerformed", e);
        }
    }
    ...
    protected class actionSplitProd extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "actionSplitProd", "actionSplitProd_actionPerformed", e);
        }
    }
    ...
    protected class actionImpContrSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTechEconChangeAuditEditUI.this, "actionImpContrSplit", "actionImpContrSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "TechEconChangeAuditEditUI");
    }
    /**
