 ...
 * output class name
 */
public abstract class AbstractProjectChangeAuditListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectChangeAuditListUI.class);
     ...
     */
    public AbstractProjectChangeAuditListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectChangeAuditListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ProjectChangeAuditQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","curProject.id","period.number","orgUnit.name","number","name","bookedDate","curProject.name","changeState","auditType.name","billType","putForwardTime","quality","timeLi","sale","cost","reaDesc","creator.name","createTime","auditor.name","auditTime","contractBill.name","contractBill.number","partB.name","partB.number"});
...
contAudit.getContentPane().setLayout(new BorderLayout(0, 0));        contAudit.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ProjectChangeAuditListUIHandler";
	}
    ...
    protected class ActionDisPatch extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectChangeAuditListUI.this, "ActionDisPatch", "actionDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionAheadDisPatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditListUI.this, "ActionAheadDisPatch", "actionAheadDisPatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionSetRespite extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditListUI.this, "ActionSetRespite", "actionSetRespite_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancelRespite extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectChangeAuditListUI.this, "ActionCancelRespite", "actionCancelRespite_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ProjectChangeAuditListUI");
    }
    /**
