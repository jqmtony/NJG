...
contContrList.getContentPane().setLayout(new BorderLayout(0, 0));        contContrList.getContentPane().add(tblMain, BorderLayout.CENTER);
    ...
    {
        return new String[] {"id","bookedDate","period","state","hasSettle","contractType.name","number","name","isContractor","currency.name","ceremonyb","ceremonybb","contractPrice","exRate","partB.name","contractSource","signDate","respDept","respPerson","landDeveloper.name","partC.name","costProperty","contractPropert","curProject.id","isArchived","orgUnit.name","curProject.displayName","currency.id","currency.precision","auditor","auditTime","creator.name","createTime","isRespite"};
    }
