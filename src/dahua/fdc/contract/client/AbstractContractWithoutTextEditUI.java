...
public abstract class AbstractContractWithoutTextEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contCreateTime, new KDLayout.Constraints(530, 580, 469, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contNumber.setBounds(new Rectangle(9, 40, 469, 19));
        this.add(contNumber, new KDLayout.Constraints(9, 40, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(8, 603, 469, 19));
        this.add(contAuditor, new KDLayout.Constraints(8, 603, 469, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcurProject.setBounds(new Rectangle(531, 15, 469, 19));
        this.add(contcurProject, new KDLayout.Constraints(531, 15, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbillName.setBounds(new Rectangle(531, 40, 469, 19));
        this.add(contbillName, new KDLayout.Constraints(531, 40, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contamount.setBounds(new Rectangle(531, 200, 469, 19));
        this.add(contamount, new KDLayout.Constraints(531, 200, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contpayDate.setBounds(new Rectangle(531, 125, 469, 19));
        this.add(contpayDate, new KDLayout.Constraints(531, 125, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contreceiveUnit.setBounds(new Rectangle(9, 175, 469, 19));
        this.add(contreceiveUnit, new KDLayout.Constraints(9, 175, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbank.setBounds(new Rectangle(9, 300, 469, 19));
        this.add(contbank, new KDLayout.Constraints(9, 300, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbankAcct.setBounds(new Rectangle(9, 325, 469, 19));
        this.add(contbankAcct, new KDLayout.Constraints(9, 325, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsettlementType.setBounds(new Rectangle(9, 275, 469, 19));
        this.add(contsettlementType, new KDLayout.Constraints(9, 275, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contauditTime.setBounds(new Rectangle(530, 605, 469, 19));
        this.add(contauditTime, new KDLayout.Constraints(530, 605, 469, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer5.setBounds(new Rectangle(9, 100, 469, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(9, 100, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer6.setBounds(new Rectangle(531, 100, 469, 19));
        this.add(kDLabelContainer6, new KDLayout.Constraints(531, 100, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer7.setBounds(new Rectangle(9, 200, 469, 19));
        this.add(kDLabelContainer7, new KDLayout.Constraints(9, 200, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(531, 150, 469, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(531, 150, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer1.setBounds(new Rectangle(9, 350, 469, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(9, 350, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer9.setBounds(new Rectangle(9, 150, 469, 19));
        this.add(kDLabelContainer9, new KDLayout.Constraints(9, 150, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer3.setBounds(new Rectangle(531, 175, 469, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(531, 175, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer10.setBounds(new Rectangle(531, 300, 469, 19));
        this.add(kDLabelContainer10, new KDLayout.Constraints(531, 300, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer11.setBounds(new Rectangle(531, 275, 469, 19));
        this.add(kDLabelContainer11, new KDLayout.Constraints(531, 275, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        chkCostsplit.setBounds(new Rectangle(357, 455, 121, 19));
        this.add(chkCostsplit, new KDLayout.Constraints(357, 455, 121, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer12.setBounds(new Rectangle(531, 350, 469, 19));
        this.add(kDLabelContainer12, new KDLayout.Constraints(531, 350, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        chkUrgency.setBounds(new Rectangle(9, 455, 58, 19));
        ...
        this.add(chkNeedPaid, new KDLayout.Constraints(902, 374, 100, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer8.setBounds(new Rectangle(531, 325, 469, 19));
        this.add(kDLabelContainer8, new KDLayout.Constraints(531, 325, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer14.setBounds(new Rectangle(9, 399, 469, 50));
        ...
        this.add(contInvoiceDate, new KDLayout.Constraints(9, 250, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceAmt.setBounds(new Rectangle(531, 225, 469, 19));
        this.add(contInvoiceAmt, new KDLayout.Constraints(531, 225, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAllInvoiceAmt.setBounds(new Rectangle(531, 250, 469, 19));
        this.add(contAllInvoiceAmt, new KDLayout.Constraints(531, 250, 469, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        lblAttachmentContainer.setBounds(new Rectangle(8, 482, 378, 19));
        this.add(lblAttachmentContainer, new KDLayout.Constraints(8, 482, 378, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnViewAttachment.setBounds(new Rectangle(410, 481, 86, 21));
        this.add(btnViewAttachment, new KDLayout.Constraints(410, 481, 86, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPlanProject.setBounds(new Rectangle(11, 375, 270, 19));
        this.add(contPlanProject, new KDLayout.Constraints(11, 375, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnViewBudget.setBounds(new Rectangle(384, 374, 93, 21));
