...
public class MaterialEnterPlanBillControllerBean extends AbstractMaterialEnterPlanBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.material.app.MaterialEnterPlanBillControllerBean");
