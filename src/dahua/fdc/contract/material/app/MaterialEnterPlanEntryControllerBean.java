...
public class MaterialEnterPlanEntryControllerBean extends AbstractMaterialEnterPlanEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.material.app.MaterialEnterPlanEntryControllerBean");
}