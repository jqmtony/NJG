...
public class PartAMaterialEntryControllerBean extends AbstractPartAMaterialEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.material.app.PartAMaterialEntryControllerBean");
}