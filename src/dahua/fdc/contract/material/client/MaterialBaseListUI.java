 ...
 * output class name
 */
public class MaterialBaseListUI extends AbstractMaterialBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialBaseListUI.class);
     ...
     */
    public MaterialBaseListUI() throws Exception
    {
        super();
    }
