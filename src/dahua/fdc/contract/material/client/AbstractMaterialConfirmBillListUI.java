 ...
 * output class name
 */
public abstract class AbstractMaterialConfirmBillListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMaterialConfirmBillListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDContainer kDContainer1;
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblMaterilaConfirm;
    /**
     * output class constructor
     */
    public AbstractMaterialConfirmBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMaterialConfirmBillListUI.class.getName());
        ...
        this.tblMaterilaConfirm = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        this.kDContainer1.setName("kDContainer1");
        this.tblMaterilaConfirm.setName("tblMaterilaConfirm");
        // CoreUI
        ...
        // kDContainer1
        // tblMaterilaConfirm		
        this.tblMaterilaConfirm.setFormatXml(resHelper.getString("tblMaterilaConfirm.formatXml"));
...
contContrList.getContentPane().setLayout(new BorderLayout(0, 0));        contContrList.getContentPane().add(tblMain, BorderLayout.CENTER);
        //kDContainer1
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMaterilaConfirm, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.material.app.MaterialConfirmBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.material.client", "MaterialConfirmBillListUI");
    }
    /**
