...
public class DBDynCostSnapShotControllerBean extends AbstractDBDynCostSnapShotControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.costdb.app.DBDynCostSnapShotControllerBean");
}