 ...
 * output class name
 */
public abstract class AbstractFdcMaterialQueryUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFdcMaterialQueryUI.class);
    /**
     * output class constructor
     */
    public AbstractFdcMaterialQueryUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFdcMaterialQueryUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costdb.app.FdcMaterialQueryUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costdb.client", "FdcMaterialQueryUI");
    }
