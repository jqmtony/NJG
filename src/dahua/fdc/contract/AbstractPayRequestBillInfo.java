...
public class AbstractPayRequestBillInfo extends com.kingdee.eas.fdc.basedata.FDCBillInfo implements Serializable 
{
    ...
    /**
     * Object: 付款申请单 's 材料收货单分录 property 
     */
    ...
    /**
     * Object:付款申请单's 计划付款状态property 
     */
    public com.kingdee.eas.fdc.contract.DepPlanStateEnum getDepPlanState()
    {
        return com.kingdee.eas.fdc.contract.DepPlanStateEnum.getEnum(getString("depPlanState"));
    }
    public void setDepPlanState(com.kingdee.eas.fdc.contract.DepPlanStateEnum item)
    {
		if (item != null) {
        setString("depPlanState", item.getValue());
		}
    }
    /**
     * Object:付款申请单's 拓展字段01property 
     */
    public String getExtField01()
    {
        return getString("extField01");
    }
    public void setExtField01(String item)
    {
        setString("extField01", item);
    }
    /**
     * Object:付款申请单's 拓展字段02property 
     */
    public String getExtField02()
    {
        return getString("extField02");
    }
    public void setExtField02(String item)
    {
        setString("extField02", item);
    }
    /**
     * Object:付款申请单's 拓展字段03property 
     */
    public String getExtField03()
    {
        return getString("extField03");
    }
    public void setExtField03(String item)
    {
        setString("extField03", item);
    }
    /**
     * Object:付款申请单's 拓展字段04property 
     */
    public String getExtField04()
    {
        return getString("extField04");
    }
    public void setExtField04(String item)
    {
        setString("extField04", item);
    }
    /**
     * Object:付款申请单's 拓展字段05property 
     */
    public String getExtField05()
    {
        return getString("extField05");
    }
    public void setExtField05(String item)
    {
        setString("extField05", item);
    }
    /**
     * Object:付款申请单's 拓展布尔字段01property 
     */
    public boolean isExtBooleanField01()
    {
        return getBoolean("extBooleanField01");
    }
    public void setExtBooleanField01(boolean item)
    {
        setBoolean("extBooleanField01", item);
    }
    /**
     * Object:付款申请单's 拓展布尔字段02property 
     */
    public boolean isExtBooleanField02()
    {
        return getBoolean("extBooleanField02");
    }
    public void setExtBooleanField02(boolean item)
    {
        setBoolean("extBooleanField02", item);
    }
    /**
     * Object:付款申请单's 拓展枚举字段01property 
     */
    public com.kingdee.eas.fdc.basedata.FdcExtEnum01 getExtEnumField01()
    {
        return com.kingdee.eas.fdc.basedata.FdcExtEnum01.getEnum(getString("extEnumField01"));
    }
    public void setExtEnumField01(com.kingdee.eas.fdc.basedata.FdcExtEnum01 item)
    {
		if (item != null) {
        setString("extEnumField01", item.getValue());
		}
    }
    /**
     * Object:付款申请单's 拓展枚举字段02property 
     */
    public com.kingdee.eas.fdc.basedata.FdcExtEnum02 getExtEnumField02()
    {
        return com.kingdee.eas.fdc.basedata.FdcExtEnum02.getEnum(getString("extEnumField02"));
    }
    public void setExtEnumField02(com.kingdee.eas.fdc.basedata.FdcExtEnum02 item)
    {
		if (item != null) {
     ...
     */
    public String getKxnr()
    {
        return getString("Kxnr");
    }
    public void setKxnr(String item)
    {
        setString("Kxnr", item);
    }
    /**
    ...
    /**
     * Object:付款申请单's 是否超资金计划付款property 
     */
    public boolean isSfczjjhfk()
    {
        return getBoolean("sfczjjhfk");
    }
    public void setSfczjjhfk(boolean item)
    {
        setBoolean("sfczjjhfk", item);
    }
    /**
     * Object:付款申请单's 三材金额property 
     */
    public java.math.BigDecimal getThreeCaiAmount()
    {
        return getBigDecimal("threeCaiAmount");
    }
    public void setThreeCaiAmount(java.math.BigDecimal item)
    {
        setBigDecimal("threeCaiAmount", item);
    }
