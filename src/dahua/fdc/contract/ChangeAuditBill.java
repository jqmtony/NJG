...
public class ChangeAuditBill extends FDCBill implements IChangeAuditBill
{
     ...
     *@param pk 当参数“合同签约金额超过与之关联的合约规划金额时是否严格控制”的参数值为“严格控制”时，变更签证申请提交时校验：当前变更审批上关联的多个合同中的“测算金额”+“签约金额”+“累计变更”是否大于“框架合约”的“规划余额”，如果大于：提示：“合同XX”的“测算金额”+“签约金额”+“累计变更”大于“框架合约”的“规划余额”，不允许提交。
