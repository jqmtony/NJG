...
public class ContractChangeBill extends FDCBill implements IContractChangeBill
{
    ...
    /**
     *为了在点击了变更签证确认结算UI上的"提交"按钮之后可以走工作流需要的方法-User defined method
     *@param model model
     */
    ...
    /**
     *变更签证确认结算之后设置为审批中状态-User defined method
     *@param pk pk
     */
    ...
    /**
     *变更签证确认结算之后设置为已审批状态-User defined method
     *@param pk pk
     */
    ...
    /**
     *之前中渝提单要把变更签证确认的结算做一个完整的审批工作流,但是现在为了解决该提单"合同执行部分无法区分设计变更与工程签证业务"问题又要将变更结算作为流程中的一个节点来做,于是又增加了这个方法-User defined method
     *@param billId 内码
     */
