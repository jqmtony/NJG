...
public class AbstractTemplatePlanIndexInfo extends com.kingdee.eas.framework.CoreBaseInfo implements Serializable 
{
    public AbstractTemplatePlanIndexInfo()
    {
        this("id");
    }
    protected AbstractTemplatePlanIndexInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.fdc.aimcost.TemplatePlanIndexEntryCollection());
        put("customEntrys", new com.kingdee.eas.fdc.aimcost.TemplateCustomPlanIndexEntryCollection());
    }
    /**
     ...
     */
    public com.kingdee.eas.fdc.aimcost.TemplatePlanIndexEntryCollection getEntrys()
    {
        return (com.kingdee.eas.fdc.aimcost.TemplatePlanIndexEntryCollection)get("entrys");
    }
    /**
     ...
     */
    public com.kingdee.eas.fdc.aimcost.TemplateCustomPlanIndexEntryCollection getCustomEntrys()
    {
        return (com.kingdee.eas.fdc.aimcost.TemplateCustomPlanIndexEntryCollection)get("customEntrys");
    }
    /**
