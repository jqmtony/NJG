...
public class DynamicCostMonitor extends FDCBill implements IDynamicCostMonitor
{
    public DynamicCostMonitor()
    {
        super();
        registerInterface(IDynamicCostMonitor.class, this);
    }
    public DynamicCostMonitor(Context ctx)
    {
        super(ctx);
        registerInterface(IDynamicCostMonitor.class, this);
    }
    ...
    private DynamicCostMonitorController getController() throws BOSException
    {
        return (DynamicCostMonitorController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDynamicCostMonitorInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynamicCostMonitorInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynamicCostMonitorInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynamicCostMonitorCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynamicCostMonitorCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDynamicCostMonitorCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *通过工程项目ID获取最新的合同框架-User defined method
     *@param prjID 工程项目ID
     *@return
     */
    ...
    {
        try {
            return getController().getLatestProgrammingByPrjId(getContext(), prjID);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
