...
public class AimCostCtrlBill extends FDCBill implements IAimCostCtrlBill
{
    public AimCostCtrlBill()
    {
        super();
        registerInterface(IAimCostCtrlBill.class, this);
    }
    public AimCostCtrlBill(Context ctx)
    {
        super(ctx);
        registerInterface(IAimCostCtrlBill.class, this);
    }
    ...
    private AimCostCtrlBillController getController() throws BOSException
    {
        return (AimCostCtrlBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAimCostCtrlBillInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getAimCostCtrlBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAimCostCtrlBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *getMaxVerNumber-User defined method
    ...
    {
        try {
            return getController().getMaxVerNumber(getContext(), projectId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAimCostCtrlBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAimCostCtrlBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAimCostCtrlBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
