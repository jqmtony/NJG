 ...
 * output class name
 */
public abstract class AbstractAimMeasureCostListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	abstract protected void _handleActionExportToAim(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionExportIndex(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionVersion(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}