...
public class DynCostCtrlBillEntryControllerBean extends AbstractDynCostCtrlBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.DynCostCtrlBillEntryControllerBean");
}