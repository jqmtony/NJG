...
public class AimAimCostAdjustEntryControllerBean extends AbstractAimAimCostAdjustEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.AimAimCostAdjustEntryControllerBean");
}