...
public abstract class AbstractAimCostVersionCompareUI extends com.kingdee.eas.fdc.basedata.client.FDCRptBaseUI
{
    ...
    protected com.kingdee.bos.ctrl.kdf.table.KDTable productTable;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.productTable = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        ...
        this.productTable.setName("productTable");
        // CoreUI
        ...
        this.prmtCompareVer.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    prmtCompareVer_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        // productTable
		String productTableStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"acctNumber\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"acctName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{acctNumber}</t:Cell><t:Cell>$Resource{acctName}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.productTable.setFormatXml(resHelper.translateString("productTable",productTableStrXML));
    ...
    public void initUIContentLayout()
    {
        ...
        //kDPanel2
kDPanel2.setLayout(new BorderLayout(0, 0));        kDPanel2.add(kDPanel1, BorderLayout.NORTH);
        kDPanel2.add(kDTabbedPane1, BorderLayout.CENTER);
        //kDPanel1
        ...
        chkAimCost.setBounds(new Rectangle(114, 45, 84, 19));
        kDPanel1.add(chkAimCost, new KDLayout.Constraints(114, 45, 84, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        chkBuildArea.setBounds(new Rectangle(221, 45, 83, 19));
        kDPanel1.add(chkBuildArea, new KDLayout.Constraints(221, 45, 83, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        chkSellArea.setBounds(new Rectangle(328, 45, 85, 19));
        kDPanel1.add(chkSellArea, new KDLayout.Constraints(328, 45, 85, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        ...
        kDLabel1.setBounds(new Rectangle(7, 45, 100, 19));
        kDPanel1.add(kDLabel1, new KDLayout.Constraints(7, 45, 100, 19, 0));
        //conBaseVer
        ...
        kDTabbedPane1.add(productTable, resHelper.getString("productTable.constraints"));
    ...
    /**
     * output prmtCompareVer_dataChanged method
     */
    protected void prmtCompareVer_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    }
