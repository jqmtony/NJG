...
public abstract class AbstractDynCostSnapShotQueryUI extends com.kingdee.eas.framework.client.ListUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabel1.setBounds(new Rectangle(10, 8, 86, 19));
        this.add(kDLabel1, new KDLayout.Constraints(10, 8, 86, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        kDLabel2.setBounds(new Rectangle(508, 8, 61, 19));
        this.add(kDLabel2, new KDLayout.Constraints(508, 8, 61, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtProjectName.setBounds(new Rectangle(95, 8, 333, 19));
        this.add(txtProjectName, new KDLayout.Constraints(95, 8, 333, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtSaleArea.setBounds(new Rectangle(568, 8, 170, 19));
        this.add(txtSaleArea, new KDLayout.Constraints(568, 8, 170, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnAll.setBounds(new Rectangle(818, 8, 109, 21));
        this.add(btnAll, new KDLayout.Constraints(818, 8, 109, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_RIGHT));
    ...
    protected class ActionAll extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDynCostSnapShotQueryUI.this, "ActionAll", "actionAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDynCostSnapShotQueryUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
