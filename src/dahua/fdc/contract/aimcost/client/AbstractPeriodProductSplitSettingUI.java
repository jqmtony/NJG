 ...
 * output class name
 */
public abstract class AbstractPeriodProductSplitSettingUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPeriodProductSplitSettingUI.class);
     ...
     */
    public AbstractPeriodProductSplitSettingUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPeriodProductSplitSettingUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.PeriodProductSplitSettingUIHandler";
	}
    ...
    protected class ActionSelectAll extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPeriodProductSplitSettingUI.this, "ActionSelectAll", "actionSelectAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelectNone extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPeriodProductSplitSettingUI.this, "ActionSelectNone", "actionSelectNone_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPeriodProductSplitSettingUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "PeriodProductSplitSettingUI");
    }
