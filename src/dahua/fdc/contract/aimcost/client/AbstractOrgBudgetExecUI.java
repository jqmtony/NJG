 ...
 * output class name
 */
public abstract class AbstractOrgBudgetExecUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOrgBudgetExecUI.class);
     ...
     */
    public AbstractOrgBudgetExecUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOrgBudgetExecUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.OrgBudgetExecUIHandler";
	}
    ...
    protected class ActionSubmit extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOrgBudgetExecUI.this, "ActionSubmit", "actionSubmit_actionPerformed", e);
        }
    }
    ...
    protected class ActionApportion extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOrgBudgetExecUI.this, "ActionApportion", "actionApportion_actionPerformed", e);
        }
    }
    ...
    protected class ActionRevert extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOrgBudgetExecUI.this, "ActionRevert", "actionRevert_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "OrgBudgetExecUI");
    }
    /**
