 ...
 * output class name
 */
public abstract class AbstractAdjustCostDetailUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustCostDetailUI.class);
     ...
     */
    public AbstractAdjustCostDetailUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustCostDetailUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.AdjustCostDetailUIHandler";
	}
    ...
    protected class ActionChart extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAdjustCostDetailUI.this, "ActionChart", "actionChart_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "AdjustCostDetailUI");
    }
    /**
