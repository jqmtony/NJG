 ...
 * output class name
 */
public abstract class AbstractProductAimCostUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProductAimCostUI.class);
     ...
     */
    public AbstractProductAimCostUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProductAimCostUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 805, 579));        tblMain.setBounds(new Rectangle(5, 32, 796, 541));
        kDPanel1.add(tblMain, new KDLayout.Constraints(5, 32, 796, 541, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnAll.setBounds(new Rectangle(5, 6, 110, 21));
        kDPanel1.add(btnAll, new KDLayout.Constraints(5, 6, 110, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.aimcost.app.ProductAimCostUIHandler";
	}
    ...
    protected class ActionSubmit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProductAimCostUI.this, "ActionSubmit", "actionSubmit_actionPerformed", e);
        }
    }
    ...
    protected class ActionApportion extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProductAimCostUI.this, "ActionApportion", "actionApportion_actionPerformed", e);
        }
    }
    ...
    protected class ActionRevert extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProductAimCostUI.this, "ActionRevert", "actionRevert_actionPerformed", e);
        }
    }
    ...
    protected class ActionAll extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProductAimCostUI.this, "ActionAll", "actionAll_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.aimcost.client", "ProductAimCostUI");
    }
    /**
