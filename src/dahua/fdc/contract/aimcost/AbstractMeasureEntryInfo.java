...
public class AbstractMeasureEntryInfo extends com.kingdee.eas.framework.DataBaseInfo implements Serializable 
{
    public AbstractMeasureEntryInfo()
    {
        this("id");
    }
    protected AbstractMeasureEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
