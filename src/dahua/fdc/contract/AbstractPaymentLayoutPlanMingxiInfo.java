...
public class AbstractPaymentLayoutPlanMingxiInfo extends com.kingdee.eas.framework.BillEntryBaseInfo implements Serializable 
{
    public AbstractPaymentLayoutPlanMingxiInfo()
    {
        this("id");
    }
    protected AbstractPaymentLayoutPlanMingxiInfo(String pkField)
    {
        super(pkField);
    }
    /**
