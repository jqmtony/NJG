...
public class ContractSettlementBillCollectionAgent extends ContractSettlementBillCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public ContractSettlementBillCollectionAgent() {
        super();
