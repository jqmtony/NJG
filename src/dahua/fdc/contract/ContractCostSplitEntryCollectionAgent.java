...
public class ContractCostSplitEntryCollectionAgent extends ContractCostSplitEntryCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public ContractCostSplitEntryCollectionAgent() {
        super();
