...
public class SettlementCostSplitAgent extends SettlementCostSplitInfo implements IObjectValueAgent{
    public static final BOSObjectType bosType = new BOSObjectType("BE73CE09");
    private final AgentManager manager;

    private SettlementCostSplitAgent ()
    {
        manager = new AgentManager();
    }
    
    public static SettlementCostSplitAgent copyOvToAgent(IObjectValue vo){
        SettlementCostSplitAgent agent = new SettlementCostSplitAgent();
        return (SettlementCostSplitAgent)agent.manager.copyOvToAgent(agent,vo);
    }

    public static SettlementCostSplitAgent copyOvAsNewAgent(IObjectValue vo){
        SettlementCostSplitAgent agent = new SettlementCostSplitAgent();
        return (SettlementCostSplitAgent)agent.manager.copyOvToAgentAsNew(agent,vo);
    }

    public static SettlementCostSplitAgent find(IObjectPK id) throws BOSException
    {
		SettlementCostSplitAgent agent = new SettlementCostSplitAgent();
        return (SettlementCostSplitAgent)agent.manager.find(agent, id);
    }
    
    public static SettlementCostSplitAgent create() throws BOSException
    {
        return (SettlementCostSplitAgent)AgentManager.create(new SettlementCostSplitAgent());
    }
