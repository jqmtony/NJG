 ...
 * output class name
 */
public class ContractSettlePCSplitBillListUI extends AbstractContractSettlePCSplitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractSettlePCSplitBillListUI.class);
    protected static final BOSUuid splitBillNullID = BOSUuid.create("null");
    private String[] contractType=null;
    public ContractSettlePCSplitBillListUI() throws Exception
    {
        super();
	...
	public void onLoad() throws Exception {
		...
		super.onLoad();
		FDCHelper.formatTableNumber(getMainTable(), "curSettlePrice");
		FDCHelper.formatTableNumber(getMainTable(), "constructPrice");
	...
	protected void prepareUIContext(UIContext uiContext, ActionEvent e) {
		...
		if (act.equals(actionAddNew)) {
			uiContext.put("contractSettleBillId", getSelectedCostBillID());
