 ...
 * output class name
 */
public abstract class AbstractContractSettlePCSplitBillListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractSettlePCSplitBillListUI.class);
     ...
     */
    public AbstractContractSettlePCSplitBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractSettlePCSplitBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.contractsplit.app", "ContractSettlePCSplitBillQuery");
        //actionSplit
...
mainPanel.setLayout(new BorderLayout(0, 0));        mainPanel.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.contractsplit.app.ContractSettlePCSplitBillListUIHandler";
	}
    ...
    protected class ActionSplit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractSettlePCSplitBillListUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.contractsplit.client", "ContractSettlePCSplitBillListUI");
    }
