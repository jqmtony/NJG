...
public class ContractPCSplitBill extends FDCBill implements IContractPCSplitBill
{
    public ContractPCSplitBill()
    {
        super();
        registerInterface(IContractPCSplitBill.class, this);
    }
    public ContractPCSplitBill(Context ctx)
    {
        super(ctx);
        registerInterface(IContractPCSplitBill.class, this);
    }
    ...
    private ContractPCSplitBillController getController() throws BOSException
    {
        return (ContractPCSplitBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractPCSplitBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPCSplitBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPCSplitBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPCSplitBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPCSplitBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPCSplitBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
