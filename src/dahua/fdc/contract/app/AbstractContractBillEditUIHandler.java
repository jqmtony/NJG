 ...
 * output class name
 */
public abstract class AbstractContractBillEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCBillEditUIHandler

{
	...
	public void handleActionAddTblBailLine(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionAddTblBailLine(request,response,context);
	}
	protected void _handleActionAddTblBailLine(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionRemoveTblBailLine(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionRemoveTblBailLine(request,response,context);
	}
	protected void _handleActionRemoveTblBailLine(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionViewInvite(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewInvite(request,response,context);
	}
	protected void _handleActionViewInvite(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	public void handleactionRemoveSplit(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleactionRemoveSplit(request,response,context);
	}
