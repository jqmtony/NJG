...
public interface ContractPayPlanController extends FDCBillController
{
    ...
    public IObjectPK addnew(Context ctx, ContractPayPlanInfo model) throws BOSException, EASBizException, RemoteException;
    public void addnew(Context ctx, IObjectPK pk, ContractPayPlanInfo model) throws BOSException, EASBizException, RemoteException;
    public void update(Context ctx, IObjectPK pk, ContractPayPlanInfo model) throws BOSException, EASBizException, RemoteException;
    public void updatePartial(Context ctx, ContractPayPlanInfo model, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public void updateBigObject(Context ctx, IObjectPK pk, ContractPayPlanInfo model) throws BOSException, RemoteException;
