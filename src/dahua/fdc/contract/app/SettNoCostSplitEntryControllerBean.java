...
public class SettNoCostSplitEntryControllerBean extends AbstractSettNoCostSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.SettNoCostSplitEntryControllerBean");
}