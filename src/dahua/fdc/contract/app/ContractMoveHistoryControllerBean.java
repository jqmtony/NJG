...
public class ContractMoveHistoryControllerBean extends AbstractContractMoveHistoryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.ContractMoveHistoryControllerBean");
}