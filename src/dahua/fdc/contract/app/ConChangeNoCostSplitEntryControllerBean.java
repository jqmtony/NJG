...
public class ConChangeNoCostSplitEntryControllerBean extends AbstractConChangeNoCostSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.ConChangeNoCostSplitEntryControllerBean");
}