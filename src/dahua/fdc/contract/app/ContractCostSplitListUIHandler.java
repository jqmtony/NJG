 ...
 * output class name
 */
public class ContractCostSplitListUIHandler extends AbstractContractCostSplitListUIHandler
{
	...
	protected void _handleActionMeasureSplit(RequestContext request,
