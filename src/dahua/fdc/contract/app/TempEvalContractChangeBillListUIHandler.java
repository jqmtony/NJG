 ...
 * output class name
 */
public class TempEvalContractChangeBillListUIHandler extends AbstractTempEvalContractChangeBillListUIHandler
{
	...
	protected void _handleActionViewChangeAudtiAttachment(
			RequestContext request, ResponseContext response, Context context)
			throws Exception {
	}
}