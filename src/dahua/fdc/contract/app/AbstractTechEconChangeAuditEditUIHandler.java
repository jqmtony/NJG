 ...
 * output class name
 */
public abstract class AbstractTechEconChangeAuditEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCBillEditUIHandler

{
	...
	public void handleactionAddSplit(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleactionAddSplit(request,response,context);
	}
