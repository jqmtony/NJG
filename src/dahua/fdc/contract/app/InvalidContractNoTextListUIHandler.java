 ...
 * output class name
 */
public class InvalidContractNoTextListUIHandler extends AbstractInvalidContractNoTextListUIHandler
{
	...
	protected void _handleActionViewAdjust(RequestContext request,
