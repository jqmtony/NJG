...
public class CostAccountWithAccount extends CoreBase implements ICostAccountWithAccount
{
    public CostAccountWithAccount()
    {
        super();
        registerInterface(ICostAccountWithAccount.class, this);
    }
    public CostAccountWithAccount(Context ctx)
    {
        super(ctx);
        registerInterface(ICostAccountWithAccount.class, this);
    }
    ...
    private CostAccountWithAccountController getController() throws BOSException
    {
        return (CostAccountWithAccountController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCostAccountWithAccountInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountWithAccountInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountWithAccountInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountWithAccountCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountWithAccountCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostAccountWithAccountCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *成本科目与会计科目关系定义保存-User defined method
     *@param objCol objCol
     */
    ...
    /**
     *引入集团数据-User defined method
     */
    public void importGroupData() throws BOSException, EASBizException
    {
        try {
            getController().importGroupData(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().importGroupData(getContext(), nodeIdSet);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().submitAll(getContext(), objCol, nodeID);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
