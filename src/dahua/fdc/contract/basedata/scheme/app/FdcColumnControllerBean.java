...
public class FdcColumnControllerBean extends AbstractFdcColumnControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.scheme.app.FdcColumnControllerBean");
}