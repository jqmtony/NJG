...
public class FdcPropertyControllerBean extends AbstractFdcPropertyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.scheme.app.FdcPropertyControllerBean");
}