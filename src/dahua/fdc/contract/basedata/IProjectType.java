...
public interface IProjectType extends IFDCDataBase
{
    ...
    public IObjectPK addnew(ProjectTypeInfo model) throws BOSException, EASBizException;
    public void addnew(IObjectPK pk, ProjectTypeInfo model) throws BOSException, EASBizException;
    public void update(IObjectPK pk, ProjectTypeInfo model) throws BOSException, EASBizException;
    public void updatePartial(ProjectTypeInfo model, SelectorItemCollection selector) throws BOSException, EASBizException;
    public void updateBigObject(IObjectPK pk, ProjectTypeInfo model) throws BOSException;
