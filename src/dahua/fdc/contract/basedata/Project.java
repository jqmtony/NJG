...
public class Project extends TreeBase implements IProject
{
     ...
     *@return
     */
    public ProjectInfo getProjectInfo(String oql) throws BOSException, EASBizException
    {
        try {
            return getController().getProjectInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public IObjectPK addnew(ProjectInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 新增
     */
    public void addnew(IObjectPK pk, ProjectInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 更新
     */
    public void update(IObjectPK pk, ProjectInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector 局部更新
     */
    public void updatePartial(ProjectInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model 更新大对象
     */
    public void updateBigObject(IObjectPK pk, ProjectInfo model) throws BOSException
    {
        try {
     ...
     *@return
     */
    public ProjectCollection getProjectCollection(String oql) throws BOSException
    {
        try {
            return getController().getProjectCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
