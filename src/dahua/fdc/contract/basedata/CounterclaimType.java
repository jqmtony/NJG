...
public class CounterclaimType extends FDCDataBase implements ICounterclaimType
{
    public CounterclaimType()
    {
        super();
        registerInterface(ICounterclaimType.class, this);
    }
    public CounterclaimType(Context ctx)
    {
        super(ctx);
        registerInterface(ICounterclaimType.class, this);
    }
    ...
    private CounterclaimTypeController getController() throws BOSException
    {
        return (CounterclaimTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCounterclaimTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCounterclaimTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCounterclaimTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCounterclaimTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCounterclaimTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCounterclaimTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
