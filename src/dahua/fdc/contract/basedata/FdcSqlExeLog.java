...
public class FdcSqlExeLog extends ObjectBase implements IFdcSqlExeLog
{
    public FdcSqlExeLog()
    {
        super();
        registerInterface(IFdcSqlExeLog.class, this);
    }
    public FdcSqlExeLog(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcSqlExeLog.class, this);
    }
    ...
    private FdcSqlExeLogController getController() throws BOSException
    {
        return (FdcSqlExeLogController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcSqlExeLogInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcSqlExeLogInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcSqlExeLogInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcSqlExeLogCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcSqlExeLogCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcSqlExeLogCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
