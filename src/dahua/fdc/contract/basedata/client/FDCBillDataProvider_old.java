...
public abstract class FDCBillDataProvider_old implements BOSQueryDelegate {
	private static Logger logger = Logger.getLogger(FDCBillDataProvider_old.class);
	public String billId = "";
	public List auditAllList = null;
	public IMetaDataPK mainQuery=null;
	public FDCBillDataProvider_old(String billId,IMetaDataPK mainQuery) {
		this.billId = billId;
