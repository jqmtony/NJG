 ...
 * output class name
 */
public abstract class AbstractTestUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        // CoreUI
        this.setPreferredSize(new Dimension(10,300));
        // btnImport
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnImport.setBounds(new Rectangle(99, 123, 130, 36));
        this.add(btnImport, null);
        btnOK.setBounds(new Rectangle(240, 123, 130, 36));
        this.add(btnOK, null);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "TestUI");
    }
