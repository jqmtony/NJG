 ...
 * output class name
 */
public abstract class AbstractBackdropColorListUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBackdropColorListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDButton btnYes;
    protected com.kingdee.bos.ctrl.swing.KDButton btnNo;
    protected com.kingdee.bos.ctrl.swing.KDContainer kDContainer1;
    protected EntityViewInfo queryBackdropColorQuery = null;
    protected IMetaDataPK queryBackdropColorQueryPK;
    /**
     * output class constructor
     */
    public AbstractBackdropColorListUI() throws Exception
    {
        super();
        this.defaultObjectName = "queryBackdropColorQuery";
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBackdropColorListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        queryBackdropColorQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "BackdropColorQuery");
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnYes.setBounds(new Rectangle(307, 369, 73, 21));
        this.add(btnYes, null);
        btnNo.setBounds(new Rectangle(402, 368, 73, 21));
        this.add(btnNo, null);
        kDContainer1.setBounds(new Rectangle(16, 11, 464, 341));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.BackdropColorListUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.queryBackdropColorQuery = (EntityViewInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "BackdropColorListUI");
    }
