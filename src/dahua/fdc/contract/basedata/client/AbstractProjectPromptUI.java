 ...
 * output class name
 */
public abstract class AbstractProjectPromptUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectPromptUI.class);
     ...
     */
    public AbstractProjectPromptUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectPromptUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 268, 359));
        this.setLayout(null);
        kDTreeView1.setBounds(new Rectangle(10, 10, 248, 315));
        this.add(kDTreeView1, null);
        btnSave.setBounds(new Rectangle(95, 333, 73, 21));
        this.add(btnSave, null);
        btnCancel.setBounds(new Rectangle(178, 333, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ProjectPromptUIHandler";
	}
    ...
    protected class ActionSave extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectPromptUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectPromptUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ProjectPromptUI");
    }
