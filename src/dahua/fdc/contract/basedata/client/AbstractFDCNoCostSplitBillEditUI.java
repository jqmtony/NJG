 ...
 * output class name
 */
public abstract class AbstractFDCNoCostSplitBillEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCNoCostSplitBillEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.FDCNoCostSplitBillInfo editData = null;
     ...
     */
    public AbstractFDCNoCostSplitBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCNoCostSplitBillEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.FDCNoCostSplitBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.FDCNoCostSplitBillInfo)ov;
    }
    ...
    protected class ActionAcctSelect extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFDCNoCostSplitBillEditUI.this, "ActionAcctSelect", "actionAcctSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplitProj extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCNoCostSplitBillEditUI.this, "ActionSplitProj", "actionSplitProj_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplitBotUp extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCNoCostSplitBillEditUI.this, "ActionSplitBotUp", "actionSplitBotUp_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplitProd extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCNoCostSplitBillEditUI.this, "ActionSplitProd", "actionSplitProd_actionPerformed", e);
        }
    }
    ...
    protected class ActionImpContrSplit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCNoCostSplitBillEditUI.this, "ActionImpContrSplit", "actionImpContrSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "FDCNoCostSplitBillEditUI");
    }
