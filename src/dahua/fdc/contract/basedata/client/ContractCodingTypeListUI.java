 ...
 * @version EAS5.3
 */
public class ContractCodingTypeListUI extends AbstractContractCodingTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractCodingTypeListUI.class);
    
    /**
     * output class constructor
     */
    public ContractCodingTypeListUI() throws Exception
    {
        super();
    }
		...
		this.tblMain.getDataRequestManager().addDataFillListener(new KDTDataFillListener() {
			public void afterDataFill(KDTDataRequestEvent e) {
				...
				for (int i = e.getFirstRow(); i <= e.getLastRow(); i++) {
					strTemp = tblMain.getRow(i).getCell("secondType").getValue().toString();
					Locale locale = SysContext.getSysContext().getLocale();
					if(strTemp.equalsIgnoreCase(com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.OLD_VALUE)){
						strTemp = com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.OLD.getAlias(locale);
					}else if(strTemp.equalsIgnoreCase(com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.DIRECT_VALUE)){
						strTemp = com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.DIRECT.getAlias(locale);
					}else if(strTemp.equalsIgnoreCase(com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.THREE_PARTY_VALUE)){
						strTemp = com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.THREE_PARTY.getAlias(locale);
					}else if(strTemp.equalsIgnoreCase(com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.SUPPLY_VALUE)){
						strTemp = com.kingdee.eas.fdc.basedata.ContractSecondTypeEnum.SUPPLY.getAlias(locale);
					}
					tblMain.getRow(i).getCell("secondType").setValue(strTemp);
				}
			}
		});
		super.onLoad();
...
//		tHelper = new TablePreferencesHelper(this);
	...
	protected String getEditUIName() {
		return ContractCodingTypeEditUI.class.getName();
	}
