...
import com.kingdee.eas.fdc.basedata.IInviteType;
...
public class InviteTypeEditUI extends AbstractInviteTypeEditUI {
	private static final Logger logger = CoreUIObject.getLogger(InviteTypeEditUI.class);
...
//		setBtnStatus();		
	...
	private void setTitle() {
		FDCBaseDataClientUtils.setupUITitle(this, EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, FDCBaseDataClientUtils.INVITETYPE));
	}
...
//		FDCBaseTypeValidator.validate(((InviteTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtNumber, bizName);
//	}
...
//			IInviteType iInviteType = InviteTypeFactory.getRemoteInstance();
//			if(iInviteType.disEnabled(new ObjectUuidPK(editData.getId()))){			
...
//		if(this.editData!=null&&this.editData.getId()!=null){
//			IInviteType iInviteType = InviteTypeFactory.getRemoteInstance();
//			if(iInviteType.enabled(new ObjectUuidPK(editData.getId()))){
...
//	}
	protected IObjectValue createNewData() {
		...
		inviteTypeInfo.setIsEnabled(isEnabled);
