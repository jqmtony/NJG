 ...
 * output class name
 */
public abstract class AbstractInvalidCostReasonListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInvalidCostReasonListUI.class);
    /**
     * output class constructor
     */
    public AbstractInvalidCostReasonListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInvalidCostReasonListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "InvalidCostReasonQuery");
        //actionMoveTree
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"longNumber","name","isEnabled","description","id","CU.id","number"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.InvalidCostReasonListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "InvalidCostReasonListUI");
    }
