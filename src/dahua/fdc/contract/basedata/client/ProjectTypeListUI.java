 ...
 * @version EAS4.1
 */
public class ProjectTypeListUI extends AbstractProjectTypeListUI {
	private static final Logger logger = CoreUIObject.getLogger(ProjectTypeListUI.class);

	/**
	 * output class constructor
	 */
	public ProjectTypeListUI() throws Exception {
		super();
	}
...
//	}
	...
	protected String getEditUIName() {
		return ProjectTypeEditUI.class.getName();
	}
...
//		if(iProjectType.enabled(new ObjectUuidPK(id))){
...
//		String id = row.getCell("id").getValue().toString().trim();
//		IProjectType iProjectType = ProjectTypeFactory.getRemoteInstance();
//		if(iProjectType.disEnabled(new ObjectUuidPK(id))){
