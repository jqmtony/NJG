 ...
 * output class name
 */
public abstract class AbstractNoCostSplitApptProjUI extends com.kingdee.eas.fdc.basedata.client.NoCostSplitApptUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNoCostSplitApptProjUI.class);
    protected com.kingdee.eas.framework.CoreBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractNoCostSplitApptProjUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNoCostSplitApptProjUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.NoCostSplitApptProjUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "NoCostSplitApptProjUI");
    }
