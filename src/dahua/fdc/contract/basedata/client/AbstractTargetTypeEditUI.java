 ...
 * output class name
 */
public abstract class AbstractTargetTypeEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTargetTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.TargetTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTargetTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTargetTypeEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(223, 71, 57, 19));
        ...
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(bizName);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.TargetTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.TargetTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "TargetTypeEditUI");
    }
