 ...
 * output class name
 */
public abstract class AbstractAdjustTypeListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractAdjustTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "AdjustTypeQuery");
        //actionPageSetup
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.AdjustTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "AdjustTypeListUI");
    }
