 ...
 * output class name
 */
public abstract class AbstractCompensationTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompensationTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.CompensationTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCompensationTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCompensationTypeEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(10, 72, 270, 100));
        this.add(contDescription, null);
        chkIsEnabled.setBounds(new Rectangle(12, 63, 51, 19));
        ...
        //contDescription
        contDescription.setBoundEditor(bizDescription);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CompensationTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.CompensationTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CompensationTypeEditUI");
    }
