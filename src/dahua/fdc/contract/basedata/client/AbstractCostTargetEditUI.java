 ...
 * output class name
 */
public abstract class AbstractCostTargetEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostTargetEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.CostTargetInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCostTargetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostTargetEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostTargetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.CostTargetInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostTargetEditUI");
    }
