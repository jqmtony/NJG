 ...
 * 描述:组织数据管理叙事簿
 * 
 * @author jackwang date:2007-5-15
 * @version EAS5.3
 */
public class UnitDataManagerListUI extends AbstractUnitDataManagerListUI
{
    private static final Logger logger = CoreUIObject.getLogger(UnitDataManagerListUI.class);
    
    /**
     * output class constructor
     */
    public UnitDataManagerListUI() throws Exception
    {
        super();
    }
	public void onLoad() throws Exception {
		...
		super.onLoad();
		FDCHelper.formatTableNumber(this.tblMain,"licenceManager.registerCapital");
	}
    /**
	...
	protected String getEditUIName() {
		// TODO 自动生成方法存根
		return UnitDataManagerEditUI.class.getName();
	}
