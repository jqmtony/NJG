 ...
 * output class name
 */
public abstract class AbstractCounterclaimTypeEditUI extends com.kingdee.eas.basedata.framework.client.DataBaseSIEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCounterclaimTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.CounterclaimTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCounterclaimTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCounterclaimTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CounterclaimTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.CounterclaimTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CounterclaimTypeEditUI");
    }
