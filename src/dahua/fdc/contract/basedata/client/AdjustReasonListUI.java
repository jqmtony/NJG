 ...
 * @version EAS5.1
 */
public class AdjustReasonListUI extends AbstractAdjustReasonListUI {
	private static final Logger logger = CoreUIObject.getLogger(AdjustReasonListUI.class);

	/**
	 * output class constructor
	 */
	public AdjustReasonListUI() throws Exception {
		super();
	}
...
//	}
	...
	protected String getEditUIName() {
		return AdjustReasonEditUI.class.getName();
	}
...
//		if(iAdjustReason.enabled(new ObjectUuidPK(id))){
...
//		String id = row.getCell("id").getValue().toString().trim();
//		IAdjustReason iAdjustReason = AdjustReasonFactory.getRemoteInstance();
//		if(iAdjustReason.disEnabled(new ObjectUuidPK(id))){
