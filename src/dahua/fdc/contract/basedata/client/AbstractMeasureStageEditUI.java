 ...
 * output class name
 */
public abstract class AbstractMeasureStageEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMeasureStageEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.MeasureStageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMeasureStageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMeasureStageEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 41, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(10, 67, 104, 19));
        this.add(contDescription, null);
        chkIsEnabled.setBounds(new Rectangle(234, 70, 54, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.MeasureStageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.MeasureStageInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "MeasureStageEditUI");
    }
