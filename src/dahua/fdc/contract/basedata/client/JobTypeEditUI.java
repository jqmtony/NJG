...
import com.kingdee.eas.fdc.basedata.IJobType;
 ...
 * @version EAS5.2
 */
public class JobTypeEditUI extends AbstractJobTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(JobTypeEditUI.class);
    
    /**
     * output class constructor
     */
    public JobTypeEditUI() throws Exception
    {
        super();
    }
...
//		setBtnStatus();		
	...
	private void setTitle() {
		FDCBaseDataClientUtils.setupUITitle(this, EASResource.getString(FDCBaseDataClientUtils.FDCBASEDATA_RESOURCE, FDCBaseDataClientUtils.JOBTYPE));
	}
...
//		FDCBaseTypeValidator.validate(((JobTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtNumber, bizName);
//	}
...
//			if(iJobType.disEnabled(new ObjectUuidPK(editData.getId()))){
...
//		if(this.editData!=null&&this.editData.getId()!=null){
//			IJobType iJobType = JobTypeFactory.getRemoteInstance();
//			if(iJobType.enabled(new ObjectUuidPK(editData.getId()))){
...
//	}
	protected IObjectValue createNewData() {
		...
		jobTypeInfo.setIsEnabled(isEnabled);
		return jobTypeInfo;
	}
