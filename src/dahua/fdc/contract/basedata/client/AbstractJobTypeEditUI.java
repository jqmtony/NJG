 ...
 * output class name
 */
public abstract class AbstractJobTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractJobTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.JobTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractJobTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractJobTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.JobTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.JobTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "JobTypeEditUI");
    }
