 ...
 * output class name
 */
public abstract class AbstractNoCostSplitApptUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNoCostSplitApptUI.class);
     ...
     */
    public AbstractNoCostSplitApptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNoCostSplitApptUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.NoCostSplitApptUIHandler";
	}
    ...
    protected class ActionSelectAll extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractNoCostSplitApptUI.this, "ActionSelectAll", "actionSelectAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelectNone extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractNoCostSplitApptUI.this, "ActionSelectNone", "actionSelectNone_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractNoCostSplitApptUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "NoCostSplitApptUI");
    }
