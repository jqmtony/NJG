 ...
 * output class name
 */
public abstract class AbstractCostAccountAssignUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostAccountAssignUI.class);
     ...
     */
    public AbstractCostAccountAssignUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostAccountAssignUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.CostAccountAssignUIHandler";
	}
	...
	public RequestContext prepareActionAssigned(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionAssigned() {
    	return false;
    }
	public RequestContext prepareActionNotAssigned(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionNotAssigned() {
    	return false;
    }
	...
	public RequestContext prepareActionAllDisselect(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionAllDisselect() {
    	return false;
    }
	public RequestContext prepareActionSelectUpper(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionSelectUpper() {
    	return false;
    }
	public RequestContext prepareActionDisSelectUpper(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionDisSelectUpper() {
    	return false;
    }
    ...
    protected class ActionAssign extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionAssign", "actionAssign_actionPerformed", e);
        }
    }
    ...
    protected class ActionAssigned extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionAssigned", "actionAssigned_actionPerformed", e);
        }
    }
    ...
    protected class ActionNotAssigned extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionNotAssigned", "actionNotAssigned_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllSelect extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionAllSelect", "actionAllSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllDisselect extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionAllDisselect", "actionAllDisselect_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelectUpper extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionSelectUpper", "actionSelectUpper_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisSelectUpper extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCostAccountAssignUI.this, "ActionDisSelectUpper", "actionDisSelectUpper_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "CostAccountAssignUI");
    }
