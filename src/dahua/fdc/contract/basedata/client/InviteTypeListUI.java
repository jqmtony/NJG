...
public class InviteTypeListUI extends AbstractInviteTypeListUI {
	private static final Logger logger = CoreUIObject.getLogger(InviteTypeListUI.class);
...
//		if(iInviteType.enabled(new ObjectUuidPK(id))){
...
//		String id = row.getCell("id").getValue().toString().trim();
//		IInviteType iInviteType = InviteTypeFactory.getRemoteInstance();
//		if(iInviteType.disEnabled(new ObjectUuidPK(id))){
