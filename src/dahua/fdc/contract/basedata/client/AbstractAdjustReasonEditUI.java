 ...
 * output class name
 */
public abstract class AbstractAdjustReasonEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustReasonEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.AdjustReasonInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAdjustReasonEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustReasonEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.AdjustReasonEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.AdjustReasonInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "AdjustReasonEditUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.basedata.client.AdjustReasonEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.basedata.AdjustReasonFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.basedata.AdjustReasonInfo objectValue = new com.kingdee.eas.fdc.basedata.AdjustReasonInfo();
