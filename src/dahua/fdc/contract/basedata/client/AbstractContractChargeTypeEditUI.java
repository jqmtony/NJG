 ...
 * output class name
 */
public abstract class AbstractContractChargeTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractChargeTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.ContractChargeTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractContractChargeTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractChargeTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.ContractChargeTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.ContractChargeTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "ContractChargeTypeEditUI");
    }
