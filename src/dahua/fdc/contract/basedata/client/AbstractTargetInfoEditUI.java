 ...
 * output class name
 */
public abstract class AbstractTargetInfoEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTargetInfoEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.TargetInfoInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTargetInfoEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTargetInfoEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contCurProject.setBounds(new Rectangle(411, 10, 270, 19));
        this.add(contCurProject, new KDLayout.Constraints(411, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDTabbedPane1.setBounds(new Rectangle(18, 47, 663, 433));
        this.add(kDTabbedPane1, new KDLayout.Constraints(18, 47, 663, 433, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contYear
...
sale.setLayout(new BorderLayout(0, 0));        sale.add(saleTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.TargetInfoEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.TargetInfoInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "TargetInfoEditUI");
    }
