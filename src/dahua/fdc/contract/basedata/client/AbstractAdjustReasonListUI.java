 ...
 * output class name
 */
public abstract class AbstractAdjustReasonListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustReasonListUI.class);
    /**
     * output class constructor
     */
    public AbstractAdjustReasonListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustReasonListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.basedata.app", "AdjustReasonQuery");
        //actionPageSetup
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.AdjustReasonListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "AdjustReasonListUI");
    }
