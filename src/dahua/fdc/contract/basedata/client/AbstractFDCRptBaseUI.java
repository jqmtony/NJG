 ...
 * output class name
 */
public abstract class AbstractFDCRptBaseUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCRptBaseUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCRptBaseUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCRptBaseUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.FDCRptBaseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "FDCRptBaseUI");
    }
