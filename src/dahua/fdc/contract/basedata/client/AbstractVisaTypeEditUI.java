 ...
 * output class name
 */
public abstract class AbstractVisaTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVisaTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.basedata.VisaTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractVisaTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractVisaTypeEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contName.setBounds(new Rectangle(9, 39, 270, 19));
        this.add(contName, null);
        kDLabel1.setBounds(new Rectangle(9, 69, 100, 19));
        this.add(kDLabel1, null);
        chkIsEnabled.setBounds(new Rectangle(192, 69, 71, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(9, 99, 270, 70));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.VisaTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.basedata.VisaTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "VisaTypeEditUI");
    }
