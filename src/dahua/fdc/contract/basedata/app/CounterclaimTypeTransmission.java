 ...
 * @see						
 */
public class CounterclaimTypeTransmission extends AbstractDataTransmission {
	...
	protected ICoreBase getController(Context ctx) throws TaskExternalException {
		try {
			return CounterclaimTypeFactory.getLocalInstance(ctx);
	...
	public CoreBaseInfo transmit(Hashtable hsData, Context ctx)
		...
		CounterclaimTypeInfo info = new CounterclaimTypeInfo();
