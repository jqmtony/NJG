...
public class ProgrammingTempControllerBean extends AbstractProgrammingTempControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.basedata.app.ProgrammingTempControllerBean");
}