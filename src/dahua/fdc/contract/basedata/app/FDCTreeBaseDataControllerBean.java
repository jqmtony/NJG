...
public class FDCTreeBaseDataControllerBean extends AbstractFDCTreeBaseDataControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.FDCTreeBaseDataControllerBean");
