...
public class CurProjProductEntriesControllerBean extends AbstractCurProjProductEntriesControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.CurProjProductEntriesControllerBean");
}