...
public class ContractChargeTypeControllerBean extends AbstractContractChargeTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.ContractChargeTypeControllerBean");
	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_ContractChargeType set  FIsEnabled = ?  where FID = ? ";
