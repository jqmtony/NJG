 ...
 * @version EAS5.1
 */
public class LandDeveloperControllerBean extends AbstractLandDeveloperControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.LandDeveloperControllerBean");

	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_LandDeveloper set  FIsEnabled = ?  where FID = ? ";
