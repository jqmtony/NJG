...
public abstract class AbstractTypeControllerBean extends FDCDataBaseControllerBean implements TypeController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0003c0a80e94"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0004c0a80e94"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0005c0a80e94"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0006c0a80e94"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0007c0a80e94"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("198bcbb9-0113-1000-e000-0008c0a80e94"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
    	return (FDCDataBaseCollection)(getTypeCollection(ctx).cast(FDCDataBaseCollection.class));
    }
    public FDCDataBaseCollection getFDCDataBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (FDCDataBaseCollection)(getTypeCollection(ctx, view).cast(FDCDataBaseCollection.class));
    }
    public FDCDataBaseCollection getFDCDataBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (FDCDataBaseCollection)(getTypeCollection(ctx, oql).cast(FDCDataBaseCollection.class));
    }
