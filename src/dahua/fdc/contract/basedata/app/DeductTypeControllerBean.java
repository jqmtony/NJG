 ...
 * @version EAS5.1
 */
public class DeductTypeControllerBean extends AbstractDeductTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.DeductTypeControllerBean");

	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_DeductType set  FIsEnabled = ?  where FID = ? ";
