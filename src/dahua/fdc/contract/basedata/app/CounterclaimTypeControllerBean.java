...
public class CounterclaimTypeControllerBean extends AbstractCounterclaimTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.CounterclaimTypeControllerBean");
    protected boolean _enabled(Context ctx, IObjectPK ctPK)throws BOSException, EASBizException
    {
	    String sql = "update T_FDC_CounterclaimType set  FIsEnabled = ?  where FID = ? ";
