...
public class HisProjProductEntriesControllerBean extends AbstractHisProjProductEntriesControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.HisProjProductEntriesControllerBean");
}