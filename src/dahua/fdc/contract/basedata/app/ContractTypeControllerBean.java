...
//        }
	...
	/**
	 * 去掉对administrator的权限校验 - BT869946
	 * 
	 * @author RD_zhaoqin
	 * @date 2015-4-21
	 */
	public ContractTypeCollection getContractTypeCollection(Context ctx)
			throws BOSException {
		try {
			disablePermissionForUser(ctx);

			ServiceContext svcCtx = createServiceContext(
					new MetaDataPK("416f74ec-010c-1000-e000-00f8c0a813bb"),	new Object[] { ctx });
	...
	public ContractTypeCollection getContractTypeCollection(Context ctx,
		...
		try {
			...
			ServiceContext svcCtx = createServiceContext(
					new MetaDataPK("416f74ec-010c-1000-e000-00f9c0a813bb"), new Object[] {ctx, view });
			invokeServiceBefore(svcCtx);
	...
	private void disablePermissionForUser(Context ctx) {
		if ("administrator".equals(ContextUtil.getCurrentUserInfo(ctx).getName())) {
