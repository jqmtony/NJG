 ...
 * output class name
 */
public abstract class AbstractCostAccountWithAccountUIHandler extends com.kingdee.eas.framework.app.CoreUIHandler

{
	...
	abstract protected void _handleActionImport(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}