...
public class JobTypeControllerBean extends AbstractJobTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.JobTypeControllerBean");
	protected boolean _enabled(Context ctx, IObjectPK ctPK) throws BOSException, EASBizException {
	    String sql = "update T_FDC_JobType set  FIsEnabled = ?  where FID = ? ";
