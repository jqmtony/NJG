 ...
 * @see						
 */
public class ContractSourceTransmission extends AbstractDataTransmission {
	...
	protected ICoreBase getController(Context ctx) throws TaskExternalException {
		try {
			return ContractSourceFactory.getLocalInstance(ctx);
	...
	public CoreBaseInfo transmit(Hashtable hsData, Context ctx)
		...
		ContractSourceInfo info = new ContractSourceInfo();
