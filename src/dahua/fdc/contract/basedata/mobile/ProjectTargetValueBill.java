...
public class ProjectTargetValueBill extends FdcMobileBill implements IProjectTargetValueBill
{
    public ProjectTargetValueBill()
    {
        super();
        registerInterface(IProjectTargetValueBill.class, this);
    }
    public ProjectTargetValueBill(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectTargetValueBill.class, this);
    }
    ...
    private ProjectTargetValueBillController getController() throws BOSException
    {
        return (ProjectTargetValueBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectTargetValueBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
