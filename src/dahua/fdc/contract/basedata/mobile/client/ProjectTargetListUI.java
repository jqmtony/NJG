 ...
 * output class name
 */
public class ProjectTargetListUI extends AbstractProjectTargetListUI {

	private static final Logger logger = CoreUIObject.getLogger(ProjectTargetListUI.class);
	 ...
	 */
	public ProjectTargetListUI() throws Exception {
		super();
	}
	...
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return ProjectTargetEditUI.class.getName();
	}
	...
	protected String getExportBillTableName() {
		return "T_FDC_ProjectTargetBill";
	}
	...
	protected String getExportEntryTableName() {
		return "T_FDC_ProjectTargetEntry";
	}
	...
	protected String getExportItemTableName() {
		return null;
		// return "T_FDC_ProjectTargetItem";
	}
