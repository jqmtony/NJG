 ...
 * output class name
 */
public class ProjectTargetShowListUI extends AbstractProjectTargetShowListUI {

	private static final Logger logger = CoreUIObject.getLogger(ProjectTargetShowListUI.class);
	 ...
	 */
	public ProjectTargetShowListUI() throws Exception {
		super();
	}
	...
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return ProjectTargetShowEditUI.class.getName();
	}
	...
	protected String getExportBillTableName() {
		return "T_FDC_ProjectTargetSBill";
	}
	...
	protected String getExportEntryTableName() {
		return "T_FDC_ProjectTargetSEntry";
	}
	...
	protected String getExportItemTableName() {
		return "T_FDC_ProjectTargetSItem";
	}
