...
public class ProjectTargetShowEntry extends FdcMobileEntry implements IProjectTargetShowEntry
{
    public ProjectTargetShowEntry()
    {
        super();
        registerInterface(IProjectTargetShowEntry.class, this);
    }
    public ProjectTargetShowEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectTargetShowEntry.class, this);
    }
    ...
    private ProjectTargetShowEntryController getController() throws BOSException
    {
        return (ProjectTargetShowEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectTargetShowEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
