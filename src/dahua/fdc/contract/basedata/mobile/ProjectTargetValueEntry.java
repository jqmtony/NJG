...
public class ProjectTargetValueEntry extends FdcMobileEntry implements IProjectTargetValueEntry
{
    public ProjectTargetValueEntry()
    {
        super();
        registerInterface(IProjectTargetValueEntry.class, this);
    }
    public ProjectTargetValueEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectTargetValueEntry.class, this);
    }
    ...
    private ProjectTargetValueEntryController getController() throws BOSException
    {
        return (ProjectTargetValueEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectTargetValueEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetValueEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
