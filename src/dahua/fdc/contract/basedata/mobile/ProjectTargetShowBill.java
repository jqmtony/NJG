...
public class ProjectTargetShowBill extends FdcMobileBill implements IProjectTargetShowBill
{
    public ProjectTargetShowBill()
    {
        super();
        registerInterface(IProjectTargetShowBill.class, this);
    }
    public ProjectTargetShowBill(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectTargetShowBill.class, this);
    }
    ...
    private ProjectTargetShowBillController getController() throws BOSException
    {
        return (ProjectTargetShowBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectTargetShowBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectTargetShowBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
