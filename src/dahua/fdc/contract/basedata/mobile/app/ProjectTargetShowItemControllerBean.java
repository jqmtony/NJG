...
public class ProjectTargetShowItemControllerBean extends AbstractProjectTargetShowItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.mobile.app.ProjectTargetShowItemControllerBean");
}