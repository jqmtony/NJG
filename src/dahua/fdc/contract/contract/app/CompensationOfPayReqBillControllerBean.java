...
public class CompensationOfPayReqBillControllerBean extends AbstractCompensationOfPayReqBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.CompensationOfPayReqBillControllerBean");
