...
public class ConNoCostSplitEntryControllerBean extends AbstractConNoCostSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.ConNoCostSplitEntryControllerBean");
}