 ...
 * output class name
 */
public class ContractSettlementBillEditUIHandler extends AbstractContractSettlementBillEditUIHandler
{
	...
	protected void _handleActionViewAttachment(RequestContext request,
