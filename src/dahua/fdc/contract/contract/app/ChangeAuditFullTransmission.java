...
//		}
		...
		}else if(getResource(ctx,"Offer_ConstrParty").equals(fOffer.trim())){
			changeAuditBill.setOffer(OfferEnum.CONSTRPARTY);
		}else if(getResource(ctx,"Offer_Superviser").equals(fOffer.trim())){
			changeAuditBill.setOffer(OfferEnum.SUPERVISER);
		}else{
