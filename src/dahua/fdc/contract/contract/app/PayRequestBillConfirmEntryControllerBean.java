...
public class PayRequestBillConfirmEntryControllerBean extends AbstractPayRequestBillConfirmEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.app.PayRequestBillConfirmEntryControllerBean");
}