...
public class ContractCostSplitCollectionAgent extends ContractCostSplitCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public ContractCostSplitCollectionAgent() {
        super();
