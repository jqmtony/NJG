...
public class ContractCostSplitAgent extends ContractCostSplitInfo implements IObjectValueAgent{
    public static final BOSObjectType bosType = new BOSObjectType("1C2F5180");
    private final AgentManager manager;

    private ContractCostSplitAgent ()
    {
        manager = new AgentManager();
    }
    
    public static ContractCostSplitAgent copyOvToAgent(IObjectValue vo){
        ContractCostSplitAgent agent = new ContractCostSplitAgent();
        return (ContractCostSplitAgent)agent.manager.copyOvToAgent(agent,vo);
    }

    public static ContractCostSplitAgent copyOvAsNewAgent(IObjectValue vo){
        ContractCostSplitAgent agent = new ContractCostSplitAgent();
        return (ContractCostSplitAgent)agent.manager.copyOvToAgentAsNew(agent,vo);
    }

    public static ContractCostSplitAgent find(IObjectPK id) throws BOSException
    {
		ContractCostSplitAgent agent = new ContractCostSplitAgent();
        return (ContractCostSplitAgent)agent.manager.find(agent, id);
    }
    
    public static ContractCostSplitAgent create() throws BOSException
    {
        return (ContractCostSplitAgent)AgentManager.create(new ContractCostSplitAgent());
    }
