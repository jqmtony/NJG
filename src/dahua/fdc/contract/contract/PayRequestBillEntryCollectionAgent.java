...
public class PayRequestBillEntryCollectionAgent extends PayRequestBillEntryCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public PayRequestBillEntryCollectionAgent() {
        super();
