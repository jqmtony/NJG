...
{
    public static final String TEMP_EVAL_VALUE = "TEMP_EVAL";
    public static final String BASE_CONFIRM_VALUE = "BASE_CONFIRM";
    public static final String COMP_COMFIRM_VALUE = "COMP_COMFIRM";
