...
public class ContractSettlementBillAgent extends ContractSettlementBillInfo implements IObjectValueAgent{
    public static final BOSObjectType bosType = new BOSObjectType("1D604E7D");
    private final AgentManager manager;

    private ContractSettlementBillAgent ()
    {
        manager = new AgentManager();
    }
    
    public static ContractSettlementBillAgent copyOvToAgent(IObjectValue vo){
        ContractSettlementBillAgent agent = new ContractSettlementBillAgent();
        return (ContractSettlementBillAgent)agent.manager.copyOvToAgent(agent,vo);
    }

    public static ContractSettlementBillAgent copyOvAsNewAgent(IObjectValue vo){
        ContractSettlementBillAgent agent = new ContractSettlementBillAgent();
        return (ContractSettlementBillAgent)agent.manager.copyOvToAgentAsNew(agent,vo);
    }

    public static ContractSettlementBillAgent find(IObjectPK id) throws BOSException
    {
		ContractSettlementBillAgent agent = new ContractSettlementBillAgent();
        return (ContractSettlementBillAgent)agent.manager.find(agent, id);
    }
    
    public static ContractSettlementBillAgent create() throws BOSException
    {
        return (ContractSettlementBillAgent)AgentManager.create(new ContractSettlementBillAgent());
    }
