...
public class SettlementCostSplitEntryCollectionAgent extends SettlementCostSplitEntryCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public SettlementCostSplitEntryCollectionAgent() {
        super();
