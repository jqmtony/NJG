 ...
 * output class name
 */
public class PcTypeListUI extends AbstractPcTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PcTypeListUI.class);
    
    /**
     * output class constructor
     */
    public PcTypeListUI() throws Exception
    {
        super();
    }
