...
public abstract class AbstractProgrammingContracCostControllerBean extends CoreBillEntryBaseControllerBean implements ProgrammingContracCostController
{
    ...
    public ProgrammingContracCostInfo getProgrammingContracCostInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
          ...
          return (ProgrammingContracCostInfo)svcCtx.getMethodReturnValue();
    ...
    public ProgrammingContracCostCollection getProgrammingContracCostCollection(Context ctx) throws BOSException
    {
        try {
          ...
          return (ProgrammingContracCostCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContracCostCollection(ctx).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContracCostCollection(ctx, view).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContracCostCollection(ctx, oql).cast(CoreBillEntryBaseCollection.class));
    }
