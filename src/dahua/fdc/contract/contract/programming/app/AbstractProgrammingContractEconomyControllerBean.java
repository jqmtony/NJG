...
public abstract class AbstractProgrammingContractEconomyControllerBean extends CoreBillEntryBaseControllerBean implements ProgrammingContractEconomyController
{
    ...
    public ProgrammingContractEconomyInfo getProgrammingContractEconomyInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
          ...
          return (ProgrammingContractEconomyInfo)svcCtx.getMethodReturnValue();
    ...
    public ProgrammingContractEconomyCollection getProgrammingContractEconomyCollection(Context ctx) throws BOSException
    {
        try {
          ...
          return (ProgrammingContractEconomyCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContractEconomyCollection(ctx).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContractEconomyCollection(ctx, view).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getProgrammingContractEconomyCollection(ctx, oql).cast(CoreBillEntryBaseCollection.class));
    }
