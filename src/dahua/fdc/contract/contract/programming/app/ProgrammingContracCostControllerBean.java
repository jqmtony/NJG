...
public class ProgrammingContracCostControllerBean extends AbstractProgrammingContracCostControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.programming.app.ProgrammingContracCostControllerBean");
}