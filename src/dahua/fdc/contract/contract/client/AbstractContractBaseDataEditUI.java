 ...
 * output class name
 */
public abstract class AbstractContractBaseDataEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractBaseDataEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contContractId;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtContractId;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsNoText;
    ...
    protected com.kingdee.eas.fdc.contract.ContractBaseDataInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractContractBaseDataEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractBaseDataEditUI.class.getName());
        ...
        this.contContractId = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.txtContractId = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.chkIsNoText = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.contContractId.setName("contContractId");
        this.txtContractId.setName("txtContractId");
        this.chkIsNoText.setName("chkIsNoText");
        ...
        // txtSimpleName
        // contContractId		
        this.contContractId.setBoundLabelText(resHelper.getString("contContractId.boundLabelText"));		
        this.contContractId.setBoundLabelLength(100);		
        this.contContractId.setBoundLabelUnderline(true);
        // txtContractId		
        this.txtContractId.setMaxLength(80);
        // chkIsNoText		
        this.chkIsNoText.setText(resHelper.getString("chkIsNoText.text"));
        // contFiOrgUnit		
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(300, 100, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(10, 130, 270, 19));
        this.add(contDescription, null);
        contSimpleName.setBounds(new Rectangle(300, 130, 270, 19));
        this.add(contSimpleName, null);
        contContractId.setBounds(new Rectangle(10, 160, 270, 19));
        this.add(contContractId, null);
        chkIsNoText.setBounds(new Rectangle(300, 160, 140, 19));
        this.add(chkIsNoText, null);
        contFiOrgUnit.setBounds(new Rectangle(10, 190, 270, 19));
        ...
        //contContractId
        contContractId.setBoundEditor(txtContractId);
        //contFiOrgUnit
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("contractId", String.class, this.txtContractId, "text");
		dataBinder.registerBinding("isNoText", boolean.class, this.chkIsNoText, "selected");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractBaseDataEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.ContractBaseDataInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("contractId", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("isNoText", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractBaseDataEditUI");
    }
