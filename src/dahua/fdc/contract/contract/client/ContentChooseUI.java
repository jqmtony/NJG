 ...
 * output class name
 */
public class ContentChooseUI extends AbstractContentChooseUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContentChooseUI.class);
    
    /**
     * output class constructor
     */
    public ContentChooseUI() throws Exception
    {
        super();
    }
    ...
    {
        super.btnConcel2_actionPerformed(e);
    }
