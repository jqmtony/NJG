 ...
 * output class name
 */
public abstract class AbstractContractSettleFullFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractSettleFullFilterUI.class);
     ...
     */
    public AbstractContractSettleFullFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractSettleFullFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        pnlContractState.setBounds(new Rectangle(147, 163, 111, 146));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractSettleFullFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractSettleFullFilterUI");
    }
