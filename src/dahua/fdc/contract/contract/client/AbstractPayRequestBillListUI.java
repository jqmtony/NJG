...
public abstract class AbstractPayRequestBillListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblPayRequestBill.addKDTMouseListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTMouseListener() {
            public void tableClicked(com.kingdee.bos.ctrl.kdf.table.event.KDTMouseEvent e) {
                try {
                    tblPayRequestBill_tableClicked(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblPayRequestBill, BorderLayout.CENTER);
    ...
    /**
     * output tblPayRequestBill_tableClicked method
     */
    protected void tblPayRequestBill_tableClicked(com.kingdee.bos.ctrl.kdf.table.event.KDTMouseEvent e) throws Exception
    {
    }
