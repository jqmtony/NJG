 ...
 * output class name
 */
public abstract class AbstractTempEvalContractChangeBillListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTempEvalContractChangeBillListUI.class);
     ...
     */
    public AbstractTempEvalContractChangeBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTempEvalContractChangeBillListUI.class.getName());
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblChangeList, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.TempEvalContractChangeBillListUIHandler";
	}
    ...
    protected class ActionVisa extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTempEvalContractChangeBillListUI.this, "ActionVisa", "actionVisa_actionPerformed", e);
        }
    }
    ...
    protected class ActionSettlement extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempEvalContractChangeBillListUI.this, "ActionSettlement", "actionSettlement_actionPerformed", e);
        }
    }
    ...
    protected class ActionVisaBatch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempEvalContractChangeBillListUI.this, "ActionVisaBatch", "actionVisaBatch_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnVisa extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempEvalContractChangeBillListUI.this, "ActionUnVisa", "actionUnVisa_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewChangeAudtiAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempEvalContractChangeBillListUI.this, "ActionViewChangeAudtiAttachment", "actionViewChangeAudtiAttachment_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "TempEvalContractChangeBillListUI");
    }
    /**
