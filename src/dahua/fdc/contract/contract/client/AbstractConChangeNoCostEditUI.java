 ...
 * output class name
 */
public abstract class AbstractConChangeNoCostEditUI extends com.kingdee.eas.fdc.basedata.client.FDCNoCostSplitBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConChangeNoCostEditUI.class);
    protected com.kingdee.eas.fdc.contract.ConChangeNoCostSplitInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractConChangeNoCostEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConChangeNoCostEditUI.class.getName());
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","","","","","","amount","product","curProject.id","accountView.id","level","splitType","apportionType.name","apportionValue","directAmount","apportionValueTotal","directAmountTotal","otherRatioTotal"});
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("contractChange.amount", java.math.BigDecimal.class, this.txtAmount, "value");
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.fdc.contract.ConChangeNoCostSplitEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ConChangeNoCostEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.ConChangeNoCostSplitInfo)ov;
    }
...
//        sic.add(new SelectorItemInfo("entrys.product.number"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ConChangeNoCostEditUI");
    }
    /**
