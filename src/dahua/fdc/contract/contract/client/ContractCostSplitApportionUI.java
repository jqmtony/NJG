 ...
 * output class name
 */
public class ContractCostSplitApportionUI extends AbstractContractCostSplitApportionUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractCostSplitApportionUI.class);
    
    /**
     * output class constructor
     */
    public ContractCostSplitApportionUI() throws Exception
    {
        super();
    }
