 ...
 * output class name
 */
public class ContractCostSplitApptProdUI extends AbstractContractCostSplitApptProdUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractCostSplitApptProdUI.class);
    
    /**
     * output class constructor
     */
    public ContractCostSplitApptProdUI() throws Exception
    {
        super();
    }
