 ...
 * output class name
 */
public abstract class AbstractInvalidContractSplitListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInvalidContractSplitListUI.class);
    /**
     * output class constructor
     */
    public AbstractInvalidContractSplitListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.InvalidContractSplitListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "InvalidContractSplitListUI");
    }
