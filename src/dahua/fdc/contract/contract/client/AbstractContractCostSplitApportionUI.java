 ...
 * output class name
 */
public abstract class AbstractContractCostSplitApportionUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractCostSplitApportionUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtCostObj;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer2;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtCostAcct;
     ...
     */
    public AbstractContractCostSplitApportionUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractCostSplitApportionUI.class.getName());
        ...
        this.txtCostObj = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.kDLabelContainer2 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.txtCostAcct = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.txtCostObj.setName("txtCostObj");
        this.kDLabelContainer2.setName("kDLabelContainer2");
        this.txtCostAcct.setName("txtCostAcct");
        ...
        // txtCostObj		
        this.txtCostObj.setMaxLength(80);		
        this.txtCostObj.setVisible(true);		
        this.txtCostObj.setEnabled(false);		
        this.txtCostObj.setHorizontalAlignment(2);		
        this.txtCostObj.setRequired(false);
        // kDLabelContainer2		
        ...
        // txtCostAcct		
        this.txtCostAcct.setVisible(true);		
        this.txtCostAcct.setHorizontalAlignment(2);		
        this.txtCostAcct.setMaxLength(100);		
        this.txtCostAcct.setRequired(false);		
        this.txtCostAcct.setEnabled(false);
        // btnSplit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractCostSplitApportionUIHandler";
	}
    ...
    protected class ActionSelectAll extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractCostSplitApportionUI.this, "ActionSelectAll", "actionSelectAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelectNone extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractContractCostSplitApportionUI.this, "ActionSelectNone", "actionSelectNone_actionPerformed", e);
        }
    }
    ...
    protected class ActionSplit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractContractCostSplitApportionUI.this, "ActionSplit", "actionSplit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractCostSplitApportionUI");
    }
