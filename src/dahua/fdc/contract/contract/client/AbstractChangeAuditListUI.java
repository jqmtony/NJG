...
contAudit.getContentPane().setLayout(new BorderLayout(0, 0));        contAudit.getContentPane().add(tblMain, BorderLayout.CENTER);
    ...
    {
        return new String[] {"id","bookedDate","period","changeState","number","name","curProject.name","changeReason.name","auditType.name","isRespite","contractNumber","contractName","partB","offer","isHasAttament","specialtyName","urgentDegree","jobType.name","auditor.name","auditTime","billType","putForwardTime","quality","timeLi","sale","cost","reworkVisa","contractAmPro","totalChangeAmount","designChangeAmount","changeEstimate","imgNumber","compDate","appliAmount","punisAmount","approvedAmount","constructionHead","workNote","BIMUDF0052.name","delyDay"};
    }
