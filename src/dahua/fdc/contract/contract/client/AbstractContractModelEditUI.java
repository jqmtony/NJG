 ...
 * output class name
 */
public abstract class AbstractContractModelEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractModelEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer ctnNumber;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer lableName;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer ctnContractType;
    ...
    protected com.kingdee.eas.fdc.contract.ContractModelInfo editData = null;
    protected ActionEditLine actionEditLine = null;
    /**
     * output class constructor
     */
    public AbstractContractModelEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractModelEditUI.class.getName());
        ...
        this.lableName = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.ctnContractType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.lableName.setName("lableName");
        this.ctnContractType.setName("ctnContractType");
        ...
        // lableName		
        this.lableName.setBoundLabelText(resHelper.getString("lableName.boundLabelText"));		
        this.lableName.setBoundLabelUnderline(true);		
        this.lableName.setBoundLabelLength(100);
        // ctnContractType		
        this.ctnContractType.setBoundLabelText(resHelper.getString("ctnContractType.boundLabelText"));		
        this.ctnContractType.setBoundLabelUnderline(true);		
        this.ctnContractType.setBoundLabelLength(100);
        // ctnVerNumber		
        ...
        // tblModel
		String tblModelStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol3\"><c:NumberFormat>#####.0</c:NumberFormat></c:Style><c:Style id=\"sCol5\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"fileName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"creatorName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"createTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" /><t:Column t:key=\"version\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:configured=\"false\" t:styleID=\"sCol3\" /><t:Column t:key=\"fileType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"4\" t:configured=\"false\" /><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"5\" t:configured=\"false\" t:styleID=\"sCol5\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:configured=\"false\"><t:Cell t:configured=\"false\">$Resource{fileName}</t:Cell><t:Cell t:configured=\"false\">$Resource{creatorName}</t:Cell><t:Cell t:configured=\"false\">$Resource{createTime}</t:Cell><t:Cell t:configured=\"false\">$Resource{version}</t:Cell><t:Cell t:configured=\"false\">$Resource{fileType}</t:Cell><t:Cell t:configured=\"false\">$Resource{id}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
    ...
    public void initUIContentLayout()
    {
        ...
        lableName.setBounds(new Rectangle(371, 13, 270, 19));
        this.add(lableName, new KDLayout.Constraints(371, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ctnContractType.setBounds(new Rectangle(724, 13, 270, 19));
        this.add(ctnContractType, new KDLayout.Constraints(724, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ctnVerNumber.setBounds(new Rectangle(18, 40, 270, 19));
        this.add(ctnVerNumber, new KDLayout.Constraints(18, 40, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        lblAuditTime.setBounds(new Rectangle(574, 599, 420, 19));
        this.add(lblAuditTime, new KDLayout.Constraints(574, 599, 420, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ctnModel.setBounds(new Rectangle(18, 69, 977, 141));
        this.add(ctnModel, new KDLayout.Constraints(18, 69, 977, 141, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDScrollPane1.setBounds(new Rectangle(18, 240, 977, 110));
        this.add(kDScrollPane1, new KDLayout.Constraints(18, 240, 977, 110, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabel1.setBounds(new Rectangle(18, 216, 100, 19));
        this.add(kDLabel1, new KDLayout.Constraints(18, 216, 100, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT));
        kDScrollPane2.setBounds(new Rectangle(18, 378, 977, 150));
        this.add(kDScrollPane2, new KDLayout.Constraints(18, 378, 977, 150, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabel2.setBounds(new Rectangle(18, 357, 100, 19));
        this.add(kDLabel2, new KDLayout.Constraints(18, 357, 100, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //ctnNumber
        ctnNumber.setBoundEditor(txtNumber);
        //lableName
        lableName.setBoundEditor(txtName);
        //ctnContractType
        ctnContractType.setBoundEditor(prmtContractType);
        //ctnVerNumber
...
ctnModel.getContentPane().setLayout(new BorderLayout(0, 0));        ctnModel.getContentPane().add(tblModel, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractModelEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.ContractModelInfo)ov;
    }
    ...
    protected class ActionEditLine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractModelEditUI.this, "ActionEditLine", "actionEditLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractModelEditUI");
    }
