 ...
 * output class name
 */
public abstract class AbstractTempEvalContractChangeFullFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTempEvalContractChangeFullFilterUI.class);
     ...
     */
    public AbstractTempEvalContractChangeFullFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTempEvalContractChangeFullFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        plChangeState.setBounds(new Rectangle(10, 148, 111, 162));
        ...
        radioStateAll.setBounds(new Rectangle(23, 106, 64, 19));
        plChangeState.add(radioStateAll, null);
        radioVisa.setBounds(new Rectangle(23, 84, 64, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.TempEvalContractChangeFullFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "TempEvalContractChangeFullFilterUI");
    }
