 ...
 * output class name
 */
public class ContractChangeFullFilterUI extends
		AbstractContractChangeFullFilterUI {
	 ...
	 */
	public ContractChangeFullFilterUI(ListUI listUI, ItemAction actionListOnLoad)
			throws Exception {
		super();
		this.listUI = listUI;
