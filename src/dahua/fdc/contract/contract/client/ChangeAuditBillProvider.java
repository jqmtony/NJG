...
public class ChangeAuditBillProvider extends FDCNoteDataProvider {
	...
	public ChangeAuditBillProvider(String billId, IMetaDataPK mainQuery,IMetaDataPK attchQuery) {
