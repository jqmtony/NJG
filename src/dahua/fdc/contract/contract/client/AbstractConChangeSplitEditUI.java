...
public abstract class AbstractConChangeSplitEditUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","","","","","workLoad","price","splitScale","amount","","product","costAccount.curProject.id","costAccount.id","level","splitType","apportionType.name","apportionValue","directAmount","apportionValueTotal","directAmountTotal","otherRatioTotal"});
