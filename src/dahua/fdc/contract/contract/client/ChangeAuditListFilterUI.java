...
public class ChangeAuditListFilterUI extends ChangeAuditFullFilterUI {
	private static final Logger logger = CoreUIObject.getLogger("com.kingdee.eas.fdc.contract.client.ChangeAuditListFilterUI");

	private FullOrgUnitInfo company;
	private CurProjectInfo project;
	private Set authorizedOrgs;

	public ChangeAuditListFilterUI(ListUI listUI, ItemAction actionListOnLoad) throws Exception {
	...
	public void clear() {
		...
		this.f7ContractChangeType.setQueryInfo("com.kingdee.eas.fdc.basedata.app.F7ChangeTypeQuery");
	}
