...
public class GuerdonBillPrintProvider extends FDCNoteDataProvider {
	...
	public GuerdonBillPrintProvider(String billId, IMetaDataPK mainQuery,IMetaDataPK attchQuery) {
