...
public class AbstractContractBillReviseEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractContractBillReviseEntryInfo()
    {
        this("id");
    }
    protected AbstractContractBillReviseEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.fdc.contract.ContractBillReviseInfo getParent()
    {
        return (com.kingdee.eas.fdc.contract.ContractBillReviseInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.fdc.contract.ContractBillReviseInfo item)
    {
        put("parent", item);
    }
    /**
