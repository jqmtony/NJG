...
public class RealDateRelControllerBean extends AbstractRealDateRelControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.basedata.app.RealDateRelControllerBean");
}