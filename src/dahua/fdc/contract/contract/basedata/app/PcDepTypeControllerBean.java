...
public class PcDepTypeControllerBean extends AbstractPcDepTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.basedata.app.PcDepTypeControllerBean");
}