 ...
 * output class name
 */
public abstract class AbstractTempImportUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTempImportUI.class);
     ...
     */
    public AbstractTempImportUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTempImportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.basedata.app.TempImportUIHandler";
	}
    ...
    protected class ActionConfirm extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTempImportUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionExit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempImportUI.this, "ActionExit", "actionExit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.basedata.client", "TempImportUI");
    }
