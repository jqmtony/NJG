...
public class SettlementCostSplitCollectionAgent extends SettlementCostSplitCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public SettlementCostSplitCollectionAgent() {
        super();
