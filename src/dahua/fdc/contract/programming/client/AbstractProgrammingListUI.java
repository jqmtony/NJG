...
public abstract class AbstractProgrammingListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","name","version","aimCost.versionName","aimCost.versionNumber","state","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","versionGroup","isLatest"});
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.programming.app.ProgrammingListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.programming.client", "ProgrammingListUI");
    }
    /**
