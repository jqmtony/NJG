 ...
 * output class name
 */
public abstract class AbstractRESchTemplateTaskF7UI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRESchTemplateTaskF7UI.class);
     ...
     */
    public AbstractRESchTemplateTaskF7UI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRESchTemplateTaskF7UI.class.getName());
        ...
        // tblTask		
        this.tblTask.setFormatXml(resHelper.getString("tblTask.formatXml"));
...
contTask.getContentPane().setLayout(new BorderLayout(0, 0));        contTask.getContentPane().add(tblTask, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.programming.app.RESchTemplateTaskF7UIHandler";
	}
    ...
    protected class ActionSelectAll extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRESchTemplateTaskF7UI.this, "ActionSelectAll", "actionSelectAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionClearAll extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRESchTemplateTaskF7UI.this, "ActionClearAll", "actionClearAll_actionPerformed", e);
        }
    }
    ...
    protected class ActionOk extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRESchTemplateTaskF7UI.this, "ActionOk", "actionOk_actionPerformed", e);
        }
    }
    ...
    protected class ActionQuit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRESchTemplateTaskF7UI.this, "ActionQuit", "actionQuit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.programming.client", "RESchTemplateTaskF7UI");
    }
