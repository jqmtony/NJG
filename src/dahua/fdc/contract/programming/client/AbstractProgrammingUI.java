...
pnlCostAccount.getContentPane().setLayout(new BorderLayout(0, 0));        pnlCostAccount.getContentPane().add(kdtCostAccount, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entries.isQk", boolean.class, this.kdtEntries, "isQk.text");
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entries.isQk", ValidateHelper.ON_SAVE);    
