 ...
 * output class name
 */
public abstract class AbstractProjectImportUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectImportUI.class);
     ...
     */
    public AbstractProjectImportUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectImportUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 770, 580));
        this.setLayout(null);
        tblMain.setBounds(new Rectangle(10, 10, 751, 527));
        this.add(tblMain, null);
        kDSeparator3.setBounds(new Rectangle(10, 541, 752, 10));
        this.add(kDSeparator3, null);
        btnConfirm.setBounds(new Rectangle(598, 550, 73, 21));
        this.add(btnConfirm, null);
        btnExit.setBounds(new Rectangle(688, 550, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.programming.app.ProjectImportUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("orgUnit.isCostOrgUnit"));
    ...
    protected class ActionConfirm extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectImportUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionExit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectImportUI.this, "ActionExit", "actionExit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.programming.client", "ProjectImportUI");
    }
