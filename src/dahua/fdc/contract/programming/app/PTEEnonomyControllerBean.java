...
public class PTEEnonomyControllerBean extends AbstractPTEEnonomyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.programming.app.PTEEnonomyControllerBean");
}