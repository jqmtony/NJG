...
public class ProgrammingContractFxbdEntryControllerBean extends AbstractProgrammingContractFxbdEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.programming.app.ProgrammingContractFxbdEntryControllerBean");
}