...
public class AbstractProgrammingContracCostInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    ...
    {
        return getString("aimCostId");
    }
    public void setAimCostId(String item)
    {
        setString("aimCostId", item);
    }
