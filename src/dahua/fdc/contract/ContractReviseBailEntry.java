...
public class ContractReviseBailEntry extends CoreBillEntryBase implements IContractReviseBailEntry
{
    public ContractReviseBailEntry()
    {
        super();
        registerInterface(IContractReviseBailEntry.class, this);
    }
    public ContractReviseBailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractReviseBailEntry.class, this);
    }
    ...
    private ContractReviseBailEntryController getController() throws BOSException
    {
        return (ContractReviseBailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractReviseBailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractReviseBailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractReviseBailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractReviseBailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractReviseBailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractReviseBailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
