...
public class FDCPaymentBill extends FDCBill implements IFDCPaymentBill
{
    public FDCPaymentBill()
    {
        super();
        registerInterface(IFDCPaymentBill.class, this);
    }
    public FDCPaymentBill(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCPaymentBill.class, this);
    }
    ...
    private FDCPaymentBillController getController() throws BOSException
    {
        return (FDCPaymentBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCPaymentBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCPaymentBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCPaymentBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCPaymentBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCPaymentBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCPaymentBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *根据付款单ID获取是否暂缓字段-User defined method
     *@param idSet 付款单ID集合
     *@return
     */
    ...
    {
        try {
            return getController().getIsRespiteByPaymentBillIds(getContext(), idSet);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *审批后更新期间-User defined method
     *@param idList 付款单ID列表
     */
    public void updatePeriodAfterAudit(List idList) throws BOSException, EASBizException
    {
        try {
            getController().updatePeriodAfterAudit(getContext(), idList);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *更新发票金额-User defined method
     *@param fdcPayment 房地产付款单
    ...
    {
        try {
            getController().updateInvoiceAmt(getContext(), fdcPayment, paymentBill);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
