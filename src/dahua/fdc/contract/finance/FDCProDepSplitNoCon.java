...
public class FDCProDepSplitNoCon extends CoreBillEntryBase implements IFDCProDepSplitNoCon
{
    public FDCProDepSplitNoCon()
    {
        super();
        registerInterface(IFDCProDepSplitNoCon.class, this);
    }
    public FDCProDepSplitNoCon(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCProDepSplitNoCon.class, this);
    }
    ...
    private FDCProDepSplitNoConController getController() throws BOSException
    {
        return (FDCProDepSplitNoConController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitNoConCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
