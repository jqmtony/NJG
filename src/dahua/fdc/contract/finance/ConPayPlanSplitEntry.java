...
public class ConPayPlanSplitEntry extends FDCSplitBillEntry implements IConPayPlanSplitEntry
{
    public ConPayPlanSplitEntry()
    {
        super();
        registerInterface(IConPayPlanSplitEntry.class, this);
    }
    public ConPayPlanSplitEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IConPayPlanSplitEntry.class, this);
    }
    ...
    private ConPayPlanSplitEntryController getController() throws BOSException
    {
        return (ConPayPlanSplitEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
