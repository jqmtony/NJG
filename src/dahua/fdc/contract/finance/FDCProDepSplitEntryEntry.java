...
public class FDCProDepSplitEntryEntry extends CoreBase implements IFDCProDepSplitEntryEntry
{
    public FDCProDepSplitEntryEntry()
    {
        super();
        registerInterface(IFDCProDepSplitEntryEntry.class, this);
    }
    public FDCProDepSplitEntryEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCProDepSplitEntryEntry.class, this);
    }
    ...
    private FDCProDepSplitEntryEntryController getController() throws BOSException
    {
        return (FDCProDepSplitEntryEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCProDepSplitEntryEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
