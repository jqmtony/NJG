...
public class FDCMonthBudgetAcct extends FDCBudgetAcct implements IFDCMonthBudgetAcct
{
    public FDCMonthBudgetAcct()
    {
        super();
        registerInterface(IFDCMonthBudgetAcct.class, this);
    }
    public FDCMonthBudgetAcct(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCMonthBudgetAcct.class, this);
    }
    ...
    private FDCMonthBudgetAcctController getController() throws BOSException
    {
        return (FDCMonthBudgetAcctController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCMonthBudgetAcctCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().update(getContext(), billId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
