...
public class ConPayPlanDataAControllerBean extends AbstractConPayPlanDataAControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanDataAControllerBean");
}