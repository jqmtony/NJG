...
public class PayPlanTemplateByMonthControllerBean extends AbstractPayPlanTemplateByMonthControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanTemplateByMonthControllerBean");
}