...
public class PayPlanDataBaseControllerBean extends AbstractPayPlanDataBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanDataBaseControllerBean");
}