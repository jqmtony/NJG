...
public class PaymentNoCostSplitControllerBean extends
	...
	protected IObjectPK _save(Context ctx, IObjectValue model)
		...
		if (model.get("firstSettCompletePrjAmt") != null) {
			...
			BigDecimal prop = FDCHelper.toBigDecimal(reqInfo.getProjectPriceInContract()).setScale(4, BigDecimal.ROUND_HALF_UP).divide(completePrjAmt, BigDecimal.ROUND_HALF_UP).multiply(
