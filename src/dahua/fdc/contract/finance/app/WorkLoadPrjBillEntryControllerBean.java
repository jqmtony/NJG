...
public class WorkLoadPrjBillEntryControllerBean extends AbstractWorkLoadPrjBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.WorkLoadPrjBillEntryControllerBean");
}