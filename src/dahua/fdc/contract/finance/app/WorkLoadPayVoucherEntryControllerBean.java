...
public class WorkLoadPayVoucherEntryControllerBean extends AbstractWorkLoadPayVoucherEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.WorkLoadPayVoucherEntryControllerBean");
}