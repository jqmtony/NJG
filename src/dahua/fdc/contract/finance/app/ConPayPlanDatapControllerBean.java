...
public class ConPayPlanDatapControllerBean extends AbstractConPayPlanDatapControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanDatapControllerBean");
}