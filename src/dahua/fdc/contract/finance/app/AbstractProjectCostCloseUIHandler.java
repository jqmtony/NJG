...

{
	...
	abstract protected void _handleActionAdd(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionDelete(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionAddAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionDelAll(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}