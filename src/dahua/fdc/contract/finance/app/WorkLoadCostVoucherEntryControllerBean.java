...
public class WorkLoadCostVoucherEntryControllerBean extends AbstractWorkLoadCostVoucherEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.WorkLoadCostVoucherEntryControllerBean");
}