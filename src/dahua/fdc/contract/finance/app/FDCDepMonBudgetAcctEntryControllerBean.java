...
public class FDCDepMonBudgetAcctEntryControllerBean extends AbstractFDCDepMonBudgetAcctEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.FDCDepMonBudgetAcctEntryControllerBean");
}