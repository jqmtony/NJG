...
public class PayPlanNewByMonthControllerBean extends AbstractPayPlanNewByMonthControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanNewByMonthControllerBean");
}