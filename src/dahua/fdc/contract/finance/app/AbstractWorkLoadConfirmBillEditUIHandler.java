...

{
	...
	public void handleActionViewContractFull(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewContractFull(request,response,context);
	}
	protected void _handleActionViewContractFull(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}