...
public class ConPayPlanDataControllerBean extends AbstractConPayPlanDataControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanDataControllerBean");
}