...
public class PayPlanNewByScheduleControllerBean extends AbstractPayPlanNewByScheduleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanNewByScheduleControllerBean");
}