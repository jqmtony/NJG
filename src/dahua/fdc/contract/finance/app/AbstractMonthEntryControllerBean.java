...
public abstract class AbstractMonthEntryControllerBean extends CoreBillEntryBaseControllerBean implements MonthEntryController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9de0b76e-51f3-4622-9345-31be6c36ac1e"), new Object[]{ctx});
          ...
          return (MonthEntryCollection)svcCtx.getMethodReturnValue();
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("60fa4709-9097-4596-9139-14f57628ea01"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("244235b0-a2ef-457e-aec2-c62c4a3e3fef"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
