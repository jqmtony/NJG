...
public class PayPlanNewDataControllerBean extends AbstractPayPlanNewDataControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayPlanNewDataControllerBean");
}