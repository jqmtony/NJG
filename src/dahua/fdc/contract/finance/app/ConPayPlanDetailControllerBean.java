...
public class ConPayPlanDetailControllerBean extends AbstractConPayPlanDetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanDetailControllerBean");
}