...
public abstract class AbstractFDCDepConPayPlanBillControllerBean extends FDCBillControllerBean implements FDCDepConPayPlanBillController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("be3377d7-b9a7-4ceb-b208-69cca61a2fdb"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9f163ec9-75de-4187-993c-31f18cd1f987"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
