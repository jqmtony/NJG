...
public class PaymentNoCostSplitEntry extends FDCNoCostSplitBillEntry implements IPaymentNoCostSplitEntry
{
    public PaymentNoCostSplitEntry()
    {
        super();
        registerInterface(IPaymentNoCostSplitEntry.class, this);
    }
    public PaymentNoCostSplitEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPaymentNoCostSplitEntry.class, this);
    }
    ...
    private PaymentNoCostSplitEntryController getController() throws BOSException
    {
        return (PaymentNoCostSplitEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPaymentNoCostSplitEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
