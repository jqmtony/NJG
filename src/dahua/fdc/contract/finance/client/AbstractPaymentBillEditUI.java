...
public abstract class AbstractPaymentBillEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contInvoiceOriAllAmt;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtRecCountry;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtInvoiceOriAllAmt;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.contInvoiceOriAllAmt = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtRecCountry = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.txtInvoiceOriAllAmt = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contInvoiceOriAllAmt.setName("contInvoiceOriAllAmt");
        ...
        this.prmtRecCountry.setName("prmtRecCountry");
        ...
        this.txtInvoiceOriAllAmt.setName("txtInvoiceOriAllAmt");
        ...
        this.contAuditDate.setBoundLabelLength(120);		
        ...
        this.contPayeeArea.setVisible(false);		
        this.contPayeeArea.setEnabled(false);
        // kDLabelContainer9		
        ...
        this.contAllInvoiceAmt.setEnabled(false);
        // contInvoiceDate		
        ...
        // contInvoiceOriAllAmt		
        this.contInvoiceOriAllAmt.setBoundLabelText(resHelper.getString("contInvoiceOriAllAmt.boundLabelText"));		
        this.contInvoiceOriAllAmt.setBoundLabelUnderline(true);
        // contInvoiceOriAmt		
        ...
        this.txtrecCity.setToolTipText(resHelper.getString("txtrecCity.toolTipText"));
        ...
        // prmtRecCountry		
        this.prmtRecCountry.setToolTipText(resHelper.getString("prmtRecCountry.toolTipText"));		
        this.prmtRecCountry.setDisplayFormat("$name$");		
        this.prmtRecCountry.setEditFormat("$name$");		
        this.prmtRecCountry.setQueryInfo("com.kingdee.eas.basedata.assistant.app.F7CountryQuery");
        // difPlace		
        ...
        this.prmtFpItem.setToolTipText(resHelper.getString("prmtFpItem.toolTipText"));
        // prmtPayeeArea		
        ...
        this.txtPlanItem.setEnabled(false);
        // txtInvoiceOriAllAmt
        // txtInvoiceOriAmt
        // kdtEntries
        ...
        // menuItemViewBalance
        this.menuItemViewBalance.setAction((IItemAction)ActionProxyFactory.getProxy(actionViewBudget, new Class[] { IItemAction.class }, getServiceContext()));		
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(20, 621, 385, 19));
        this.add(contCreator, new KDLayout.Constraints(20, 621, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(485, 621, 385, 19));
        this.add(contCreateTime, new KDLayout.Constraints(485, 621, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(20, 646, 385, 19));
        this.add(contAuditor, new KDLayout.Constraints(20, 646, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditDate.setBounds(new Rectangle(485, 646, 385, 19));
        this.add(contAuditDate, new KDLayout.Constraints(485, 646, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contCashier.setBounds(new Rectangle(20, 671, 385, 19));
        this.add(contCashier, new KDLayout.Constraints(20, 671, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contAccountant.setBounds(new Rectangle(485, 671, 385, 19));
        this.add(contAccountant, new KDLayout.Constraints(485, 671, 385, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
        ...
        pnlPayBillHeader.putClientProperty("OriginalBounds", new Rectangle(0, 0, 869, 579));        kDSeparator5.setBounds(new Rectangle(8, 111, 850, 5));
        pnlPayBillHeader.add(kDSeparator5, new KDLayout.Constraints(8, 111, 850, 5, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCompany.setBounds(new Rectangle(10, 7, 385, 19));
        pnlPayBillHeader.add(contCompany, new KDLayout.Constraints(10, 7, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contContraNo.setBounds(new Rectangle(10, 60, 385, 19));
        pnlPayBillHeader.add(contContraNo, new KDLayout.Constraints(10, 60, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFdcPayType.setBounds(new Rectangle(10, 35, 385, 19));
        pnlPayBillHeader.add(contFdcPayType, new KDLayout.Constraints(10, 35, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPayeeAccountBank1.setBounds(new Rectangle(300, 270, 270, 19));
        pnlPayBillHeader.add(contPayeeAccountBank1, new KDLayout.Constraints(300, 270, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPayeeBank.setBounds(new Rectangle(300, 245, 270, 19));
        pnlPayBillHeader.add(contPayeeBank, new KDLayout.Constraints(300, 245, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contActFdcPayeeName.setBounds(new Rectangle(585, 220, 270, 19));
        pnlPayBillHeader.add(contActFdcPayeeName, new KDLayout.Constraints(585, 220, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPayerAccount.setBounds(new Rectangle(9, 245, 270, 19));
        pnlPayBillHeader.add(contPayerAccount, new KDLayout.Constraints(9, 245, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPayerBank.setBounds(new Rectangle(10, 220, 270, 19));
        pnlPayBillHeader.add(contPayerBank, new KDLayout.Constraints(10, 220, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDayaccount.setBounds(new Rectangle(585, 145, 270, 19));
        pnlPayBillHeader.add(contDayaccount, new KDLayout.Constraints(585, 145, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contConceit.setBounds(new Rectangle(585, 395, 270, 19));
        pnlPayBillHeader.add(contConceit, new KDLayout.Constraints(585, 395, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAccessoryAmt.setBounds(new Rectangle(10, 320, 268, 19));
        pnlPayBillHeader.add(contAccessoryAmt, new KDLayout.Constraints(10, 320, 268, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLocalAmt.setBounds(new Rectangle(300, 320, 270, 19));
        pnlPayBillHeader.add(contLocalAmt, new KDLayout.Constraints(300, 320, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAmount.setBounds(new Rectangle(300, 295, 270, 19));
        pnlPayBillHeader.add(contAmount, new KDLayout.Constraints(300, 295, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBillStatus.setBounds(new Rectangle(10, 85, 385, 19));
        pnlPayBillHeader.add(contBillStatus, new KDLayout.Constraints(10, 85, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSettlementNumber.setBounds(new Rectangle(300, 420, 270, 19));
        pnlPayBillHeader.add(contSettlementNumber, new KDLayout.Constraints(300, 420, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSettlementType.setBounds(new Rectangle(10, 420, 270, 19));
        pnlPayBillHeader.add(contSettlementType, new KDLayout.Constraints(10, 420, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contExchangeRate.setBounds(new Rectangle(585, 270, 270, 19));
        pnlPayBillHeader.add(contExchangeRate, new KDLayout.Constraints(585, 270, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contCurrency.setBounds(new Rectangle(585, 245, 270, 19));
        pnlPayBillHeader.add(contCurrency, new KDLayout.Constraints(585, 245, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSourceType.setBounds(new Rectangle(475, 35, 385, 19));
        pnlPayBillHeader.add(contSourceType, new KDLayout.Constraints(475, 35, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBizDate.setBounds(new Rectangle(300, 145, 270, 19));
        pnlPayBillHeader.add(contBizDate, new KDLayout.Constraints(300, 145, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(300, 120, 270, 19));
        pnlPayBillHeader.add(contNumber, new KDLayout.Constraints(300, 120, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contuseDepartment.setBounds(new Rectangle(585, 120, 270, 19));
        pnlPayBillHeader.add(contuseDepartment, new KDLayout.Constraints(585, 120, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contcapitalAmount.setBounds(new Rectangle(585, 320, 270, 19));
        pnlPayBillHeader.add(contcapitalAmount, new KDLayout.Constraints(585, 320, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contDescription.setBounds(new Rectangle(300, 345, 555, 19));
        pnlPayBillHeader.add(contDescription, new KDLayout.Constraints(300, 345, 555, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        btnInputCollect.setBounds(new Rectangle(585, 295, 100, 19));
        pnlPayBillHeader.add(btnInputCollect, new KDLayout.Constraints(585, 295, 100, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFdcPayeeName.setBounds(new Rectangle(300, 220, 270, 19));
        pnlPayBillHeader.add(contFdcPayeeName, new KDLayout.Constraints(300, 220, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPayerAccountBank.setBounds(new Rectangle(10, 195, 270, 19));
        pnlPayBillHeader.add(contPayerAccountBank, new KDLayout.Constraints(10, 195, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpaymentProportion.setBounds(new Rectangle(10, 345, 270, 19));
        pnlPayBillHeader.add(contpaymentProportion, new KDLayout.Constraints(10, 345, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcompletePrjAmt.setBounds(new Rectangle(10, 370, 270, 19));
        pnlPayBillHeader.add(contcompletePrjAmt, new KDLayout.Constraints(10, 370, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSettleBizType.setBounds(new Rectangle(10, 270, 270, 19));
        pnlPayBillHeader.add(contSettleBizType, new KDLayout.Constraints(10, 270, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFeeType.setBounds(new Rectangle(10, 170, 270, 19));
        pnlPayBillHeader.add(contFeeType, new KDLayout.Constraints(10, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(10, 120, 270, 19));
        pnlPayBillHeader.add(kDLabelContainer1, new KDLayout.Constraints(10, 120, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(10, 145, 270, 19));
        pnlPayBillHeader.add(kDLabelContainer2, new KDLayout.Constraints(10, 145, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer3.setBounds(new Rectangle(475, 60, 385, 19));
        pnlPayBillHeader.add(kDLabelContainer3, new KDLayout.Constraints(475, 60, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer4.setBounds(new Rectangle(10, 505, 846, 70));
        pnlPayBillHeader.add(kDLabelContainer4, new KDLayout.Constraints(10, 505, 846, 70, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer5.setBounds(new Rectangle(300, 170, 270, 19));
        pnlPayBillHeader.add(kDLabelContainer5, new KDLayout.Constraints(300, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer6.setBounds(new Rectangle(585, 170, 184, 19));
        pnlPayBillHeader.add(kDLabelContainer6, new KDLayout.Constraints(585, 170, 184, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer7.setBounds(new Rectangle(585, 195, 184, 19));
        pnlPayBillHeader.add(kDLabelContainer7, new KDLayout.Constraints(585, 195, 184, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer8.setBounds(new Rectangle(10, 295, 270, 19));
        pnlPayBillHeader.add(kDLabelContainer8, new KDLayout.Constraints(10, 295, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFpItem.setBounds(new Rectangle(300, 395, 270, 19));
        pnlPayBillHeader.add(contFpItem, new KDLayout.Constraints(300, 395, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contPayeeArea.setBounds(new Rectangle(689, 294, 164, 19));
        pnlPayBillHeader.add(contPayeeArea, new KDLayout.Constraints(689, 294, 164, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer9.setBounds(new Rectangle(300, 370, 555, 19));
        pnlPayBillHeader.add(kDLabelContainer9, new KDLayout.Constraints(300, 370, 555, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPayeeAccountBank2.setBounds(new Rectangle(300, 270, 270, 19));
        pnlPayBillHeader.add(contPayeeAccountBank2, new KDLayout.Constraints(300, 270, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer10.setBounds(new Rectangle(300, 195, 270, 19));
        pnlPayBillHeader.add(kDLabelContainer10, new KDLayout.Constraints(300, 195, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAllCompletePrjAmt.setBounds(new Rectangle(10, 445, 270, 19));
        pnlPayBillHeader.add(contAllCompletePrjAmt, new KDLayout.Constraints(10, 445, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contQualityGuarante.setBounds(new Rectangle(585, 420, 270, 19));
        pnlPayBillHeader.add(contQualityGuarante, new KDLayout.Constraints(585, 420, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAllInvoiceAmt.setBounds(new Rectangle(475, 85, 270, 19));
        pnlPayBillHeader.add(contAllInvoiceAmt, new KDLayout.Constraints(475, 85, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contInvoiceDate.setBounds(new Rectangle(585, 445, 270, 19));
        pnlPayBillHeader.add(contInvoiceDate, new KDLayout.Constraints(585, 445, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contInvoiceNumber.setBounds(new Rectangle(10, 470, 270, 19));
        pnlPayBillHeader.add(contInvoiceNumber, new KDLayout.Constraints(10, 470, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceAmt.setBounds(new Rectangle(585, 470, 270, 19));
        pnlPayBillHeader.add(contInvoiceAmt, new KDLayout.Constraints(585, 470, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAgentCompany.setBounds(new Rectangle(475, 7, 385, 19));
        pnlPayBillHeader.add(contAgentCompany, new KDLayout.Constraints(475, 7, 385, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPlanItem.setBounds(new Rectangle(10, 395, 270, 19));
        pnlPayBillHeader.add(contPlanItem, new KDLayout.Constraints(10, 395, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceOriAllAmt.setBounds(new Rectangle(300, 445, 270, 19));
        pnlPayBillHeader.add(contInvoiceOriAllAmt, new KDLayout.Constraints(300, 445, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceOriAmt.setBounds(new Rectangle(300, 470, 270, 19));
        pnlPayBillHeader.add(contInvoiceOriAmt, new KDLayout.Constraints(300, 470, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtrecCity.setBounds(new Rectangle(780, 170, 75, 19));
        pnlPayBillHeader.add(txtrecCity, new KDLayout.Constraints(780, 170, 75, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        difBank.setBounds(new Rectangle(780, 195, 75, 19));
        pnlPayBillHeader.add(difBank, new KDLayout.Constraints(780, 195, 75, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCompany
        ...
        //kDLabelContainer6
        kDLabelContainer6.setBoundEditor(prmtRecCountry);
        //kDLabelContainer7
        ...
        //contInvoiceOriAllAmt
        contInvoiceOriAllAmt.setBoundEditor(txtInvoiceOriAllAmt);
        //contInvoiceOriAmt
...
pnlPayBillMaterial.setLayout(new BorderLayout(0, 0));        pnlPayBillMaterial.add(tblMaterial, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("FRecCountry", com.kingdee.eas.basedata.assistant.CountryInfo.class, this.prmtRecCountry, "data");
...
//        sic.add(new SelectorItemInfo("entries.number"));
    ...
    protected class ActionViewContract extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPaymentBillEditUI.this, "ActionViewContract", "actionViewContract_actionPerformed", e);
        }
    }
