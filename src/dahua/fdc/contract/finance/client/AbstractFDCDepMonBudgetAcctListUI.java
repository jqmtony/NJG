 ...
 * output class name
 */
public abstract class AbstractFDCDepMonBudgetAcctListUI extends com.kingdee.eas.fdc.finance.client.FDCBudgetAcctListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCDepMonBudgetAcctListUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCDepMonBudgetAcctListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCDepMonBudgetAcctListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.finance.app", "FDCDepMonBudgetAcctQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","state","number","verNumber","period","curProject.name","orgUnit.name","deptment.name","creator.name","createTime","auditor.name","auditTime","orgUnit.id","curProject.id","fdcPeriod.id"});
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCDepMonBudgetAcctListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCDepMonBudgetAcctListUI");
    }
    /**
