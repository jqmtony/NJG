...
//		
	...
	/**
	 * @see com.kingdee.eas.fdc.finance.client.AbstractDeductBillListUI#actionRemove_actionPerformed(java.awt.event.ActionEvent)
	 */
	public void actionRemove_actionPerformed(ActionEvent e) throws Exception {
	
		FilterInfo filter = new FilterInfo();
		filter.appendFilterItem("id", getSelectedKeyValue());
