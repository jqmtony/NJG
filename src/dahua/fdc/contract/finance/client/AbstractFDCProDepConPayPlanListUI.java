...
public abstract class AbstractFDCProDepConPayPlanListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    ...
    { 
        ...
        sorterFieldList.add("sort1"); 
        sorterFieldList.add("sort2"); 
        sorterFieldList.add("number"); 
        sorterFieldList.add("version"); 
    ...
    {
        return new String[] {"id","curProject.name","number","name","state","payPlanCycle.cycle","version","creator.name","creator.createTime","auditor.name","auditor.createTime"};
    }
