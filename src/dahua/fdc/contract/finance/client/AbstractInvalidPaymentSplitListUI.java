 ...
 * output class name
 */
public abstract class AbstractInvalidPaymentSplitListUI extends com.kingdee.eas.fdc.basedata.client.ProjectTreeListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInvalidPaymentSplitListUI.class);
    /**
     * output class constructor
     */
    public AbstractInvalidPaymentSplitListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInvalidPaymentSplitListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.finance.app", "InvalidPaymentSplitQuery");
        // CoreUI		
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"contractBill.isCostSplit","costSplit.splitState","billStatus","costSplit.Fivouchered","costSplit.id","number","fdcPayReqNumber","contractBill.number","contractBill.name","currency.name","amount","exchangeRate","localAmt","payDate","costCreator.name","costSplit.createTime","fdcPayeeName.name","actFdcPayeeName.name","summary","payeeBank","payeeAccountBank","costAuditor.name","costSplit.auditTime","costSplit.state","costSplit.lastUpdateTime","curProject.id","contractId","id"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.InvalidPaymentSplitListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "InvalidPaymentSplitListUI");
    }
