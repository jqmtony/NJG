 ...
 * output class name
 */
public abstract class AbstractFDCDepMonBudgetAcctEditUI extends com.kingdee.eas.fdc.finance.client.FDCBudgetAcctEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCDepMonBudgetAcctEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contDeptment;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtDeptment;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem menuItemLocate;
    protected com.kingdee.eas.fdc.finance.FDCDepMonBudgetAcctInfo editData = null;
    protected ActionLocate actionLocate = null;
    /**
     * output class constructor
     */
    public AbstractFDCDepMonBudgetAcctEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCDepMonBudgetAcctEditUI.class.getName());
        ...
        this.txtDeptment = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.menuItemLocate = new com.kingdee.bos.ctrl.swing.KDMenuItem();
        this.contDeptment.setName("contDeptment");
        this.txtDeptment.setName("txtDeptment");
        this.menuItemLocate.setName("menuItemLocate");
        // CoreUI		
        ...
        this.contDeptment.setEnabled(false);		
        this.contDeptment.setBoundLabelUnderline(true);
        // txtDeptment		
        this.txtDeptment.setEnabled(false);
        // menuItemLocate
    ...
    public void initUIContentLayout()
    {
        ...
        contVerNumber.setBounds(new Rectangle(369, 38, 270, 19));
        this.add(contVerNumber, new KDLayout.Constraints(369, 38, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contProject.setBounds(new Rectangle(21, 12, 270, 19));
        this.add(contProject, new KDLayout.Constraints(21, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        panel.setBounds(new Rectangle(369, 12, 270, 28));
        this.add(panel, new KDLayout.Constraints(369, 12, 270, 28, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDeptment.setBounds(new Rectangle(718, 12, 270, 19));
        this.add(contDeptment, new KDLayout.Constraints(718, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contNumber
        ...
        //contDeptment
        contDeptment.setBoundEditor(txtDeptment);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCDepMonBudgetAcctEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.FDCDepMonBudgetAcctInfo)ov;
    }
    ...
    protected class ActionLocate extends ItemAction
    {
        ...
        public ActionLocate(IUIObject uiObject)
        {
            super(uiObject);
            String _tempStr = null;
            this.putValue(ItemAction.ACCELERATOR_KEY, KeyStroke.getKeyStroke("F6"));
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFDCDepMonBudgetAcctEditUI.this, "ActionLocate", "actionLocate_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCDepMonBudgetAcctEditUI");
    }
    /**
