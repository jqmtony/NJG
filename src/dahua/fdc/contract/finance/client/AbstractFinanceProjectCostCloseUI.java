 ...
 * output class name
 */
public abstract class AbstractFinanceProjectCostCloseUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFinanceProjectCostCloseUI.class);
    ...
    protected AcionAddAll acionAddAll = null;
    protected AcionDelAll acionDelAll = null;
    /**
     * output class constructor
     */
    public AbstractFinanceProjectCostCloseUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFinanceProjectCostCloseUI.class.getName());
        ...
        //acionAddAll
        this.acionAddAll = new AcionAddAll(this);
        getActionManager().registerAction("acionAddAll", acionAddAll);
         this.acionAddAll.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        //acionDelAll
        this.acionDelAll = new AcionDelAll(this);
        getActionManager().registerAction("acionDelAll", acionDelAll);
         this.acionDelAll.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        ...
        // btnAddall
        this.btnAddall.setAction((IItemAction)ActionProxyFactory.getProxy(acionAddAll, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnAddall.setText(resHelper.getString("btnAddall.text"));
        // btnDelAll
        this.btnDelAll.setAction((IItemAction)ActionProxyFactory.getProxy(acionDelAll, new Class[] { IItemAction.class }, getServiceContext()));		
    ...
    public void initUIContentLayout()
    {
        ...
        btnDelAll.setBounds(new Rectangle(15, 235, 26, 19));
        pnlSelect.add(btnDelAll, new KDLayout.Constraints(15, 235, 26, 19, 0));
        //pnlOperation
        ...
        //pnlResult
        pnlResult.setLayout(null);        labelResult.setBounds(new Rectangle(0, 37, 68, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FinanceProjectCostCloseUIHandler";
	}
    ...
    /**
     * output acionAddAll_actionPerformed method
     */
    public void acionAddAll_actionPerformed(ActionEvent e) throws Exception
    {
    }
    	

    /**
     * output acionDelAll_actionPerformed method
     */
    public void acionDelAll_actionPerformed(ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionAdd extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "ActionAdd", "actionAdd_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelete extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "ActionDelete", "actionDelete_actionPerformed", e);
        }
    }
    ...
    protected class ActionConfirm extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }

    /**
     * output AcionAddAll class
     */
    protected class AcionAddAll extends ItemAction
    {
        public AcionAddAll()
        {
            this(null);
        ...
        public AcionAddAll(IUIObject uiObject)
        {
            super(uiObject);
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("AcionAddAll.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("AcionAddAll.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("AcionAddAll.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "AcionAddAll", "acionAddAll_actionPerformed", e);
        }
    }

    /**
     * output AcionDelAll class
     */
    protected class AcionDelAll extends ItemAction
    {
        public AcionDelAll()
        {
            this(null);
        ...
        public AcionDelAll(IUIObject uiObject)
        {
            super(uiObject);
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("AcionDelAll.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("AcionDelAll.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("AcionDelAll.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFinanceProjectCostCloseUI.this, "AcionDelAll", "acionDelAll_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FinanceProjectCostCloseUI");
    }
