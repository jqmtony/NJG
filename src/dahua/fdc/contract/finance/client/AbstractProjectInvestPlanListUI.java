 ...
 * output class name
 */
public abstract class AbstractProjectInvestPlanListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectInvestPlanListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDSplitPane kDSplitPane1;
    protected com.kingdee.bos.ctrl.swing.KDContainer conProjectTree;
     ...
     */
    public AbstractProjectInvestPlanListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectInvestPlanListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.finance.app", "ProjectInvestPlanQuery");
        //actionAudit
        ...
        this.conProjectTree = new com.kingdee.bos.ctrl.swing.KDContainer();
        ...
        this.conProjectTree.setName("conProjectTree");
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"project.name","number","name","versionNumber","state","startDate","endDate","createTime","creator.name","auditTime","auditor.name","id"});


        // kDSplitPane1
        // conProjectTree		
        this.conProjectTree.setTitle(resHelper.getString("conProjectTree.title"));
        // projectTree
        ...
        this.btnRecension.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_creat"));		
        this.btnRecension.setToolTipText(resHelper.getString("btnRecension.toolTipText"));
        // btnPublish
        ...
        this.btnPublish.setToolTipText(resHelper.getString("btnPublish.toolTipText"));		
        this.btnPublish.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_timingrefer"));
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(2, 1, 1011, 624));
        this.add(kDSplitPane1, new KDLayout.Constraints(2, 1, 1011, 624, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
        kDSplitPane1.add(tblMain, "right");
        kDSplitPane1.add(conProjectTree, "left");
        //conProjectTree
conProjectTree.getContentPane().setLayout(new BorderLayout(0, 0));        conProjectTree.getContentPane().add(projectTree, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProjectInvestPlanListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectInvestPlanListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectInvestPlanListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionPublish extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectInvestPlanListUI.this, "ActionPublish", "actionPublish_actionPerformed", e);
        }
    }
    ...
    protected class ActionRecension extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectInvestPlanListUI.this, "ActionRecension", "actionRecension_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ProjectInvestPlanListUI");
    }
