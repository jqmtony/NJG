 ...
 * output class name
 */
public class FDCCostCloseRptUI extends AbstractFDCCostCloseRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(FDCCostCloseRptUI.class);
    

    public FDCCostCloseRptUI() throws Exception
    {
        super();
    }
