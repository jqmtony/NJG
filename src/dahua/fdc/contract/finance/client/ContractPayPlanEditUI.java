...
//    	editdata.setPayDate(new Date());
	...
	public void onLoad() throws Exception {
		...
		txtContractAmount.setHorizontalAlignment(JTextField.RIGHT);
		txtContractAmount.setPrecision(2);
		txtContractAmount.setRemoveingZeroInDispaly(false);
		this.txtContractAmount.setValue(lastAmount.setScale(2, BigDecimal.ROUND_HALF_UP));
		ContractPayPlanHandler.fillTable(contract.getId().toString(),
				this.tblPayPlan);
		initControl();
