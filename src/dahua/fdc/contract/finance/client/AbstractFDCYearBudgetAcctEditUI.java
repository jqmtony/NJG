 ...
 * output class name
 */
public abstract class AbstractFDCYearBudgetAcctEditUI extends com.kingdee.eas.fdc.finance.client.FDCBudgetAcctEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCYearBudgetAcctEditUI.class);
    protected com.kingdee.eas.fdc.finance.FDCYearBudgetAcctInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractFDCYearBudgetAcctEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCYearBudgetAcctEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        //panel
        panel.setLayout(null);        spYear.setBounds(new Rectangle(0, 1, 79, 19));
        panel.add(spYear, null);
        spMonth.setBounds(new Rectangle(113, 1, 55, 19));
        panel.add(spMonth, null);
        lbMonth.setBounds(new Rectangle(173, 1, 24, 19));
        panel.add(lbMonth, null);
        lbYear.setBounds(new Rectangle(84, 1, 18, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCYearBudgetAcctEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.finance.FDCYearBudgetAcctInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCYearBudgetAcctEditUI");
    }
    /**
