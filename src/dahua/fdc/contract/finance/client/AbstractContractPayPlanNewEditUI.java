...
public abstract class AbstractContractPayPlanNewEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        // kdtPayByStages		
        this.kdtPayByStages.setFormatXml(resHelper.getString("kdtPayByStages.formatXml"));
        ...
        // kdtPlanMingxi		
        this.kdtPlanMingxi.setFormatXml(resHelper.getString("kdtPlanMingxi.formatXml"));
        ...
        // kdtPlam		
        this.kdtPlam.setFormatXml(resHelper.getString("kdtPlam.formatXml"));
