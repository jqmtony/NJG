 ...
 * output class name
 */
public abstract class AbstractFDCFinanceCostCloseRptUI extends com.kingdee.eas.fdc.finance.client.FDCCostCloseBaseRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCFinanceCostCloseRptUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCFinanceCostCloseRptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCFinanceCostCloseRptUI.class.getName());
...
ctnCostClose.getContentPane().setLayout(new BorderLayout(0, 0));        ctnCostClose.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCFinanceCostCloseRptUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCFinanceCostCloseRptUI");
    }
