 ...
 * output class name
 */
public abstract class AbstractFIProductSettleBillListUI extends com.kingdee.eas.fdc.finance.client.ProductSettleBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFIProductSettleBillListUI.class);
    /**
     * output class constructor
     */
    public AbstractFIProductSettleBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFIProductSettleBillListUI.class.getName());
        ...
        this.tblBill.setFormatXml(resHelper.getString("tblBill.formatXml"));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FIProductSettleBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FIProductSettleBillListUI");
    }
