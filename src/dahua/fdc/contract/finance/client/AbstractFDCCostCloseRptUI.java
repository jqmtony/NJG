 ...
 * output class name
 */
public abstract class AbstractFDCCostCloseRptUI extends com.kingdee.eas.fdc.finance.client.FDCCostCloseBaseRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCCostCloseRptUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCCostCloseRptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCCostCloseRptUI.class.getName());
...
ctnCostClose.getContentPane().setLayout(new BorderLayout(0, 0));        ctnCostClose.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.FDCCostCloseRptUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "FDCCostCloseRptUI");
    }
