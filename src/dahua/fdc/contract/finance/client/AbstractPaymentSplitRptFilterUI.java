 ...
 * output class name
 */
public abstract class AbstractPaymentSplitRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPaymentSplitRptFilterUI.class);
     ...
     */
    public AbstractPaymentSplitRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPaymentSplitRptFilterUI.class.getName());
        ...
        this.chkPeriod.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent e) {
                try {
                    chkPeriod_stateChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        this.chkPeriod.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent e) {
                try {
                    chkPeriod_mouseClicked(e);
                } catch(Exception exc) {
                    handUIException(exc);
                }
            }
    ...
    public void initUIContentLayout()
    {
        ...
        chkPeriod.setBounds(new Rectangle(10, 189, 140, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.PaymentSplitRptFilterUIHandler";
	}
    ...
    /**
     * output chkPeriod_mouseClicked method
     */
    protected void chkPeriod_mouseClicked(java.awt.event.MouseEvent e) throws Exception
    {
    }

    /**
     * output chkPeriod_stateChanged method
     */
    protected void chkPeriod_stateChanged(javax.swing.event.ChangeEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "PaymentSplitRptFilterUI");
    }
