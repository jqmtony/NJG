...
protected void _Audit(Context ctx, BOSUuid model) throws BOSException {//审核
...
//			info.setAuditor(ContextUtil.getCurrentUserInfo(ctx));//审批人
    ...
    protected void _UnAudit(Context ctx, BOSUuid model) throws BOSException {//反审核
...
//			info.setAuditor(ContextUtil.getCurrentUserInfo(ctx));//审批人
    ...
    protected void _InTrial(Context ctx, BOSUuid model) throws BOSException {//送审
...
//    	super._InTrial(ctx, model);
    ...
    protected void _Approved(Context ctx, BOSUuid model) throws BOSException {//审定
