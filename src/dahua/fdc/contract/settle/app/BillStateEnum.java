...
{
    public static final int ADDNEW_VALUE = 10;
    public static final int SAVE_VALUE = 20;
    public static final int SUBMIT_VALUE = 30;
    public static final int AUDIT_VALUE = 40;
    public static final int UNAUDIT_VALUE = 50;
    public static final int EXPIREINVALID_VALUE = 60;
    public static final int TEMPORARILYSAVED_VALUE = 15;
