...
public class SettleDeclarationBillEntry3 extends CoreBillEntryBase implements ISettleDeclarationBillEntry3
{
    public SettleDeclarationBillEntry3()
    {
        super();
        registerInterface(ISettleDeclarationBillEntry3.class, this);
    }
    public SettleDeclarationBillEntry3(Context ctx)
    {
        super(ctx);
        registerInterface(ISettleDeclarationBillEntry3.class, this);
    }
    ...
    private SettleDeclarationBillEntry3Controller getController() throws BOSException
    {
        return (SettleDeclarationBillEntry3Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleDeclarationBillEntry3Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
