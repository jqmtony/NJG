 ...
 * output class name
 */
public abstract class AbstractMarketInfoListUI extends com.kingdee.eas.framework.client.TreeDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketInfoListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnViewContent;
    protected ActionViewContent actionViewContent = null;
    /**
     * output class constructor
     */
    public AbstractMarketInfoListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketInfoListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.costdb.app", "MarketInfoQuery");
        //actionViewContent
        ...
        this.tblMain.setPreferredSize(new Dimension(488,585));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","createTime","creator.name","number","personName","org.id","org.name","name","type.name","isGroupFile","lastUpdateUser.name","lastUpdateTime","type.id"});
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.costdb.app.MarketInfoListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("org.id"));
    ...
    protected class ActionViewContent extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMarketInfoListUI.this, "ActionViewContent", "actionViewContent_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.costdb.client", "MarketInfoListUI");
    }
