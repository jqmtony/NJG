 ...
 * output class name
 */
public abstract class AbstractXRDataBaseListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractXRDataBaseListUI.class);
    /**
     * output class constructor
     */
    public AbstractXRDataBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractXRDataBaseListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.xr.xrbase.app.XRDataBaseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.xr.xrbase.client", "XRDataBaseListUI");
    }
