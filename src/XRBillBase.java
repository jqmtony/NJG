...
public class XRBillBase extends CoreBillBase implements IXRBillBase
{
    public XRBillBase()
    {
        super();
        registerInterface(IXRBillBase.class, this);
    }
    public XRBillBase(Context ctx)
    {
        super(ctx);
        registerInterface(IXRBillBase.class, this);
    }
    ...
    private XRBillBaseController getController() throws BOSException
    {
        return (XRBillBaseController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getXRBillBaseInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXRBillBaseInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXRBillBaseInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXRBillBaseCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXRBillBaseCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getXRBillBaseCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
