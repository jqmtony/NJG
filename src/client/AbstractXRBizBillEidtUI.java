 ...
 * output class name
 */
public abstract class AbstractXRBizBillEidtUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractXRBizBillEidtUI.class);
    ...
    protected com.kingdee.eas.xr.XRBizBillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractXRBizBillEidtUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractXRBizBillEidtUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contStatus.setBounds(new Rectangle(10, 220, 270, 19));
        this.add(contStatus, null);
        contBizStatus.setBounds(new Rectangle(300, 220, 270, 19));
        this.add(contBizStatus, null);
        //contId
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.xr.app.XRBizBillEidtUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.xr.XRBizBillInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.xr.client", "XRBizBillEidtUI");
    }
