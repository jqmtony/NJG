 ...
 * output class name
 */
public class ApproveBackSetListUI extends AbstractApproveBackSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ApproveBackSetListUI.class);
    
    /**
     * output class constructor
     */
    public ApproveBackSetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.bpm.client.ApproveBackSetTreeEditUI.class.getName();
    }
