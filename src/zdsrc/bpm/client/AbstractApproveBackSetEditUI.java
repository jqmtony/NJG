 ...
 * output package name
 */
package com.kingdee.eas.bpm.client;
 ...
 * output class name
 */
public abstract class AbstractApproveBackSetEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractApproveBackSetEditUI.class);
     ...
     */
    public AbstractApproveBackSetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractApproveBackSetEditUI.class.getName());
        ...
        KDTextField kdtEntry_field_TextField = new KDTextField();
        kdtEntry_field_TextField.setName("kdtEntry_field_TextField");
        kdtEntry_field_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntry_field_CellEditor = new KDTDefaultCellEditor(kdtEntry_field_TextField);
        this.kdtEntry.getColumn("field").setEditor(kdtEntry_field_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(423, 14, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(44, 36, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(423, 36, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.bpm.ApproveBackSetEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("Entry.field", String.class, this.kdtEntry, "field.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.bpm.app.ApproveBackSetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.bpm.ApproveBackSetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entry.field", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("Entry.field"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.bpm.client", "ApproveBackSetEditUI");
    }
    ...
    {
        return com.kingdee.eas.bpm.client.ApproveBackSetEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.bpm.ApproveBackSetFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.bpm.ApproveBackSetInfo objectValue = new com.kingdee.eas.bpm.ApproveBackSetInfo();
