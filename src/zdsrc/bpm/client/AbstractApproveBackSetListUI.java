 ...
 * output class name
 */
public abstract class AbstractApproveBackSetListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractApproveBackSetListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractApproveBackSetListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractApproveBackSetListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.bpm.app.ApproveBackSetListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.bpm.client", "ApproveBackSetListUI");
    }
