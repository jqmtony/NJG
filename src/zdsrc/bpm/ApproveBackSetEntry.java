...
public class ApproveBackSetEntry extends CoreBillEntryBase implements IApproveBackSetEntry
{
    public ApproveBackSetEntry()
    {
        super();
        registerInterface(IApproveBackSetEntry.class, this);
    }
    public ApproveBackSetEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IApproveBackSetEntry.class, this);
    }
    ...
    private ApproveBackSetEntryController getController() throws BOSException
    {
        return (ApproveBackSetEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getApproveBackSetEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getApproveBackSetEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getApproveBackSetEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getApproveBackSetEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getApproveBackSetEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getApproveBackSetEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
