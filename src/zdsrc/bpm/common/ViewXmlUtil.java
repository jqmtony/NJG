...
public class ViewXmlUtil {
	...
	public static String[] getHTBAIlViewXmlString(Context ctx,String BTID,String BOID){
		String[] str = new String[3];
		str[0] = "Y";
		str[1] = "成功！";
		PzViewInfo info = null;
	...
	public static String[] getHTPAYViewXmlString(Context ctx,String BTID,String BOID){
		String[] str = new String[3];
		str[0] = "Y";
		str[1] = "成功！";
		PzViewInfo info = null;
