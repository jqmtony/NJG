 ...
 * output class name
 */
public class ChangeVisaAppListUI extends AbstractChangeVisaAppListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChangeVisaAppListUI.class);
    
    /**
     * output class constructor
     */
    public ChangeVisaAppListUI() throws Exception
    {
        super();
    }
