 ...
 * output class name
 */
public class ContractsettlementListUI extends AbstractContractsettlementListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractsettlementListUI.class);
    
    /**
     * output class constructor
     */
    public ContractsettlementListUI() throws Exception
    {
        super();
    }
