 ...
 * output class name
 */
public class ContractsettlementEditUI extends AbstractContractsettlementEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractsettlementEditUI.class);
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        objectValue.setOrgunit(SysContext.getSysContext().getCurrentAdminUnit().getDisplayName());
        objectValue.setCurProject(SysContext.getSysContext().getCurrentAdminUnit().getName());
    ...
    {
    	editData = ContractsettlementFactory.getRemoteInstance().getContractsettlementInfo(new ObjectUuidPK(editData.getId()));
