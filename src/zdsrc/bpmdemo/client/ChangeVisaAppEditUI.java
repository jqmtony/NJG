 ...
 * output class name
 */
public class ChangeVisaAppEditUI extends AbstractChangeVisaAppEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChangeVisaAppEditUI.class);
    
    /**
     * output class constructor
     */
    public ChangeVisaAppEditUI() throws Exception
    {
        super();
    }
