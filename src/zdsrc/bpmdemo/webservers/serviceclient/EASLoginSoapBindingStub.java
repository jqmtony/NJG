...
public class EASLoginSoapBindingStub extends org.apache.axis.client.Stub implements com.kingdee.eas.bpmdemo.webservers.serviceclient.EASLoginProxy {
    ...
    static {
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "slnName"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "dcName"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "language"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "dbType"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("urn:client", "WSContext"));
        oper.setReturnClass(com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext.class);
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "language"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "dbType"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "authPattern"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("urn:client", "WSContext"));
        oper.setReturnClass(com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "loginReturn"));
        _operations[1] = oper;
        ...
        oper.addParameter(new javax.xml.namespace.QName("", "dbType"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "authPattern"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.addParameter(new javax.xml.namespace.QName("", "isEncodePwd"), new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("urn:client", "WSContext"));
        oper.setReturnClass(com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "loginReturn"));
        _operations[2] = oper;
    ...
    public EASLoginSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            cls = com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext.class;
    ...
    public com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext login(java.lang.String userName, java.lang.String password, java.lang.String slnName, java.lang.String dcName, java.lang.String language, int dbType) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext) org.apache.axis.utils.JavaUtils.convert(_resp, com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext.class);
            }
        }
    }
    ...
    public com.kingdee.eas.bpmdemo.webservers.serviceclient.WSContext login(java.lang.String userName, java.lang.String password, java.lang.String slnName, java.lang.String dcName, java.lang.String language, int dbType, java.lang.String authPattern, int isEncodePwd) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {userName, password, slnName, dcName, language, new java.lang.Integer(dbType), authPattern, new java.lang.Integer(isEncodePwd)});
    ...
    public boolean logout(java.lang.String userName, java.lang.String slnName, java.lang.String dcName, java.lang.String language) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {userName, slnName, dcName, language});
