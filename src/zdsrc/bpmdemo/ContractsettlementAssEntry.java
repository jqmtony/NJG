...
public class ContractsettlementAssEntry extends CoreBillEntryBase implements IContractsettlementAssEntry
{
    public ContractsettlementAssEntry()
    {
        super();
        registerInterface(IContractsettlementAssEntry.class, this);
    }
    public ContractsettlementAssEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractsettlementAssEntry.class, this);
    }
    ...
    private ContractsettlementAssEntryController getController() throws BOSException
    {
        return (ContractsettlementAssEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractsettlementAssEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractsettlementAssEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractsettlementAssEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractsettlementAssEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractsettlementAssEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractsettlementAssEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
