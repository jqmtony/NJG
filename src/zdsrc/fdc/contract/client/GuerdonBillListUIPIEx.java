...
public class GuerdonBillListUIPIEx extends GuerdonBillListUI{

	public GuerdonBillListUIPIEx() throws Exception {
		super();
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		if(info.getId()!=null){
			...
			if("审批中".equals(info.getState().getAlias()) && ("".equals(info.getState().getAlias())||info.getDescription()==null))
			{
