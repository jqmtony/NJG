...
public abstract class AbstractPayRequestBillEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        // kDPanel1		
        this.kDPanel1.setPreferredSize(new Dimension(1013,550));
        // contBgEntry
        // kdtEntrys
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator6.setBounds(new Rectangle(11, 56, 995, 10));
        this.add(kDSeparator6, new KDLayout.Constraints(11, 56, 995, 10, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contDescription.setBounds(new Rectangle(12, 128, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(12, 128, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contuseDepartment.setBounds(new Rectangle(533, 32, 470, 19));
        this.add(contuseDepartment, new KDLayout.Constraints(533, 32, 470, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contpayDate.setBounds(new Rectangle(730, 62, 270, 19));
        this.add(contpayDate, new KDLayout.Constraints(730, 62, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contrecBank.setBounds(new Rectangle(730, 106, 270, 19));
        this.add(contrecBank, new KDLayout.Constraints(730, 106, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contrecAccount.setBounds(new Rectangle(730, 128, 270, 19));
        this.add(contrecAccount, new KDLayout.Constraints(730, 128, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contcontractNo.setBounds(new Rectangle(12, 32, 470, 19));
        this.add(contcontractNo, new KDLayout.Constraints(12, 32, 470, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contattachment.setBounds(new Rectangle(509, 304, 140, 19));
        this.add(contattachment, new KDLayout.Constraints(509, 304, 140, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcurrency.setBounds(new Rectangle(380, 150, 270, 19));
        this.add(contcurrency, new KDLayout.Constraints(380, 150, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contexchangeRate.setBounds(new Rectangle(730, 150, 270, 19));
        this.add(contexchangeRate, new KDLayout.Constraints(730, 150, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBcAmount.setBounds(new Rectangle(380, 194, 270, 19));
        this.add(contBcAmount, new KDLayout.Constraints(380, 194, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsupplier.setBounds(new Rectangle(380, 106, 270, 19));
        this.add(contsupplier, new KDLayout.Constraints(380, 106, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsettlementType.setBounds(new Rectangle(12, 106, 270, 19));
        this.add(contsettlementType, new KDLayout.Constraints(12, 106, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAmount.setBounds(new Rectangle(380, 172, 270, 19));
        this.add(contAmount, new KDLayout.Constraints(380, 172, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnInputCollect.setBounds(new Rectangle(730, 172, 98, 21));
        this.add(btnInputCollect, new KDLayout.Constraints(730, 172, 98, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPayment.setBounds(new Rectangle(380, 84, 270, 19));
        this.add(contPayment, new KDLayout.Constraints(380, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpaymentRequestBillNumber.setBounds(new Rectangle(380, 62, 270, 19));
        this.add(contpaymentRequestBillNumber, new KDLayout.Constraints(380, 62, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcapitalAmount.setBounds(new Rectangle(380, 216, 270, 19));
        this.add(contcapitalAmount, new KDLayout.Constraints(380, 216, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contrealSupplier.setBounds(new Rectangle(380, 128, 270, 19));
        this.add(contrealSupplier, new KDLayout.Constraints(380, 128, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpaymentProportion.setBounds(new Rectangle(12, 172, 270, 19));
        this.add(contpaymentProportion, new KDLayout.Constraints(12, 172, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcompletePrjAmt.setBounds(new Rectangle(12, 194, 270, 19));
        this.add(contcompletePrjAmt, new KDLayout.Constraints(12, 194, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contGrtAmount.setBounds(new Rectangle(730, 194, 270, 19));
        this.add(contGrtAmount, new KDLayout.Constraints(730, 194, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDLabelContainer2.setBounds(new Rectangle(12, 84, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(12, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkIsPay.setBounds(new Rectangle(920, 216, 80, 19));
        this.add(chkIsPay, new KDLayout.Constraints(920, 216, 80, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer3.setBounds(new Rectangle(12, 326, 987, 47));
        this.add(kDLabelContainer3, new KDLayout.Constraints(12, 326, 987, 47, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer4.setBounds(new Rectangle(730, 216, 157, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(730, 216, 157, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer5.setBounds(new Rectangle(731, 84, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(731, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer6.setBounds(new Rectangle(12, 150, 270, 19));
        this.add(kDLabelContainer6, new KDLayout.Constraints(12, 150, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer7.setBounds(new Rectangle(12, 216, 270, 19));
        this.add(kDLabelContainer7, new KDLayout.Constraints(12, 216, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceNumber.setBounds(new Rectangle(12, 238, 270, 19));
        this.add(contInvoiceNumber, new KDLayout.Constraints(12, 238, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contInvoiceAmt.setBounds(new Rectangle(730, 238, 270, 19));
        this.add(contInvoiceAmt, new KDLayout.Constraints(730, 238, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAllInvoiceAmt.setBounds(new Rectangle(12, 282, 270, 19));
        this.add(contAllInvoiceAmt, new KDLayout.Constraints(12, 282, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAllCompletePrjAmt.setBounds(new Rectangle(380, 260, 270, 19));
        this.add(contAllCompletePrjAmt, new KDLayout.Constraints(380, 260, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAllPaymentProportion.setBounds(new Rectangle(730, 260, 270, 19));
        this.add(contAllPaymentProportion, new KDLayout.Constraints(730, 260, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contInvoiceDate.setBounds(new Rectangle(12, 260, 270, 19));
        this.add(contInvoiceDate, new KDLayout.Constraints(12, 260, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        lblAttachmentContainer.setBounds(new Rectangle(12, 304, 270, 19));
        this.add(lblAttachmentContainer, new KDLayout.Constraints(12, 304, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnViewAttachment.setBounds(new Rectangle(379, 304, 98, 21));
        this.add(btnViewAttachment, new KDLayout.Constraints(379, 304, 98, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contProcess.setBounds(new Rectangle(730, 304, 270, 19));
        this.add(contProcess, new KDLayout.Constraints(730, 304, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPlanHasCon.setBounds(new Rectangle(380, 282, 270, 19));
        this.add(contPlanHasCon, new KDLayout.Constraints(380, 282, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnViewBudget.setBounds(new Rectangle(909, 282, 100, 21));
        this.add(btnViewBudget, new KDLayout.Constraints(909, 282, 100, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contPlanUnCon.setBounds(new Rectangle(380, 282, 270, 19));
        this.add(contPlanUnCon, new KDLayout.Constraints(380, 282, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        txtAllInvoiceAmt.setBounds(new Rectangle(658, 304, 65, 19));
        this.add(txtAllInvoiceAmt, new KDLayout.Constraints(658, 304, 65, 19, 0));
        contInvoiceOriAmt.setBounds(new Rectangle(380, 238, 270, 19));
        this.add(contInvoiceOriAmt, new KDLayout.Constraints(380, 238, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdLplanState.setBounds(new Rectangle(730, 282, 167, 19));
        this.add(kdLplanState, new KDLayout.Constraints(730, 282, 167, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDScrollPane1.setBounds(new Rectangle(3, 401, 1005, 401));
        this.add(kDScrollPane1, new KDLayout.Constraints(3, 401, 1005, 401, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCostedCompany.setBounds(new Rectangle(12, 376, 270, 19));
        this.add(contCostedCompany, new KDLayout.Constraints(12, 376, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCostedDept.setBounds(new Rectangle(380, 376, 270, 19));
        this.add(contCostedDept, new KDLayout.Constraints(380, 376, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contDescription
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1013, 550));        contBgEntry.setBounds(new Rectangle(6, 6, 989, 142));
        kDPanel1.add(contBgEntry, new KDLayout.Constraints(6, 6, 989, 142, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(5, 152, 993, 183));
        kDPanel1.add(kdtEntrys, new KDLayout.Constraints(5, 152, 993, 183, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCreator.setBounds(new Rectangle(6, 345, 470, 19));
        kDPanel1.add(contCreator, new KDLayout.Constraints(6, 345, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(6, 367, 470, 19));
        kDPanel1.add(contAuditor, new KDLayout.Constraints(6, 367, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(527, 345, 470, 19));
        kDPanel1.add(contCreateTime, new KDLayout.Constraints(527, 345, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contauditDate.setBounds(new Rectangle(527, 367, 470, 19));
        kDPanel1.add(contauditDate, new KDLayout.Constraints(527, 367, 470, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contBgEntry
