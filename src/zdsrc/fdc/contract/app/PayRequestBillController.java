...
public interface PayRequestBillController extends FDCBillController
{
    ...
    public BigDecimal getLocalBudget(Context ctx, PayRequestBillInfo payRequestBill) throws BOSException, EASBizException, RemoteException;
    public BigDecimal getActPaied(Context ctx, PayRequestBillInfo payRequestBill) throws BOSException, EASBizException, RemoteException;
    public BigDecimal getFloatFund(Context ctx, PayRequestBillInfo payRequestBill) throws BOSException, EASBizException, RemoteException;
    public BigDecimal getBgBalance(Context ctx, PayRequestBillInfo payRequestBill) throws BOSException, EASBizException, RemoteException;
}