...
public class PurOrderEntry extends CoreBillEntryBase implements IPurOrderEntry
{
     ...
     *@return
     */
    public IObjectPK addnew(PurOrderEntryInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, PurOrderEntryInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void update(IObjectPK pk, PurOrderEntryInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector selector
     */
    public void updatePartial(PurOrderEntryInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void updateBigObject(IObjectPK pk, PurOrderEntryInfo model) throws BOSException
    {
        try {
