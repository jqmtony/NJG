 ...
 * output class name
 */
public class PurOrderListUI extends AbstractPurOrderListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurOrderListUI.class);
    
    /**
     * output class constructor
     */
    public PurOrderListUI() throws Exception
    {
        super();
    }
