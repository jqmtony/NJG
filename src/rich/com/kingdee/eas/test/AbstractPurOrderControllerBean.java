...
public abstract class AbstractPurOrderControllerBean extends CoreBillBaseControllerBean implements PurOrderController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("6e61157e-d336-47dd-9437-b59486f38c24"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f9277aec-ea23-4a7c-a9e9-7b5929e51613"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("992f36ed-0e0c-43ae-b342-9c034866a0d6"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("e51f2126-3857-45b6-b3b3-0dd2be6edb9e"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c490f1f6-6c11-44c7-8551-79a5a147cfd6"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("cd5d9b4a-12ce-4854-8207-117cfa209241"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public IObjectPK addnew(Context ctx, PurOrderInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("b79058f5-f3a2-4bdc-ba60-f468926a6bc7"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public void addnew(Context ctx, IObjectPK pk, PurOrderInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0390f1d0-d3aa-4469-a635-8fcdbe8cd968"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void update(Context ctx, IObjectPK pk, PurOrderInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("09b01b12-2fa3-499f-9983-d3e378271117"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updatePartial(Context ctx, PurOrderInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("09bc660a-19fc-4129-9ba2-f18cf2cafe1e"), new Object[]{ctx, model, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updateBigObject(Context ctx, IObjectPK pk, PurOrderInfo model) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0fdc5ee9-9c3d-4c3b-926f-44c869eb6f42"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("900eb1d7-da44-45e2-a10b-1906fa4dc0f2"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, pk);
            }
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("47430ac3-9b80-4454-b5f5-352aafeb0764"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("965b8d80-0f58-45d4-8e3b-9b1e8513c1b8"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fa31df55-c00d-46a7-9bea-a36a48802aee"), new Object[]{ctx, filter, sorter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("5db7d796-083a-4dc9-9cd6-12053bb5b3fe"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c60a3f45-6970-4d6f-aff5-25b67db36feb"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3df6f4bf-44b3-4152-b0d2-893cbc88099a"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7d1a28ce-0807-497f-a256-4f6adc0b5407"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("158c171f-d6c7-4c0d-b800-0ff1f3a42f9d"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("cd709ec5-4aa7-4928-94e5-6892e2d174c9"), new Object[]{ctx, arrayPK});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, arrayPK);
            }
