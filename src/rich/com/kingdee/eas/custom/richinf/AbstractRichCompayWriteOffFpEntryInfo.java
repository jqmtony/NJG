...
public class AbstractRichCompayWriteOffFpEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractRichCompayWriteOffFpEntryInfo()
    {
        this("id");
    }
    protected AbstractRichCompayWriteOffFpEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
    ...
    {
        return new BOSObjectType("EBCAA747");
    }
}