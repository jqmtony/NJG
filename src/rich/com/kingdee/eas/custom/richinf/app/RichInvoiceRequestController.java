...
public interface RichInvoiceRequestController extends CoreBillBaseController
{
    public RichInvoiceRequestCollection getRichInvoiceRequestCollection(Context ctx) throws BOSException, RemoteException;
    public RichInvoiceRequestCollection getRichInvoiceRequestCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public RichInvoiceRequestCollection getRichInvoiceRequestCollection(Context ctx, String oql) throws BOSException, RemoteException;
