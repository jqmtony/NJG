...
public class RichCustomWriteOffE2 extends CoreBillEntryBase implements IRichCustomWriteOffE2
{
    public RichCustomWriteOffE2()
    {
        super();
        registerInterface(IRichCustomWriteOffE2.class, this);
    }
    public RichCustomWriteOffE2(Context ctx)
    {
        super(ctx);
        registerInterface(IRichCustomWriteOffE2.class, this);
    }
    ...
    private RichCustomWriteOffE2Controller getController() throws BOSException
    {
        return (RichCustomWriteOffE2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffE2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
