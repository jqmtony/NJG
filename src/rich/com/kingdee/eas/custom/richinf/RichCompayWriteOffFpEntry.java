...
public class RichCompayWriteOffFpEntry extends CoreBillEntryBase implements IRichCompayWriteOffFpEntry
{
    public RichCompayWriteOffFpEntry()
    {
        super();
        registerInterface(IRichCompayWriteOffFpEntry.class, this);
    }
    public RichCompayWriteOffFpEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRichCompayWriteOffFpEntry.class, this);
    }
    ...
    private RichCompayWriteOffFpEntryController getController() throws BOSException
    {
        return (RichCompayWriteOffFpEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCompayWriteOffFpEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
