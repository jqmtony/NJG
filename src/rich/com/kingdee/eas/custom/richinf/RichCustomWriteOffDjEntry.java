...
public class RichCustomWriteOffDjEntry extends CoreBillEntryBase implements IRichCustomWriteOffDjEntry
{
    public RichCustomWriteOffDjEntry()
    {
        super();
        registerInterface(IRichCustomWriteOffDjEntry.class, this);
    }
    public RichCustomWriteOffDjEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRichCustomWriteOffDjEntry.class, this);
    }
    ...
    private RichCustomWriteOffDjEntryController getController() throws BOSException
    {
        return (RichCustomWriteOffDjEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffDjEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
