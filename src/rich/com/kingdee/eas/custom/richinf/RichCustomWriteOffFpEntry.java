...
public class RichCustomWriteOffFpEntry extends CoreBillEntryBase implements IRichCustomWriteOffFpEntry
{
    public RichCustomWriteOffFpEntry()
    {
        super();
        registerInterface(IRichCustomWriteOffFpEntry.class, this);
    }
    public RichCustomWriteOffFpEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRichCustomWriteOffFpEntry.class, this);
    }
    ...
    private RichCustomWriteOffFpEntryController getController() throws BOSException
    {
        return (RichCustomWriteOffFpEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRichCustomWriteOffFpEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
