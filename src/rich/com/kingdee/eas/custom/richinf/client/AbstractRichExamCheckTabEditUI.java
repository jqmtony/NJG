 ...
 * output class name
 */
public abstract class AbstractRichExamCheckTabEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRichExamCheckTabEditUI.class);
     ...
     */
    public AbstractRichExamCheckTabEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRichExamCheckTabEditUI.class.getName());
        ...
        // contcheckInfo		
        this.contcheckInfo.setBoundLabelText(resHelper.getString("contcheckInfo.boundLabelText"));		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.richinf.app.RichExamCheckTabEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.richinf.RichExamCheckTabInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.richinf.client", "RichExamCheckTabEditUI");
    }
