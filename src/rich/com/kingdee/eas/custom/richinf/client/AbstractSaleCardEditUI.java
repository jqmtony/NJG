 ...
 * output class name
 */
public abstract class AbstractSaleCardEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleCardEditUI.class);
    ...
    protected com.kingdee.eas.custom.richinf.SaleCardInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSaleCardEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleCardEditUI.class.getName());
        ...
        // txtsaleAmount		
        this.txtsaleAmount.setVisible(true);		
    ...
    {
        this.setBounds(new Rectangle(0, 0, 651, 229));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(33, 164, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(351, 164, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(33, 195, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(351, 195, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(33, 33, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(351, 33, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(351, 133, 270, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(33, 133, 270, 19));
        this.add(contAuditor, null);
        kdtEntrys.setBounds(new Rectangle(765, 191, 273, 26));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.richinf.SaleCardEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, null);
        contamount.setBounds(new Rectangle(33, 64, 270, 19));
        this.add(contamount, null);
        contsaleAmount.setBounds(new Rectangle(33, 99, 270, 19));
        this.add(contsaleAmount, null);
        contcardType.setBounds(new Rectangle(351, 64, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.richinf.SaleCardEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.richinf.app.SaleCardEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.richinf.SaleCardInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.richinf.client", "SaleCardEditUI");
    }
    /**
