 ...
 * output class name
 */
public class RichCustomWriteOffListUI extends AbstractRichCustomWriteOffListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichCustomWriteOffListUI.class);
    
    /**
     * output class constructor
     */
    public RichCustomWriteOffListUI() throws Exception
    {
        super();
    }
