...
import com.kingdee.eas.custom.richinf.IRichCustomWriteOff;
 ...
 * output class name
 */
public class RichCustomWriteOffEditUI extends AbstractRichCustomWriteOffEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichCustomWriteOffEditUI.class);
    
    /**
     * output class constructor
     */
    public RichCustomWriteOffEditUI() throws Exception
    {
        super();
...
//    	btnDelVoucher.setVisible(true);
    ...
    //反核销
    @Override
    protected void kdb_fanhx_actionPerformed(ActionEvent e) throws Exception {
    	checkSaveState();
    	//检查有无发票和到检单
    	Set<Integer> djIndexs = new HashSet<Integer>();
    	KDTSelectBlock selectBlock = null;
    ...
    IRichCustomWriteOff ir = (IRichCustomWriteOff )getBizInterface();
