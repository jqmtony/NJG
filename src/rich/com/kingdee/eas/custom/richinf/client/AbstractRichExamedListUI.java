...
public abstract class AbstractRichExamedListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","ldNumber","djDate","ywNumber","qyUnit.name","djUnit.name","kpUnit.name","fkUnit.name","fpNumber","amount","sales.name","tjType.name","bizState","beizhu","kpCompany.name","djCompany.name","dj","entrys.slType.name","entrys.skType.name","auditDate","cardNo","cardType","cardAmount","saleAmount","hc","zjjg.name","yhxAmount"};
    }
