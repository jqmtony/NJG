 ...
 * output class name
 */
public abstract class AbstractDateUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(46, 49, 270, 19));
        this.add(kDLabelContainer1, null);
        btnSure.setBounds(new Rectangle(64, 110, 94, 26));
        this.add(btnSure, null);
        btnNo.setBounds(new Rectangle(216, 110, 94, 26));
        this.add(btnNo, null);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.richinf.app.DateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.richinf.client", "DateUI");
    }
