 ...
 * output class name
 */
public class RichExamCheckTabEditUI extends AbstractRichExamCheckTabEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichExamCheckTabEditUI.class);
    
    /**
     * output class constructor
     */
    public RichExamCheckTabEditUI() throws Exception
    {
        super();
    }
    /**
