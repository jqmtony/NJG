 ...
 * output class name
 */
public abstract class AbstractSaleCardListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleCardListUI.class);
     ...
     */
    public AbstractSaleCardListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleCardListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.richinf.app", "SaleCardQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.richinf.app.SaleCardListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSaleCardListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSaleCardListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.richinf.client", "SaleCardListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.richinf.client.SaleCardEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.richinf.SaleCardFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.richinf.SaleCardInfo objectValue = new com.kingdee.eas.custom.richinf.SaleCardInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","amount","saleAmount","cardType"};
    }



	protected String getTDFileName() {
    	return "/bim/custom/richinf/SaleCard";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.richinf.app.SaleCardQuery");
	}
