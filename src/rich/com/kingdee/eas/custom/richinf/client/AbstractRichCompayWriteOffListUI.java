...
public abstract class AbstractRichCompayWriteOffListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","sales.name","kpCustomer.name"};
    }
