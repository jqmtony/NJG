 ...
 * output class name
 */
public class RichExamedEditUI extends AbstractRichExamedEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichExamedEditUI.class);
    
    /**
     * output class constructor
     */
    public RichExamedEditUI() throws Exception
    {
        super();
    }
