 ...
 * output class name
 */
public class RichCompayWriteOffListUI extends AbstractRichCompayWriteOffListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichCompayWriteOffListUI.class);
    
    /**
     * output class constructor
     */
    public RichCompayWriteOffListUI() throws Exception
    {
        super();
    }
