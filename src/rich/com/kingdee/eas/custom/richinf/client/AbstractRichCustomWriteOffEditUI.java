...
public abstract class AbstractRichCustomWriteOffEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(393, 542, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(393, 542, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(730, 540, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(730, 540, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(394, 571, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(394, 571, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(730, 571, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(730, 571, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAuditor.setBounds(new Rectangle(15, 543, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(15, 543, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(kdtFpEntry_detailPanel, new KDLayout.Constraints(10, 320, 992, 199, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(kdtDjEntry_detailPanel, new KDLayout.Constraints(9, 64, 992, 253, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(kdb_hx, new KDLayout.Constraints(467, 39, 90, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdb_fanhx.setBounds(new Rectangle(574, 39, 73, 21));
        this.add(kdb_fanhx, new KDLayout.Constraints(574, 39, 73, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        autoHX.setBounds(new Rectangle(361, 39, 90, 21));
        this.add(autoHX, new KDLayout.Constraints(361, 39, 90, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
