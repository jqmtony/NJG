 ...
 * output class name
 */
public class RichExamTempTabEditUI extends AbstractRichExamTempTabEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(RichExamTempTabEditUI.class);
    
    /**
     * output class constructor
     */
    public RichExamTempTabEditUI() throws Exception
    {
        super();
    }
    /**
