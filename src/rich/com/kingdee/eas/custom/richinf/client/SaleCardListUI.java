 ...
 * output class name
 */
public class SaleCardListUI extends AbstractSaleCardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleCardListUI.class);
    
    /**
     * output class constructor
     */
    public SaleCardListUI() throws Exception
    {
        super();
    }
