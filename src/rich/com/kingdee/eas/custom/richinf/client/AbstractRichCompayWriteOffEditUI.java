 ...
 * output class name
 */
public abstract class AbstractRichCompayWriteOffEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRichCompayWriteOffEditUI.class);
    ...
    protected com.kingdee.eas.custom.richinf.RichCompayWriteOffInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractRichCompayWriteOffEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRichCompayWriteOffEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(377, 554, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(377, 554, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(730, 553, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(730, 553, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(379, 583, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(379, 583, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(730, 582, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(730, 582, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contNumber.setBounds(new Rectangle(729, 12, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(729, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBizDate.setBounds(new Rectangle(729, 36, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(729, 36, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contDescription.setBounds(new Rectangle(13, 36, 271, 19));
        this.add(contDescription, new KDLayout.Constraints(13, 36, 271, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(15, 560, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(15, 560, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsales.setBounds(new Rectangle(13, 12, 270, 19));
        this.add(contsales, new KDLayout.Constraints(13, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtFpEntry.setBounds(new Rectangle(10, 317, 992, 204));
        kdtFpEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtFpEntry,new com.kingdee.eas.custom.richinf.RichCompayWriteOffFpEntryInfo(),null,false);
        this.add(kdtFpEntry_detailPanel, new KDLayout.Constraints(10, 317, 992, 204, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtDjEntry.setBounds(new Rectangle(11, 62, 992, 248));
        kdtDjEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtDjEntry,new com.kingdee.eas.custom.richinf.RichCompayWriteOffDjEntryInfo(),null,false);
        this.add(kdtDjEntry_detailPanel, new KDLayout.Constraints(11, 62, 992, 248, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contkpCustomer.setBounds(new Rectangle(372, 12, 270, 19));
        this.add(contkpCustomer, new KDLayout.Constraints(372, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdb_hx.setBounds(new Rectangle(473, 38, 90, 21));
        this.add(kdb_hx, new KDLayout.Constraints(473, 38, 90, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdb_fanhx.setBounds(new Rectangle(580, 38, 73, 21));
        this.add(kdb_fanhx, new KDLayout.Constraints(580, 38, 73, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        autoHX.setBounds(new Rectangle(366, 38, 90, 21));
        this.add(autoHX, new KDLayout.Constraints(366, 38, 90, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("FpEntry", com.kingdee.eas.custom.richinf.RichCompayWriteOffFpEntryInfo.class, this.kdtFpEntry, "userObject");
		...
		dataBinder.registerBinding("DjEntry", com.kingdee.eas.custom.richinf.RichCompayWriteOffDjEntryInfo.class, this.kdtDjEntry, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.richinf.app.RichCompayWriteOffEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.richinf.RichCompayWriteOffInfo)ov;
    }
    ...
    /**
     * output kdb_hx_actionPerformed method
     */
    protected void kdb_hx_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
...
kdtDjEntry.getCell(rowIndex,"jsAmount").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtDjEntry.getCell(rowIndex,"djNo").getValue(),"amount")));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.richinf.client", "RichCompayWriteOffEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.richinf.client.RichCompayWriteOffEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/richinf/RichCompayWriteOff";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.richinf.app.RichCompayWriteOffQuery");
	}
