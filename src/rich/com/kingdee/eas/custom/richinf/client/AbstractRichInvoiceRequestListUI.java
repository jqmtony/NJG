...
com.kingdee.eas.custom.richinf.RichInvoiceRequestFactory.getRemoteInstance().unAudit(editData);
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","ldNumber","kpUnit.name","sales.name","bizState","beizhu","kpCompany.name","auditDate","entrys.djd.number","reqSumAmount","invoicedAmount","amount","djAmount","djkp","billState"};
    }
