...
public class SaleType extends DataBase implements ISaleType
{
    public SaleType()
    {
        super();
        registerInterface(ISaleType.class, this);
    }
    public SaleType(Context ctx)
    {
        super(ctx);
        registerInterface(ISaleType.class, this);
    }
    ...
    private SaleTypeController getController() throws BOSException
    {
        return (SaleTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSaleTypeInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getSaleTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
