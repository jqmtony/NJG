...
public class OrgUnitEntry extends CoreBillEntryBase implements IOrgUnitEntry
{
    public OrgUnitEntry()
    {
        super();
        registerInterface(IOrgUnitEntry.class, this);
    }
    public OrgUnitEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IOrgUnitEntry.class, this);
    }
    ...
    private OrgUnitEntryController getController() throws BOSException
    {
        return (OrgUnitEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOrgUnitEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
