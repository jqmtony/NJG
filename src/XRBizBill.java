...
public class XRBizBill extends XRBillBase implements IXRBizBill
{
    public XRBizBill()
    {
        super();
        registerInterface(IXRBizBill.class, this);
    }
    public XRBizBill(Context ctx)
    {
        super(ctx);
        registerInterface(IXRBizBill.class, this);
    }
    ...
    private XRBizBillController getController() throws BOSException
    {
        return (XRBizBillController)getBizController();
    }
    /**
     *addnew-User defined method
     *@param pk pk
     *@param model model
     */
     ...
     *@return
     */
    public XRBizBillCollection getXRBizBillCollection() throws BOSException
    {
        try {
            return getController().getXRBizBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public XRBizBillCollection getXRBizBillCollection(EntityViewInfo view) throws BOSException
    {
        try {
            return getController().getXRBizBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public XRBizBillCollection getXRBizBillCollection(String oql) throws BOSException
    {
        try {
            return getController().getXRBizBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public XRBizBillInfo getXRBizBillInfo(IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            return getController().getXRBizBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public XRBizBillInfo getXRBizBillInfo(IObjectPK pk) throws BOSException, EASBizException
    {
        try {
            return getController().getXRBizBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public XRBizBillInfo getXRBizBillInfo(String oql) throws BOSException, EASBizException
    {
        try {
            return getController().getXRBizBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *updateBigObject-User defined method
     *@param pk pk
     *@param model model
     */
    ...
    /**
     *updatePartial-User defined method
     *@param model model
     *@param selector selector
     */
