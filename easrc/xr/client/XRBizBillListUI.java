 ...
 * output class name
 */
public class XRBizBillListUI extends AbstractXRBizBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(XRBizBillListUI.class);
    
    /**
     * output class constructor
     */
    public XRBizBillListUI() throws Exception
    {
        super();
    }
