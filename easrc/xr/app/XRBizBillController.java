...
import com.kingdee.eas.xr.XRBizBillInfo;
...
import com.kingdee.bos.framework.*;
import com.kingdee.eas.xr.XRBizBillCollection;

import java.rmi.RemoteException;
import com.kingdee.bos.framework.ejb.BizController;

public interface XRBizBillController extends XRBillBaseController
{
    ...
    public XRBizBillCollection getXRBizBillCollection(Context ctx) throws BOSException, RemoteException;
    public XRBizBillCollection getXRBizBillCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public XRBizBillCollection getXRBizBillCollection(Context ctx, String oql) throws BOSException, RemoteException;
    public IObjectPK[] getPKList(Context ctx) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, FilterInfo filter, SorterItemCollection sorter) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    public XRBizBillInfo getXRBizBillInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public XRBizBillInfo getXRBizBillInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public XRBizBillInfo getXRBizBillInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
