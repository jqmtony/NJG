...
{
    public static final String INVITETYPE_VALUE = "1INVITETYPE";//alias=招标方式
    public static final String TENDERDISCUSSION_VALUE = "2TENDERDISCUSSION";//alias=议标方式
    public static final String DIRECTCONSIGNMENT_VALUE = "3DIRECTCONSIGNMENT";//alias=直接委托方式
