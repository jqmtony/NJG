...
public abstract class AbstractFDCCPDMFacadeControllerBean extends AbstractBizControllerBean implements FDCCPDMFacadeController
{
    ...
    public ArchiveResultInfo upLoadFileToCP(Context ctx, ArchiveDocumentParamsInfo params, String content, String[] fileNames, List fileStream) throws BOSException
    {
        try {
            ...
            return (ArchiveResultInfo)svcCtx.getMethodReturnValue();
    ...
    protected abstract ArchiveResultInfo _upLoadFileToCP(Context ctx, ArchiveDocumentParamsInfo params, String content, String[] fileNames, List fileStream) throws BOSException;

    public List downLoadFileFromCP(Context ctx, String bizID, String docID) throws BOSException
    {
        try {
    ...
    protected abstract List _downLoadFileFromCP(Context ctx, String bizID, String docID) throws BOSException;

    public void deleteCPFile(Context ctx, String bizID, String docID) throws BOSException
    {
        try {
    ...
    protected abstract void _deleteCPFile(Context ctx, String bizID, String docID) throws BOSException;

    public void addFileToCP(Context ctx, String bizID, String fileName, byte[] fileStream) throws BOSException
    {
        try {
    ...
    protected abstract void _addFileToCP(Context ctx, String bizID, String fileName, byte[] fileStream) throws BOSException;
