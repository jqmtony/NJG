...
//					paramItem = FDCUtils.getDefaultFDCParam(null, SysContext.getSysContext().getCurrentFIUnit().getId().toString());
				} else {
...
//						com.kingdee.eas.port.pm.utils.FDCClientHelper.tblMainAfterDataFill(e,getMainTable(),FDCBillListUI.this);
					}
				}
		);	
	}
