 ...
 * output class name
 */
public abstract class AbstractFDCBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCBillListUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCBillListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.FDCBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "FDCBillListUI");
    }
