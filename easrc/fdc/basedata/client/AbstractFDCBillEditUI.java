 ...
 * output class name
 */
public abstract class AbstractFDCBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCBillEditUI.class);
    ...
    protected ActionAttamentCtrl actionAttamentCtrl = null;
    /**
     * output class constructor
     */
    public AbstractFDCBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCBillEditUI.class.getName());
        ...
        //actionAttamentCtrl
        this.actionAttamentCtrl = new ActionAttamentCtrl(this);
        getActionManager().registerAction("actionAttamentCtrl", actionAttamentCtrl);
         this.actionAttamentCtrl.addService(new com.kingdee.eas.framework.client.service.PermissionService());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.basedata.app.FDCBillEditUIHandler";
	}
    ...
    /**
     * output actionAttamentCtrl_actionPerformed method
     */
	...
	public RequestContext prepareActionAttamentCtrl(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionAttamentCtrl() {
    	return false;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFDCBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }

    /**
     * output ActionAttamentCtrl class
     */     
    protected class ActionAttamentCtrl extends ItemAction {     
    
        public ActionAttamentCtrl()
        {
            this(null);
        }

        public ActionAttamentCtrl(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionAttamentCtrl.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionAttamentCtrl.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionAttamentCtrl.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCBillEditUI.this, "ActionAttamentCtrl", "actionAttamentCtrl_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.basedata.client", "FDCBillEditUI");
    }
