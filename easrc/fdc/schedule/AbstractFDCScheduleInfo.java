...
public class AbstractFDCScheduleInfo extends com.kingdee.eas.fdc.schedule.framework.ScheduleBaseInfo implements Serializable 
{
    ...
    /**
     * Object:房地产进度计划's 项目阶段property 
     */
    public String getProjectStep()
    {
        return getString("projectStep");
    }
    public void setProjectStep(String item)
    {
        setString("projectStep", item);
    }
    /**
     * Object:房地产进度计划's 版本类型property 
     */
    public String getProjectVersionType()
    {
        return getString("projectVersionType");
    }
    public void setProjectVersionType(String item)
    {
        setString("projectVersionType", item);
    }
