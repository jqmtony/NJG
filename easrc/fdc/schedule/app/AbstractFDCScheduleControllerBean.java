...
public abstract class AbstractFDCScheduleControllerBean extends ScheduleBaseControllerBean implements FDCScheduleController
{
    ...
    public FDCScheduleInfo getScheduleInfo(Context ctx, boolean isMainSchedule, boolean isAdjust, ProjectInfo project, ProjectSpecialInfo projectSpecial, Map param) throws BOSException, EASBizException
    {
        try {
