 ...
 * output class name
 */
public abstract class AbstractPortMainScheduleExecuteUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPortMainScheduleExecuteUI.class);
     ...
     */
    public AbstractPortMainScheduleExecuteUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPortMainScheduleExecuteUI.class.getName());
        ...
        this.lblAdjustDesc.setEnabled(false);		
        this.lblAdjustDesc.setVisible(false);		
        this.kdsDescription.setVisible(false);		
        this.projectType.setEnabled(false);		
        this.projectType.setVisible(false);		
        this.combView.setEnabled(false);		
        this.combView.setVisible(false);
    ...
    public void initUIContentLayout()
    {
        ...
        contAuditor.setBounds(new Rectangle(523, 733, 371, 19));
        this.add(contAuditor, new KDLayout.Constraints(523, 733, 371, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditTime.setBounds(new Rectangle(48, 704, 371, 19));
        this.add(contAuditTime, new KDLayout.Constraints(48, 704, 371, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contProject.setBounds(new Rectangle(340, 664, 270, 19));
        this.add(contProject, new KDLayout.Constraints(340, 664, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDLabelContainer2.setBounds(new Rectangle(325, 5, 155, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(325, 5, 155, 19, 0));
        contSelectType.setBounds(new Rectangle(666, 5, 112, 19));
        this.add(contSelectType, new KDLayout.Constraints(666, 5, 112, 19, 0));
        lblAdjustDesc.setBounds(new Rectangle(5, 28, 270, 19));
        this.add(lblAdjustDesc, new KDLayout.Constraints(5, 28, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdsDescription.setBounds(new Rectangle(5, 49, 891, 29));
        this.add(kdsDescription, new KDLayout.Constraints(5, 49, 891, 29, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel1.setBounds(new Rectangle(126, 77, 767, 300));
        this.add(kDPanel1, new KDLayout.Constraints(126, 77, 767, 300, 0));
        paySubway.setBounds(new Rectangle(10, 563, 610, 33));
        this.add(paySubway, new KDLayout.Constraints(10, 563, 610, 33, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT));
        //contCreateTime
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.PortMainScheduleExecuteUIHandler";
	}
    ...
    protected class ActionWeekReport extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPortMainScheduleExecuteUI.this, "ActionWeekReport", "actionWeekReport_actionPerformed", e);
        }
    }
    ...
    protected class ActionMonthReport extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPortMainScheduleExecuteUI.this, "ActionMonthReport", "actionMonthReport_actionPerformed", e);
        }
    }
    ...
    protected class ActionTaskApprise extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPortMainScheduleExecuteUI.this, "ActionTaskApprise", "actionTaskApprise_actionPerformed", e);
        }
    }
    ...
    protected class ActionScheduleReport extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPortMainScheduleExecuteUI.this, "ActionScheduleReport", "actionScheduleReport_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "PortMainScheduleExecuteUI");
    }
