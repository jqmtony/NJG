 ...
 * output class name
 */
public class PortMainScheduleListUI extends AbstractPortMainScheduleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PortMainScheduleListUI.class);
    
    /**
     * output class constructor
     */
    public PortMainScheduleListUI() throws Exception
    {
        super();
    }
