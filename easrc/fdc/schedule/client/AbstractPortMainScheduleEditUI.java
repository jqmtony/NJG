 ...
 * output class name
 */
public abstract class AbstractPortMainScheduleEditUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPortMainScheduleEditUI.class);
    protected com.kingdee.eas.fdc.schedule.FDCScheduleInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPortMainScheduleEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPortMainScheduleEditUI.class.getName());
        ...
        actionExportPlanTemplate.setDaemonRun(false);

        _tempStr = resHelper.getString("actionExportPlanTemplate.SHORT_DESCRIPTION");
        actionExportPlanTemplate.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("actionExportPlanTemplate.LONG_DESCRIPTION");
        actionExportPlanTemplate.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("actionExportPlanTemplate.NAME");
        actionExportPlanTemplate.putValue(ItemAction.NAME, _tempStr);
        ...
        actionImportPlanTemplate.setEnabled(true);
        actionImportPlanTemplate.setDaemonRun(false);

        _tempStr = resHelper.getString("actionImportPlanTemplate.SHORT_DESCRIPTION");
        actionImportPlanTemplate.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("actionImportPlanTemplate.LONG_DESCRIPTION");
        actionImportPlanTemplate.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
        _tempStr = resHelper.getString("actionImportPlanTemplate.NAME");
        actionImportPlanTemplate.putValue(ItemAction.NAME, _tempStr);
        ...
        this.contCurProject.setBoundLabelLength(50);		
        this.contVersion.setBoundLabelLength(50);		
        this.contState.setBoundLabelLength(30);		
        this.kDLabelContainer1.setBoundLabelLength(50);		
        this.kDLabelContainer2.setBoundLabelLength(50);		
        this.contSelectType.setBoundLabelLength(30);		
        this.lblAdjustDesc.setBoundLabelText(resHelper.getString("lblAdjustDesc.boundLabelText"));		
        ...
        this.btnImportPlanTemplate.setToolTipText(resHelper.getString("btnImportPlanTemplate.toolTipText"));
        ...
        this.btnHisVerion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnHisVerion_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
        ...
        this.btnHisVerion.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent e) {
                try {
                    btnHisVerion_itemStateChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(11, 571, 371, 19));
        this.add(contCreator, new KDLayout.Constraints(11, 571, 371, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(520, 571, 371, 19));
        this.add(contCreateTime, new KDLayout.Constraints(520, 571, 371, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(520, 668, 371, 19));
        this.add(contAuditor, new KDLayout.Constraints(520, 668, 371, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditTime.setBounds(new Rectangle(519, 691, 371, 19));
        this.add(contAuditTime, new KDLayout.Constraints(519, 691, 371, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        mainPanel.setBounds(new Rectangle(5, 115, 892, 465));
        this.add(mainPanel, new KDLayout.Constraints(5, 115, 892, 465, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCurProject.setBounds(new Rectangle(4, 5, 144, 19));
        this.add(contCurProject, new KDLayout.Constraints(4, 5, 144, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contVersion.setBounds(new Rectangle(448, 5, 227, 19));
        this.add(contVersion, new KDLayout.Constraints(448, 5, 227, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contState.setBounds(new Rectangle(803, 5, 95, 19));
        this.add(contState, new KDLayout.Constraints(803, 5, 95, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contProject.setBounds(new Rectangle(87, 787, 270, 19));
        this.add(contProject, new KDLayout.Constraints(87, 787, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAdminDept.setBounds(new Rectangle(96, 823, 270, 19));
        this.add(contAdminDept, new KDLayout.Constraints(96, 823, 270, 19, KDLayout.Constraints.ANCHOR_CENTRE | KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer1.setBounds(new Rectangle(152, 5, 144, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(152, 5, 144, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(300, 5, 144, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(300, 5, 144, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSelectType.setBounds(new Rectangle(681, 5, 118, 19));
        this.add(contSelectType, new KDLayout.Constraints(681, 5, 118, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        lblAdjustDesc.setBounds(new Rectangle(4, 28, 270, 19));
        this.add(lblAdjustDesc, new KDLayout.Constraints(4, 28, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdsDescription.setBounds(new Rectangle(4, 49, 891, 29));
        this.add(kdsDescription, new KDLayout.Constraints(4, 49, 891, 29, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
mainPanel.setLayout(new BorderLayout(0, 0));        //contCurProject
        ...
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(projectStep);
        //kDLabelContainer2
        kDLabelContainer2.setBoundEditor(projectType);
        //contSelectType
        contSelectType.setBoundEditor(combView);
        //kdsDescription
        kdsDescription.getViewport().add(txtDescription, null);
        //kDPanel1
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.PortMainScheduleEditUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("projectStep", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("projectVersionType", ValidateHelper.ON_SAVE);    		
	}
    ...
    /**
     * output btnHisVerion_actionPerformed method
     */
    protected void btnHisVerion_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }

    /**
     * output btnHisVerion_itemStateChanged method
     */
    protected void btnHisVerion_itemStateChanged(java.awt.event.ItemEvent e) throws Exception
    {
    }
    ...
    {
        super.actionExportPlanTemplate_actionPerformed(e);
    }
    ...
    {
        super.actionImportPlanTemplate_actionPerformed(e);
    }
	...
	public RequestContext prepareactionExportPlanTemplate(IItemAction itemAction) throws Exception {
			RequestContext request = super.prepareactionExportPlanTemplate(itemAction);		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
		return request;
	...
	public RequestContext prepareactionImportPlanTemplate(IItemAction itemAction) throws Exception {
			RequestContext request = super.prepareactionImportPlanTemplate(itemAction);		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
		return request;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "PortMainScheduleEditUI");
    }
    /**
