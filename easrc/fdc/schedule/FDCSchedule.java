...
public class FDCSchedule extends ScheduleBase implements IFDCSchedule
{
     ...
     *@return
     */
    public FDCScheduleInfo getScheduleInfo(boolean isMainSchedule, boolean isAdjust, ProjectInfo project, ProjectSpecialInfo projectSpecial, Map param) throws BOSException, EASBizException
    {
        try {
