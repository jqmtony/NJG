...
public class AbstractFDCWBSInfo extends com.kingdee.eas.fdc.basedata.FDCTreeBaseDataInfo implements Serializable 
{
     ...
     */
    public com.kingdee.eas.basedata.assistant.ProjectInfo getCurProject()
    {
        return (com.kingdee.eas.basedata.assistant.ProjectInfo)get("curProject");
    }
    public void setCurProject(com.kingdee.eas.basedata.assistant.ProjectInfo item)
    {
        put("curProject", item);
    }
    /**
