...
{
    public static final String TEMP_EVAL_VALUE = "TEMP_EVAL";//alias=暂估价
    public static final String BASE_CONFIRM_VALUE = "BASE_CONFIRM";//alias=基本确定价
    public static final String COMP_COMFIRM_VALUE = "COMP_COMFIRM";//alias=完全确定价
