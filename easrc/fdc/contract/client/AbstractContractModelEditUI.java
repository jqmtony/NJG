...
public abstract class AbstractContractModelEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer 合同范本名称;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.合同范本名称 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        // 合同范本名称		
        this.合同范本名称.setBoundLabelText(resHelper.getString("合同范本名称.boundLabelText"));		
        this.合同范本名称.setBoundLabelUnderline(true);		
        this.合同范本名称.setBoundLabelLength(100);
        // ctnContractType		
    ...
    public void initUIContentLayout()
    {
        ...
        合同范本名称.setBounds(new Rectangle(371, 13, 270, 19));
        this.add(合同范本名称, new KDLayout.Constraints(371, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
