...
public class ContractBillReviseControllerBean extends AbstractContractBillReviseControllerBean
{
    ...
    */
    protected void _unAudit(Context ctx, BOSUuid billId) throws BOSException,EASBizException {
		...
		if (lastModel != null) {
			addAmountToMainContract(ctx, lastModel.getId());
		}
    ...
    protected void _audit(Context ctx, BOSUuid billId) throws BOSException, EASBizException {
		...
		//现在对应的主合同要加上这次的不计成本金额
		addAmountToMainContract(ctx, model.getId());
...
//    		newConInfo.setName(info.getMainContractNumber());
    	...
    	//newConInfo.setLocalAmount(info.getRevLocalAmount());
    	//设置不计成本的金额
...
//					}
	 ...
	 * @throws UuidException
	 */
	private void addAmountToMainContract(Context ctx, BOSUuid billId) throws BOSException, EASBizException,
