...
public class EqmScrap extends XRBillBase implements IEqmScrap
{
    public EqmScrap()
    {
        super();
        registerInterface(IEqmScrap.class, this);
    }
    public EqmScrap(Context ctx)
    {
        super(ctx);
        registerInterface(IEqmScrap.class, this);
    }
    ...
    private EqmScrapController getController() throws BOSException
    {
        return (EqmScrapController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEqmScrapCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmScrapCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmScrapCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmScrapInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmScrapInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmScrapInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
