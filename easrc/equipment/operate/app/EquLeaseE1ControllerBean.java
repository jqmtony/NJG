...
public class EquLeaseE1ControllerBean extends AbstractEquLeaseE1ControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.operate.app.EquLeaseE1ControllerBean");
}