...
public class ComproductionEntryControllerBean extends AbstractComproductionEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.operate.app.ComproductionEntryControllerBean");
}