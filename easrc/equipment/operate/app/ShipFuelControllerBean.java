...
public class ShipFuelControllerBean extends AbstractShipFuelControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.operate.app.ShipFuelControllerBean");
}