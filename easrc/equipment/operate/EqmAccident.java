...
public class EqmAccident extends XRBillBase implements IEqmAccident
{
    public EqmAccident()
    {
        super();
        registerInterface(IEqmAccident.class, this);
    }
    public EqmAccident(Context ctx)
    {
        super(ctx);
        registerInterface(IEqmAccident.class, this);
    }
    ...
    private EqmAccidentController getController() throws BOSException
    {
        return (EqmAccidentController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEqmAccidentCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmAccidentCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmAccidentCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmAccidentInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmAccidentInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEqmAccidentInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
