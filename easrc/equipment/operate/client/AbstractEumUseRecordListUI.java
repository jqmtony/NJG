...
com.kingdee.eas.port.equipment.operate.EumUseRecordFactory.getRemoteInstance().shiyong(editData);
    ...
    {
        return new String[] {"number","status","reportMonth.number","UseOrgUnit.name","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","staPerson.name","initialiRecord","reportTime.name"};
    }
