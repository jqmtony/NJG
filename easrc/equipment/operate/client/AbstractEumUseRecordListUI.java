...
public abstract class AbstractEumUseRecordListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","status","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","staPerson.name","UseOrgUnit.name","reportTime.name"});
...
com.kingdee.eas.port.equipment.operate.EumUseRecordFactory.getRemoteInstance().shiyong(editData);
    ...
    {
        return new String[] {"number","status","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","staPerson.name","UseOrgUnit.name","reportTime.name"};
    }
