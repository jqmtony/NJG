...
com.kingdee.eas.port.equipment.operate.EumUseRecordFactory.getRemoteInstance().shiyong(editData);
    ...
    {
        return new String[] {"number","status","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","staPerson.name","UseOrgUnit.name","reportTime.name","initialiRecord"};
    }
