...
com.kingdee.eas.port.equipment.operate.ComproductionFactory.getRemoteInstance().actionUnAudit(editData);
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","Fivouchered","reportingUnit.name","note","AuditTime","state","reportMonth.name"};
    }
