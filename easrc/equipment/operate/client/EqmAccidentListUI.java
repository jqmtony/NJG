 ...
 * output class name
 */
public class EqmAccidentListUI extends AbstractEqmAccidentListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmAccidentListUI.class);
    
    /**
     * output class constructor
     */
    public EqmAccidentListUI() throws Exception
    {
        super();
    }
