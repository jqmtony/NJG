 ...
 * output class name
 */
public class EqmScrapListUI extends AbstractEqmScrapListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmScrapListUI.class);
    
    /**
     * output class constructor
     */
    public EqmScrapListUI() throws Exception
    {
        super();
    }
