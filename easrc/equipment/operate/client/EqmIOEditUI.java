 ...
 * output class name
 */
public class EqmIOEditUI extends AbstractEqmIOEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmIOEditUI.class);
    
    /**
     * output class constructor
     */
    public EqmIOEditUI() throws Exception
    {
        super();
    }
    /**
