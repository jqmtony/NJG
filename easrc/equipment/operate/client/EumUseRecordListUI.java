 ...
 * output class name
 */
public class EumUseRecordListUI extends AbstractEumUseRecordListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EumUseRecordListUI.class);
    
    /**
     * output class constructor
     */
    public EumUseRecordListUI() throws Exception
    {
        super();
    }
	...
	protected IQueryExecutor getQueryExecutor(IMetaDataPK arg0,EntityViewInfo arg1) {
		...
		filInfo.getFilterItems().add(new FilterItemInfo("UseOrgUnit.id",id ,CompareType.EQUALS));
