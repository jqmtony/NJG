 ...
 * output class name
 */
public class EqmAccidentEditUI extends AbstractEqmAccidentEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmAccidentEditUI.class);
    
    /**
     * output class constructor
     */
    public EqmAccidentEditUI() throws Exception
    {
        super();
    }
    /**
