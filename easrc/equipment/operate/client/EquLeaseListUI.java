 ...
 * output class name
 */
public class EquLeaseListUI extends AbstractEquLeaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EquLeaseListUI.class);
    
    /**
     * output class constructor
     */
    public EquLeaseListUI() throws Exception
    {
        super();
    }
