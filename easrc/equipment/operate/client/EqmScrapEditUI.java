 ...
 * output class name
 */
public class EqmScrapEditUI extends AbstractEqmScrapEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmScrapEditUI.class);
    
    /**
     * output class constructor
     */
    public EqmScrapEditUI() throws Exception
    {
        super();
    }
    /**
