 ...
 * output class name
 */
public class ShipFuelListUI extends AbstractShipFuelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ShipFuelListUI.class);
    
    /**
     * output class constructor
     */
    public ShipFuelListUI() throws Exception
    {
        super();
    }
