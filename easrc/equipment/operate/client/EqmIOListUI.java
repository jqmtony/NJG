 ...
 * output class name
 */
public class EqmIOListUI extends AbstractEqmIOListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmIOListUI.class);
    
    /**
     * output class constructor
     */
    public EqmIOListUI() throws Exception
    {
        super();
    }
