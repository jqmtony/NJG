...
public class InsuranceCoverage extends XRBillBase implements IInsuranceCoverage
{
    public InsuranceCoverage()
    {
        super();
        registerInterface(IInsuranceCoverage.class, this);
    }
    public InsuranceCoverage(Context ctx)
    {
        super(ctx);
        registerInterface(IInsuranceCoverage.class, this);
    }
    ...
    private InsuranceCoverageController getController() throws BOSException
    {
        return (InsuranceCoverageController)getBizController();
    }
    /**
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, InsuranceCoverageInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public IObjectPK addnew(InsuranceCoverageInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public InsuranceCoverageCollection getInsuranceCoverageCollection() throws BOSException
    {
        try {
            return getController().getInsuranceCoverageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InsuranceCoverageCollection getInsuranceCoverageCollection(EntityViewInfo view) throws BOSException
    {
        try {
            return getController().getInsuranceCoverageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InsuranceCoverageCollection getInsuranceCoverageCollection(String oql) throws BOSException
    {
        try {
            return getController().getInsuranceCoverageCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InsuranceCoverageInfo getInsuranceCoverageInfo(IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            return getController().getInsuranceCoverageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InsuranceCoverageInfo getInsuranceCoverageInfo(IObjectPK pk) throws BOSException, EASBizException
    {
        try {
            return getController().getInsuranceCoverageInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InsuranceCoverageInfo getInsuranceCoverageInfo(String oql) throws BOSException, EASBizException
    {
        try {
            return getController().getInsuranceCoverageInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@param model model
     */
    public void update(IObjectPK pk, InsuranceCoverageInfo model) throws BOSException, EASBizException
    {
        try {
