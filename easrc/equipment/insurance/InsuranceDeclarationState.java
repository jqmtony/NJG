...
public class InsuranceDeclarationState extends XRBillBase implements IInsuranceDeclarationState
{
    public InsuranceDeclarationState()
    {
        super();
        registerInterface(IInsuranceDeclarationState.class, this);
    }
    public InsuranceDeclarationState(Context ctx)
    {
        super(ctx);
        registerInterface(IInsuranceDeclarationState.class, this);
    }
    ...
    private InsuranceDeclarationStateController getController() throws BOSException
    {
        return (InsuranceDeclarationStateController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceDeclarationStateInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
