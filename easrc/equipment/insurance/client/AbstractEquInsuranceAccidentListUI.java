...
public abstract class AbstractEquInsuranceAccidentListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","equNumber.number","equName","insuranceCompany.name","policyNumber.number","insurance.name","lossDate","expectedLoss","claimAmount","descriptionIncident","xianzhongID"};
    }
