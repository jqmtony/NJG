...
public abstract class AbstractEquInsuranceAccidentListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
     ...
     */
    public AbstractEquInsuranceAccidentListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEquInsuranceAccidentListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.equipment.insurance.app", "EquInsuranceAccidentQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.insurance.app.EquInsuranceAccidentListUIHandler";
	}
...
com.kingdee.eas.port.equipment.insurance.EquInsuranceAccidentFactory.getRemoteInstance().equInfomation(editData);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.insurance.client", "EquInsuranceAccidentListUI");
    }
    /**
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","equNumber.number","equName","insuranceCompany.name","insurance.name","lossDate","expectedLoss","claimAmount","descriptionIncident","xianzhongID","policyNumber.coverNumber"};
    }
