...
com.kingdee.eas.port.equipment.insurance.InsuranceDeclarationStateFactory.getRemoteInstance().shengbao(editData);
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","year","totalAmountInsured","E1.equNumber.number"};
    }
