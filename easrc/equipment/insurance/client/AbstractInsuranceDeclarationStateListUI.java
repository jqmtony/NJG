...
public abstract class AbstractInsuranceDeclarationStateListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","year","totalAmountInsured","E1.equNumber.number"};
    }
