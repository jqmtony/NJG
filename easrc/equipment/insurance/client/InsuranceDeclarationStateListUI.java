 ...
 * output class name
 */
public class InsuranceDeclarationStateListUI extends AbstractInsuranceDeclarationStateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InsuranceDeclarationStateListUI.class);
    
    /**
     * output class constructor
     */
    public InsuranceDeclarationStateListUI() throws Exception
    {
        super();
    }
