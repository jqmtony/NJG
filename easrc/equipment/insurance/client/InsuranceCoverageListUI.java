 ...
 * output class name
 */
public class InsuranceCoverageListUI extends AbstractInsuranceCoverageListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InsuranceCoverageListUI.class);
    
    /**
     * output class constructor
     */
    public InsuranceCoverageListUI() throws Exception
    {
        super();
    }
