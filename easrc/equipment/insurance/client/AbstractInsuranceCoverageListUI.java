...
public abstract class AbstractInsuranceCoverageListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","year","insurance.name","insuranceCompany.name","E1.seq","E1.useUnit.name","E1.equNumber.number","E1.equType","E1.equName","E1.specModel","E1.factoryUseDate","E1.makeUnit","E1.tonnage","E1.originalValue","E1.presentValue","E1.insuranceAmount","E1.remark","xianzhongID"});
...
com.kingdee.eas.port.equipment.insurance.InsuranceCoverageFactory.getRemoteInstance().excelBxmx(editData);
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","year","insurance.name","insuranceCompany.name","E1.useUnit.name","E1.equNumber.number","xianzhongID"};
    }
