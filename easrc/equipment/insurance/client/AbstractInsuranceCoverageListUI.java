...
com.kingdee.eas.port.equipment.insurance.InsuranceCoverageFactory.getRemoteInstance().excelBxmx(editData);
    ...
    {
        return new String[] {"number","coverNumber","contNumber","effectDate","endDate","bizDate","status","id","CU.id","year","insurance.name","insuranceCompany.name","E1.useUnit.name","E1.equNumber.number","xianzhongID","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","year"};
    }
