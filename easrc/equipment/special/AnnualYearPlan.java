...
public class AnnualYearPlan extends XRBillBase implements IAnnualYearPlan
{
    public AnnualYearPlan()
    {
        super();
        registerInterface(IAnnualYearPlan.class, this);
    }
    public AnnualYearPlan(Context ctx)
    {
        super(ctx);
        registerInterface(IAnnualYearPlan.class, this);
    }
    ...
    private AnnualYearPlanController getController() throws BOSException
    {
        return (AnnualYearPlanController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAnnualYearPlanCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearPlanCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearPlanCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearPlanInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearPlanInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearPlanInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
