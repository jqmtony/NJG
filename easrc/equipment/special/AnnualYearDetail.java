...
public class AnnualYearDetail extends XRBillBase implements IAnnualYearDetail
{
    public AnnualYearDetail()
    {
        super();
        registerInterface(IAnnualYearDetail.class, this);
    }
    public AnnualYearDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IAnnualYearDetail.class, this);
    }
    ...
    private AnnualYearDetailController getController() throws BOSException
    {
        return (AnnualYearDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAnnualYearDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
