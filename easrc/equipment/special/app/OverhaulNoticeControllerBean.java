...
public class OverhaulNoticeControllerBean extends AbstractOverhaulNoticeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.special.app.OverhaulNoticeControllerBean");
    protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
    	OverhaulNoticeInfo aXRBillBaseInfo = (OverhaulNoticeInfo)model;
