...
public interface AnnualYearDetailController extends XRBillBaseController
{
    public void addnew(Context ctx, IObjectPK pk, AnnualYearDetailInfo model) throws BOSException, EASBizException, RemoteException;
    public IObjectPK addnew(Context ctx, AnnualYearDetailInfo model) throws BOSException, EASBizException, RemoteException;
    ...
    public AnnualYearDetailCollection getAnnualYearDetailCollection(Context ctx) throws BOSException, RemoteException;
    public AnnualYearDetailCollection getAnnualYearDetailCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public AnnualYearDetailCollection getAnnualYearDetailCollection(Context ctx, String oql) throws BOSException, RemoteException;
    public IObjectPK[] getPKList(Context ctx) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, FilterInfo filter, SorterItemCollection sorter) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    public AnnualYearDetailInfo getAnnualYearDetailInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public AnnualYearDetailInfo getAnnualYearDetailInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public AnnualYearDetailInfo getAnnualYearDetailInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    ...
    public void update(Context ctx, IObjectPK pk, AnnualYearDetailInfo model) throws BOSException, EASBizException, RemoteException;
