...
public class SpecialChangeEntryControllerBean extends AbstractSpecialChangeEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.special.app.SpecialChangeEntryControllerBean");
}