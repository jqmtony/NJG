...
public class AnnualYearFeeControllerBean extends AbstractAnnualYearFeeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.special.app.AnnualYearFeeControllerBean");
}