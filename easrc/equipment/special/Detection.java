...
public class Detection extends XRBillBase implements IDetection
{
    public Detection()
    {
        super();
        registerInterface(IDetection.class, this);
    }
    public Detection(Context ctx)
    {
        super(ctx);
        registerInterface(IDetection.class, this);
    }
    ...
    private DetectionController getController() throws BOSException
    {
        return (DetectionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDetectionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
