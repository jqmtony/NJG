 ...
 * output class name
 */
public class AnnouncementListUI extends AbstractAnnouncementListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AnnouncementListUI.class);
    
    /**
     * output class constructor
     */
    public AnnouncementListUI() throws Exception
    {
        super();
    }
	...
	public void onLoad() throws Exception {
    	...
    	this.kDContainer1.setTitle("通告栏");
    }
    ...
    protected IQueryExecutor getQueryExecutor(IMetaDataPK queryPK,EntityViewInfo viewInfo) {
    	...
    	filInfo.getFilterItems().add(new FilterItemInfo("RegulationsEntry.beizhu","通告栏",CompareType.EQUALS));
