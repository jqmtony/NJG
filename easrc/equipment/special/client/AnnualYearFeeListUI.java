 ...
 * output class name
 */
public class AnnualYearFeeListUI extends AbstractAnnualYearFeeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AnnualYearFeeListUI.class);
    
    /**
     * output class constructor
     */
    public AnnualYearFeeListUI() throws Exception
    {
        super();
    }
