 ...
 * output class name
 */
public class BgXzUI extends AbstractBgXzUI
{
    private static final Logger logger = CoreUIObject.getLogger(BgXzUI.class);
    
    /**
     * output class constructor
     */
    public BgXzUI() throws Exception
    {
        super();
    }
    ...
    protected IQueryExecutor getQueryExecutor(IMetaDataPK queryPK,EntityViewInfo viewInfo) {
    	...
    	filInfo.getFilterItems().add(new FilterItemInfo("RegulationsEntry.beizhu","表格下载",CompareType.EQUALS));
