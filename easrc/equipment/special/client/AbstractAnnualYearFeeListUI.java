 ...
 * output class name
 */
public abstract class AbstractAnnualYearFeeListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAnnualYearFeeListUI.class);
    /**
     * output class constructor
     */
    public AbstractAnnualYearFeeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAnnualYearFeeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.equipment.special.app", "AnnualYearFeeQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.special.app.AnnualYearFeeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.special.client", "AnnualYearFeeListUI");
    }
    /**
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","Entry.zdaNumber.tzdaNumber"};
    }
