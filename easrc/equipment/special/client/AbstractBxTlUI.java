 ...
 * output class name
 */
public abstract class AbstractBxTlUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBxTlUI.class);
     ...
     */
    public AbstractBxTlUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBxTlUI.class.getName());
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.special.app.BxTlUIHandler";
	}
    ...
    protected class actionAddAtttachment extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBxTlUI.this, "actionAddAtttachment", "actionAddAtttachment_actionPerformed", e);
        }
    }
    ...
    protected class actionViewAtttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBxTlUI.this, "actionViewAtttachment", "actionViewAtttachment_actionPerformed", e);
        }
    }
    ...
    protected class actionAttRemove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBxTlUI.this, "actionAttRemove", "actionAttRemove_actionPerformed", e);
        }
    }
    ...
    protected class actionDow extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBxTlUI.this, "actionDow", "actionDow_actionPerformed", e);
        }
    }
    ...
    protected class actionOpen extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBxTlUI.this, "actionOpen", "actionOpen_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.special.client", "BxTlUI");
    }
