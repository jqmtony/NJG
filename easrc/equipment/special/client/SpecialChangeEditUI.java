 ...
 * output class name
 */
public class SpecialChangeEditUI extends AbstractSpecialChangeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpecialChangeEditUI.class);
    
    /**
     * output class constructor
     */
    public SpecialChangeEditUI() throws Exception
    {
        super();
    }
    /**
