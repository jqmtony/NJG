...
com.kingdee.eas.port.equipment.special.OverhaulNoticeFactory.getRemoteInstance().feedInfor(editData);
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","Entry.zdaNumber.tzdaNumber","Entry.noCheckItem.name","noticeDate","planFinishDate","requestContent","feedback","backDate"};
    }
