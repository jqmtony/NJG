    ...
    private void jbInit() throws Exception
    {
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"seq","zdaNumber","equipmentName","code","useUnit","planDate","endDate","state","address","companyNumber","NO","engineNumber","carNumber","weight","useDate","createUnit","checkType","beizhu"});
