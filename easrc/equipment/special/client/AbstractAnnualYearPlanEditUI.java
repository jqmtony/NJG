 ...
 * output class name
 */
public abstract class AbstractAnnualYearPlanEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAnnualYearPlanEditUI.class);
     ...
     */
    public AbstractAnnualYearPlanEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAnnualYearPlanEditUI.class.getName());
        ...
        KDDatePicker kdtEntry_actualDate_DatePicker = new KDDatePicker();
        kdtEntry_actualDate_DatePicker.setName("kdtEntry_actualDate_DatePicker");
        kdtEntry_actualDate_DatePicker.setVisible(true);
        kdtEntry_actualDate_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntry_actualDate_CellEditor = new KDTDefaultCellEditor(kdtEntry_actualDate_DatePicker);
        this.kdtEntry.getColumn("actualDate").setEditor(kdtEntry_actualDate_CellEditor);
...
vo.put("checkType","10");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry.actualDate", java.util.Date.class, this.kdtEntry, "actualDate.text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.special.app.AnnualYearPlanEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.equipment.special.AnnualYearPlanInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entry.actualDate", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntry.getCell(rowIndex,"createUnit").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntry.getCell(rowIndex,"zdaNumber").getValue(),"mader")));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.special.client", "AnnualYearPlanEditUI");
    }
    /**
