...
public class DetectionE1 extends CoreBillEntryBase implements IDetectionE1
{
    public DetectionE1()
    {
        super();
        registerInterface(IDetectionE1.class, this);
    }
    public DetectionE1(Context ctx)
    {
        super(ctx);
        registerInterface(IDetectionE1.class, this);
    }
    ...
    private DetectionE1Controller getController() throws BOSException
    {
        return (DetectionE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDetectionE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDetectionE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
