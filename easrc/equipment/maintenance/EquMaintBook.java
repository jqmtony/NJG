...
public class EquMaintBook extends XRBillBase implements IEquMaintBook
{
    public EquMaintBook()
    {
        super();
        registerInterface(IEquMaintBook.class, this);
    }
    public EquMaintBook(Context ctx)
    {
        super(ctx);
        registerInterface(IEquMaintBook.class, this);
    }
    ...
    private EquMaintBookController getController() throws BOSException
    {
        return (EquMaintBookController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEquMaintBookCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquMaintBookCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquMaintBookCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquMaintBookInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquMaintBookInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquMaintBookInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
