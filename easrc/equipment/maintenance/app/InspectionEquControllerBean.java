...
public class InspectionEquControllerBean extends AbstractInspectionEquControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.maintenance.app.InspectionEquControllerBean");
}