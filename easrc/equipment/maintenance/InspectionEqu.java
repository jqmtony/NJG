...
public class InspectionEqu extends XRBillBase implements IInspectionEqu
{
    public InspectionEqu()
    {
        super();
        registerInterface(IInspectionEqu.class, this);
    }
    public InspectionEqu(Context ctx)
    {
        super(ctx);
        registerInterface(IInspectionEqu.class, this);
    }
    ...
    private InspectionEquController getController() throws BOSException
    {
        return (InspectionEquController)getBizController();
    }
    /**
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, InspectionEquInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public IObjectPK addnew(InspectionEquInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public InspectionEquCollection getInspectionEquCollection() throws BOSException
    {
        try {
            return getController().getInspectionEquCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InspectionEquCollection getInspectionEquCollection(EntityViewInfo view) throws BOSException
    {
        try {
            return getController().getInspectionEquCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InspectionEquCollection getInspectionEquCollection(String oql) throws BOSException
    {
        try {
            return getController().getInspectionEquCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InspectionEquInfo getInspectionEquInfo(IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            return getController().getInspectionEquInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InspectionEquInfo getInspectionEquInfo(IObjectPK pk) throws BOSException, EASBizException
    {
        try {
            return getController().getInspectionEquInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public InspectionEquInfo getInspectionEquInfo(String oql) throws BOSException, EASBizException
    {
        try {
            return getController().getInspectionEquInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@param model model
     */
    public void update(IObjectPK pk, InspectionEquInfo model) throws BOSException, EASBizException
    {
        try {
