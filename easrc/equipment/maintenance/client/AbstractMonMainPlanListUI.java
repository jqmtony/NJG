...
public abstract class AbstractMonMainPlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","planMonth.name","planTotalCost","E1.equNumber.number","E1.appDepart.name","E1.implementDepart.name"};
    }
