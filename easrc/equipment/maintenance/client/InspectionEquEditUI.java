 ...
 * output class name
 */
public class InspectionEquEditUI extends AbstractInspectionEquEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(InspectionEquEditUI.class);
    
    /**
     * output class constructor
     */
    public InspectionEquEditUI() throws Exception
    {
        super();
    }
    /**
...
//		pkBizDate.setEnabled(false);
		...
		if(getOprtState().equals(OprtState.ADDNEW)){
			...
			prmtuserDepatrt.setValue(PersonXRHelper.getDepartmentByUserCollection(personInfo));
			AdminOrgUnitCollection adcollection = PersonXRHelper.getDepartmentByUserCollection(personInfo);
			for(int j = 0; j < adcollection.size(); j++){
				txtchangNumber.setText(adcollection.get(j).getLongNumber());
			}
		}
		 String id = SysContext.getSysContext().getCurrentCtrlUnit().getId().toString();
		 StringBuffer sb = new StringBuffer();
		    sb.append(" select a.fid from CT_REC_EquId a  ");
		    sb.append(" left join T_ORG_Admin b on a.CFUsingDeptID = b.fid");
		    sb.append(" where a.CFSsOrgUnitID = '"+id+"'");
		    sb.append(" and b.flongnumber like '"+txtchangNumber.getText()+"%"+"'");
		    sb.append(" and a.CFSbStatus = '1'");
		    sb.append(" and a.CFIsccCheck = '1'");
...
//	 		 
	 		  ...
	 		  KDBizPromptBox kdtE1_repairPerson_PromptBox = new KDBizPromptBox();
		        ...
		        kdtE1.getColumn("incPerson").setEditor(kdtE1_repairPerson_CellEditor);
