...
com.kingdee.eas.port.equipment.maintenance.RepairOrderFactory.getRemoteInstance().unToVoid(editData);
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","equName.name","equModel","equAddress","repairDepart.name","repairPerson.name","repairTime","repairContent","assignee.name","acceptTime","maintenanceType.name","maintenanceProgram","E1.replaceSparePart.name","E1.repairPerson.name","BIMUDF0021","repairDate","acceptSituation","deliveryPerson.name","recipient.name","transferTime","slDepart.name","selfStudy","outsourcing","selfAmount","outAmount","E1.FaLocation.name"};
    }
