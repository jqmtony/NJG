...
com.kingdee.eas.port.equipment.maintenance.RepairOrderFactory.getRemoteInstance().equInfomation(editData);
    ...
    {
        return new String[] {"number","bizDate","status","id","CU.id","CU.name","equName.name","equModel","equAddress","repairDepart.name","repairPerson.name","repairTime","repairContent","assignee.name","planStartTime","acceptTime","actualStartTime","actualEndTime","maintenanceType.name","maintenanceProgram","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","BIMUDF0021","acceptSituation","repairDate","deliveryPerson.name","recipient.name","transferTime","slDepart.name","selfStudy","outsourcing","selfAmount","outAmount","sfjhn","baoxiuren.name","baoxiuTime","E1.equNameOne.name","E1.FaLocation.name","E1.replaceSparePart.name","E1.repairPerson.name"};
    }
