 ...
 * output class name
 */
public class ShipReportFormEditUI extends AbstractShipReportFormEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ShipReportFormEditUI.class);
    
    /**
     * output class constructor
     */
    public ShipReportFormEditUI() throws Exception
    {
        super();
    }
    /**
	...
	String cleName[] = {"±¨—πMPa","≈≈Œ¬°Ê" };
	
	public void onLoad() throws Exception {
		this.kdtE1.getColumn("zhujigangone").getStyleAttributes().setLocked(true);
		this.kdtE1.getColumn("seq").getStyleAttributes().setHided(true);
		this.kdtE1.getColumn("zhujigangtwo").getStyleAttributes().setLocked(true);
		...
		if (OprtState.ADDNEW.equals(getOprtState())) {
			...
			for (int i = 0; i < cleName.length; i++) {
				IRow IRow = this.kdtE1.addRow();
				IRow.getCell("zhujigangone").setValue("◊Ûª˙");
				IRow.getCell("zhujigangtwo").setValue(cleName[i]);
			}
			for (int i = 0; i < cleName.length; i++) {
				IRow IRow = this.kdtE1.addRow();
				IRow.getCell("zhujigangone").setValue("”“ª˙");
				IRow.getCell("zhujigangtwo").setValue(cleName[i]);
			}
		}
		
		this.kdtE1.getColumn("zhujigangone").setWidth(30);
		this.kdtE1.getColumn("zhujigangtwo").setWidth(100);
		KDTMergeManager mm = this.kdtE1.getMergeManager();
		mm.mergeBlock(0, 1, 1, 1);
		mm.mergeBlock(2, 1, 3, 1);
