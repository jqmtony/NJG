 ...
 * output class name
 */
public class EquMaintBookListUI extends AbstractEquMaintBookListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EquMaintBookListUI.class);
    
    /**
     * output class constructor
     */
    public EquMaintBookListUI() throws Exception
    {
        super();
    }
