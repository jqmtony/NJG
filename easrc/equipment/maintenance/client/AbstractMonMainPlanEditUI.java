    ...
    private void jbInit() throws Exception
    {
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtE1.putBindContents("editData",new String[] {"seq","equNumber","equName","appDepart","mainContent","planStartTime","planCompleteT","planCost","implementDepart","actualCompleteT","complete"});
