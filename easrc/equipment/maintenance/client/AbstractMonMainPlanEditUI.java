    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtE1.addKDTMouseListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTMouseListener() {
            public void tableClicked(com.kingdee.bos.ctrl.kdf.table.event.KDTMouseEvent e) {
                ...
                this.kdtE1.putBindContents("editData",new String[] {"seq","equNumber","equName","appDepart","useDepart","mainContent","weixiuType","planStartTime","planCompleteT","planWeixiuDay","planCost","implementDepart","implementUnit","actualCompleteT","complete","note","shangyuandanjuID"});
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtplanMonth,txtplanTotalCost,prmtCU,pkLastUpdateTime,prmtLastUpdateUser,pkCreateTime,prmtCreator,kdtE1,prmtAuditor,txtDescription,pkBizDate,txtNumber,pkAuditTime,comboBizStatus,comboStatus}));
