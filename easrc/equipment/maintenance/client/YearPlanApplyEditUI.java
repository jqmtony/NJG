 ...
 * output class name
 */
public class YearPlanApplyEditUI extends AbstractYearPlanApplyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(YearPlanApplyEditUI.class);
    
    /**
     * output class constructor
     */
    public YearPlanApplyEditUI() throws Exception
    {
        super();
    }
    /**
