 ...
 * output class name
 */
public class RepairOrderListUI extends AbstractRepairOrderListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RepairOrderListUI.class);
    
    /**
     * output class constructor
     */
    public RepairOrderListUI() throws Exception
    {
        super();
    }
