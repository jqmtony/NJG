 ...
 * output class name
 */
public class InspectionEquListUI extends AbstractInspectionEquListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InspectionEquListUI.class);
    
    /**
     * output class constructor
     */
    public InspectionEquListUI() throws Exception
    {
        super();
    }
