 ...
 * output class name
 */
public class EquMaintBookEditUI extends AbstractEquMaintBookEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EquMaintBookEditUI.class);
    
    /**
     * output class constructor
     */
    public EquMaintBookEditUI() throws Exception
    {
        super();
    }
    /**
