...
public abstract class AbstractMonMPApplicationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","status","id","CU.id","planMonth.name","appDepart.name","planTotalCost","preparer.name","E1.equNumber.number"};
    }
