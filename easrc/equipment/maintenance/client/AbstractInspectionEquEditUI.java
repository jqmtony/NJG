 ...
 * output class name
 */
public abstract class AbstractInspectionEquEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInspectionEquEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contuserDepatrt;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contchangNumber;
     ...
     */
    public AbstractInspectionEquEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInspectionEquEditUI.class.getName());
        ...
        this.contuserDepatrt = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contchangNumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtuserDepatrt = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtchangNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contuserDepatrt.setName("contuserDepatrt");
        this.contchangNumber.setName("contchangNumber");
        ...
        this.prmtuserDepatrt.setName("prmtuserDepatrt");
        this.txtchangNumber.setName("txtchangNumber");
        // CoreUI
        // contCreator		
        ...
        final KDBizPromptBox kdtE1_incPerson_PromptBox = new KDBizPromptBox();
        kdtE1_incPerson_PromptBox.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonQuery");
        kdtE1_incPerson_PromptBox.setVisible(true);
        kdtE1_incPerson_PromptBox.setEditable(true);
        kdtE1_incPerson_PromptBox.setDisplayFormat("$number$");
        kdtE1_incPerson_PromptBox.setEditFormat("$number$");
        kdtE1_incPerson_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtE1_incPerson_CellEditor = new KDTDefaultCellEditor(kdtE1_incPerson_PromptBox);
        this.kdtE1.getColumn("incPerson").setEditor(kdtE1_incPerson_CellEditor);
        ObjectValueRender kdtE1_incPerson_OVR = new ObjectValueRender();
        kdtE1_incPerson_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtE1.getColumn("incPerson").setRenderer(kdtE1_incPerson_OVR);
        KDComboBox kdtE1_xunjianResult_ComboBox = new KDComboBox();
        kdtE1_xunjianResult_ComboBox.setName("kdtE1_xunjianResult_ComboBox");
        kdtE1_xunjianResult_ComboBox.setVisible(true);
        kdtE1_xunjianResult_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.port.equipment.base.enumbase.CheckResult").toArray());
        KDTDefaultCellEditor kdtE1_xunjianResult_CellEditor = new KDTDefaultCellEditor(kdtE1_xunjianResult_ComboBox);
        this.kdtE1.getColumn("xunjianResult").setEditor(kdtE1_xunjianResult_CellEditor);
        KDTextArea kdtE1_question_TextArea = new KDTextArea();
        kdtE1_question_TextArea.setName("kdtE1_question_TextArea");
        kdtE1_question_TextArea.setMaxLength(500);
        KDTDefaultCellEditor kdtE1_question_CellEditor = new KDTDefaultCellEditor(kdtE1_question_TextArea);
        this.kdtE1.getColumn("question").setEditor(kdtE1_question_CellEditor);
        // contuserDepatrt		
        this.contuserDepatrt.setBoundLabelText(resHelper.getString("contuserDepatrt.boundLabelText"));		
        this.contuserDepatrt.setBoundLabelLength(100);		
        this.contuserDepatrt.setBoundLabelUnderline(true);		
        this.contuserDepatrt.setEnabled(false);		
        this.contuserDepatrt.setVisible(false);
        // contchangNumber		
        this.contchangNumber.setBoundLabelText(resHelper.getString("contchangNumber.boundLabelText"));		
        this.contchangNumber.setBoundLabelLength(100);		
        this.contchangNumber.setBoundLabelUnderline(true);		
        this.contchangNumber.setEnabled(false);		
        this.contchangNumber.setVisible(false);
        // prmtCreator		
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contStatus, new KDLayout.Constraints(369, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtE1.setBounds(new Rectangle(30, 73, 946, 478));
        kdtE1_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtE1,new com.kingdee.eas.port.equipment.maintenance.InspectionEquE1Info(),null,false);
        this.add(kdtE1_detailPanel, new KDLayout.Constraints(30, 73, 946, 478, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
vo.put("xunjianResult","10");
			}
			public void afterEvent(com.kingdee.eas.framework.client.multiDetail.DetailPanelEvent event) throws Exception {
			}
		});
        contuserDepatrt.setBounds(new Rectangle(712, 39, 270, 19));
        this.add(contuserDepatrt, new KDLayout.Constraints(712, 39, 270, 19, 0));
        contchangNumber.setBounds(new Rectangle(709, 59, 270, 19));
        this.add(contchangNumber, new KDLayout.Constraints(709, 59, 270, 19, 0));
        //contCreator
        ...
        //contuserDepatrt
        contuserDepatrt.setBoundEditor(prmtuserDepatrt);
        //contchangNumber
        contchangNumber.setBoundEditor(txtchangNumber);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("E1", com.kingdee.eas.port.equipment.maintenance.InspectionEquE1Info.class, this.kdtE1, "userObject");
		...
		dataBinder.registerBinding("userDepatrt", com.kingdee.eas.basedata.org.AdminOrgUnitInfo.class, this.prmtuserDepatrt, "data");
		dataBinder.registerBinding("changNumber", String.class, this.txtchangNumber, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.maintenance.app.InspectionEquEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.equipment.maintenance.InspectionEquInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("userDepatrt", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("changNumber", ValidateHelper.ON_SAVE);    		
	}
...
kdtE1.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtE1.getCell(rowIndex,"equNumber").getValue(),"model")));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("E1.incPerson.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("E1.incPerson.id"));
			sic.add(new SelectorItemInfo("E1.incPerson.name"));
        	sic.add(new SelectorItemInfo("E1.incPerson.number"));
		}
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("userDepatrt.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("userDepatrt.id"));
        	sic.add(new SelectorItemInfo("userDepatrt.number"));
        	sic.add(new SelectorItemInfo("userDepatrt.name"));
		}
        sic.add(new SelectorItemInfo("changNumber"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.maintenance.client", "InspectionEquEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.port.equipment.maintenance.client.InspectionEquEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.port.equipment.maintenance.InspectionEquFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.equipment.maintenance.InspectionEquInfo objectValue = new com.kingdee.eas.port.equipment.maintenance.InspectionEquInfo();
    	...
    	return "/bim/port/equipment/maintenance/InspectionEqu";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.port.equipment.maintenance.app.InspectionEquQuery");
	}
