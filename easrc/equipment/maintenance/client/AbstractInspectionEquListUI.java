...
public abstract class AbstractInspectionEquListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
     ...
     */
    public AbstractInspectionEquListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInspectionEquListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.equipment.maintenance.app", "InspectionEquQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.maintenance.app.InspectionEquListUIHandler";
	}
...
com.kingdee.eas.port.equipment.maintenance.InspectionEquFactory.getRemoteInstance().excel(editData);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.maintenance.client", "InspectionEquListUI");
    }
    /**
    ...
    {
        return new String[] {"number","status","bizDate","id","CU.id","CU.name","E1.equNumber.number","E1.incPerson.name","userDepatrt.name","changNumber","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime"};
    }
