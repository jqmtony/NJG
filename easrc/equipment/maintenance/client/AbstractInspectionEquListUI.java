...
public abstract class AbstractInspectionEquListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"status","number","bizDate","id","CU.id","CU.name","E1.seq","E1.equNumber.number","E1.equName","E1.model","E1.incPerson.name","E1.xunjianResult","E1.question","userDepatrt.name","changNumber","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime"});
...
com.kingdee.eas.port.equipment.maintenance.InspectionEquFactory.getRemoteInstance().excel(editData);
    ...
    {
        return new String[] {"status","number","bizDate","id","CU.id","CU.name","E1.equNumber.number","E1.incPerson.name","userDepatrt.name","changNumber","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime"};
    }
