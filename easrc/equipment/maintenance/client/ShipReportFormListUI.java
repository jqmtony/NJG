 ...
 * output class name
 */
public class ShipReportFormListUI extends AbstractShipReportFormListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ShipReportFormListUI.class);
    
    /**
     * output class constructor
     */
    public ShipReportFormListUI() throws Exception
    {
        super();
    }
