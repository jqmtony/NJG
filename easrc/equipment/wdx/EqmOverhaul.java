...
public class EqmOverhaul extends XRBillBase implements IEqmOverhaul
{
    public EqmOverhaul()
    {
        super();
        registerInterface(IEqmOverhaul.class, this);
    }
    public EqmOverhaul(Context ctx)
    {
        super(ctx);
        registerInterface(IEqmOverhaul.class, this);
    }
    ...
    private EqmOverhaulController getController() throws BOSException
    {
        return (EqmOverhaulController)getBizController();
    }
    /**
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, EqmOverhaulInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public IObjectPK addnew(EqmOverhaulInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@return
     */
    public EqmOverhaulCollection getEqmOverhaulCollection() throws BOSException
    {
        try {
            return getController().getEqmOverhaulCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public EqmOverhaulCollection getEqmOverhaulCollection(EntityViewInfo view) throws BOSException
    {
        try {
            return getController().getEqmOverhaulCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public EqmOverhaulCollection getEqmOverhaulCollection(String oql) throws BOSException
    {
        try {
            return getController().getEqmOverhaulCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public EqmOverhaulInfo getEqmOverhaulInfo(IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            return getController().getEqmOverhaulInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public EqmOverhaulInfo getEqmOverhaulInfo(IObjectPK pk) throws BOSException, EASBizException
    {
        try {
            return getController().getEqmOverhaulInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@return
     */
    public EqmOverhaulInfo getEqmOverhaulInfo(String oql) throws BOSException, EASBizException
    {
        try {
            return getController().getEqmOverhaulInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
     ...
     *@param model model
     */
    public void update(IObjectPK pk, EqmOverhaulInfo model) throws BOSException, EASBizException
    {
        try {
