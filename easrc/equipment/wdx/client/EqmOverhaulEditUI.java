 ...
 * output class name
 */
public class EqmOverhaulEditUI extends AbstractEqmOverhaulEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmOverhaulEditUI.class);
    
    /**
     * output class constructor
     */
    public EqmOverhaulEditUI() throws Exception
    {
        super();
    }
    /**
...
//		txtplanCost.setEnabled(false);
	...
	protected void verifyInput(ActionEvent e) throws Exception {
		 if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtexpenseAccount.getText())) {
	 			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"决算费用"});
	 		}
		super.verifyInput(e);
	}
}