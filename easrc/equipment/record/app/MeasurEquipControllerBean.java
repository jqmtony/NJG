...
public class MeasurEquipControllerBean extends AbstractMeasurEquipControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.record.app.MeasurEquipControllerBean");
}