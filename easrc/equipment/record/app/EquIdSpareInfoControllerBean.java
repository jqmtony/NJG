...
public class EquIdSpareInfoControllerBean extends AbstractEquIdSpareInfoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.record.app.EquIdSpareInfoControllerBean");
}