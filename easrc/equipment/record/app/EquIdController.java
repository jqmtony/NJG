...
public interface EquIdController extends XRBillBaseController
{
    public void addnew(Context ctx, IObjectPK pk, EquIdInfo model) throws BOSException, EASBizException, RemoteException;
    public IObjectPK addnew(Context ctx, EquIdInfo model) throws BOSException, EASBizException, RemoteException;
    ...
    public EquIdCollection getEquIdCollection(Context ctx) throws BOSException, RemoteException;
    public EquIdCollection getEquIdCollection(Context ctx, EntityViewInfo view) throws BOSException, RemoteException;
    public EquIdCollection getEquIdCollection(Context ctx, String oql) throws BOSException, RemoteException;
    public IObjectPK[] getPKList(Context ctx) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, FilterInfo filter, SorterItemCollection sorter) throws BOSException, EASBizException, RemoteException;
    public IObjectPK[] getPKList(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    public EquIdInfo getEquIdInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public EquIdInfo getEquIdInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException, RemoteException;
    public EquIdInfo getEquIdInfo(Context ctx, String oql) throws BOSException, EASBizException, RemoteException;
    ...
    public void update(Context ctx, IObjectPK pk, EquIdInfo model) throws BOSException, EASBizException, RemoteException;
