...
public class TankTechnicalControllerBean extends AbstractTankTechnicalControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.record.app.TankTechnicalControllerBean");
}