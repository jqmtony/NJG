...
public class EquIdTechnologyPar extends CoreBillEntryBase implements IEquIdTechnologyPar
{
    public EquIdTechnologyPar()
    {
        super();
        registerInterface(IEquIdTechnologyPar.class, this);
    }
    public EquIdTechnologyPar(Context ctx)
    {
        super(ctx);
        registerInterface(IEquIdTechnologyPar.class, this);
    }
    ...
    private EquIdTechnologyParController getController() throws BOSException
    {
        return (EquIdTechnologyParController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEquIdTechnologyParInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdTechnologyParInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdTechnologyParInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdTechnologyParCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdTechnologyParCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdTechnologyParCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
