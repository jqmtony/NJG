 ...
 * output class name
 */
public class PressurePipingEditUI extends AbstractPressurePipingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PressurePipingEditUI.class);
    
    /**
     * output class constructor
     */
    public PressurePipingEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    /**
     * output actionExcel_actionPerformed
     */
