 ...
 * output class name
 */
public class TankTechnicalListUI extends AbstractTankTechnicalListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TankTechnicalListUI.class);
    
    /**
     * output class constructor
     */
    public TankTechnicalListUI() throws Exception
    {
        super();
    }
