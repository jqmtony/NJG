...
public abstract class AbstractEquIdListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"name","model","size","weight","qyDate","serialNumber","sbStatus","special","ccNumber","tzdaNumber","tzsbStatus","assetValue","EqmCategory","number","wxOrgUnit.id","id","specialType.name","cityPeriod","portPeriod","code","engineNumber","carNumber","ratedWeight","textDate1","dayone","daytow"});
...
com.kingdee.eas.port.equipment.record.EquIdFactory.getRemoteInstance().excelFoced(editData);
    ...
    {
        return new String[] {"name","model","size","weight","qyDate","serialNumber","sbStatus","special","ccNumber","tzdaNumber","tzsbStatus","assetValue","EqmCategory","number","wxOrgUnit.id","id","specialType.name","cityPeriod","portPeriod","code","engineNumber","carNumber","ratedWeight","textDate1","dayone","daytow"};
    }
