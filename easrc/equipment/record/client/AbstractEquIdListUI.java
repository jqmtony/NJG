...
com.kingdee.eas.port.equipment.record.EquIdFactory.getRemoteInstance().xiangxi(editData);
    ...
    {
        return new String[] {"ssOrgUnit.name","number","name","model","eqmType.name","innerNumber","qyDate","sbStatus","special","ratedWeight","isbaoxian","isccCheck","ccNumber","tzdaNumber","cityTest","portTest","chuanCheck","cityPeriod","specialType.name","code","engineNumber","carNumber","textDate1","status","textType.name","equTypeone.name","asset.number","assetValue","nowAmount","oldYear","createTime","lastUpdateTime","wxOrgUnit.id","id"};
    }
