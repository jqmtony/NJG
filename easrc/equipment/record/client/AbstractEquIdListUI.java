...
com.kingdee.eas.port.equipment.record.EquIdFactory.getRemoteInstance().excelEqu(editData);
    ...
    {
        return new String[] {"number","name","model","size","weight","qyDate","serialNumber","sbStatus","special","ccNumber","tzdaNumber","tzsbStatus","assetValue","EqmCategory","wxOrgUnit.id","id","specialType.name","cityPeriod","portPeriod","code","engineNumber","carNumber","ratedWeight","textDate1","dayone","daytow","testDay","status","telePhoneNumber","actrueTime","responsible","inStreet","inspectorOne","textType.name","equTypeone.name"};
    }
