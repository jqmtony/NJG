 ...
 * output class name
 */
public class TankTechnicalEditUI extends AbstractTankTechnicalEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TankTechnicalEditUI.class);
    
    /**
     * output class constructor
     */
    public TankTechnicalEditUI() throws Exception
    {
        super();
    }
    /**
