 ...
 * output class name
 */
public class MeasurEquipListUI extends AbstractMeasurEquipListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MeasurEquipListUI.class);
    
    /**
     * output class constructor
     */
    public MeasurEquipListUI() throws Exception
    {
        super();
    }
    ...
    public void actionExcel_actionPerformed(ActionEvent e) throws Exception
    {
        ...
        String strSolutionName = "eas.equ.018";
