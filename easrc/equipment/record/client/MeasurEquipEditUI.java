 ...
 * output class name
 */
public class MeasurEquipEditUI extends AbstractMeasurEquipEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MeasurEquipEditUI.class);
    
    /**
     * output class constructor
     */
    public MeasurEquipEditUI() throws Exception
    {
        super();
    }
    /**
