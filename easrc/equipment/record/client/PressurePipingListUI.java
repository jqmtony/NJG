 ...
 * output class name
 */
public class PressurePipingListUI extends AbstractPressurePipingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PressurePipingListUI.class);
    
    /**
     * output class constructor
     */
    public PressurePipingListUI() throws Exception
    {
        super();
    }
    ...
    public void actionExcel_actionPerformed(ActionEvent e) throws Exception
    {
        ...
        String strSolutionName = "eas.equ.019";
