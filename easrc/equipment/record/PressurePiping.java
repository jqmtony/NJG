...
public class PressurePiping extends XRBillBase implements IPressurePiping
{
    public PressurePiping()
    {
        super();
        registerInterface(IPressurePiping.class, this);
    }
    public PressurePiping(Context ctx)
    {
        super(ctx);
        registerInterface(IPressurePiping.class, this);
    }
    ...
    private PressurePipingController getController() throws BOSException
    {
        return (PressurePipingController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPressurePipingCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPressurePipingCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPressurePipingCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPressurePipingInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPressurePipingInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPressurePipingInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
