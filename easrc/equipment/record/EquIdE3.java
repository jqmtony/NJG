...
public class EquIdE3 extends CoreBillEntryBase implements IEquIdE3
{
    public EquIdE3()
    {
        super();
        registerInterface(IEquIdE3.class, this);
    }
    public EquIdE3(Context ctx)
    {
        super(ctx);
        registerInterface(IEquIdE3.class, this);
    }
    ...
    private EquIdE3Controller getController() throws BOSException
    {
        return (EquIdE3Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEquIdE3Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdE3Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdE3Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdE3Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdE3Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquIdE3Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
