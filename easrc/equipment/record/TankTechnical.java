...
public class TankTechnical extends XRBillBase implements ITankTechnical
{
    public TankTechnical()
    {
        super();
        registerInterface(ITankTechnical.class, this);
    }
    public TankTechnical(Context ctx)
    {
        super(ctx);
        registerInterface(ITankTechnical.class, this);
    }
    ...
    private TankTechnicalController getController() throws BOSException
    {
        return (TankTechnicalController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTankTechnicalCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTankTechnicalCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTankTechnicalCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTankTechnicalInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTankTechnicalInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTankTechnicalInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
