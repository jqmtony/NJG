 ...
 * output class name
 */
public abstract class AbstractCzUnitListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCzUnitListUI.class);
    /**
     * output class constructor
     */
    public AbstractCzUnitListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCzUnitListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.equipment.base.app", "CzUnitQuery");
        // CoreUI		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.base.app.CzUnitListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.base.client", "CzUnitListUI");
    }
