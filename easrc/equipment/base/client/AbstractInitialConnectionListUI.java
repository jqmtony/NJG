 ...
 * output class name
 */
public abstract class AbstractInitialConnectionListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInitialConnectionListUI.class);
    /**
     * output class constructor
     */
    public AbstractInitialConnectionListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.base.app.InitialConnectionListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.base.client", "InitialConnectionListUI");
    }
