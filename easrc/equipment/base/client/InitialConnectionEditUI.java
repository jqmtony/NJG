 ...
 * output class name
 */
public class InitialConnectionEditUI extends AbstractInitialConnectionEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(InitialConnectionEditUI.class);
    
    /**
     * output class constructor
     */
    public InitialConnectionEditUI() throws Exception
    {
        super();
    }
    /**
    	  ...
    	  KDBizPromptBox kdtE1_equNumber_PromptBox = new KDBizPromptBox();
	        ...
	        kdtE1_equNumber_PromptBox.setCommitFormat("$number$");
			 ...
			 FilterInfo filter = new FilterInfo();
	 		 ...
	 		 kdtE1.getColumn("equpment").setEditor(kdtEntry_feeType_CellEditor);
    }
