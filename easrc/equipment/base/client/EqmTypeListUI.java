 ...
 * output class name
 */
public class EqmTypeListUI extends AbstractEqmTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmTypeListUI.class);
    
    /**
     * output class constructor
     */
    public EqmTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.port.equipment.base.client.EqmTypeTreeEditUI.class.getName();
    }
