 ...
 * output class name
 */
public class CzUnitEditUI extends AbstractCzUnitEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CzUnitEditUI.class);
    
    /**
     * output class constructor
     */
    public CzUnitEditUI() throws Exception
    {
        super();
    }
    /**
