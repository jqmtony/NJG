...
public class TestTypeControllerBean extends AbstractTestTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.base.app.TestTypeControllerBean");
}