...
public class MonthTime extends XRDataBase implements IMonthTime
{
    public MonthTime()
    {
        super();
        registerInterface(IMonthTime.class, this);
    }
    public MonthTime(Context ctx)
    {
        super(ctx);
        registerInterface(IMonthTime.class, this);
    }
    ...
    private MonthTimeController getController() throws BOSException
    {
        return (MonthTimeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMonthTimeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthTimeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthTimeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthTimeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthTimeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthTimeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
