...
public class MaintenanceType extends XRDataBase implements IMaintenanceType
{
    public MaintenanceType()
    {
        super();
        registerInterface(IMaintenanceType.class, this);
    }
    public MaintenanceType(Context ctx)
    {
        super(ctx);
        registerInterface(IMaintenanceType.class, this);
    }
    ...
    private MaintenanceTypeController getController() throws BOSException
    {
        return (MaintenanceTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMaintenanceTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenanceTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenanceTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenanceTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenanceTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenanceTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
