...
public class SpecialType extends XRDataBase implements ISpecialType
{
    public SpecialType()
    {
        super();
        registerInterface(ISpecialType.class, this);
    }
    public SpecialType(Context ctx)
    {
        super(ctx);
        registerInterface(ISpecialType.class, this);
    }
    ...
    private SpecialTypeController getController() throws BOSException
    {
        return (SpecialTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSpecialTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
