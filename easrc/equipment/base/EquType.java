...
public class EquType extends XRDataBase implements IEquType
{
    public EquType()
    {
        super();
        registerInterface(IEquType.class, this);
    }
    public EquType(Context ctx)
    {
        super(ctx);
        registerInterface(IEquType.class, this);
    }
    ...
    private EquTypeController getController() throws BOSException
    {
        return (EquTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEquTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEquTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
