 ...
 * output class name
 */
public abstract class AbstractQuestionTypeTteeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuestionTypeTteeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractQuestionTypeTteeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractQuestionTypeTteeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuestionTypeTteeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.base.app", "QuestionTypeTteeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.QuestionTypeTteeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "QuestionTypeTteeListUI");
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.QuestionTypeTteeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.pm.base.QuestionTypeTteeInfo objectValue = new com.kingdee.eas.port.pm.base.QuestionTypeTteeInfo();		
        return objectValue;
    }
