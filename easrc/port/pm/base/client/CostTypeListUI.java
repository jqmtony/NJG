 ...
 * output class name
 */
public class CostTypeListUI extends AbstractCostTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostTypeListUI.class);
    
    /**
     * output class constructor
     */
    public CostTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.client.CostTypeTreeEditUI.class.getName();
    }
