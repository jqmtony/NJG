 ...
 * output class name
 */
public abstract class AbstractReviewerListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReviewerListUI.class);
    /**
     * output class constructor
     */
    public AbstractReviewerListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.ReviewerListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "ReviewerListUI");
    }
