 ...
 * output class name
 */
public class QuestionTypeTteeListUI extends AbstractQuestionTypeTteeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(QuestionTypeTteeListUI.class);
    
    /**
     * output class constructor
     */
    public QuestionTypeTteeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.client.QuestionTypeTteeTreeEditUI.class.getName();
    }
