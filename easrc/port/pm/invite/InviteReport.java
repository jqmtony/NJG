...
public class InviteReport extends XRBillBase implements IInviteReport
{
    public InviteReport()
    {
        super();
        registerInterface(IInviteReport.class, this);
    }
    public InviteReport(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteReport.class, this);
    }
    ...
    private InviteReportController getController() throws BOSException
    {
        return (InviteReportController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteReportCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
