...
public class EvaluationSum extends XRBillBase implements IEvaluationSum
{
    public EvaluationSum()
    {
        super();
        registerInterface(IEvaluationSum.class, this);
    }
    public EvaluationSum(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationSum.class, this);
    }
    ...
    private EvaluationSumController getController() throws BOSException
    {
        return (EvaluationSumController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationSumCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
