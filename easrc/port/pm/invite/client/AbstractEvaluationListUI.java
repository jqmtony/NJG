 ...
 * output class name
 */
public abstract class AbstractEvaluationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEvaluationListUI.class);
    /**
     * output class constructor
     */
    public AbstractEvaluationListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEvaluationListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.invite.app", "EvaluationQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invite.app.EvaluationListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invite.client", "EvaluationListUI");
    }
    /**
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","inviteReport.reportName","prjName","evaSolution","evaDate","basePrice"};
    }
