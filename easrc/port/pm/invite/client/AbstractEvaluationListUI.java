...
public abstract class AbstractEvaluationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","inviteReport.reportName","prjName","evaSolution","evaDate","basePrice","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","bizDate","id","CU.id"};
    }
