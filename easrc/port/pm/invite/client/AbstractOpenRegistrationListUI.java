...
public abstract class AbstractOpenRegistrationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","opLocation","opDate","reportName.projectNumber","endDate","reportNumber","Entry.supplierName.supplierName","regName","coefficient"};
    }
