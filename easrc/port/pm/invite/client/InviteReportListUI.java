 ...
 * output class name
 */
public class InviteReportListUI extends AbstractInviteReportListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InviteReportListUI.class);
    
    /**
     * output class constructor
     */
    public InviteReportListUI() throws Exception
    {
        super();
    }
    @Override
