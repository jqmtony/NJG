...
public abstract class AbstractJudgesComfirmListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","planNumber","inviteType","prjName","orgUnit","department.name","comment","Entry.judgeNumber.number","planName.reportName"};
    }
