...
public abstract class AbstractInvitePlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","planName","startDate","endDate","inDate","response.name","department.name","BIMUDF0009","project.name"};
    }
