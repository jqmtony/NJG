...
public abstract class AbstractInviteReportEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        KDFormattedTextField kdtEntry2_seq_TextField = new KDFormattedTextField();
        kdtEntry2_seq_TextField.setName("kdtEntry2_seq_TextField");
        kdtEntry2_seq_TextField.setVisible(true);
        kdtEntry2_seq_TextField.setEditable(true);
        kdtEntry2_seq_TextField.setHorizontalAlignment(2);
        kdtEntry2_seq_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntry2_seq_CellEditor = new KDTDefaultCellEditor(kdtEntry2_seq_TextField);
        this.kdtEntry2.getColumn("seq").setEditor(kdtEntry2_seq_CellEditor);
        ...
        KDFormattedTextField kdtEntry5_seq_TextField = new KDFormattedTextField();
        kdtEntry5_seq_TextField.setName("kdtEntry5_seq_TextField");
        kdtEntry5_seq_TextField.setVisible(true);
        kdtEntry5_seq_TextField.setEditable(true);
        kdtEntry5_seq_TextField.setHorizontalAlignment(2);
        kdtEntry5_seq_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntry5_seq_CellEditor = new KDTDefaultCellEditor(kdtEntry5_seq_TextField);
        this.kdtEntry5.getColumn("seq").setEditor(kdtEntry5_seq_CellEditor);
        ...
        KDFormattedTextField kdtEntry3_seq_TextField = new KDFormattedTextField();
        kdtEntry3_seq_TextField.setName("kdtEntry3_seq_TextField");
        kdtEntry3_seq_TextField.setVisible(true);
        kdtEntry3_seq_TextField.setEditable(true);
        kdtEntry3_seq_TextField.setHorizontalAlignment(2);
        kdtEntry3_seq_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntry3_seq_CellEditor = new KDTDefaultCellEditor(kdtEntry3_seq_TextField);
        this.kdtEntry3.getColumn("seq").setEditor(kdtEntry3_seq_CellEditor);
        ...
        // prmtproName		
        this.prmtproName.setQueryInfo("com.kingdee.eas.port.pm.project.app.PortProjectQuery");		
        ...
        this.prmtproName.setRequired(false);
        		prmtproName.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.port.pm.project.client.PortProjectListUI prmtproName_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmtproName_F7ListUI == null) {
					try {
						prmtproName_F7ListUI = new com.kingdee.eas.port.pm.project.client.PortProjectListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(prmtproName_F7ListUI));
					prmtproName_F7ListUI.setF7Use(true,ctx);
					prmtproName.setSelector(prmtproName_F7ListUI);
				}
			}
		});
        ...
        KDFormattedTextField kdtEntry1_seq_TextField = new KDFormattedTextField();
        kdtEntry1_seq_TextField.setName("kdtEntry1_seq_TextField");
        kdtEntry1_seq_TextField.setVisible(true);
        kdtEntry1_seq_TextField.setEditable(true);
        kdtEntry1_seq_TextField.setHorizontalAlignment(2);
        kdtEntry1_seq_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntry1_seq_CellEditor = new KDTDefaultCellEditor(kdtEntry1_seq_TextField);
        this.kdtEntry1.getColumn("seq").setEditor(kdtEntry1_seq_CellEditor);
        // txtreportName		
        ...
        KDFormattedTextField kdtEntry4_seq_TextField = new KDFormattedTextField();
        kdtEntry4_seq_TextField.setName("kdtEntry4_seq_TextField");
        kdtEntry4_seq_TextField.setVisible(true);
        kdtEntry4_seq_TextField.setEditable(true);
        kdtEntry4_seq_TextField.setHorizontalAlignment(2);
        kdtEntry4_seq_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntry4_seq_CellEditor = new KDTDefaultCellEditor(kdtEntry4_seq_TextField);
        this.kdtEntry4.getColumn("seq").setEditor(kdtEntry4_seq_CellEditor);
        // contrmhigh		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtBIMUDF0004,comboStatus,comboBizStatus,pkAuditTime,txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,pkCreateTime,prmtLastUpdateUser,pkLastUpdateTime,prmtCU,prmtdevOrg,prmtuseOrg,prmtproName,txtinviteBudget,prmtinviteType,pkinviteDate,pkopenDate,pksubDate,prmtapplicant,pkaudDate,txtpaperFee,txtbidBond,judgeSolution,txtproSite,prmtevaTemplate,kdtEntry3,kdtEntry2,kdtEntry1,kdtEntry5,kdtEntry4,txtreportName,txtprojectNumber,prmtvalidTemplate,txtrmhigh,txtrmlow,txtbusinessScore,txttechScore,txtreduHigh,txtreduLow}));
    ...
    {
        this.setBounds(new Rectangle(10, 10, 1015, 1000));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 1015, 1000));
        kDScrollPane1.setBounds(new Rectangle(3, 3, 1015, 1000));
        this.add(kDScrollPane1, new KDLayout.Constraints(3, 3, 1015, 1000, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDScrollPane1
        kDScrollPane1.getViewport().add(kDPanel3, null);
        //kDPanel3
        kDPanel3.setLayout(new KDLayout());
        kDPanel3.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1015, 1000));        contCreator.setBounds(new Rectangle(25, 785, 270, 19));
        kDPanel3.add(contCreator, new KDLayout.Constraints(25, 785, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(25, 816, 270, 19));
        kDPanel3.add(contCreateTime, new KDLayout.Constraints(25, 816, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditTime.setBounds(new Rectangle(693, 816, 270, 19));
        kDPanel3.add(contAuditTime, new KDLayout.Constraints(693, 816, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(693, 785, 270, 19));
        kDPanel3.add(contAuditor, new KDLayout.Constraints(693, 785, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel2.setBounds(new Rectangle(1, 205, 1005, 304));
        kDPanel3.add(kDPanel2, new KDLayout.Constraints(1, 205, 1005, 304, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel1.setBounds(new Rectangle(1, 3, 1006, 199));
        kDPanel3.add(kDPanel1, new KDLayout.Constraints(1, 3, 1006, 199, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contBizDate.setBounds(new Rectangle(689, 933, 270, 19));
        kDPanel3.add(contBizDate, new KDLayout.Constraints(689, 933, 270, 19, 0));
        contDescription.setBounds(new Rectangle(358, 933, 270, 19));
        kDPanel3.add(contDescription, new KDLayout.Constraints(358, 933, 270, 19, 0));
        contBizStatus.setBounds(new Rectangle(25, 966, 270, 19));
        kDPanel3.add(contBizStatus, new KDLayout.Constraints(25, 966, 270, 19, 0));
        contLastUpdateTime.setBounds(new Rectangle(359, 816, 270, 19));
        kDPanel3.add(contLastUpdateTime, new KDLayout.Constraints(359, 816, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCU.setBounds(new Rectangle(25, 933, 270, 19));
        kDPanel3.add(contCU, new KDLayout.Constraints(25, 933, 270, 19, 0));
        contLastUpdateUser.setBounds(new Rectangle(359, 785, 270, 19));
        kDPanel3.add(contLastUpdateUser, new KDLayout.Constraints(359, 785, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDPanel4.setBounds(new Rectangle(1, 511, 1004, 178));
        kDPanel3.add(kDPanel4, new KDLayout.Constraints(1, 511, 1004, 178, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel5.setBounds(new Rectangle(1, 694, 1000, 83));
        kDPanel3.add(kDPanel5, new KDLayout.Constraints(1, 694, 1000, 83, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        kDPanel2.putClientProperty("OriginalBounds", new Rectangle(1, 205, 1005, 304));        contjudgeSolution.setBounds(new Rectangle(17, 153, 270, 19));
        kDPanel2.add(contjudgeSolution, new KDLayout.Constraints(17, 153, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsubDate.setBounds(new Rectangle(17, 107, 270, 19));
        kDPanel2.add(contsubDate, new KDLayout.Constraints(17, 107, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        continviteType.setBounds(new Rectangle(17, 130, 270, 19));
        kDPanel2.add(continviteType, new KDLayout.Constraints(17, 130, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        continviteBudget.setBounds(new Rectangle(17, 15, 270, 19));
        kDPanel2.add(continviteBudget, new KDLayout.Constraints(17, 15, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        continviteDate.setBounds(new Rectangle(17, 84, 270, 19));
        kDPanel2.add(continviteDate, new KDLayout.Constraints(17, 84, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contapplicant.setBounds(new Rectangle(17, 222, 270, 19));
        kDPanel2.add(contapplicant, new KDLayout.Constraints(17, 222, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpaperFee.setBounds(new Rectangle(17, 245, 270, 19));
        kDPanel2.add(contpaperFee, new KDLayout.Constraints(17, 245, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbidBond.setBounds(new Rectangle(17, 268, 270, 19));
        kDPanel2.add(contbidBond, new KDLayout.Constraints(17, 268, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contaudDate.setBounds(new Rectangle(17, 61, 270, 19));
        kDPanel2.add(contaudDate, new KDLayout.Constraints(17, 61, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contopenDate.setBounds(new Rectangle(17, 38, 270, 19));
        kDPanel2.add(contopenDate, new KDLayout.Constraints(17, 38, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contevaTemplate.setBounds(new Rectangle(17, 176, 270, 19));
        kDPanel2.add(contevaTemplate, new KDLayout.Constraints(17, 176, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDContainer1.setBounds(new Rectangle(299, 158, 440, 131));
        kDPanel2.add(kDContainer1, new KDLayout.Constraints(299, 158, 440, 131, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDContainer2.setBounds(new Rectangle(744, 158, 244, 131));
        kDPanel2.add(kDContainer2, new KDLayout.Constraints(744, 158, 244, 131, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDContainer3.setBounds(new Rectangle(299, 12, 689, 145));
        kDPanel2.add(kDContainer3, new KDLayout.Constraints(299, 12, 689, 145, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contvalidTemplate.setBounds(new Rectangle(17, 199, 270, 19));
        kDPanel2.add(contvalidTemplate, new KDLayout.Constraints(17, 199, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contjudgeSolution
...
kDContainer3.getContentPane().setLayout(new BorderLayout(0, 0));        kdtEntry3_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry3,new com.kingdee.eas.port.pm.invite.InviteReportEntry3Info(),null,false);
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(1, 3, 1006, 199));        contdevOrg.setBounds(new Rectangle(718, 39, 270, 19));
        kDPanel1.add(contdevOrg, new KDLayout.Constraints(718, 39, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contproName.setBounds(new Rectangle(362, 16, 270, 19));
        kDPanel1.add(contproName, new KDLayout.Constraints(362, 16, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contuseOrg.setBounds(new Rectangle(362, 39, 270, 19));
        kDPanel1.add(contuseOrg, new KDLayout.Constraints(362, 39, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDButton1.setBounds(new Rectangle(718, 14, 133, 21));
        kDPanel1.add(kDButton1, new KDLayout.Constraints(718, 14, 133, 21, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contproSite.setBounds(new Rectangle(15, 62, 270, 19));
        kDPanel1.add(contproSite, new KDLayout.Constraints(15, 62, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBIMUDF0004.setBounds(new Rectangle(15, 83, 505, 101));
        kDPanel1.add(contBIMUDF0004, new KDLayout.Constraints(15, 83, 505, 101, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDContainer4.setBounds(new Rectangle(524, 83, 464, 101));
        kDPanel1.add(kDContainer4, new KDLayout.Constraints(524, 83, 464, 101, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contreportName.setBounds(new Rectangle(15, 16, 270, 19));
        kDPanel1.add(contreportName, new KDLayout.Constraints(15, 16, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contprojectNumber.setBounds(new Rectangle(15, 39, 270, 19));
        kDPanel1.add(contprojectNumber, new KDLayout.Constraints(15, 39, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(362, 62, 270, 19));
        kDPanel1.add(contNumber, new KDLayout.Constraints(362, 62, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contStatus.setBounds(new Rectangle(718, 62, 270, 19));
        kDPanel1.add(contStatus, new KDLayout.Constraints(718, 62, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contdevOrg
...
kDContainer4.getContentPane().setLayout(new BorderLayout(0, 0));        kdtEntry1_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry1,new com.kingdee.eas.port.pm.invite.InviteReportEntry1Info(),null,false);
        ...
        kDPanel4.putClientProperty("OriginalBounds", new Rectangle(1, 511, 1004, 178));        kdtEntry4.setBounds(new Rectangle(31, 15, 847, 151));
        ...
        kDPanel4.add(kdtEntry4_detailPanel, new KDLayout.Constraints(31, 15, 847, 151, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDPanel5
        kDPanel5.setLayout(new KDLayout());
        kDPanel5.putClientProperty("OriginalBounds", new Rectangle(1, 694, 1000, 83));        contrmhigh.setBounds(new Rectangle(25, 17, 270, 19));
        kDPanel5.add(contrmhigh, new KDLayout.Constraints(25, 17, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contrmlow.setBounds(new Rectangle(357, 17, 270, 19));
        kDPanel5.add(contrmlow, new KDLayout.Constraints(357, 17, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbusinessScore.setBounds(new Rectangle(357, 43, 270, 19));
        kDPanel5.add(contbusinessScore, new KDLayout.Constraints(357, 43, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttechScore.setBounds(new Rectangle(690, 43, 270, 19));
        kDPanel5.add(conttechScore, new KDLayout.Constraints(690, 43, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contreduHigh.setBounds(new Rectangle(690, 17, 270, 19));
        kDPanel5.add(contreduHigh, new KDLayout.Constraints(690, 17, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contreduLow.setBounds(new Rectangle(25, 43, 270, 19));
        kDPanel5.add(contreduLow, new KDLayout.Constraints(25, 43, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contrmhigh
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("proName", com.kingdee.eas.port.pm.project.PortProjectInfo.class, this.prmtproName, "data");
