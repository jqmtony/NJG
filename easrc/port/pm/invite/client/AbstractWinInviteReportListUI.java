...
public abstract class AbstractWinInviteReportListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","inviteReport.number","content","inviteType.name","inviteDate","address","Judges.org.name","budgetAmount","evaSolution","evaDate","invitePrjName"};
    }
