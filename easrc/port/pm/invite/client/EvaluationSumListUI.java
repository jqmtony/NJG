 ...
 * output class name
 */
public class EvaluationSumListUI extends AbstractEvaluationSumListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EvaluationSumListUI.class);
    
    /**
     * output class constructor
     */
    public EvaluationSumListUI() throws Exception
    {
        super();
    }
