...
public class InviteReportEntry2 extends CoreBillEntryBase implements IInviteReportEntry2
{
    public InviteReportEntry2()
    {
        super();
        registerInterface(IInviteReportEntry2.class, this);
    }
    public InviteReportEntry2(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteReportEntry2.class, this);
    }
    ...
    private InviteReportEntry2Controller getController() throws BOSException
    {
        return (InviteReportEntry2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteReportEntry2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportEntry2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportEntry2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportEntry2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportEntry2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportEntry2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
