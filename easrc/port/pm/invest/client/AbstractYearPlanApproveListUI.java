 ...
 * output class name
 */
public abstract class AbstractYearPlanApproveListUI extends com.kingdee.eas.framework.client.BillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractYearPlanApproveListUI.class);
    /**
     * output class constructor
     */
    public AbstractYearPlanApproveListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractYearPlanApproveListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.invest.app", "YearPlanAppoveQuery");
        // CoreUI		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.app.YearPlanApproveListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.client", "YearPlanApproveListUI");
    }
