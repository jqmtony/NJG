...
public abstract class AbstractYearInvestPlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"id","number","projectName","objectState","CU.name","requestOrg.name","requestPerson.name","planStartDate","planEndDate","amount","investAmount","chancedAmount","addInvestAmount","year","planType","address","CU.id"};
    }
