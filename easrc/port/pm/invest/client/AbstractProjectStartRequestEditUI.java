...
public abstract class AbstractProjectStartRequestEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 974, 393));        kdtE1.setBounds(new Rectangle(4, 4, 962, 378));
        kDPanel1.add(kdtE1, new KDLayout.Constraints(4, 4, 962, 378, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDPanel2
        kDPanel2.setLayout(new KDLayout());
        kDPanel2.putClientProperty("OriginalBounds", new Rectangle(0, 0, 974, 393));        contscheme.setBounds(new Rectangle(4, 2, 960, 371));
        kDPanel2.add(contscheme, new KDLayout.Constraints(4, 2, 960, 371, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contscheme
