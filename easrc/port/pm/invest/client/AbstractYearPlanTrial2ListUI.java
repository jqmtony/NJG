 ...
 * output class name
 */
public abstract class AbstractYearPlanTrial2ListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractYearPlanTrial2ListUI.class);
    /**
     * output class constructor
     */
    public AbstractYearPlanTrial2ListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractYearPlanTrial2ListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.app.YearPlanTrial2ListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.client", "YearPlanTrial2ListUI");
    }
