 ...
 * output class name
 */
public class ProjectAdjuestListUI extends AbstractProjectAdjuestListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectAdjuestListUI.class);
    
    /**
     * output class constructor
     */
    public ProjectAdjuestListUI() throws Exception
    {
        super();
    }
