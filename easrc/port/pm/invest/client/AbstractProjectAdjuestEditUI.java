 ...
 * output class name
 */
public abstract class AbstractProjectAdjuestEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectAdjuestEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contadjuestName;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtadjuestName;
    protected com.kingdee.bos.ctrl.swing.KDComboBox adjustType;
    ...
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPaneadjustReson;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtadjustReson;
    ...
    protected com.kingdee.eas.port.pm.invest.ProjectAdjuestInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractProjectAdjuestEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectAdjuestEditUI.class.getName());
        ...
        this.contadjuestName = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtadjuestName = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.adjustType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.scrollPaneadjustReson = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtadjustReson = new com.kingdee.bos.ctrl.swing.KDTextArea();
        ...
        this.contadjuestName.setName("contadjuestName");
        ...
        this.txtadjuestName.setName("txtadjuestName");
        this.adjustType.setName("adjustType");
        this.txtoriginalAmount.setName("txtoriginalAmount");
        this.txtadjustAmount.setName("txtadjustAmount");
        this.scrollPaneadjustReson.setName("scrollPaneadjustReson");
        this.txtadjustReson.setName("txtadjustReson");
        ...
        // contadjuestName		
        this.contadjuestName.setBoundLabelText(resHelper.getString("contadjuestName.boundLabelText"));		
        this.contadjuestName.setBoundLabelLength(100);		
        this.contadjuestName.setBoundLabelUnderline(true);		
        this.contadjuestName.setVisible(true);
        // contadjustType		
        ...
        this.contadjustReson.setVisible(true);
        // contcontent		
        ...
        // txtadjuestName		
        this.txtadjuestName.setVisible(true);		
        this.txtadjuestName.setHorizontalAlignment(2);		
        this.txtadjuestName.setMaxLength(100);		
        this.txtadjuestName.setRequired(false);
        // adjustType		
        this.adjustType.setVisible(true);		
        this.adjustType.addItems(EnumUtils.getEnumList("com.kingdee.eas.port.pm.base.coms.AdjustType").toArray());		
        this.adjustType.setRequired(false);
        // txtoriginalAmount		
        ...
        this.txtoriginalAmount.setMinimumValue( new java.math.BigDecimal("-1.0E26"));		
        this.txtoriginalAmount.setMaximumValue( new java.math.BigDecimal("1.0E26"));		
        ...
        this.txtadjustAmount.setMinimumValue( new java.math.BigDecimal("-1.0E26"));		
        this.txtadjustAmount.setMaximumValue( new java.math.BigDecimal("1.0E26"));		
        this.txtadjustAmount.setPrecision(2);		
        this.txtadjustAmount.setRequired(false);
        // scrollPaneadjustReson
        // txtadjustReson		
        this.txtadjustReson.setVisible(true);		
        this.txtadjustReson.setRequired(false);		
        this.txtadjustReson.setMaxLength(1000);
        // scrollPanecontent
        // txtcontent		
    ...
    public void initUIContentLayout()
    {
        ...
        contadjuestName.setBounds(new Rectangle(33, 66, 607, 19));
        this.add(contadjuestName, new KDLayout.Constraints(33, 66, 607, 19, 0));
        contadjustType.setBounds(new Rectangle(707, 64, 270, 19));
        this.add(contadjustType, new KDLayout.Constraints(707, 64, 270, 19, 0));
        contoriginalAmount.setBounds(new Rectangle(33, 92, 270, 19));
        this.add(contoriginalAmount, new KDLayout.Constraints(33, 92, 270, 19, 0));
        contadjustAmount.setBounds(new Rectangle(370, 92, 270, 19));
        this.add(contadjustAmount, new KDLayout.Constraints(370, 92, 270, 19, 0));
        contadjustReson.setBounds(new Rectangle(33, 117, 948, 79));
        this.add(contadjustReson, new KDLayout.Constraints(33, 117, 948, 79, 0));
        contcontent.setBounds(new Rectangle(32, 201, 949, 85));
        this.add(contcontent, new KDLayout.Constraints(32, 201, 949, 85, 0));
        //contCreator
        ...
        //contadjuestName
        contadjuestName.setBoundEditor(txtadjuestName);
        //contadjustType
        contadjustType.setBoundEditor(adjustType);
        //contoriginalAmount
        contoriginalAmount.setBoundEditor(txtoriginalAmount);
        //contadjustAmount
        contadjustAmount.setBoundEditor(txtadjustAmount);
        //contadjustReson
        contadjustReson.setBoundEditor(scrollPaneadjustReson);
        //scrollPaneadjustReson
        scrollPaneadjustReson.getViewport().add(txtadjustReson, null);
        //contcontent
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("adjuestName", String.class, this.txtadjuestName, "text");
		dataBinder.registerBinding("adjustType", com.kingdee.eas.port.pm.base.coms.AdjustType.class, this.adjustType, "selectedItem");
		...
		dataBinder.registerBinding("adjustReson", String.class, this.txtadjustReson, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.app.ProjectAdjuestEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.pm.invest.ProjectAdjuestInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("adjuestName", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("adjustReson", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.client", "ProjectAdjuestEditUI");
    }
    /**
