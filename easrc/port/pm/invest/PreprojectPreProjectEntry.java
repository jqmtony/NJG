...
public class PreprojectPreProjectEntry extends CoreBillEntryBase implements IPreprojectPreProjectEntry
{
    public PreprojectPreProjectEntry()
    {
        super();
        registerInterface(IPreprojectPreProjectEntry.class, this);
    }
    public PreprojectPreProjectEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPreprojectPreProjectEntry.class, this);
    }
    ...
    private PreprojectPreProjectEntryController getController() throws BOSException
    {
        return (PreprojectPreProjectEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreprojectPreProjectEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
