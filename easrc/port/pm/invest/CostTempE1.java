...
public class CostTempE1 extends CoreBillEntryBase implements ICostTempE1
{
    public CostTempE1()
    {
        super();
        registerInterface(ICostTempE1.class, this);
    }
    public CostTempE1(Context ctx)
    {
        super(ctx);
        registerInterface(ICostTempE1.class, this);
    }
    ...
    private CostTempE1Controller getController() throws BOSException
    {
        return (CostTempE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCostTempE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTempE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTempE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTempE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTempE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCostTempE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
