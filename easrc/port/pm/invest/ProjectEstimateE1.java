...
public class ProjectEstimateE1 extends CoreBillEntryBase implements IProjectEstimateE1
{
    public ProjectEstimateE1()
    {
        super();
        registerInterface(IProjectEstimateE1.class, this);
    }
    public ProjectEstimateE1(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectEstimateE1.class, this);
    }
    ...
    private ProjectEstimateE1Controller getController() throws BOSException
    {
        return (ProjectEstimateE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectEstimateE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectEstimateE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectEstimateE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectEstimateE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectEstimateE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectEstimateE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
