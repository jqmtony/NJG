...
public class ProjectEstimateControllerBean extends AbstractProjectEstimateControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.invest.app.ProjectEstimateControllerBean");
}