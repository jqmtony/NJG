...
public class ProjectBudget2ControllerBean extends AbstractProjectBudget2ControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.invest.app.ProjectBudget2ControllerBean");
}