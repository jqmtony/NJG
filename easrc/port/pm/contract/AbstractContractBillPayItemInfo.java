...
public class AbstractContractBillPayItemInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractContractBillPayItemInfo()
    {
        this("id");
    }
    protected AbstractContractBillPayItemInfo(String pkField)
    {
        super(pkField);
    }
    /**
