...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblSettlementList, BorderLayout.CENTER);
    ...
    {
        return new String[] {"id","bookedDate","period","state","hasSettle","contractType.name","number","contractName","currency","partB.name","contractSource","signDate","landDeveloper.name","partC.name","costProperty","contractPropert","currency.id","currency.precision"};
    }
