...
import com.kingdee.eas.port.pm.utils.TreeSelectInteface;
...
//			}
	...
	private void setOriTree() {
		...
		this.treeOrigin.expandPath(treeOrigin.getSelectionPath());
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2){
					if(e.getSource().equals(treeOrigin)){
						if(treeOrigin!=null&&treeOrigin.getSelectionPath()!=null){
