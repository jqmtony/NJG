...
public class ContractTypeInviteTypeEntry extends CoreBillEntryBase implements IContractTypeInviteTypeEntry
{
    public ContractTypeInviteTypeEntry()
    {
        super();
        registerInterface(IContractTypeInviteTypeEntry.class, this);
    }
    public ContractTypeInviteTypeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractTypeInviteTypeEntry.class, this);
    }
    ...
    private ContractTypeInviteTypeEntryController getController() throws BOSException
    {
        return (ContractTypeInviteTypeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractTypeInviteTypeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
