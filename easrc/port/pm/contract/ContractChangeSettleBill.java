...
public class ContractChangeSettleBill extends FDCBill implements IContractChangeSettleBill
{
    public ContractChangeSettleBill()
    {
        super();
        registerInterface(IContractChangeSettleBill.class, this);
    }
    public ContractChangeSettleBill(Context ctx)
    {
        super(ctx);
        registerInterface(IContractChangeSettleBill.class, this);
    }
    ...
    private ContractChangeSettleBillController getController() throws BOSException
    {
        return (ContractChangeSettleBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractChangeSettleBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractChangeSettleBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractChangeSettleBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractChangeSettleBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractChangeSettleBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractChangeSettleBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
