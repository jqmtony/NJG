...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblPayRequestBill, BorderLayout.CENTER);
    ...
    {
        return new String[] {"id","bookedDate","period.number","state","hasSettle","contractType.name","number","contractName","currency","partB.name","contractSource","signDate","landDeveloper.name","partC.name","costProperty","contractPropert","currency.id","currency.precision"};
    }
