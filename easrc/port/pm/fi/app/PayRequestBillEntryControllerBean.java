...
public class PayRequestBillEntryControllerBean extends AbstractPayRequestBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.fi.app.PayRequestBillEntryControllerBean");
}