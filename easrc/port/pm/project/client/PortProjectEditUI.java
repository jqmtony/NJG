 ...
 * output class name
 */
public class PortProjectEditUI extends AbstractPortProjectEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PortProjectEditUI.class);
    
    /**
     * output class constructor
     */
    public PortProjectEditUI() throws Exception
    {
        super();
    }
    /**
