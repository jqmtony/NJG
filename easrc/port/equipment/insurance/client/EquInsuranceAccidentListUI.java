 ...
 * output class name
 */
public class EquInsuranceAccidentListUI extends AbstractEquInsuranceAccidentListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EquInsuranceAccidentListUI.class);
    
    /**
     * output class constructor
     */
    public EquInsuranceAccidentListUI() throws Exception
    {
        super();
    }
