...
public class EquInsuranceAccidentControllerBean extends AbstractEquInsuranceAccidentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.insurance.app.EquInsuranceAccidentControllerBean");
}