...
public class InsuranceCoverageControllerBean extends AbstractInsuranceCoverageControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.insurance.app.InsuranceCoverageControllerBean");
}