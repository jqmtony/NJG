 ...
 * output class name
 */
public class EqmOverhaulListUI extends AbstractEqmOverhaulListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EqmOverhaulListUI.class);
    
    /**
     * output class constructor
     */
    public EqmOverhaulListUI() throws Exception
    {
        super();
    }
