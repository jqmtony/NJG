 ...
 * output class name
 */
public class MonMPApplicationListUI extends AbstractMonMPApplicationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonMPApplicationListUI.class);
    
    /**
     * output class constructor
     */
    public MonMPApplicationListUI() throws Exception
    {
        super();
    }
