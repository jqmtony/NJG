...
public class QuarterTime extends XRDataBase implements IQuarterTime
{
    public QuarterTime()
    {
        super();
        registerInterface(IQuarterTime.class, this);
    }
    public QuarterTime(Context ctx)
    {
        super(ctx);
        registerInterface(IQuarterTime.class, this);
    }
    ...
    private QuarterTimeController getController() throws BOSException
    {
        return (QuarterTimeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getQuarterTimeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQuarterTimeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQuarterTimeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQuarterTimeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQuarterTimeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQuarterTimeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
