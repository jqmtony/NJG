 ...
 * output class name
 */
public abstract class AbstractEqmTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEqmTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractEqmTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractEqmTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEqmTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.equipment.base.app", "EqmTypeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.base.app.EqmTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.base.client", "EqmTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.port.equipment.base.EqmTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.equipment.base.EqmTypeInfo objectValue = new com.kingdee.eas.port.equipment.base.EqmTypeInfo();		
        return objectValue;
    }
