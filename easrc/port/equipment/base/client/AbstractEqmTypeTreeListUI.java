 ...
 * output class name
 */
public abstract class AbstractEqmTypeTreeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEqmTypeTreeListUI.class);
    /**
     * output class constructor
     */
    public AbstractEqmTypeTreeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.equipment.base.app.EqmTypeTreeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.equipment.base.client", "EqmTypeTreeListUI");
    }
