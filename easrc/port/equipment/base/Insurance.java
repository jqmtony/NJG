...
public class Insurance extends XRDataBase implements IInsurance
{
    public Insurance()
    {
        super();
        registerInterface(IInsurance.class, this);
    }
    public Insurance(Context ctx)
    {
        super(ctx);
        registerInterface(IInsurance.class, this);
    }
    ...
    {
        return new BOSObjectType("9128AED8");
    }
    private InsuranceController getController() throws BOSException
    {
        return (InsuranceController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInsuranceInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInsuranceCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
