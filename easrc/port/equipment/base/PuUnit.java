...
public class PuUnit extends XRDataBase implements IPuUnit
{
    public PuUnit()
    {
        super();
        registerInterface(IPuUnit.class, this);
    }
    public PuUnit(Context ctx)
    {
        super(ctx);
        registerInterface(IPuUnit.class, this);
    }
    ...
    private PuUnitController getController() throws BOSException
    {
        return (PuUnitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPuUnitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPuUnitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPuUnitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPuUnitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPuUnitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPuUnitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
