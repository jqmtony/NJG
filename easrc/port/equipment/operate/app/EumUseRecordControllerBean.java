...
public class EumUseRecordControllerBean extends AbstractEumUseRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.operate.app.EumUseRecordControllerBean");
}