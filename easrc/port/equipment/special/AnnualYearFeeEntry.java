...
public class AnnualYearFeeEntry extends CoreBillEntryBase implements IAnnualYearFeeEntry
{
    public AnnualYearFeeEntry()
    {
        super();
        registerInterface(IAnnualYearFeeEntry.class, this);
    }
    public AnnualYearFeeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAnnualYearFeeEntry.class, this);
    }
    ...
    private AnnualYearFeeEntryController getController() throws BOSException
    {
        return (AnnualYearFeeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
