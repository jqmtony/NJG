 ...
 * output class name
 */
public class SpecialChangeListUI extends AbstractSpecialChangeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpecialChangeListUI.class);
    
    /**
     * output class constructor
     */
    public SpecialChangeListUI() throws Exception
    {
        super();
    }
