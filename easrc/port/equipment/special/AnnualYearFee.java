...
public class AnnualYearFee extends XRBillBase implements IAnnualYearFee
{
    public AnnualYearFee()
    {
        super();
        registerInterface(IAnnualYearFee.class, this);
    }
    public AnnualYearFee(Context ctx)
    {
        super(ctx);
        registerInterface(IAnnualYearFee.class, this);
    }
    ...
    private AnnualYearFeeController getController() throws BOSException
    {
        return (AnnualYearFeeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAnnualYearFeeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearFeeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
