...
public class AnnualYearDetailEntry extends CoreBillEntryBase implements IAnnualYearDetailEntry
{
    public AnnualYearDetailEntry()
    {
        super();
        registerInterface(IAnnualYearDetailEntry.class, this);
    }
    public AnnualYearDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAnnualYearDetailEntry.class, this);
    }
    ...
    private AnnualYearDetailEntryController getController() throws BOSException
    {
        return (AnnualYearDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAnnualYearDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
