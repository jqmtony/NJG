...
public class Regulations extends XRDataBase implements IRegulations
{
    public Regulations()
    {
        super();
        registerInterface(IRegulations.class, this);
    }
    public Regulations(Context ctx)
    {
        super(ctx);
        registerInterface(IRegulations.class, this);
    }
    ...
    private RegulationsController getController() throws BOSException
    {
        return (RegulationsController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRegulationsInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRegulationsInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRegulationsInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRegulationsCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRegulationsCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRegulationsCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
