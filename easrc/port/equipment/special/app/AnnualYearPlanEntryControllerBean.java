...
public class AnnualYearPlanEntryControllerBean extends AbstractAnnualYearPlanEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.special.app.AnnualYearPlanEntryControllerBean");
}