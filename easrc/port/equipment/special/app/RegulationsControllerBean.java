...
public class RegulationsControllerBean extends AbstractRegulationsControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.special.app.RegulationsControllerBean");
}