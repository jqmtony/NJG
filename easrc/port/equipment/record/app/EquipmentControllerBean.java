...
public class EquipmentControllerBean extends AbstractEquipmentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.equipment.record.app.EquipmentControllerBean");
}