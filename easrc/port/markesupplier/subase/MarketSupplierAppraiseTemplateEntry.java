...
public class MarketSupplierAppraiseTemplateEntry extends CoreBillEntryBase implements IMarketSupplierAppraiseTemplateEntry
{
    public MarketSupplierAppraiseTemplateEntry()
    {
        super();
        registerInterface(IMarketSupplierAppraiseTemplateEntry.class, this);
    }
    public MarketSupplierAppraiseTemplateEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierAppraiseTemplateEntry.class, this);
    }
    ...
    private MarketSupplierAppraiseTemplateEntryController getController() throws BOSException
    {
        return (MarketSupplierAppraiseTemplateEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierAppraiseTemplateEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
