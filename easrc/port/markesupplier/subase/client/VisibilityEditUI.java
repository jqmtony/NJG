 ...
 * output class name
 */
public class VisibilityEditUI extends AbstractVisibilityEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(VisibilityEditUI.class);
    
    /**
     * output class constructor
     */
    public VisibilityEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void actionEdit_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	VisibilityInfo Info = (VisibilityInfo)getBizInterface().getValue(pk);
    	if(Info.isIsEnable()){
