 ...
 * output class name
 */
public class SupplierTypeEditUI extends AbstractSupplierTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupplierTypeEditUI.class);
    
    /**
     * output class constructor
     */
    public SupplierTypeEditUI() throws Exception
    {
        super();
    }
    /**
