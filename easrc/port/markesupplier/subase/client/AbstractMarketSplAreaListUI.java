 ...
 * output class name
 */
public abstract class AbstractMarketSplAreaListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSplAreaListUI.class);
    /**
     * output class constructor
     */
    public AbstractMarketSplAreaListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSplAreaListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSplAreaListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.MarketSplAreaEditUI.class.getName();
    }
