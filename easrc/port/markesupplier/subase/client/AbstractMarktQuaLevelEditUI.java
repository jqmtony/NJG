 ...
 * output class name
 */
public abstract class AbstractMarktQuaLevelEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarktQuaLevelEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarktQuaLevelInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarktQuaLevelEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarktQuaLevelEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 324, 274));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(26, 21, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(26, 49, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(26, 77, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(531, 129, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(546, 161, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(26, 97, 270, 154));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarktQuaLevelEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarktQuaLevelInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarktQuaLevelEditUI");
    }
