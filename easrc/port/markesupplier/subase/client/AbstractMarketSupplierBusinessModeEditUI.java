 ...
 * output class name
 */
public abstract class AbstractMarketSupplierBusinessModeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSupplierBusinessModeEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSupplierBusinessModeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSupplierBusinessModeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSupplierBusinessModeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 339, 274));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(37, 22, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(37, 51, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(37, 81, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(593, 106, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(602, 147, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(37, 101, 270, 144));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSupplierBusinessModeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSupplierBusinessModeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSupplierBusinessModeEditUI");
    }
