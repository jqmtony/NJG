 ...
 * output class name
 */
public abstract class AbstractMarketSupplierAttachListListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSupplierAttachListListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractMarketSupplierAttachListListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractMarketSupplierAttachListListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSupplierAttachListListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSupplierAttachListListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.MarketSupplierAttachListEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.MarketSupplierAttachListFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.markesupplier.subase.MarketSupplierAttachListInfo objectValue = new com.kingdee.eas.port.markesupplier.subase.MarketSupplierAttachListInfo();		
        return objectValue;
    }
