 ...
 * output class name
 */
public abstract class AbstractSupplierTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierTypeEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.SupplierTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSupplierTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 328, 264));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(27, 18, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(27, 47, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(27, 77, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(585, 102, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(597, 134, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(27, 97, 270, 140));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.SupplierTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.SupplierTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "SupplierTypeEditUI");
    }
