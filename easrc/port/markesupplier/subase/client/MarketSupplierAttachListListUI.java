 ...
 * output class name
 */
public class MarketSupplierAttachListListUI extends AbstractMarketSupplierAttachListListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarketSupplierAttachListListUI.class);
    private MarketSupplierFileTypInfo supplierFileType=null;
    /**
     * output class constructor
     */
    public MarketSupplierAttachListListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.MarketSupplierAttachListTreeEditUI.class.getName();
    }
