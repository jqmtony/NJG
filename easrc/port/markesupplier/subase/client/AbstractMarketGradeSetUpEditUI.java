 ...
 * output class name
 */
public abstract class AbstractMarketGradeSetUpEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketGradeSetUpEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketGradeSetUpInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketGradeSetUpEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketGradeSetUpEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 334, 267));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(31, 24, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(31, 56, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(31, 88, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(460, 168, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(466, 134, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(31, 109, 270, 132));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketGradeSetUpEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketGradeSetUpInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketGradeSetUpEditUI");
    }
