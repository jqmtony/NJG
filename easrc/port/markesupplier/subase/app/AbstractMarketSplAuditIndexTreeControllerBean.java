...
import com.kingdee.bos.dao.IObjectPK;
import com.kingdee.eas.port.markesupplier.subase.MarketSplAuditIndexTreeCollection;
...
public abstract class AbstractMarketSplAuditIndexTreeControllerBean extends TreeBaseControllerBean implements MarketSplAuditIndexTreeController
{
    ...
    {
        return new BOSObjectType("D7AEC952");
    }
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("58dbde8b-45ab-4aec-af83-511f9a4a6235"), new Object[]{ctx, pk});
          ...
          return (MarketSplAuditIndexTreeInfo)svcCtx.getMethodReturnValue();
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("17f0bba0-f4a0-4a53-9d39-57c75f6524e4"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f960501c-7810-4d91-86fa-c302dfbd4ec0"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7284b3a5-9e34-4e17-a333-56db6ecacb5f"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
          ...
          return (MarketSplAuditIndexTreeCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("318c3f1d-f5a2-456d-9233-71203db30b74"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("b0f028fc-b4a8-4aa7-8004-3806ee364dd1"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
