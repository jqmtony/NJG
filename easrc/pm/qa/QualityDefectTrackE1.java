...
public class QualityDefectTrackE1 extends CoreBillEntryBase implements IQualityDefectTrackE1
{
    public QualityDefectTrackE1()
    {
        super();
        registerInterface(IQualityDefectTrackE1.class, this);
    }
    public QualityDefectTrackE1(Context ctx)
    {
        super(ctx);
        registerInterface(IQualityDefectTrackE1.class, this);
    }
    ...
    private QualityDefectTrackE1Controller getController() throws BOSException
    {
        return (QualityDefectTrackE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQualityDefectTrackE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
