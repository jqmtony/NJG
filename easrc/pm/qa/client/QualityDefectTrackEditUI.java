 ...
 * output class name
 */
public class QualityDefectTrackEditUI extends AbstractQualityDefectTrackEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(QualityDefectTrackEditUI.class);

	/**
	 * output class constructor
	 */
	public QualityDefectTrackEditUI() throws Exception {
		super();
	}
...
//		prmtprojectName.setEntityViewInfo(evi);
		...
		prmtquestionType.setRequired(true);
		prmtrespondDepart.setRequired(true);
		...
		this.prmtpersonImplement.setSelector(person);
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.port.pm.qa.QualityDefectTrackFactory
				.getRemoteInstance();
	}
