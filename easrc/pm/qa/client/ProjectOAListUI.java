 ...
 * 项目协同
 */
public class ProjectOAListUI extends AbstractProjectOAListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectOAListUI.class);
    
    public ProjectOAListUI() throws Exception
    {
        super();
    }
