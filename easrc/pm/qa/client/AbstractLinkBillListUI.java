 ...
 * output class name
 */
public abstract class AbstractLinkBillListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLinkBillListUI.class);
    /**
     * output class constructor
     */
    public AbstractLinkBillListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.qa.app.LinkBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.qa.client", "LinkBillListUI");
    }
