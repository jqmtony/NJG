 ...
 * output class name
 */
public class QualityDefectTrackListUI extends AbstractQualityDefectTrackListUI
{
    private static final Logger logger = CoreUIObject.getLogger(QualityDefectTrackListUI.class);
    
    /**
     * output class constructor
     */
    public QualityDefectTrackListUI() throws Exception
    {
        super();
    }
