...
public class ContractWithoutTextBgEntry extends PayBgEntry implements IContractWithoutTextBgEntry
{
    public ContractWithoutTextBgEntry()
    {
        super();
        registerInterface(IContractWithoutTextBgEntry.class, this);
    }
    public ContractWithoutTextBgEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractWithoutTextBgEntry.class, this);
    }
    ...
    private ContractWithoutTextBgEntryController getController() throws BOSException
    {
        return (ContractWithoutTextBgEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBgEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
