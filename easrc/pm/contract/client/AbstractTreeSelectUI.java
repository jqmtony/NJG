 ...
 * output class name
 */
public abstract class AbstractTreeSelectUI extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTreeSelectUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox isIncludeForbid;
    ...
    public com.kingdee.bos.ctrl.swing.KDTree treeSelected;
     ...
     */
    public AbstractTreeSelectUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTreeSelectUI.class.getName());
        ...
        this.isIncludeForbid = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.isIncludeForbid.setName("isIncludeForbid");
        ...
        // isIncludeForbid		
        this.isIncludeForbid.setText(resHelper.getString("isIncludeForbid.text"));
        this.isIncludeForbid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    isIncludeForbid_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.setBounds(new Rectangle(290, 10, 52, 380));
        this.add(kDPanel1, new KDLayout.Constraints(290, 10, 52, 380, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDTreeView2.setBounds(new Rectangle(344, 9, 280, 380));
        this.add(kDTreeView2, new KDLayout.Constraints(344, 9, 280, 380, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        isIncludeForbid.setBounds(new Rectangle(15, 411, 157, 19));
        this.add(isIncludeForbid, new KDLayout.Constraints(15, 411, 157, 19, 0));
        //kDTreeView1
        kDTreeView1.setTree(treeOrigin);
        //kDPanel1
        kDPanel1.setLayout(new KDLayout());
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(290, 10, 52, 380));        btnAdd.setBounds(new Rectangle(17, 173, 22, 19));
        kDPanel1.add(btnAdd, new KDLayout.Constraints(17, 173, 22, 19, 0));
        btnDelete.setBounds(new Rectangle(17, 204, 22, 19));
        kDPanel1.add(btnDelete, new KDLayout.Constraints(17, 204, 22, 19, 0));
        //kDTreeView2
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.contract.app.TreeSelectUIHandler";
	}
    ...
    /**
     * output isIncludeForbid_actionPerformed method
     */
    protected void isIncludeForbid_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    ...
    protected class ActionAdd extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTreeSelectUI.this, "ActionAdd", "actionAdd_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelete extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTreeSelectUI.this, "ActionDelete", "actionDelete_actionPerformed", e);
        }
    }
    ...
    protected class ActionConfirm extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTreeSelectUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTreeSelectUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.contract.client", "TreeSelectUI");
    }
