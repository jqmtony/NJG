...
import com.kingdee.eas.fdc.contract.client.ContractWithoutTextPrintDataProvider;
import com.kingdee.eas.fdc.contract.client.FDCDepConPayPlanSelector;
...
import com.kingdee.eas.port.pm.contract.ContractWithoutTextBgEntryCollection;
import com.kingdee.eas.port.pm.contract.ContractWithoutTextBgEntryInfo;
...
//		objectValue.setSignDate(this.serverDate);
		...
		if(projId != null) { 
			ProjectInfo projInfo = curProject;			
...
//		}
	...
	protected  void fetchInitParam() throws Exception{
		...
		if(projId != null) { 
			...
			//启用成本财务一体化
			HashMap paramItem = FDCUtils.getDefaultFDCParam(null,projInfo.getCompany().getId().toString());
//			HashMap paramItem = FDCUtils.getDefaultFDCParam(null,SysContext.getSysContext().getCurrentFIUnit().getId().toString());
	...
	public void isNotEnterCAS(){
		...
		ProjectInfo info = editData.getCurProject();
		
		if(info!=null){
			Map paramItem = null;
			try {
				paramItem = FDCUtils.getDefaultFDCParam(null, info.getCompany().getId().toString());
			} catch (EASBizException e) {
...
//			initFDCDepConPayPlanF7();
    ...
    protected void prmtcurProject_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    	...
    	if(e.getNewValue()!=null
    		...
    		ProjectInfo projectInfo = (ProjectInfo)e.getNewValue();
...
//    	prbi.setUsage(txtMoneyDesc.getText());//款项说明
    	...
    	this.prbi.setCurProject((ProjectInfo) this.prmtcurProject.getValue());//工程项目
