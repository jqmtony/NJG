...
public class ContractBillBudgetEntry extends CoreBillEntryBase implements IContractBillBudgetEntry
{
    public ContractBillBudgetEntry()
    {
        super();
        registerInterface(IContractBillBudgetEntry.class, this);
    }
    public ContractBillBudgetEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractBillBudgetEntry.class, this);
    }
    ...
    private ContractBillBudgetEntryController getController() throws BOSException
    {
        return (ContractBillBudgetEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractBillBudgetEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractBillBudgetEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractBillBudgetEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractBillBudgetEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractBillBudgetEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractBillBudgetEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
