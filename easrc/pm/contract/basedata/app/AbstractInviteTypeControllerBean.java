...
public abstract class AbstractInviteTypeControllerBean extends XRDataBaseControllerBean implements InviteTypeController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2d60b712-b9b9-42a8-8509-bc7fc2616d7b"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("8a6f9c6f-eb31-42ff-80ca-d27a0fb7bb23"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("1695476a-cf52-4130-844d-22c84f4084d8"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0cb57161-2d53-44ef-a349-d4f4f9e04f8b"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("937443bc-c25d-49d0-8c6f-1ed24bd41063"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("5f51b7cf-6983-41d5-9f7d-13f6f6a87d4f"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("af0e7104-e527-4bfd-a2f0-e567e00d6548"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("03ec95b1-b38f-4785-be8c-d973008f1f61"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("33d42443-5b14-41e4-86c8-efbd5c2ee871"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("e49d54fe-5dba-436e-8055-49484cbdeca6"), new Object[]{ctx, model, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7404d410-450c-417e-bcb1-903c82b94065"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c9c2c79e-aaa2-4cfd-8967-d79de5e36658"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, pk);
            }
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a79953ea-3f52-4ecb-b684-cc3499c9a3e4"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fc77c448-e873-4983-a6cb-21d85c0ef5aa"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("120281e8-6f8a-4202-9db8-a1131005df51"), new Object[]{ctx, filter, sorter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9741a18c-f8e0-4ad3-b595-7690c18c49f0"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("26d400c9-c09a-4824-b2e7-f1c639e50b77"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("cec86f00-e7f6-4696-9b7a-43d607bd6356"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9c182074-8644-4dc2-8fe9-d8838d49a1c7"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f436106d-fd82-4176-adcd-28749a487f7b"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a0dbfcb7-3025-4a87-b4eb-71d05339e81b"), new Object[]{ctx, arrayPK});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, arrayPK);
            }
    ...
    {
    	return (XRDataBaseCollection)(getInviteTypeCollection(ctx).cast(XRDataBaseCollection.class));
    }
    public XRDataBaseCollection getXRDataBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (XRDataBaseCollection)(getInviteTypeCollection(ctx, view).cast(XRDataBaseCollection.class));
    }
    public XRDataBaseCollection getXRDataBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (XRDataBaseCollection)(getInviteTypeCollection(ctx, oql).cast(XRDataBaseCollection.class));
    }
