...
public class ContractWithoutTextBudgetEntry extends CoreBillEntryBase implements IContractWithoutTextBudgetEntry
{
    public ContractWithoutTextBudgetEntry()
    {
        super();
        registerInterface(IContractWithoutTextBudgetEntry.class, this);
    }
    public ContractWithoutTextBudgetEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractWithoutTextBudgetEntry.class, this);
    }
    ...
    private ContractWithoutTextBudgetEntryController getController() throws BOSException
    {
        return (ContractWithoutTextBudgetEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWithoutTextBudgetEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
