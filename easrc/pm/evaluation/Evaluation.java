...
public class Evaluation extends XRBillBase implements IEvaluation
{
    public Evaluation()
    {
        super();
        registerInterface(IEvaluation.class, this);
    }
    public Evaluation(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluation.class, this);
    }
    ...
    private EvaluationController getController() throws BOSException
    {
        return (EvaluationController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
