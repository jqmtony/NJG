...
public class EvaluationEditUI extends AbstractEvaluationEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(EvaluationEditUI.class);
	...
	@Override
	protected void prmtprojectName_dataChanged(DataChangeEvent e)
			throws Exception {
		// TODO Auto-generated method stub
		super.prmtprojectName_dataChanged(e);
		this.kdtE1.removeRows();
		ProjectInfo projectInfo = (ProjectInfo) this.prmtprojectName.getValue();
		String oql = "where projectName='" + projectInfo.getName() + "'"
				+ "and objectState='" + 8 + "'";
		YearInvestPlanCollection yearInvestPlanColl = YearInvestPlanFactory
				.getRemoteInstance().getYearInvestPlanCollection(oql);
		YearInvestPlanInfo yearPlanInfo = yearInvestPlanColl.get(0);
		YearInvestPlanE2Collection yearPlanEntryEva = yearPlanInfo.getE2();
		for (int i = 0; i < yearPlanEntryEva.size(); i++) {
			YearInvestPlanE2Info entryInfo = yearPlanEntryEva.get(i);
			IRow rowAdd = this.kdtE1.addRow();
			rowAdd.getCell("apIndex").setValue(entryInfo.getApIndex());
		}
	}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.port.pm.evaluation.EvaluationFactory
				.getRemoteInstance();
	}
