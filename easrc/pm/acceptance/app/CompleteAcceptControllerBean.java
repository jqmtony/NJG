...
public class CompleteAcceptControllerBean extends AbstractCompleteAcceptControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.acceptance.app.CompleteAcceptControllerBean");
}