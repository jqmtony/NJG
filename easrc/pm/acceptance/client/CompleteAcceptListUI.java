 ...
 * output class name
 */
public class CompleteAcceptListUI extends AbstractCompleteAcceptListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompleteAcceptListUI.class);
    
    /**
     * output class constructor
     */
    public CompleteAcceptListUI() throws Exception
    {
        super();
    }
