...
public class PayRequestBillAcctPay extends CoreBase implements IPayRequestBillAcctPay
{
    public PayRequestBillAcctPay()
    {
        super();
        registerInterface(IPayRequestBillAcctPay.class, this);
    }
    public PayRequestBillAcctPay(Context ctx)
    {
        super(ctx);
        registerInterface(IPayRequestBillAcctPay.class, this);
    }
    ...
    private PayRequestBillAcctPayController getController() throws BOSException
    {
        return (PayRequestBillAcctPayController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestBillAcctPayCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
