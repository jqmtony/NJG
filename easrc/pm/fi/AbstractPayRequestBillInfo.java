...
public class AbstractPayRequestBillInfo extends com.kingdee.eas.fdc.basedata.FDCBillInfo implements Serializable 
{
    ...
    {
        super(pkField);
        put("confirmEntry", new com.kingdee.eas.port.pm.fi.PayRequestBillConfirmEntryCollection());
        put("acctPays", new com.kingdee.eas.port.pm.fi.PayRequestBillAcctPayCollection());
        put("entrys", new com.kingdee.eas.port.pm.fi.PayRequestBillEntryCollection());
        put("bgEntry", new com.kingdee.eas.port.pm.fi.PayRequestBillBgEntryCollection());
    }
    /**
     * Object: 付款申请单 's 分录 property 
     */
    public com.kingdee.eas.port.pm.fi.PayRequestBillEntryCollection getEntrys()
    {
        return (com.kingdee.eas.port.pm.fi.PayRequestBillEntryCollection)get("entrys");
    }
    /**
     ...
     */
    public com.kingdee.eas.port.pm.fi.PayRequestBillAcctPayCollection getAcctPays()
    {
        return (com.kingdee.eas.port.pm.fi.PayRequestBillAcctPayCollection)get("acctPays");
    }
    /**
     ...
     */
    public com.kingdee.eas.port.pm.fi.PayRequestBillBgEntryCollection getBgEntry()
    {
        return (com.kingdee.eas.port.pm.fi.PayRequestBillBgEntryCollection)get("bgEntry");
    }
    /**
