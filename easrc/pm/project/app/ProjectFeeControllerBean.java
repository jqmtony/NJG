...
public class ProjectFeeControllerBean extends AbstractProjectFeeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.project.app.ProjectFeeControllerBean");
}