 ...
 * output class name
 */
public abstract class AbstractProjectFeeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectFeeEditUI.class);
    ...
    protected com.kingdee.eas.port.pm.project.ProjectFeeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractProjectFeeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectFeeEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contestimatesAmount.setBounds(new Rectangle(346, 63, 270, 19));
        this.add(contestimatesAmount, null);
        contbudgetAmount.setBounds(new Rectangle(346, 100, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.project.app.ProjectFeeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.pm.project.ProjectFeeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.project.client", "ProjectFeeEditUI");
    }
