 ...
 * output class name
 */
public abstract class AbstractPortProjectListUI extends com.kingdee.eas.framework.client.TreeListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPortProjectListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractPortProjectListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractPortProjectListUI() throws Exception
    {
        super();
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(4, 9, 1009, 580));
        this.add(pnlMain, new KDLayout.Constraints(4, 9, 1009, 580, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.project.app.PortProjectListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.project.client", "PortProjectListUI");
    }
