 ...
 * output class name
 */
public class PortProjectListUI extends AbstractPortProjectListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PortProjectListUI.class);
    
    /**
     * output class constructor
     */
    public PortProjectListUI() throws Exception
    {
        super();
    }
