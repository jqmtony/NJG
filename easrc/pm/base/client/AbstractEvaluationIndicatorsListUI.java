 ...
 * output class name
 */
public abstract class AbstractEvaluationIndicatorsListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEvaluationIndicatorsListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractEvaluationIndicatorsListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractEvaluationIndicatorsListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.EvaluationIndicatorsListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "EvaluationIndicatorsListUI");
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.client.EvaluationIndicatorsEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.EvaluationIndicatorsFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.pm.base.EvaluationIndicatorsInfo objectValue = new com.kingdee.eas.port.pm.base.EvaluationIndicatorsInfo();		
        return objectValue;
    }
