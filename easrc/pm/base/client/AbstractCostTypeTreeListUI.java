 ...
 * output class name
 */
public abstract class AbstractCostTypeTreeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostTypeTreeListUI.class);
    /**
     * output class constructor
     */
    public AbstractCostTypeTreeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostTypeTreeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.base.app", "CostTypeTreeQuery");
        // CoreUI		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.CostTypeTreeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "CostTypeTreeListUI");
    }
