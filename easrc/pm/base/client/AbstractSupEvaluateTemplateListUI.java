 ...
 * output class name
 */
public abstract class AbstractSupEvaluateTemplateListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupEvaluateTemplateListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractSupEvaluateTemplateListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractSupEvaluateTemplateListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.SupEvaluateTemplateListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "SupEvaluateTemplateListUI");
    }
