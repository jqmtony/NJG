 ...
 * output class name
 */
public class SupEvaluationIndicatorListUI extends AbstractSupEvaluationIndicatorListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupEvaluationIndicatorListUI.class);
    
    /**
     * output class constructor
     */
    public SupEvaluationIndicatorListUI() throws Exception
    {
        super();
    }
    ...
    protected void prepareUIContext(UIContext uiContext, ActionEvent e) {
    	...
    	if (treeNote.getUserObject() instanceof SupEvaluationIndicatorTreeInfo) {
			getUIContext().put("treeInfo", treeNote.getUserObject());
		} else {
			MsgBox.showWarning("非叶子节点无法新增！");
			SysUtil.abort();
		}
    }
    /**
    ...
    {
        return com.kingdee.eas.port.pm.base.client.SupEvaluationIndicatorTreeEditUI.class.getName();
    }
