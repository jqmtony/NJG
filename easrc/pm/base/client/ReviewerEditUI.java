 ...
 * output class name
 */
public class ReviewerEditUI extends AbstractReviewerEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReviewerEditUI.class);
    
    /**
     * output class constructor
     */
    public ReviewerEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void onLoad() throws Exception {
    	...
    	txtSimpleName.setVisible(false);
