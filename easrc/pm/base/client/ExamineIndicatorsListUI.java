 ...
 * output class name
 */
public class ExamineIndicatorsListUI extends AbstractExamineIndicatorsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ExamineIndicatorsListUI.class);
    
    /**
     * output class constructor
     */
    public ExamineIndicatorsListUI() throws Exception
    {
        super();
    }
    ...
    protected void prepareUIContext(UIContext uiContext, ActionEvent e) {
    	...
    	if(getActionFromActionEvent(e).equals(actionAddNew)) {
    		...
    		if (treeNote.getUserObject() instanceof ExamineIndicatorsTreeInfo) {
    ...
    {
        return com.kingdee.eas.port.pm.base.client.ExamineIndicatorsTreeEditUI.class.getName();
    }
