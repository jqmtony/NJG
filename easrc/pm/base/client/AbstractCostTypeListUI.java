 ...
 * output class name
 */
public abstract class AbstractCostTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCostTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCostTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCostTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCostTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.base.app", "CostTypeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.CostTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "CostTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.CostTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.pm.base.CostTypeInfo objectValue = new com.kingdee.eas.port.pm.base.CostTypeInfo();		
        return objectValue;
    }
