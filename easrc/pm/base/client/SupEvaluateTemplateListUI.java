 ...
 * output class name
 */
public class SupEvaluateTemplateListUI extends AbstractSupEvaluateTemplateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupEvaluateTemplateListUI.class);
    
    /**
     * output class constructor
     */
    public SupEvaluateTemplateListUI() throws Exception
    {
        super();
    }
    ...
    protected void prepareUIContext(UIContext uiContext, ActionEvent e) {
    	...
    	if (treeNote.getUserObject() instanceof SupEvaluateTemplateTreeInfo) {
    ...
    {
        return com.kingdee.eas.port.pm.base.client.SupEvaluateTemplateTreeEditUI.class.getName();
    }
