 ...
 * output class name
 */
public class EvaluationTemplateEditUI extends AbstractEvaluationTemplateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EvaluationTemplateEditUI.class);
    
    /**
     * output class constructor
     */
    public EvaluationTemplateEditUI() throws Exception
    {
        super();
    }
    @Override
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.port.pm.base.EvaluationTemplateTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        if(getUIContext().get("treeInfo") != null){
			EvaluationTemplateTreeInfo info = (EvaluationTemplateTreeInfo) getUIContext().get("treeInfo");
			objectValue.setTemplateType(info);
		}
        return objectValue;
    }
