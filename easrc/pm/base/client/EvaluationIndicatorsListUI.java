 ...
 * output class name
 */
public class EvaluationIndicatorsListUI extends AbstractEvaluationIndicatorsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EvaluationIndicatorsListUI.class);
    
    /**
     * output class constructor
     */
    public EvaluationIndicatorsListUI() throws Exception
    {
        super();
    ...
    protected void prepareUIContext(UIContext uiContext, ActionEvent e) {
    	...
    	if(getActionFromActionEvent(e).equals(actionAddNew)) {
    		...
    		if (treeNote.getUserObject() instanceof EvaluationIndicatorsTreeInfo) {
    ...
    public void actionEdit_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	IEvaluationIndicators ieva = (IEvaluationIndicators) getBizInterface();
    	EvaluationIndicatorsInfo info = ieva.getEvaluationIndicatorsInfo(new ObjectUuidPK(id));
    	if(info.isUse())
    	{
    		MsgBox.showInfo("已启用基础资料无法修改");
    		SysUtil.abort();
    	}
...
//        super.actionCancelCancel_actionPerformed(e);
    ...
    {
        return com.kingdee.eas.port.pm.base.client.EvaluationIndicatorsTreeEditUI.class.getName();
    }
