 ...
 * output class name
 */
public abstract class AbstractExamineIndicatorsListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractExamineIndicatorsListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractExamineIndicatorsListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractExamineIndicatorsListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.base.app.ExamineIndicatorsListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.base.client", "ExamineIndicatorsListUI");
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.client.ExamineIndicatorsEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.ExamineIndicatorsFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.pm.base.ExamineIndicatorsInfo objectValue = new com.kingdee.eas.port.pm.base.ExamineIndicatorsInfo();		
        return objectValue;
    }
