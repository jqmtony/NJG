 ...
 * output class name
 */
public class CostTypeTreeListUI extends AbstractCostTypeTreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostTypeTreeListUI.class);
    
    /**
     * output class constructor
     */
    public CostTypeTreeListUI() throws Exception
    {
        super();
    }
