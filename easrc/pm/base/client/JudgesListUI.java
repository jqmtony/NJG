 ...
 * output class name
 */
public class JudgesListUI extends AbstractJudgesListUI
{
    private static final Logger logger = CoreUIObject.getLogger(JudgesListUI.class);
    
    /**
     * output class constructor
     */
    public JudgesListUI() throws Exception
    {
        super();
    }
    ...
    public void prepareUIContext(UIContext uiContext, ActionEvent e) {
		...
		if(getActionFromActionEvent(e).equals(actionAddNew)) {
			...
			if (treeNote.getUserObject() instanceof JudgesTreeInfo) {
    ...
    public void actionCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	for(Object Id : idList) {
    		...
    		ijudge.cancel(new ObjectUuidPK(id), info);
    	}
    	actionRefresh_actionPerformed(e);
    }
    ...
    public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	for(Object Id : idList) {
    		...
    		ijudge.cancelCancel(new ObjectUuidPK(id), info);
    	}
    	actionRefresh_actionPerformed(e);
    }
    ...
    {
        return com.kingdee.eas.port.pm.base.client.JudgesTreeEditUI.class.getName();
    }
