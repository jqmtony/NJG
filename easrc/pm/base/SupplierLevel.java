...
public class SupplierLevel extends XRDataBase implements ISupplierLevel
{
    public SupplierLevel()
    {
        super();
        registerInterface(ISupplierLevel.class, this);
    }
    public SupplierLevel(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierLevel.class, this);
    }
    ...
    private SupplierLevelController getController() throws BOSException
    {
        return (SupplierLevelController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierLevelInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLevelInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLevelInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLevelCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLevelCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLevelCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
