...
public class CompanySetupEntry extends CoreBillEntryBase implements ICompanySetupEntry
{
    public CompanySetupEntry()
    {
        super();
        registerInterface(ICompanySetupEntry.class, this);
    }
    public CompanySetupEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICompanySetupEntry.class, this);
    }
    ...
    private CompanySetupEntryController getController() throws BOSException
    {
        return (CompanySetupEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCompanySetupEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanySetupEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanySetupEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanySetupEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanySetupEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanySetupEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
