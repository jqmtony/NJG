...
public class InvestYear extends XRDataBase implements IInvestYear
{
    public InvestYear()
    {
        super();
        registerInterface(IInvestYear.class, this);
    }
    public InvestYear(Context ctx)
    {
        super(ctx);
        registerInterface(IInvestYear.class, this);
    }
    ...
    private InvestYearController getController() throws BOSException
    {
        return (InvestYearController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInvestYearInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestYearInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestYearInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestYearCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestYearCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestYearCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
