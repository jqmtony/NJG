...
public class EvaluationSumEntry extends CoreBillEntryBase implements IEvaluationSumEntry
{
    public EvaluationSumEntry()
    {
        super();
        registerInterface(IEvaluationSumEntry.class, this);
    }
    public EvaluationSumEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationSumEntry.class, this);
    }
    ...
    private EvaluationSumEntryController getController() throws BOSException
    {
        return (EvaluationSumEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationSumEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationSumEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
