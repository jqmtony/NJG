...
public class WinInviteReportBudgetEntry extends CoreBillEntryBase implements IWinInviteReportBudgetEntry
{
    public WinInviteReportBudgetEntry()
    {
        super();
        registerInterface(IWinInviteReportBudgetEntry.class, this);
    }
    public WinInviteReportBudgetEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IWinInviteReportBudgetEntry.class, this);
    }
    ...
    private WinInviteReportBudgetEntryController getController() throws BOSException
    {
        return (WinInviteReportBudgetEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWinInviteReportBudgetEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
