...
public class InviteReportE7 extends CoreBillEntryBase implements IInviteReportE7
{
    public InviteReportE7()
    {
        super();
        registerInterface(IInviteReportE7.class, this);
    }
    public InviteReportE7(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteReportE7.class, this);
    }
    ...
    private InviteReportE7Controller getController() throws BOSException
    {
        return (InviteReportE7Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteReportE7Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportE7Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportE7Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportE7Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportE7Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteReportE7Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
