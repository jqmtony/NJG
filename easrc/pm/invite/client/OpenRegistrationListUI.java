 ...
 * output class name
 */
public class OpenRegistrationListUI extends AbstractOpenRegistrationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OpenRegistrationListUI.class);
    
    /**
     * output class constructor
     */
    public OpenRegistrationListUI() throws Exception
    {
        super();
    }
