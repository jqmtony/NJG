...
public abstract class AbstractJudgesExamineListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","reportName.reportName","prjName","prjOrg","ppr","invitePerson.personName","checkPerson","evaDate","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id"};
    }
