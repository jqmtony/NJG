...
public abstract class AbstractOpenRegistrationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
     ...
     */
    public AbstractOpenRegistrationListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOpenRegistrationListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.invite.app", "OpenRegistrationQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(5, 4, 1001, 620));
        this.add(kDSplitPane1, new KDLayout.Constraints(5, 4, 1001, 620, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invite.app.OpenRegistrationListUIHandler";
	}
...
com.kingdee.eas.port.pm.invite.OpenRegistrationFactory.getRemoteInstance().doCancel(editData);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invite.client", "OpenRegistrationListUI");
    }
    /**
    ...
    {
        return new String[] {"number","status","reportName.reportName","regName","reportNumber","opLocation","opDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id"};
    }
