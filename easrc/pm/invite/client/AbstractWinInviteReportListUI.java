...
public abstract class AbstractWinInviteReportListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","inviteReport.reportName","invitePrjName","inviteType.name","evaSolution","evaDate","inviteDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","content","address","Judges.org.name","budgetAmount","Judges.judgesName.personName","bizDate","id"};
    }
