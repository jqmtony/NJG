...
public abstract class AbstractWinInviteReportListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","inviteReport.reportName","invitePrjName","inviteType.name","evaSolution","evaDate","budgetAmount","inviteDate","content","creator.name","createTime","auditor.name","auditTime","address","id","unitName.supplierName"};
    }
