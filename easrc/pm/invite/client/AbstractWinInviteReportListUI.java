 ...
 * output class name
 */
public abstract class AbstractWinInviteReportListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
     ...
     */
    public AbstractWinInviteReportListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWinInviteReportListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.invite.app", "WinInviteReportQuery");
        //actionRemove
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(kDSplitPane1, new KDLayout.Constraints(5, 5, 1003, 620, 0));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invite.app.WinInviteReportListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invite.client", "WinInviteReportListUI");
    }
    /**
    ...
    {
        return new String[] {"status","number","inviteReport.number","invitePrjName","inviteType.name","evaSolution","evaDate","inviteDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","content","address","Judges.org.name","budgetAmount","Judges.judgesName.personName","bizDate","id"};
    }
