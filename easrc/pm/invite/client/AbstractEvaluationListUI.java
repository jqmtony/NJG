...
public abstract class AbstractEvaluationListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(5, 4, 1001, 619));
        this.add(kDSplitPane1, new KDLayout.Constraints(5, 4, 1001, 619, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
    ...
    {
        return new String[] {"number","status","inviteReport.reportName","prjName","evaSolution","evaDate","basePrice","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id"};
    }
