 ...
 * output class name
 */
public class EvaluationSumEditUI extends AbstractEvaluationSumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EvaluationSumEditUI.class);
    
    /**
     * output class constructor
     */
    public EvaluationSumEditUI() throws Exception
    {
        super();
    }
    /**
