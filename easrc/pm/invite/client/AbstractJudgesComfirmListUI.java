...
public abstract class AbstractJudgesComfirmListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","planName.reportName","prjName","planNumber","inviteType","orgUnit","department.name","comment","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id"};
    }
