...
public abstract class AbstractInvitePlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","planName","response.name","department.name","startDate","endDate","inDate","BIMUDF0009","bizDate","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","project.name"};
    }
