...
public class EvaluationEntryValid extends CoreBillEntryBase implements IEvaluationEntryValid
{
    public EvaluationEntryValid()
    {
        super();
        registerInterface(IEvaluationEntryValid.class, this);
    }
    public EvaluationEntryValid(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationEntryValid.class, this);
    }
    ...
    private EvaluationEntryValidController getController() throws BOSException
    {
        return (EvaluationEntryValidController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationEntryValidInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryValidInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryValidInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryValidCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryValidCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryValidCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
