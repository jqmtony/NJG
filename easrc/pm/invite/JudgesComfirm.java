...
public class JudgesComfirm extends XRBillBase implements IJudgesComfirm
{
    public JudgesComfirm()
    {
        super();
        registerInterface(IJudgesComfirm.class, this);
    }
    public JudgesComfirm(Context ctx)
    {
        super(ctx);
        registerInterface(IJudgesComfirm.class, this);
    }
    ...
    private JudgesComfirmController getController() throws BOSException
    {
        return (JudgesComfirmController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getJudgesComfirmCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJudgesComfirmCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJudgesComfirmCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJudgesComfirmInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJudgesComfirmInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJudgesComfirmInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
