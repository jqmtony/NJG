...
public class JudgesComfirmControllerBean extends AbstractJudgesComfirmControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.invite.app.JudgesComfirmControllerBean");
}