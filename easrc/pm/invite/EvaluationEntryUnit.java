...
public class EvaluationEntryUnit extends CoreBillEntryBase implements IEvaluationEntryUnit
{
    public EvaluationEntryUnit()
    {
        super();
        registerInterface(IEvaluationEntryUnit.class, this);
    }
    public EvaluationEntryUnit(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationEntryUnit.class, this);
    }
    ...
    private EvaluationEntryUnitController getController() throws BOSException
    {
        return (EvaluationEntryUnitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationEntryUnitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryUnitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryUnitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryUnitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryUnitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryUnitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
