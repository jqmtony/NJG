...
public class EvaluationEntryScore extends CoreBillEntryBase implements IEvaluationEntryScore
{
    public EvaluationEntryScore()
    {
        super();
        registerInterface(IEvaluationEntryScore.class, this);
    }
    public EvaluationEntryScore(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationEntryScore.class, this);
    }
    ...
    private EvaluationEntryScoreController getController() throws BOSException
    {
        return (EvaluationEntryScoreController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationEntryScoreInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryScoreInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryScoreInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryScoreCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryScoreCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationEntryScoreCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
