 ...
 * output class name
 */
public class ProjectAuditSettlementEditUI extends AbstractProjectAuditSettlementEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectAuditSettlementEditUI.class);
