...
public class YIPlanAccredE1E2 extends CoreBillEntryBase implements IYIPlanAccredE1E2
{
    public YIPlanAccredE1E2()
    {
        super();
        registerInterface(IYIPlanAccredE1E2.class, this);
    }
    public YIPlanAccredE1E2(Context ctx)
    {
        super(ctx);
        registerInterface(IYIPlanAccredE1E2.class, this);
    }
    ...
    private YIPlanAccredE1E2Controller getController() throws BOSException
    {
        return (YIPlanAccredE1E2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredE1E2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
