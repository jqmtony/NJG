...
public class ProProgressReportE1 extends CoreBillEntryBase implements IProProgressReportE1
{
    public ProProgressReportE1()
    {
        super();
        registerInterface(IProProgressReportE1.class, this);
    }
    public ProProgressReportE1(Context ctx)
    {
        super(ctx);
        registerInterface(IProProgressReportE1.class, this);
    }
    ...
    private ProProgressReportE1Controller getController() throws BOSException
    {
        return (ProProgressReportE1Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProProgressReportE1Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProProgressReportE1Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProProgressReportE1Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProProgressReportE1Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProProgressReportE1Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProProgressReportE1Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
