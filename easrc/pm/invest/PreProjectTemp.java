...
public class PreProjectTemp extends XRBillBase implements IPreProjectTemp
{
    public PreProjectTemp()
    {
        super();
        registerInterface(IPreProjectTemp.class, this);
    }
    public PreProjectTemp(Context ctx)
    {
        super(ctx);
        registerInterface(IPreProjectTemp.class, this);
    }
    ...
    private PreProjectTempController getController() throws BOSException
    {
        return (PreProjectTempController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPreProjectTempCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectTempCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectTempCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectTempInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectTempInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectTempInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
