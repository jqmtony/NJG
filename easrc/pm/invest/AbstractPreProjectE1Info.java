...
public class AbstractPreProjectE1Info extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
     ...
     */
    public java.util.Date getActualPlanTime()
    {
        return getDate("actualPlanTime");
    }
    public void setActualPlanTime(java.util.Date item)
    {
        setDate("actualPlanTime", item);
    }
    /**
