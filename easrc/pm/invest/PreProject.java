...
public class PreProject extends XRBillBase implements IPreProject
{
    public PreProject()
    {
        super();
        registerInterface(IPreProject.class, this);
    }
    public PreProject(Context ctx)
    {
        super(ctx);
        registerInterface(IPreProject.class, this);
    }
    ...
    private PreProjectController getController() throws BOSException
    {
        return (PreProjectController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPreProjectCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPreProjectInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
