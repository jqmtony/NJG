...
public class YIPlanAccred extends XRBillBase implements IYIPlanAccred
{
    public YIPlanAccred()
    {
        super();
        registerInterface(IYIPlanAccred.class, this);
    }
    public YIPlanAccred(Context ctx)
    {
        super(ctx);
        registerInterface(IYIPlanAccred.class, this);
    }
    ...
    private YIPlanAccredController getController() throws BOSException
    {
        return (YIPlanAccredController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getYIPlanAccredCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYIPlanAccredInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAuditPersonCollection(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
