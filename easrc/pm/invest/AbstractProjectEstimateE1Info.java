...
public class AbstractProjectEstimateE1Info extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractProjectEstimateE1Info()
    {
        this("id");
    }
    protected AbstractProjectEstimateE1Info(String pkField)
    {
        super(pkField);
    }
    /**
     * Object: 项目估算 's null property 
     */
    public com.kingdee.eas.port.pm.invest.ProjectEstimateInfo getParent()
    {
        return (com.kingdee.eas.port.pm.invest.ProjectEstimateInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.port.pm.invest.ProjectEstimateInfo item)
    {
        put("parent", item);
    }
    /**
     * Object: 项目估算 's 费用类型 property 
     */
    ...
    /**
     * Object:项目估算's 建筑工程费用property 
     */
    public java.math.BigDecimal getConstructionCost()
    {
        return getBigDecimal("constructionCost");
    }
    public void setConstructionCost(java.math.BigDecimal item)
    {
        setBigDecimal("constructionCost", item);
    }
    /**
     * Object:项目估算's 设备购置费property 
     */
    ...
    /**
     * Object: 项目估算 's 工程项目或费用名称 property 
     */
    ...
    {
        return new BOSObjectType("1E3C8970");
    }
}