...
public class ProjectBudget extends XRBillBase implements IProjectBudget
{
    public ProjectBudget()
    {
        super();
        registerInterface(IProjectBudget.class, this);
    }
    public ProjectBudget(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectBudget.class, this);
    }
    ...
    private ProjectBudgetController getController() throws BOSException
    {
        return (ProjectBudgetController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectBudgetCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectBudgetCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectBudgetCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectBudgetInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectBudgetInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectBudgetInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
