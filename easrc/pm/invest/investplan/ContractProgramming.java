...
public class ContractProgramming extends FDCBill implements IContractProgramming
{
    public ContractProgramming()
    {
        super();
        registerInterface(IContractProgramming.class, this);
    }
    public ContractProgramming(Context ctx)
    {
        super(ctx);
        registerInterface(IContractProgramming.class, this);
    }
    ...
    private ContractProgrammingController getController() throws BOSException
    {
        return (ContractProgrammingController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractProgrammingInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractProgrammingInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractProgrammingInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractProgrammingCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractProgrammingCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractProgrammingCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
