...
public class ProgrammingTemplateEntirePteEnonomy extends CoreBase implements IProgrammingTemplateEntirePteEnonomy
{
    public ProgrammingTemplateEntirePteEnonomy()
    {
        super();
        registerInterface(IProgrammingTemplateEntirePteEnonomy.class, this);
    }
    public ProgrammingTemplateEntirePteEnonomy(Context ctx)
    {
        super(ctx);
        registerInterface(IProgrammingTemplateEntirePteEnonomy.class, this);
    }
    ...
    private ProgrammingTemplateEntirePteEnonomyController getController() throws BOSException
    {
        return (ProgrammingTemplateEntirePteEnonomyController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingTemplateEntirePteEnonomyCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
