 ...
 * output class name
 */
public class InvestPlanDetailListUI extends AbstractInvestPlanDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InvestPlanDetailListUI.class);
    
    /**
     * output class constructor
     */
    public InvestPlanDetailListUI() throws Exception
    {
        super();
    }
