...
//    	setButtonStyle(btnDetails,"详细信息","imgTbtn_particular");
    	...
    	setButtonStyle(btnInsertLine,"新增框架投资规划(同级)","imgTbtn_insert");
    ...
    public void actionAddnewLine_actionPerformed(ActionEvent e) throws Exception{
    	...
    	if(rowIndex < 0){
    		...
    		if(o == null || o.toString().trim().length() == 0){
    			...
    			MsgBox.showInfo("分录第 "+(rowIndex+1)+" 行，框架投资规划编码超长\n请修改后再新增子级框架投资规划！");
    			return;
...
//			Object name = kdtEntires.getCell(i, "name").getValue();//框架投资规划模板名称
//			String proName = "";
//			String oldName = "";
//			if(name != null && name.toString().trim().length() > 0){
