...
import com.kingdee.eas.port.pm.invest.investplan.IProgrammingEntry;
...
public class ProgrammingEntryUtil {
	...
	public static void amountChange(List idList) throws Exception {
		...
		IProgrammingEntry iService = ProgrammingEntryFactory.getRemoteInstance();
		sic.clear();
...
//			ProgrammingEntryInfo programming = con.getProgrammingEntry();
...
//		}
	 ...
	 * @throws SQLException
	 */
	public static String isExitCostAccount(ProjectInfo project, CostAccountInfo costAccount) throws BOSException, SQLException {
...
//	}
	 ...
	 * @throws SQLException
	 */
	public static String getNewCostAccountID(ProjectInfo project, CostAccountInfo costAccount) throws BOSException,
			SQLException {
		String costAccountID = null;
		if (project == null && costAccount == null) {
			return costAccountID;
