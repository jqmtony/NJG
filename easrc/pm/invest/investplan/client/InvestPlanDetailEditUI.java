 ...
 * output class name
 */
public class InvestPlanDetailEditUI extends AbstractInvestPlanDetailEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(InvestPlanDetailEditUI.class);
    private ProgrammingEntryInfo pcInfo;
    private ProgrammingEntryInfo oldPcInfo;
    private ProgrammingEntryCollection pcCollection;
    private YearInvestPlanInfo yipInfo;
    /**
     * output class constructor
     */
    public InvestPlanDetailEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        if(getUIContext().get("SourceBillId")!=null)
        {
