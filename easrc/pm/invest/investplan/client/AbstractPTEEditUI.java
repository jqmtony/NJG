...
public abstract class AbstractPTEEditUI extends com.kingdee.eas.framework.client.CoreUI
{
    ...
    protected com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateEntireInfo programmingTemplateEntire = null;
    ...
    {
        super();
        this.defaultObjectName = "programmingTemplateEntire";
        jbInit();
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtCostEntries.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            ...
            public void editStarted(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtCostEntries.putBindContents("programmingTemplateEntire",new String[] {"id","costAccount.longNumber","costAccount.name","assignScale","contractScale","description"});
        ...
        this.kdtEconomyEntriese.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEconomyEntriese.putBindContents("programmingTemplateEntire",new String[] {"paymentType.name","scale","condition","description","id"});
...
kdcEconomy.getContentPane().setLayout(new BorderLayout(0, 0));        kdcEconomy.getContentPane().add(kdtEconomyEntriese, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("pteCost", com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateEntirePteCostInfo.class, this.kdtCostEntries, "userObject");
		...
		dataBinder.registerBinding("pteEnonomy", com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateEntirePteEnonomyInfo.class, this.kdtEconomyEntriese, "userObject");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.investplan.app.PTEEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.programmingTemplateEntire = (com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateEntireInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.investplan.client", "PTEEditUI");
    }
