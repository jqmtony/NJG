 ...
 * output class name
 */
public class ContractProgrammingListUI extends AbstractContractProgrammingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ContractProgrammingListUI.class);
	...
	protected void audit(List arg0) throws Exception {
	...
	protected void unAudit(List arg0) throws Exception {
