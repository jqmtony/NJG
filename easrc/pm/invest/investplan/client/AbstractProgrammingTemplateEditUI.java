...
public abstract class AbstractProgrammingTemplateEditUI extends com.kingdee.eas.basedata.framework.client.DataBaseSIEditUI
{
    ...
    protected com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateInfo editData = null;
    ...
    private void jbInit() throws Exception
    {
        ...
        // pnlSubject		
        this.pnlSubject.setVisible(false);
        // kdtEntires
        ...
        this.kdtCosetEntries.setVisible(false);
...
pnlSubject.setLayout(new BorderLayout(0, 0));        pnlSubject.add(kdtCosetEntries, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entires", com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateEntireInfo.class, this.kdtEntires, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.investplan.app.ProgrammingTemplateEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.pm.invest.investplan.ProgrammingTemplateInfo)ov;
    }
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
	    	...
	    	sic.add(new SelectorItemInfo("Entires.contractType.id"));
			sic.add(new SelectorItemInfo("Entires.contractType.name"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.investplan.client", "ProgrammingTemplateEditUI");
    }
    ...
    {
        return com.kingdee.eas.port.pm.invest.investplan.client.ProgrammingTemplateEditUI.class.getName();
    }
