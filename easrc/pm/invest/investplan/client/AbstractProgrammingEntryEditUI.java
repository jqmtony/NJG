 ...
 * output class name
 */
public abstract class AbstractProgrammingEntryEditUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProgrammingEntryEditUI.class);
    ...
    protected com.kingdee.eas.port.pm.invest.investplan.ProgrammingEntryInfo programmingEntry = null;
     ...
     */
    public AbstractProgrammingEntryEditUI() throws Exception
    {
        super();
        this.defaultObjectName = "programmingEntry";
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProgrammingEntryEditUI.class.getName());
...
kDContainerEconomy.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainerEconomy.getContentPane().add(kdtEconomy, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.investplan.app.ProgrammingEntryEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.programmingEntry = (com.kingdee.eas.port.pm.invest.investplan.ProgrammingEntryInfo)ov;
    }
    ...
    protected class ActionSubmit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProgrammingEntryEditUI.this, "ActionSubmit", "actionSubmit_actionPerformed", e);
        }
    }
    ...
    protected class ActionAttachment extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProgrammingEntryEditUI.this, "ActionAttachment", "actionAttachment_actionPerformed", e);
        }
    }
    ...
    protected class ActionSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProgrammingEntryEditUI.this, "ActionSelect", "actionSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionEdit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProgrammingEntryEditUI.this, "ActionEdit", "actionEdit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.investplan.client", "ProgrammingEntryEditUI");
    }
