...
public class InvestPlanDetailControllerBean extends AbstractInvestPlanDetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.pm.invest.investplan.app.InvestPlanDetailControllerBean");
}