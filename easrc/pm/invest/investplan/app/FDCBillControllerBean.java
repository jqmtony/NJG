...
public class FDCBillControllerBean extends AbstractFDCBillControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.port.pm.invest.investplan.app.FDCBillControllerBean");
...
//					projectInfo = ProjectFactory.getLocalInstance(ctx)
//						.getProjectInfo(new ObjectUuidPK(projectInfo.getId().toString()),sic);
//				}
...
//		initMap.put("serverDate",serverDate);
		...
		return paramMap;//return initMap;
	}
