...
public class ProgrammingEntryEntriesEn extends CoreBillEntryBase implements IProgrammingEntryEntriesEn
{
    public ProgrammingEntryEntriesEn()
    {
        super();
        registerInterface(IProgrammingEntryEntriesEn.class, this);
    }
    public ProgrammingEntryEntriesEn(Context ctx)
    {
        super(ctx);
        registerInterface(IProgrammingEntryEntriesEn.class, this);
    }
    ...
    private ProgrammingEntryEntriesEnController getController() throws BOSException
    {
        return (ProgrammingEntryEntriesEnController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProgrammingEntryEntriesEnCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
