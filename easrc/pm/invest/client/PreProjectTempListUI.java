 ...
 * output class name
 */
public class PreProjectTempListUI extends AbstractPreProjectTempListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PreProjectTempListUI.class);
    
    /**
     * output class constructor
     */
    public PreProjectTempListUI() throws Exception
    {
        super();
    }
