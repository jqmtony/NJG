...
public abstract class AbstractPreProjectEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        KDDatePicker kdtE1_actualPlanTime_DatePicker = new KDDatePicker();
        kdtE1_actualPlanTime_DatePicker.setName("kdtE1_actualPlanTime_DatePicker");
        kdtE1_actualPlanTime_DatePicker.setVisible(true);
        kdtE1_actualPlanTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtE1_actualPlanTime_CellEditor = new KDTDefaultCellEditor(kdtE1_actualPlanTime_DatePicker);
        this.kdtE1.getColumn("actualPlanTime").setEditor(kdtE1_actualPlanTime_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmttempName,prmtprojectName,prmtCU,pkLastUpdateTime,prmtLastUpdateUser,pkCreateTime,kdtE1,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,pkAuditTime,comboBizStatus,comboStatus,prmtperson,prmtdeparment,prmtprojectType}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(10, 564, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(10, 564, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(10, 588, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(10, 588, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateUser.setBounds(new Rectangle(370, 564, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(370, 564, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(370, 588, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(370, 588, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCU.setBounds(new Rectangle(731, 33, 270, 19));
        this.add(contCU, new KDLayout.Constraints(731, 33, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contBizDate.setBounds(new Rectangle(370, 11, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(370, 11, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contAuditor.setBounds(new Rectangle(731, 564, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(731, 564, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contStatus.setBounds(new Rectangle(731, 8, 270, 19));
        this.add(contStatus, new KDLayout.Constraints(731, 8, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contAuditTime.setBounds(new Rectangle(731, 588, 270, 19));
        this.add(contAuditTime, new KDLayout.Constraints(731, 588, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttempName.setBounds(new Rectangle(731, 59, 270, 19));
        this.add(conttempName, new KDLayout.Constraints(731, 59, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contprojectName.setBounds(new Rectangle(10, 33, 270, 19));
        this.add(contprojectName, new KDLayout.Constraints(10, 33, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtE1.setBounds(new Rectangle(10, 93, 990, 448));
        ...
        this.add(kdtE1_detailPanel, new KDLayout.Constraints(10, 93, 990, 448, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contperson.setBounds(new Rectangle(10, 59, 270, 19));
        this.add(contperson, new KDLayout.Constraints(10, 59, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contdeparment.setBounds(new Rectangle(370, 59, 270, 19));
        this.add(contdeparment, new KDLayout.Constraints(370, 59, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contprojectType.setBounds(new Rectangle(370, 35, 270, 19));
        this.add(contprojectType, new KDLayout.Constraints(370, 35, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("E1.actualPlanTime", java.util.Date.class, this.kdtE1, "actualPlanTime.text");
    ...
    {
        super.onShow();
        this.prmttempName.requestFocusInWindow();
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("E1.actualPlanTime", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("E1.actualPlanTime"));
