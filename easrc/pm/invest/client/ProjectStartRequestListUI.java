 ...
 * output class name
 */
public class ProjectStartRequestListUI extends AbstractProjectStartRequestListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectStartRequestListUI.class);
    
    /**
     * output class constructor
     */
    public ProjectStartRequestListUI() throws Exception
    {
        super();
    }
