 ...
 * output class name
 */
public class PreProjectTwoListUI extends AbstractPreProjectTwoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PreProjectTwoListUI.class);
    
    /**
     * output class constructor
     */
    public PreProjectTwoListUI() throws Exception
    {
        super();
    }
