 ...
 * output class name
 */
public class ProjectBudgetListUI extends AbstractProjectBudgetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectBudgetListUI.class);
    
    /**
     * output class constructor
     */
    public ProjectBudgetListUI() throws Exception
    {
        super();
    }
