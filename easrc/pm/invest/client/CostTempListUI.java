 ...
 * output class name
 */
public class CostTempListUI extends AbstractCostTempListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostTempListUI.class);
    
    /**
     * output class constructor
     */
    public CostTempListUI() throws Exception
    {
        super();
    }
