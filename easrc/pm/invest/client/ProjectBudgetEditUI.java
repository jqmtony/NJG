 ...
 * output class name
 */
public class ProjectBudgetEditUI extends AbstractProjectBudgetEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectBudgetEditUI.class);
    
    /**
     * output class constructor
     */
    public ProjectBudgetEditUI() throws Exception
    {
        super();
    }
    /**
