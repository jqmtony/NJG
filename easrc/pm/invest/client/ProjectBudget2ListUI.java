 ...
 * output class name
 */
public class ProjectBudget2ListUI extends AbstractProjectBudget2ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectBudget2ListUI.class);
    
    /**
     * output class constructor
     */
    public ProjectBudget2ListUI() throws Exception
    {
        super();
    }
