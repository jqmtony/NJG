...
public abstract class AbstractProjectBudget2ListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","year.name","projectName.name","projectType.name","CU.name","estimateCost","bizDate","person.name","deparment.name","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id"};
    }
