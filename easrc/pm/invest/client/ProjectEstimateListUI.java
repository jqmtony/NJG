 ...
 * output class name
 */
public class ProjectEstimateListUI extends AbstractProjectEstimateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectEstimateListUI.class);
    
    /**
     * output class constructor
     */
    public ProjectEstimateListUI() throws Exception
    {
        super();
    }
