...
public abstract class AbstractYearInvestPlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","objectState","CU.name","seq","projectType.name","projectName","BIMUDF0027","amount","investAmount","scheme","analyse","year.name","planType","fundSource.name","companyProperty.name","buildType.name","bizDate","requestOrg.name","requestPerson.name","planStartDate","planEndDate","chancedAmount","addInvestAmount","address","balance","project.name","CU.id","id"};
    }
