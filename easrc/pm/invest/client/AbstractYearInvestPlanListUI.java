...
public abstract class AbstractYearInvestPlanListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","projectName","status","objectState","CU.name","requestOrg.name","requestPerson.name","planStartDate","planEndDate","amount","investAmount","chancedAmount","addInvestAmount","planType","address","CU.id","id","year.name","balance","companyProperty.name","seq","desc"};
    }
