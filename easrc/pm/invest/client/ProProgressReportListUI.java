 ...
 * output class name
 */
public class ProProgressReportListUI extends AbstractProProgressReportListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProProgressReportListUI.class);
    
    /**
     * output class constructor
     */
    public ProProgressReportListUI() throws Exception
    {
        super();
    }
