...
public class PreProjectListUI extends AbstractPreProjectListUI
{
    ...
    public void onLoad() throws Exception {
    	...
    	tblMain.getColumn("CU.id").getStyleAttributes().setHided(true);
    	tblMain.getColumn("projectName.id").getStyleAttributes().setHided(true);
    }
    ...
    public void actionWorkReport_actionPerformed(ActionEvent e)throws Exception {
        ...
        if(preInfo.getStatus().equals(XRBillStatusEnum.AUDITED)){
            ...
            uiWindow = UIFactory.createUIFactory(UIFactoryName.NEWTAB).create(PreProjectEditUI.class.getName(), uiContext, null, OprtState.EDIT);
            uiWindow.show(); 
         }else{
