...
public abstract class AbstractYIPlanAccredEditUI extends com.kingdee.eas.xr.client.XRBillBaseEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        kdtE2_accreConclu_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.port.pm.invest.ObjectStateEnum").toArray());
        ...
        KDDatePicker kdtE2_aduitTime_DatePicker = new KDDatePicker();
        kdtE2_aduitTime_DatePicker.setName("kdtE2_aduitTime_DatePicker");
        kdtE2_aduitTime_DatePicker.setVisible(true);
        kdtE2_aduitTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtE2_aduitTime_CellEditor = new KDTDefaultCellEditor(kdtE2_aduitTime_DatePicker);
        this.kdtE2.getColumn("aduitTime").setEditor(kdtE2_aduitTime_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {kdtE2,pkaccredDate,prmtaccredPerson,prmtCU,pkLastUpdateTime,prmtLastUpdateUser,pkCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,pkAuditTime,comboBizStatus,comboStatus,accredType,txtremark,kdtE1,accredInformation}));
...
vo.put("accreConclu","1");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("E1.E2.accreConclu", com.kingdee.util.enums.Enum.class, this.kdtE2, "accreConclu.text");
		dataBinder.registerBinding("E1.E2.aduitTime", java.util.Date.class, this.kdtE2, "aduitTime.text");
    ...
    {
        super.onShow();
        this.kdtE2.requestFocusInWindow();
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("E1.E2.aduitTime", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("E1.E2.aduitTime"));
