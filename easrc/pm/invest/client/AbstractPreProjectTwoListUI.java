 ...
 * output class name
 */
public abstract class AbstractPreProjectTwoListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPreProjectTwoListUI.class);
    /**
     * output class constructor
     */
    public AbstractPreProjectTwoListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPreProjectTwoListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.app.PreProjectTwoListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.client", "PreProjectTwoListUI");
    }
