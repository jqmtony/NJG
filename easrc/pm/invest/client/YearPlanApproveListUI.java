 ...
 * output class name
 */
public class YearPlanApproveListUI extends AbstractYearPlanApproveListUI
{
    private static final Logger logger = CoreUIObject.getLogger(YearPlanApproveListUI.class);
    
    /**
     * output class constructor
     */
    public YearPlanApproveListUI() throws Exception
    {
        super();
    }
