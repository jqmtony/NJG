 ...
 * output class name
 */
public abstract class AbstractYearPlanTrialListUI extends com.kingdee.eas.framework.client.BillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractYearPlanTrialListUI.class);
    /**
     * output class constructor
     */
    public AbstractYearPlanTrialListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractYearPlanTrialListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.pm.invest.app", "YearPlanTrialQuery");
        // CoreUI		
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(10, 23, 996, 601));
        this.add(tblMain, new KDLayout.Constraints(10, 23, 996, 601, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.pm.invest.app.YearPlanTrialListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.pm.invest.client", "YearPlanTrialListUI");
    }
