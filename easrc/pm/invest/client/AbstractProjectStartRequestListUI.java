...
public abstract class AbstractProjectStartRequestListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"status","number","bizDate","year.name","projectName.name","projectType.name","amount","person.name","deparment.name","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","scheme","id","CU.id"};
    }
