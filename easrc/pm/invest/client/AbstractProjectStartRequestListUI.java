...
public abstract class AbstractProjectStartRequestListUI extends com.kingdee.eas.xr.client.XRBillBaseListUI
{
    ...
    {
        return new String[] {"number","status","projectType.name","scheme","year.name","projectName.name","amount","bizDate","person.name","deparment.name","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","auditor.name","auditTime","id","CU.id","Entry.type.name","BIMUDF0022","dec","wuxu"};
    }
