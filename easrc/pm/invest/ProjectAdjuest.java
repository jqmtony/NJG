...
public class ProjectAdjuest extends XRBillBase implements IProjectAdjuest
{
    public ProjectAdjuest()
    {
        super();
        registerInterface(IProjectAdjuest.class, this);
    }
    public ProjectAdjuest(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectAdjuest.class, this);
    }
    ...
    private ProjectAdjuestController getController() throws BOSException
    {
        return (ProjectAdjuestController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectAdjuestCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectAdjuestCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectAdjuestCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectAdjuestInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectAdjuestInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectAdjuestInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
