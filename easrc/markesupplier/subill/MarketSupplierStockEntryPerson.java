...
public class MarketSupplierStockEntryPerson extends CoreBillEntryBase implements IMarketSupplierStockEntryPerson
{
    public MarketSupplierStockEntryPerson()
    {
        super();
        registerInterface(IMarketSupplierStockEntryPerson.class, this);
    }
    public MarketSupplierStockEntryPerson(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierStockEntryPerson.class, this);
    }
    ...
    private MarketSupplierStockEntryPersonController getController() throws BOSException
    {
        return (MarketSupplierStockEntryPersonController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryPersonCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
