...
public class MarketSupplierStockEntryAtt extends CoreBillEntryBase implements IMarketSupplierStockEntryAtt
{
    public MarketSupplierStockEntryAtt()
    {
        super();
        registerInterface(IMarketSupplierStockEntryAtt.class, this);
    }
    public MarketSupplierStockEntryAtt(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierStockEntryAtt.class, this);
    }
    ...
    private MarketSupplierStockEntryAttController getController() throws BOSException
    {
        return (MarketSupplierStockEntryAttController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockEntryAttCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
