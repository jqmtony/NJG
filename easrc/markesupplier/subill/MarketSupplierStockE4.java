...
public class MarketSupplierStockE4 extends CoreBillEntryBase implements IMarketSupplierStockE4
{
    public MarketSupplierStockE4()
    {
        super();
        registerInterface(IMarketSupplierStockE4.class, this);
    }
    public MarketSupplierStockE4(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierStockE4.class, this);
    }
    ...
    private MarketSupplierStockE4Controller getController() throws BOSException
    {
        return (MarketSupplierStockE4Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockE4Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
