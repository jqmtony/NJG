...
import com.kingdee.eas.port.markesupplier.subase.SupplierTypeFactory;
...
public class SupplierTypeControllerBean extends AbstractSupplierTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.port.markesupplier.subase.app.SupplierTypeControllerBean");
    
    protected IObjectPK _addnew(Context ctx, IObjectValue model)throws BOSException, EASBizException {
    	SupplierTypeInfo info = (SupplierTypeInfo)model;
    ...
    protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model)throws BOSException, EASBizException {
    	...
    	SupplierTypeFactory.getLocalInstance(ctx).update(new ObjectUuidPK(Info.getId()), Info);
    }
