 ...
 * output class name
 */
public abstract class AbstractVisibilityListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVisibilityListUI.class);
    /**
     * output class constructor
     */
    public AbstractVisibilityListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractVisibilityListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.app", "VisibilityQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.VisibilityListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "VisibilityListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.VisibilityEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.VisibilityFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.port.markesupplier.subase.VisibilityInfo objectValue = new com.kingdee.eas.port.markesupplier.subase.VisibilityInfo();		
        return objectValue;
    }
