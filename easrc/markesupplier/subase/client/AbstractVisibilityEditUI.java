 ...
 * output class name
 */
public abstract class AbstractVisibilityEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVisibilityEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.VisibilityInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractVisibilityEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractVisibilityEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 334, 260));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(27, 18, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(27, 45, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(27, 72, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(581, 77, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(485, 187, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(27, 91, 270, 142));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.VisibilityEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.VisibilityInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "VisibilityEditUI");
    }
