 ...
 * output class name
 */
public abstract class AbstractMarketSupplierAttachListEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSupplierAttachListEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSupplierAttachListInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSupplierAttachListEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSupplierAttachListEditUI.class.getName());
        ...
        this.prmtsupplierFileType.setVisible(false);		
    ...
    {
        this.setBounds(new Rectangle(0, 0, 336, 267));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(29, 22, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(29, 55, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(29, 88, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(342, 213, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(412, 146, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(29, 108, 270, 129));
        this.add(contremake, null);
        contsupplierFileType.setBounds(new Rectangle(304, 239, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSupplierAttachListEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSupplierAttachListInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSupplierAttachListEditUI");
    }
