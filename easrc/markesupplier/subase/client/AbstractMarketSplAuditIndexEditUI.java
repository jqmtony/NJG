 ...
 * output class name
 */
public abstract class AbstractMarketSplAuditIndexEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSplAuditIndexEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSplAuditIndexInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSplAuditIndexEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSplAuditIndexEditUI.class.getName());
        ...
        this.contthreeStandard.setBoundLabelLength(16);		
        ...
        this.txtthreeStandard.setRequired(true);		
        this.txtthreeStandard.setMaxLength(255);
        // scrollPaneremake
        // txtremake		
        this.txtremake.setVisible(true);		
        this.txtremake.setRequired(true);		
        ...
        this.prmtAccreditationType.setVisible(false);		
    ...
    {
        this.setBounds(new Rectangle(0, 0, 323, 298));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(25, 14, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(25, 42, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(25, 71, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(782, 142, 270, 19));
        this.add(kDLabelContainer4, null);
        contthreeStandard.setBounds(new Rectangle(25, 94, 270, 86));
        this.add(contthreeStandard, null);
        contremake.setBounds(new Rectangle(25, 181, 270, 89));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(394, 44, 270, 19));
        this.add(chkisEnable, null);
        contAccreditationType.setBounds(new Rectangle(295, 89, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSplAuditIndexEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSplAuditIndexInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSplAuditIndexEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtthreeStandard.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"3分标准"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtremake.getText())) {
