 ...
 * output class name
 */
public abstract class AbstractSupplierTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractSupplierTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.app", "SupplierTypeQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.SupplierTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "SupplierTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.SupplierTypeEditUI.class.getName();
    }
