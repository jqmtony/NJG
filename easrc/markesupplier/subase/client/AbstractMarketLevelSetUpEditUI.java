 ...
 * output class name
 */
public abstract class AbstractMarketLevelSetUpEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketLevelSetUpEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketLevelSetUpInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketLevelSetUpEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketLevelSetUpEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 333, 271));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(32, 20, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(32, 48, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(32, 77, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(505, 109, 270, 19));
        this.add(kDLabelContainer4, null);
        contremake.setBounds(new Rectangle(32, 97, 270, 153));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(535, 90, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketLevelSetUpEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketLevelSetUpInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketLevelSetUpEditUI");
    }
