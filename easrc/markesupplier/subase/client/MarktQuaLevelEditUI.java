 ...
 * output class name
 */
public class MarktQuaLevelEditUI extends AbstractMarktQuaLevelEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarktQuaLevelEditUI.class);
    
    /**
     * output class constructor
     */
    public MarktQuaLevelEditUI() throws Exception
    {
        super();
    }
    /**
