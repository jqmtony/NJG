 ...
 * output class name
 */
public abstract class AbstractMarktQuaLevelListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarktQuaLevelListUI.class);
    /**
     * output class constructor
     */
    public AbstractMarktQuaLevelListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarktQuaLevelListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.app", "MarktQuaLevelQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarktQuaLevelListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarktQuaLevelListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.MarktQuaLevelEditUI.class.getName();
    }
