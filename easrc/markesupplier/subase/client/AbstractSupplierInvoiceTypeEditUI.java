 ...
 * output class name
 */
public abstract class AbstractSupplierInvoiceTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierInvoiceTypeEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.SupplierInvoiceTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSupplierInvoiceTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierInvoiceTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 312, 288));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(20, 12, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(20, 42, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(20, 72, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(487, 81, 270, 19));
        this.add(kDLabelContainer4, null);
        chkisEnable.setBounds(new Rectangle(510, 121, 270, 19));
        this.add(chkisEnable, null);
        contremake.setBounds(new Rectangle(20, 92, 270, 175));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.SupplierInvoiceTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.SupplierInvoiceTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "SupplierInvoiceTypeEditUI");
    }
