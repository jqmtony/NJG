 ...
 * output class name
 */
public abstract class AbstractSupplierInvoiceTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierInvoiceTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractSupplierInvoiceTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractSupplierInvoiceTypeListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.SupplierInvoiceTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "SupplierInvoiceTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.port.markesupplier.subase.client.SupplierInvoiceTypeEditUI.class.getName();
    }
