 ...
 * output class name
 */
public abstract class AbstractMarketSplServiceTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSplServiceTypeEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSplServiceTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSplServiceTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSplServiceTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 344, 263));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(37, 19, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(37, 50, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(37, 82, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(494, 147, 270, 19));
        this.add(kDLabelContainer4, null);
        contremake.setBounds(new Rectangle(37, 102, 270, 128));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(488, 101, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSplServiceTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSplServiceTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSplServiceTypeEditUI");
    }
