 ...
 * output class name
 */
public class MarketGradeSetUpEditUI extends AbstractMarketGradeSetUpEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarketGradeSetUpEditUI.class);
    
    /**
     * output class constructor
     */
    public MarketGradeSetUpEditUI() throws Exception
    {
        super();
    }
    ...
    public void actionEdit_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	MarketGradeSetUpInfo Info = (MarketGradeSetUpInfo)getBizInterface().getValue(pk);
    	if(Info.isIsEnable()){
