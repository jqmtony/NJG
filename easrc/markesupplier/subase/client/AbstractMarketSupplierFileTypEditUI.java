 ...
 * output class name
 */
public abstract class AbstractMarketSupplierFileTypEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSupplierFileTypEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSupplierFileTypInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSupplierFileTypEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSupplierFileTypEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 330, 258));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(27, 22, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(27, 54, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(27, 86, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(249, 132, 270, 19));
        this.add(kDLabelContainer4, null);
        contremake.setBounds(new Rectangle(27, 107, 270, 129));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(290, 193, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSupplierFileTypEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSupplierFileTypInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSupplierFileTypEditUI");
    }
