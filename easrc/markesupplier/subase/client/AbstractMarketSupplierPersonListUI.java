 ...
 * output class name
 */
public abstract class AbstractMarketSupplierPersonListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSupplierPersonListUI.class);
    /**
     * output class constructor
     */
    public AbstractMarketSupplierPersonListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSupplierPersonListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSupplierPersonListUI");
    }
