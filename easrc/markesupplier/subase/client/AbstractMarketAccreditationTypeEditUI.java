 ...
 * output class name
 */
public abstract class AbstractMarketAccreditationTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketAccreditationTypeEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketAccreditationTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketAccreditationTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketAccreditationTypeEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 325, 244));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(29, 19, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(29, 49, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(29, 80, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(578, 110, 270, 19));
        this.add(kDLabelContainer4, null);
        contremake.setBounds(new Rectangle(29, 100, 270, 114));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(492, 156, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketAccreditationTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketAccreditationTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketAccreditationTypeEditUI");
    }
