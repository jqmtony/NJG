 ...
 * output class name
 */
public abstract class AbstractMarketSplAreaEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSplAreaEditUI.class);
    ...
    protected com.kingdee.eas.port.markesupplier.subase.MarketSplAreaInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMarketSplAreaEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSplAreaEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 341, 275));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(37, 22, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(37, 53, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(37, 85, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(448, 130, 270, 19));
        this.add(kDLabelContainer4, null);
        contremake.setBounds(new Rectangle(37, 104, 270, 144));
        this.add(contremake, null);
        chkisEnable.setBounds(new Rectangle(516, 193, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.port.markesupplier.subase.app.MarketSplAreaEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.port.markesupplier.subase.MarketSplAreaInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.port.markesupplier.subase.client", "MarketSplAreaEditUI");
    }
